...
DummyOutThread::DummyOutThread(DummyAudioOut *out) { out_ = out; };
...
void DummyAudioOut::Close() { SAFE_FREE(primarySoundBuffer_); }
...
std::string DummyAudioOut::GetAudioAPI() { return std::string("Internal"); };

std::string DummyAudioOut::GetAudioDevice() { return std::string("Dummy"); };

int DummyAudioOut::GetAudioBufferSize() { return 0; };

int DummyAudioOut::GetAudioRequestedBufferSize() { return 0; }

int DummyAudioOut::GetAudioPreBufferCount() { return 0; };

double DummyAudioOut::GetStreamTime() { return 0; };
