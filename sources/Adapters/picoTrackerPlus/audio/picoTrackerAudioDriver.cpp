...
bool picoTrackerAudioDriver::InitDriver() {
  ...
  uint offset = pio_add_program(AUDIO_PIO, &audio_codec_i2s_program);

  audio_codec_i2s_program_init(AUDIO_PIO, AUDIO_SM, offset, AUDIO_SDATA,
                               AUDIO_BCLK);
