 ...
 */
uint32_t HAL_GetHalVersion(void) { return __STM32H7xx_HAL_VERSION; }

/**
 * @brief  Returns the device revision identifier.
 * @retval Device revision identifier
 */
uint32_t HAL_GetREVID(void) { return ((DBGMCU->IDCODE) >> 16); }
 ...
 * @retval None
 */
void HAL_SYSCFG_EnableCM7BOOT(void) { SET_BIT(SYSCFG->UR1, SYSCFG_UR1_BCM7); }
 ...
 * @retval None
 */
void HAL_SYSCFG_EnableCM4BOOT(void) { SET_BIT(SYSCFG->UR1, SYSCFG_UR1_BCM4); }
