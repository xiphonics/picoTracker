 ...
 *         clocks (SDMMC, CKPER, FMC, QSPI*, OSPI*, DSI, SPI45, SPDIF, DFSDM1,
 * DFSDM2*, FDCAN, SWPMI, SAI23*,SAI2A*, SAI2B*, SAI1, SPI123, USART234578,
 * USART16 (USART16910*), RNG, HRTIM1*, I2C123 (I2C1235*), USB, CEC, LPTIM1,
 * LPUART1, I2C4, LPTIM2, LPTIM345, ADC, SAI4A*, SAI4B*, SPI6, RTC).
...
HAL_RCCEx_PeriphCLKConfig(RCC_PeriphCLKInitTypeDef *PeriphClkInit) {
  ...
  if (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_SPDIFRX) ==
    ...
    case RCC_SPDIFRXCLKSOURCE_PLL2: /* PLL2 is used as clock source for
                                       SPDIFRX*/
  ...
  /*---------------------------- SAI2A configuration
   * -------------------------------*/
  if (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_SAI2A) ==
      RCC_PERIPHCLK_SAI2A) {
  ...
  /*---------------------------- SAI2B configuration
   * -------------------------------*/
  if (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_SAI2B) ==
      RCC_PERIPHCLK_SAI2B) {
  ...
  if (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_SPI6) ==
    ...
    case RCC_SPI6CLKSOURCE_PCLK4: /* SRD/D3 PCLK1 (PCLK4) as clock source for
                                     SPI6*/
  ...
  if (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_RTC) ==
    ...
    if (ret == HAL_OK) {
      ...
      /* If LSE is selected as RTC clock source (and enabled prior to Backup
       * Domain reset), wait for LSE reactivation */
  ...
  if (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_USART234578) ==
    ...
    case RCC_USART234578CLKSOURCE_PCLK1: /* CD/D2 PCLK1 as clock source for
                                            USART2/3/4/5/7/8 */
      /* USART2/3/4/5/7/8 clock source configuration done later after clock
       * selection check */
      break;

    case RCC_USART234578CLKSOURCE_PLL2: /* PLL2 is used as clock source for
                                           USART2/3/4/5/7/8 */
      ret = RCCEx_PLL2_Config(&(PeriphClkInit->PLL2), DIVIDER_Q_UPDATE);
      /* USART2/3/4/5/7/8 clock source configuration done later after clock
       * selection check */
    ...
    case RCC_USART234578CLKSOURCE_PLL3: /* PLL3 is used as clock source for
                                           USART2/3/4/5/7/8 */
      ret = RCCEx_PLL3_Config(&(PeriphClkInit->PLL3), DIVIDER_Q_UPDATE);
      /* USART2/3/4/5/7/8 clock source configuration done later after clock
       * selection check */
  ...
  if (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_LPUART1) ==
    ...
    case RCC_LPUART1CLKSOURCE_PCLK4: /* SRD/D3 PCLK1 (PCLK4) as clock source for
                                        LPUART1 */
  ...
  if (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_LPTIM2) ==
    ...
    case RCC_LPTIM2CLKSOURCE_PCLK4: /* SRD/D3 PCLK1 (PCLK4) as clock source for
                                       LPTIM2*/
      /* LPTIM2 clock source configuration done later after clock selection
       * check */
      break;
  ...
  if (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_LPTIM345) ==
    ...
    case RCC_LPTIM345CLKSOURCE_PCLK4: /* SRD/D3 PCLK1 (PCLK4) as clock source
                                         for LPTIM3/4/5 */
      /* LPTIM3/4/5 clock source configuration done later after clock selection
       * check */
      break;

    case RCC_LPTIM345CLKSOURCE_PLL2: /* PLL2 is used as clock source for
                                        LPTIM3/4/5 */
      ret = RCCEx_PLL2_Config(&(PeriphClkInit->PLL2), DIVIDER_P_UPDATE);
    ...
    case RCC_LPTIM345CLKSOURCE_PLL3: /* PLL3 is used as clock source for
                                        LPTIM3/4/5 */
      ret = RCCEx_PLL3_Config(&(PeriphClkInit->PLL3), DIVIDER_R_UPDATE);
  ...
  if (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_I2C1235) ==
    ...
    if ((PeriphClkInit->I2c1235ClockSelection) == RCC_I2C1235CLKSOURCE_PLL3) {
      if (RCCEx_PLL3_Config(&(PeriphClkInit->PLL3), DIVIDER_R_UPDATE) !=
          HAL_OK) {
        status = HAL_ERROR;
      }
    }
  ...
  /*---------------------------- PLL2 configuration
   * -------------------------------*/
  if (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_PLL2_DIVP) ==
  ...
  if (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_PLL2_DIVQ) ==
  ...
  if (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_PLL3_DIVQ) ==
  ...
  if (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_PLL3_DIVR) ==
 ...
 * clocks : (SDMMC, CKPER, FMC, QSPI*, OSPI*, DSI*, SPI45, SPDIF, DFSDM1,
 * DFSDM2*, FDCAN, SWPMI, SAI23*, SAI1, SPI123, USART234578, USART16, RNG,
 * HRTIM1*, I2C123 (I2C1235*), USB, CEC, LPTIM1, LPUART1, I2C4, LPTIM2,
 * LPTIM345, ADC. SAI4A*, SAI4B*, SPI6, RTC, TIM).
 * @retval None
 *
 *   (*) : Available on some STM32H7 lines only.
 */
void HAL_RCCEx_GetPeriphCLKConfig(RCC_PeriphCLKInitTypeDef *PeriphClkInit) {
  ...
  PeriphClkInit->PeriphClockSelection =
      ...
      RCC_PERIPHCLK_LPUART1 | RCC_PERIPHCLK_I2C4 | RCC_PERIPHCLK_LPTIM1 |
      RCC_PERIPHCLK_LPTIM2 | RCC_PERIPHCLK_LPTIM345 | RCC_PERIPHCLK_SAI1 |
      RCC_PERIPHCLK_SPI123 | RCC_PERIPHCLK_SPI45 | RCC_PERIPHCLK_SPI6 |
      RCC_PERIPHCLK_FDCAN | RCC_PERIPHCLK_SDMMC | RCC_PERIPHCLK_RNG |
      RCC_PERIPHCLK_USB | RCC_PERIPHCLK_ADC | RCC_PERIPHCLK_SWPMI1 |
      RCC_PERIPHCLK_DFSDM1 | RCC_PERIPHCLK_RTC | RCC_PERIPHCLK_CEC |
      RCC_PERIPHCLK_FMC | RCC_PERIPHCLK_SPDIFRX | RCC_PERIPHCLK_TIM |
      RCC_PERIPHCLK_CKPER;
   ...
   * -----------------------------------------------*/
  PeriphClkInit->PLL3.PLL3M =
      (uint32_t)((RCC->PLLCKSELR & RCC_PLLCKSELR_DIVM3) >>
                 RCC_PLLCKSELR_DIVM3_Pos);
  PeriphClkInit->PLL3.PLL3N =
      (uint32_t)((RCC->PLL3DIVR & RCC_PLL3DIVR_N3) >> RCC_PLL3DIVR_N3_Pos) + 1U;
  PeriphClkInit->PLL3.PLL3R =
      (uint32_t)((RCC->PLL3DIVR & RCC_PLL3DIVR_R3) >> RCC_PLL3DIVR_R3_Pos) + 1U;
  PeriphClkInit->PLL3.PLL3P =
      (uint32_t)((RCC->PLL3DIVR & RCC_PLL3DIVR_P3) >> RCC_PLL3DIVR_P3_Pos) + 1U;
  PeriphClkInit->PLL3.PLL3Q =
      (uint32_t)((RCC->PLL3DIVR & RCC_PLL3DIVR_Q3) >> RCC_PLL3DIVR_Q3_Pos) + 1U;
  PeriphClkInit->PLL3.PLL3RGE =
      (uint32_t)((RCC->PLLCFGR & RCC_PLLCFGR_PLL3RGE) >>
                 RCC_PLLCFGR_PLL3RGE_Pos);
  PeriphClkInit->PLL3.PLL3VCOSEL =
      (uint32_t)((RCC->PLLCFGR & RCC_PLLCFGR_PLL3VCOSEL) >>
                 RCC_PLLCFGR_PLL3VCOSEL_Pos);

  /* Get the PLL2 Clock configuration
   * -----------------------------------------------*/
  PeriphClkInit->PLL2.PLL2M =
      (uint32_t)((RCC->PLLCKSELR & RCC_PLLCKSELR_DIVM2) >>
                 RCC_PLLCKSELR_DIVM2_Pos);
  PeriphClkInit->PLL2.PLL2N =
      (uint32_t)((RCC->PLL2DIVR & RCC_PLL2DIVR_N2) >> RCC_PLL2DIVR_N2_Pos) + 1U;
  PeriphClkInit->PLL2.PLL2R =
      (uint32_t)((RCC->PLL2DIVR & RCC_PLL2DIVR_R2) >> RCC_PLL2DIVR_R2_Pos) + 1U;
  PeriphClkInit->PLL2.PLL2P =
      (uint32_t)((RCC->PLL2DIVR & RCC_PLL2DIVR_P2) >> RCC_PLL2DIVR_P2_Pos) + 1U;
  PeriphClkInit->PLL2.PLL2Q =
      (uint32_t)((RCC->PLL2DIVR & RCC_PLL2DIVR_Q2) >> RCC_PLL2DIVR_Q2_Pos) + 1U;
  PeriphClkInit->PLL2.PLL2RGE =
      (uint32_t)((RCC->PLLCFGR & RCC_PLLCFGR_PLL2RGE) >>
                 RCC_PLLCFGR_PLL2RGE_Pos);
  PeriphClkInit->PLL2.PLL2VCOSEL =
      (uint32_t)((RCC->PLLCFGR & RCC_PLLCFGR_PLL2VCOSEL) >>
...
uint32_t HAL_RCCEx_GetPeriphCLKFreq(uint64_t PeriphClk) {
  ...
  if (PeriphClk == RCC_PERIPHCLK_SAI1) {
    ...
    case (RCC_SAI23CLKSOURCE_PIN): /* External clock is the clock source for
                                      SAI2/3 */
    {
      frequency = EXTERNAL_CLOCK_VALUE;
      break;
    ...
    case (RCC_SAI2ACLKSOURCE_PIN): /* External clock is the clock source for
                                      SAI2A */
    {
      frequency = EXTERNAL_CLOCK_VALUE;
      break;
    ...
    case (RCC_SAI2BCLKSOURCE_PIN): /* External clock is the clock source for
                                      SAI2B */
    {
      frequency = EXTERNAL_CLOCK_VALUE;
      break;
    ...
    case (RCC_SPI123CLKSOURCE_PIN): /* External clock is the clock source for
                                       I2S */
    {
      frequency = EXTERNAL_CLOCK_VALUE;
      break;
    ...
    switch (srcclk) {
    case RCC_SPI6CLKSOURCE_D3PCLK1: /* D3PCLK1 (PCLK4) is the clock source for
                                       SPI6 */
    {
 ...
 *         right D1PCLK1 value. Otherwise, any configuration based on this
...
uint32_t HAL_RCCEx_GetD1PCLK1Freq(void) {
  ...
  return (HAL_RCC_GetHCLKFreq() >>
          (D1CorePrescTable[(RCC->D1CFGR & RCC_D1CFGR_D1PPRE) >>
                            RCC_D1CFGR_D1PPRE_Pos] &
           0x1FU));
#else
  /* Get HCLK source and Compute D1PCLK1 frequency ---------------------------*/
  return (HAL_RCC_GetHCLKFreq() >>
          (D1CorePrescTable[(RCC->CDCFGR1 & RCC_CDCFGR1_CDPPRE) >>
 ...
 *         right D3PCLK1 value. Otherwise, any configuration based on this
 * function will be incorrect.
...
uint32_t HAL_RCCEx_GetD3PCLK1Freq(void) {
  ...
  return (HAL_RCC_GetHCLKFreq() >>
          (D1CorePrescTable[(RCC->D3CFGR & RCC_D3CFGR_D3PPRE) >>
                            RCC_D3CFGR_D3PPRE_Pos] &
           0x1FU));
#else
  /* Get HCLK source and Compute D3PCLK1 frequency ---------------------------*/
  return (HAL_RCC_GetHCLKFreq() >>
          (D1CorePrescTable[(RCC->SRDCFGR & RCC_SRDCFGR_SRDPPRE) >>
...
void HAL_RCCEx_GetPLL2ClockFreq(PLL2_ClocksTypeDef *PLL2_Clocks) {
  ...
  */
  ...
  pll2fracen =
      (RCC->PLLCFGR & RCC_PLLCFGR_PLL2FRACEN) >> RCC_PLLCFGR_PLL2FRACEN_Pos;
  fracn2 = (float_t)(uint32_t)(pll2fracen *
                               ((RCC->PLL2FRACR & RCC_PLL2FRACR_FRACN2) >> 3));
  ...
  if (pll2m != 0U) {
    ...
    case RCC_PLLSOURCE_HSI: /* HSI used as PLL clock source */
      ...
      if (__HAL_RCC_GET_FLAG(RCC_FLAG_HSIDIV) != 0U) {
        ...
        pll2vco = ((float_t)hsivalue / (float_t)pll2m) *
                  ((float_t)(uint32_t)(RCC->PLL2DIVR & RCC_PLL2DIVR_N2) +
    ...
    PLL2_Clocks->PLL2_P_Frequency =
        (uint32_t)(float_t)(pll2vco / ((float_t)(uint32_t)((RCC->PLL2DIVR &
                                                            RCC_PLL2DIVR_P2) >>
                                                           9) +
                                       (float_t)1));
...
void HAL_RCCEx_GetPLL3ClockFreq(PLL3_ClocksTypeDef *PLL3_Clocks) {
  ...
  */
  ...
  pll3fracen =
      (RCC->PLLCFGR & RCC_PLLCFGR_PLL3FRACEN) >> RCC_PLLCFGR_PLL3FRACEN_Pos;
  fracn3 = (float_t)(uint32_t)(pll3fracen *
                               ((RCC->PLL3FRACR & RCC_PLL3FRACR_FRACN3) >> 3));
  ...
  if (pll3m != 0U) {
    ...
    case RCC_PLLSOURCE_HSI: /* HSI used as PLL clock source */
      ...
      if (__HAL_RCC_GET_FLAG(RCC_FLAG_HSIDIV) != 0U) {
        ...
        pll3vco = ((float_t)hsivalue / (float_t)pll3m) *
                  ((float_t)(uint32_t)(RCC->PLL3DIVR & RCC_PLL3DIVR_N3) +
    ...
    PLL3_Clocks->PLL3_P_Frequency =
        (uint32_t)(float_t)(pll3vco / ((float_t)(uint32_t)((RCC->PLL3DIVR &
                                                            RCC_PLL3DIVR_P3) >>
                                                           9) +
                                       (float_t)1));
...
void HAL_RCCEx_GetPLL1ClockFreq(PLL1_ClocksTypeDef *PLL1_Clocks) {
  ...
  if (pll1m != 0U) {
    ...
    PLL1_Clocks->PLL1_P_Frequency =
        (uint32_t)(float_t)(pll1vco / ((float_t)(uint32_t)((RCC->PLL1DIVR &
                                                            RCC_PLL1DIVR_P1) >>
                                                           9) +
                                       (float_t)1));
 ...
 * @note   Each time System clock changes, this function must be called to
 * update the right core clock value. Otherwise, any configuration based on this
 * function will be incorrect.
 * @note   The SystemCoreClock CMSIS variable is used to store System current
 * Core Clock Frequency and updated within this function
 ...
 * @note   This bit can be set by software but is cleared by hardware after a
 * system reset or STANDBY
 *
 * @retval None
 */
...
#if defined(DUAL_CORE)
/**
 * @brief  Configure WWDGx to generate a system reset not only CPUx
 * reset(default) when a time-out occurs
 ...
 * @note   This bit can be set by software but is cleared by hardware during a
 * system reset
 *
 * @retval None
 */
...
/**
 * @brief  Configure WWDG1 to generate a system reset not only CPU
 * reset(default) when a time-out occurs
 * @param  RCC_WWDGx: WWDGx to be configured
 *         This parameter can be one of the following values:
 *            @arg RCC_WWDG1: WWDG1 generates system reset
...
down-counting phase (before reaching the zero value), it means that the actual
frequency is lower than the target (and so, that the TRIM value should be
           incremented), while when it is detected during the up-counting phase
...
void HAL_RCCEx_CRSConfig(const RCC_CRSInitTypeDef *pInit) {
  ...
  if ((HAL_GetREVID() <= REV_ID_Y) &&
      (pInit->Source == RCC_CRS_SYNC_SOURCE_USB2)) {
 ...
 * @note    If Time-out set to HAL_MAX_DELAY, HAL_TIMEOUT will be never
 * returned.
 ...
 * factors and enable it
 * @param  pll2: Pointer to an RCC_PLL2InitTypeDef structure that
 *         contains the configuration parameters  as well as VCI, VCO clock
 * ranges.
...
static HAL_StatusTypeDef RCCEx_PLL2_Config(const RCC_PLL2InitTypeDef *pll2,
  ...
  if (__HAL_RCC_GET_PLL_OSCSOURCE() == RCC_PLLSOURCE_NONE) {
    ...
    __HAL_RCC_PLL2_CONFIG(pll2->PLL2M, pll2->PLL2N, pll2->PLL2P, pll2->PLL2Q,
                          pll2->PLL2R);
...
static HAL_StatusTypeDef RCCEx_PLL3_Config(const RCC_PLL3InitTypeDef *pll3,
  ...
  if (__HAL_RCC_GET_PLL_OSCSOURCE() == RCC_PLLSOURCE_NONE) {
    ...
    __HAL_RCC_PLL3_CONFIG(pll3->PLL3M, pll3->PLL3N, pll3->PLL3P, pll3->PLL3Q,
                          pll3->PLL3R);
