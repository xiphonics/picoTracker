...
/**
  ...
  *
  ...
  (IRQ). The Cortex-M exceptions are managed by CMSIS functions.
  ...
  macro HAL_SYSTICK_CLKSourceConfig(SYSTICK_CLKSOURCE_HCLK_DIV8) just after the
       HAL_SYSTICK_Config() function call. The HAL_SYSTICK_CLKSourceConfig()
  macro is defined inside the stm32h7xx_hal_cortex.h file.
 ...
 * the appropriate CMSIS device file (stm32h7xxxx.h))
