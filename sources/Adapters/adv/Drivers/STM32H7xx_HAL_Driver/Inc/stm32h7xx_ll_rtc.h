...
typedef struct {
  ...
  uint8_t Hours; /*!< Specifies the RTC Time Hours.
                    ...
                    function @ref LL_RTC_TIME_SetHour(). */
...
typedef struct {
  ...
  uint8_t Month; /*!< Specifies the RTC Date Month.
                      ...
                      This feature can be modified afterwards using unitary
                    function @ref LL_RTC_DATE_SetMonth(). */
  ...
  uint8_t Day; /*!< Specifies the RTC Date Day.
                  ...
                  Max_Data = 31
                    ...
                    This feature can be modified afterwards using unitary
                  function @ref LL_RTC_DATE_SetDay(). */
  ...
  uint8_t Year; /*!< Specifies the RTC Date Year.
                   ...
                   Max_Data = 99
                     ...
                     This feature can be modified afterwards using unitary
                   function @ref LL_RTC_DATE_SetYear(). */
} LL_RTC_DateTypeDef;
  ...
  uint32_t
      AlarmMask; /*!< Specifies the RTC Alarm Masks.
                    ...
                    for ALARM A or @ref RTC_LL_EC_ALMB_MASK for ALARM B.
                      ...
                      This feature can be modified afterwards using unitary
                    function @ref LL_RTC_ALMA_SetMask() for ALARM A or @ref
  ...
  uint32_t
      AlarmDateWeekDaySel; /*!< Specifies the RTC Alarm is on day or WeekDay.
                              ...
                              @ref RTC_LL_EC_ALMB_WEEKDAY_SELECTION for ALARM B
                                ...
                                This feature can be modified afterwards using
                              unitary function @ref LL_RTC_ALMA_EnableWeekday()
                              or @ref LL_RTC_ALMA_DisableWeekday() for ALARM A
                              or @ref LL_RTC_ALMB_EnableWeekday() or @ref
                              LL_RTC_ALMB_DisableWeekday() for ALARM B
                           */

  uint8_t
      AlarmDateWeekDay; /*!< Specifies the RTC Alarm Day/WeekDay.
                             If AlarmDateWeekDaySel set to day, this parameter
                           must be a number between Min_Data = 1 and Max_Data
                           = 31.

                             This feature can be modified afterwards using
                           unitary function @ref LL_RTC_ALMA_SetDay() for ALARM
                           A or @ref LL_RTC_ALMB_SetDay() for ALARM B.

                             If AlarmDateWeekDaySel set to Weekday, this
                           parameter can be a value of @ref RTC_LL_EC_WEEKDAY.

                             This feature can be modified afterwards using
                           unitary function @ref LL_RTC_ALMA_SetWeekDay() for
                           ALARM A or @ref LL_RTC_ALMB_SetWeekDay() for ALARM B.
                        */
} LL_RTC_AlarmTypeDef;
...
#define LL_RTC_OUTPUTPOLARITY_PIN_HIGH                                         \
  0x00000000U /*!< Pin is high when ALRAF/ALRBF/WUTF is asserted (depending on \
                 OSEL)*/
...
#define LL_RTC_TAMPER_DURATION_1RTCCLK                                         \
  0x00000000U /*!< Tamper pins are pre-charged before sampling during 1 RTCCLK \
                 cycle  */
 ...
 * @{
 */
#define LL_RTC_TAMPER_FILTER_DISABLE                                           \
  0x00000000U /*!< Tamper filter is disabled */
...
/** @defgroup RTC_LL_EC_TAMPER_MASK  TAMPER MASK
 * @note     These values are not applicable to the STM32H723/33, STM32H725/35
 * and STM32H730 devices, and have been kept for backward compatibility.
 * @{
 */
#define LL_RTC_TAMPER_MASK_TAMPER1                                             \
  RTC_TAMPCR_TAMP1MF /*!< Tamper 1 event generates a trigger event. TAMP1F is  \
                        masked and internally cleared by hardware.The backup   \
                        registers are not erased */
#define LL_RTC_TAMPER_MASK_TAMPER2                                             \
  RTC_TAMPCR_TAMP2MF /*!< Tamper 2 event generates a trigger event. TAMP2F is  \
                        masked and internally cleared by hardware. The backup  \
                        registers are not erased. */
#define LL_RTC_TAMPER_MASK_TAMPER3                                             \
  RTC_TAMPCR_TAMP3MF /*!< Tamper 3 event generates a trigger event. TAMP3F is  \
                        masked and internally cleared by hardware. The backup  \
                        registers are not erased */
/**
 * @}
 ...
 */
#define LL_RTC_TAMPER_NOERASE_TAMPER1                                          \
  RTC_TAMPCR_TAMP1NOERASE /*!< Tamper 1 event does not erase the backup        \
                             registers. */
#define LL_RTC_TAMPER_NOERASE_TAMPER2                                          \
  RTC_TAMPCR_TAMP2NOERASE /*!< Tamper 2 event does not erase the backup        \
                             registers. */
#define LL_RTC_TAMPER_NOERASE_TAMPER3                                          \
  RTC_TAMPCR_TAMP3NOERASE /*!< Tamper 3 event does not erase the backup        \
                             registers. */
/**
 * @}
 */
...
#define LL_RTC_TAMPER_DURATION_1RTCCLK                                         \
  0x00000000U /*!< Tamper pins are pre-charged before sampling during 1 RTCCLK \
                 cycle  */
#define LL_RTC_TAMPER_DURATION_2RTCCLK                                         \
  RTC_TAMPCR_TAMPPRCH_0 /*!< Tamper pins are pre-charged before sampling       \
                           during 2 RTCCLK cycles */
#define LL_RTC_TAMPER_DURATION_4RTCCLK                                         \
  RTC_TAMPCR_TAMPPRCH_1 /*!< Tamper pins are pre-charged before sampling       \
                           during 4 RTCCLK cycles */
#define LL_RTC_TAMPER_DURATION_8RTCCLK                                         \
  RTC_TAMPCR_TAMPPRCH /*!< Tamper pins are pre-charged before sampling during  \
                         8 RTCCLK cycles */
/**
 * @}
 */
...
#define LL_RTC_TAMPER_FILTER_DISABLE                                           \
  0x00000000U /*!< Tamper filter is disabled */
#define LL_RTC_TAMPER_FILTER_2SAMPLE                                           \
  RTC_TAMPCR_TAMPFLT_0 /*!< Tamper is activated after 2 consecutive samples at \
                          the active level */
#define LL_RTC_TAMPER_FILTER_4SAMPLE                                           \
  RTC_TAMPCR_TAMPFLT_1 /*!< Tamper is activated after 4 consecutive samples at \
                          the active level */
#define LL_RTC_TAMPER_FILTER_8SAMPLE                                           \
  RTC_TAMPCR_TAMPFLT /*!< Tamper is activated after 8 consecutive samples at   \
                        the active level. */
/**
 * @}
 */
...
#define LL_RTC_TAMPER_SAMPLFREQDIV_32768                                       \
  0x00000000U /*!< Each of the tamper inputs are sampled with a frequency =    \
                 RTCCLK / 32768 */
#define LL_RTC_TAMPER_SAMPLFREQDIV_16384                                       \
  RTC_TAMPCR_TAMPFREQ_0 /*!< Each of the tamper inputs are sampled with a      \
                           frequency =  RTCCLK / 16384 */
#define LL_RTC_TAMPER_SAMPLFREQDIV_8192                                        \
  RTC_TAMPCR_TAMPFREQ_1 /*!< Each of the tamper inputs are sampled with a      \
                           frequency =  RTCCLK / 8192 */
#define LL_RTC_TAMPER_SAMPLFREQDIV_4096                                        \
  (RTC_TAMPCR_TAMPFREQ_1 |                                                     \
   RTC_TAMPCR_TAMPFREQ_0) /*!< Each of the tamper inputs are sampled with a    \
                             frequency =  RTCCLK / 4096 */
#define LL_RTC_TAMPER_SAMPLFREQDIV_2048                                        \
  RTC_TAMPCR_TAMPFREQ_2 /*!< Each of the tamper inputs are sampled with a      \
                           frequency =  RTCCLK / 2048 */
#define LL_RTC_TAMPER_SAMPLFREQDIV_1024                                        \
...
#define LL_RTC_TAMPER_SAMPLFREQDIV_512                                         \
  (RTC_TAMPCR_TAMPFREQ_2 |                                                     \
   RTC_TAMPCR_TAMPFREQ_1) /*!< Each of the tamper inputs are sampled with a    \
                             frequency =  RTCCLK / 512 */
#define LL_RTC_TAMPER_SAMPLFREQDIV_256                                         \
  RTC_TAMPCR_TAMPFREQ /*!< Each of the tamper inputs are sampled with a        \
                         frequency =  RTCCLK / 256 */
/**
 * @}
 */
 ...
 */
#define LL_RTC_TAMPER_ACTIVELEVEL_TAMP1                                        \
  RTC_TAMPCR_TAMP1TRG /*!< RTC_TAMP1 input falling edge (if TAMPFLT = 00) or   \
                         staying high (if TAMPFLT != 00) triggers a tamper     \
                         detection event*/
#define LL_RTC_TAMPER_ACTIVELEVEL_TAMP2                                        \
  RTC_TAMPCR_TAMP2TRG /*!< RTC_TAMP2 input falling edge (if TAMPFLT = 00) or   \
                         staying high (if TAMPFLT != 00) triggers a tamper     \
                         detection event*/
#define LL_RTC_TAMPER_ACTIVELEVEL_TAMP3                                        \
  RTC_TAMPCR_TAMP3TRG /*!< RTC_TAMP3 input falling edge (if TAMPFLT = 00) or   \
                         staying high (if TAMPFLT != 00) triggers a tamper     \
                         detection event*/
/**
 * @}
 ...
 * @{
 */
#define LL_RTC_CALIB_INSERTPULSE_NONE                                          \
  0x00000000U /*!< No RTCCLK pulses are added */
...
#define __LL_RTC_CONVERT_BCD2BIN(__VALUE__)                                    \
  ((uint8_t)((((uint8_t)((__VALUE__) & (uint8_t)0xF0) >> (uint8_t)0x4) *       \
              10U) +                                                           \
             ((__VALUE__) & (uint8_t)0x0F)))
 ...
 * @note This API shall not be used with STM32H723/33, STM32H725/35 and
 * STM32H730 devices, and has been kept for backward compatibility.
 ...
 * @note   Bit is write-protected. @ref LL_RTC_DisableWriteProtection function
 * should be called before.
 * @note Bit can be written only when RTC_CR WUTE bit = 0 and RTC_ISR WUTWF bit
 * = 1
 ...
 */
__STATIC_INLINE uint32_t LL_RTC_BAK_GetRegister(const RTC_TypeDef *RTCx,
                                                uint32_t BackupRegister) {
  uint32_t tmp;
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RTC_BKP_SetRegister(const TAMP_TypeDef *TAMPx,
                                            uint32_t BackupRegister,
                                            uint32_t Data) {
  uint32_t tmp;
...
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_RECALP(const RTC_TypeDef *RTCx) {
  return ((READ_BIT(RTCx->ISR, RTC_ISR_RECALPF) == (RTC_ISR_RECALPF)) ? 1UL
                                                                      : 0UL);
}
...
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_TAMP3(const RTC_TypeDef *RTCx) {
  return ((READ_BIT(RTCx->ISR, RTC_ISR_TAMP3F) == (RTC_ISR_TAMP3F)) ? 1UL
                                                                    : 0UL);
}
...
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_TAMP2(const RTC_TypeDef *RTCx) {
  return ((READ_BIT(RTCx->ISR, RTC_ISR_TAMP2F) == (RTC_ISR_TAMP2F)) ? 1UL
                                                                    : 0UL);
}
#endif /* RTC_TAMPER2_SUPPORT */
...
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_TAMP1(const RTC_TypeDef *RTCx) {
  return ((READ_BIT(RTCx->ISR, RTC_ISR_TAMP1F) == (RTC_ISR_TAMP1F)) ? 1UL
                                                                    : 0UL);
}
...
__STATIC_INLINE void LL_RTC_ClearFlag_ITS(RTC_TypeDef *RTCx) {
  WRITE_REG(RTCx->ISR, (~((RTC_ISR_ITSF | RTC_ISR_INIT) & 0x0000FFFFU) |
...
__STATIC_INLINE void LL_RTC_ClearFlag_TAMP3(RTC_TypeDef *RTCx) {
  WRITE_REG(RTCx->ISR, (~((RTC_ISR_TAMP3F | RTC_ISR_INIT) & 0x0000FFFFU) |
                        (RTCx->ISR & RTC_ISR_INIT)));
}
...
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_ALRBW(const RTC_TypeDef *RTCx) {
  return ((READ_BIT(RTCx->ISR, RTC_ISR_ALRBWF) == (RTC_ISR_ALRBWF)) ? 1UL
                                                                    : 0UL);
}
...
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_ALRAW(const RTC_TypeDef *RTCx) {
  return ((READ_BIT(RTCx->ISR, RTC_ISR_ALRAWF) == (RTC_ISR_ALRAWF)) ? 1UL
                                                                    : 0UL);
}
#endif /* !TAMP */
...
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_RECALP(RTC_TypeDef *RTCx) {
  return ((READ_BIT(RTCx->ICSR, RTC_ICSR_RECALPF) == (RTC_ICSR_RECALPF)) ? 1UL
                                                                         : 0UL);
}
...
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_INIT(RTC_TypeDef *RTCx) {
  return ((READ_BIT(RTCx->ICSR, RTC_ICSR_INITF) == (RTC_ICSR_INITF)) ? 1UL
                                                                     : 0UL);
}
...
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_INITS(RTC_TypeDef *RTCx) {
  return ((READ_BIT(RTCx->ICSR, RTC_ICSR_INITS) == (RTC_ICSR_INITS)) ? 1UL
                                                                     : 0UL);
}
...
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_WUTW(RTC_TypeDef *RTCx) {
  return ((READ_BIT(RTCx->ICSR, RTC_ICSR_WUTWF) == (RTC_ICSR_WUTWF)) ? 1UL
                                                                     : 0UL);
}
...
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_ALRBW(RTC_TypeDef *RTCx) {
  return ((READ_BIT(RTCx->ICSR, RTC_ICSR_ALRBWF) == (RTC_ICSR_ALRBWF)) ? 1UL
                                                                       : 0UL);
}
...
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_ALRAW(RTC_TypeDef *RTCx) {
  return ((READ_BIT(RTCx->ICSR, RTC_ICSR_ALRAWF) == (RTC_ICSR_ALRAWF)) ? 1UL
                                                                       : 0UL);
}
...
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_ALRAM(RTC_TypeDef *RTCx) {
  return ((READ_BIT(RTCx->MISR, RTC_MISR_ALRAMF) == (RTC_MISR_ALRAMF)) ? 1UL
                                                                       : 0UL);
}
...
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_ALRBM(RTC_TypeDef *RTCx) {
  return ((READ_BIT(RTCx->MISR, RTC_MISR_ALRBMF) == (RTC_MISR_ALRBMF)) ? 1UL
                                                                       : 0UL);
}
...
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_WUTM(RTC_TypeDef *RTCx) {
  return ((READ_BIT(RTCx->MISR, RTC_MISR_WUTMF) == (RTC_MISR_WUTMF)) ? 1UL
                                                                     : 0UL);
}
...
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_TSOVM(RTC_TypeDef *RTCx) {
  return ((READ_BIT(RTCx->MISR, RTC_MISR_TSOVMF) == (RTC_MISR_TSOVMF)) ? 1UL
                                                                       : 0UL);
}
...
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_ITSM(RTC_TypeDef *RTCx) {
  return ((READ_BIT(RTCx->MISR, RTC_MISR_ITSMF) == (RTC_MISR_ITSMF)) ? 1UL
                                                                     : 0UL);
}
...
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_TAMP1(TAMP_TypeDef *TAMPx) {
  return ((READ_BIT(TAMPx->SR, TAMP_SR_TAMP1F) == (TAMP_SR_TAMP1F)) ? 1UL
                                                                    : 0UL);
}
...
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_TAMP2(TAMP_TypeDef *TAMPx) {
  return ((READ_BIT(TAMPx->SR, TAMP_SR_TAMP2F) == (TAMP_SR_TAMP2F)) ? 1UL
                                                                    : 0UL);
}
...
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_TAMP3(TAMP_TypeDef *TAMPx) {
  return ((READ_BIT(TAMPx->SR, TAMP_SR_TAMP3F) == (TAMP_SR_TAMP3F)) ? 1UL
                                                                    : 0UL);
}
...
__STATIC_INLINE uint32_t LL_RTC_IsEnabledIT_TAMP3(const RTC_TypeDef *RTCx) {
  return ((READ_BIT(RTCx->TAMPCR, RTC_TAMPCR_TAMP3IE) == (RTC_TAMPCR_TAMP3IE))
              ? 1UL
              : 0UL);
}
...
__STATIC_INLINE uint32_t LL_RTC_IsEnabledIT_TAMP2(const RTC_TypeDef *RTCx) {
  return ((READ_BIT(RTCx->TAMPCR, RTC_TAMPCR_TAMP2IE) == (RTC_TAMPCR_TAMP2IE))
              ? 1UL
              : 0UL);
}
...
__STATIC_INLINE uint32_t LL_RTC_IsEnabledIT_TAMP1(const RTC_TypeDef *RTCx) {
  return ((READ_BIT(RTCx->TAMPCR, RTC_TAMPCR_TAMP1IE) == (RTC_TAMPCR_TAMP1IE))
              ? 1UL
              : 0UL);
}
#endif /* RTC_TAMPxIE_SUPPORT */
...
__STATIC_INLINE uint32_t LL_RTC_IsEnabledIT_TAMP(const RTC_TypeDef *RTCx) {
  return ((READ_BIT(RTCx->TAMPCR, RTC_TAMPCR_TAMPIE) == (RTC_TAMPCR_TAMPIE))
              ? 1UL
              : 0UL);
}
#endif /* !TAMP */
...
__STATIC_INLINE uint32_t LL_RTC_IsEnabledIT_TAMP1(TAMP_TypeDef *TAMPx) {
  return ((READ_BIT(TAMPx->IER, TAMP_IER_TAMP1IE) == (TAMP_IER_TAMP1IE)) ? 1UL
                                                                         : 0UL);
}
...
__STATIC_INLINE uint32_t LL_RTC_IsEnabledIT_TAMP2(TAMP_TypeDef *TAMPx) {
  return ((READ_BIT(TAMPx->IER, TAMP_IER_TAMP2IE) == (TAMP_IER_TAMP2IE)) ? 1UL
                                                                         : 0UL);
}
...
__STATIC_INLINE uint32_t LL_RTC_IsEnabledIT_TAMP3(TAMP_TypeDef *TAMPx) {
  return ((READ_BIT(TAMPx->IER, TAMP_IER_TAMP3IE) == (TAMP_IER_TAMP3IE)) ? 1UL
                                                                         : 0UL);
}
...
LL_RTC_TAMPER_ATAMP_SetSharedOuputSelection(uint32_t OutputSelection) {
  MODIFY_REG(TAMP->ATCR1,
             (TAMP_ATCR1_ATOSEL1 | TAMP_ATCR1_ATOSEL2 | TAMP_ATCR1_ATOSEL3),
             OutputSelection);
}
...
__STATIC_INLINE uint32_t LL_RTC_TAMPER_ATAMP_GetSharedOuputSelection(void) {
  return (READ_BIT(TAMP->ATCR1, (TAMP_ATCR1_ATOSEL1 | TAMP_ATCR1_ATOSEL2 |
                                 TAMP_ATCR1_ATOSEL3)));
}
