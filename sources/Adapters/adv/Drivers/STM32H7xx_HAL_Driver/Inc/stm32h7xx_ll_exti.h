...
typedef struct {
  ...
  uint32_t Line_64_95; /*!< Specifies the EXTI lines to be enabled or disabled
                          for Lines in range 64 to 95 This parameter can be any
                          combination of @ref EXTI_LL_EC_LINE */
...
#endif                                 /* I2C5 */
#define LL_EXTI_LINE_ALL_64_95                                                 \
  EXTI_IMR3_IM /*!< All Extended line not reserved*/
...
#define LL_EXTI_MODE_IT_EVENT                                                  \
  ((uint8_t)0x03U) /*!< Cortex-M7 Interrupt & Event Mode */
...
#define LL_EXTI_MODE_C1_IT_EVENT                                               \
...
#define LL_EXTI_MODE_C2_IT_EVENT                                               \
  ((uint8_t)0x30U) /*!< Cortex-M4 Interrupt & Event Mode */
#endif             /* DUAL_CORE */
 ...
 * @{
 */
#define LL_EXTI_D3_PEND_CLR_DMACH6                                             \
  ((uint8_t)0x00U) /*!< DMA ch6 event selected as D3 domain pendclear source   \
                    */
#define LL_EXTI_D3_PEND_CLR_DMACH7                                             \
  ((uint8_t)0x01U) /*!< DMA ch7 event selected as D3 domain pendclear source   \
                    */
#if defined(LPTIM4)
#define LL_EXTI_D3_PEND_CLR_LPTIM4                                             \
  ((uint8_t)0x02U) /*!< LPTIM4 out selected as D3 domain pendclear source */
#else
#define LL_EXTI_D3_PEND_CLR_LPTIM2                                             \
  ((uint8_t)0x02U) /*!< LPTIM2 out selected as D3 domain pendclear source */
#endif             /*LPTIM4*/
#if defined(LPTIM5)
#define LL_EXTI_D3_PEND_CLR_LPTIM5                                             \
  ((uint8_t)0x03U) /*!< LPTIM5 out selected as D3 domain pendclear source */
#else
#define LL_EXTI_D3_PEND_CLR_LPTIM3                                             \
  ((uint8_t)0x02U) /*!< LPTIM3 out selected as D3 domain pendclear source */
#endif             /*LPTIM5*/
/**
 * @}
 */
...
/**
 * @brief  Disable ExtiLine Interrupt request for Lines in range 64 to 95 for
 * cpu2
...
/**
 * @brief  Indicate if ExtiLine Event request is enabled for Lines in range 64
 * to 95
...
/**
 * @brief  Indicate if ExtiLine D3 Pending Mask is enabled for Lines in range 0
 * to 31
...
/**
 * @brief  Indicate if ExtiLine D3 Pending Mask is enabled for Lines in range 32
 * to 63
...
/**
 * @brief  Set ExtLine D3 Domain Pend Clear Source selection for Lines in range
 * 0 to 15
...
/**
 * @brief  Get ExtLine D3 Domain Pend Clear Source selection for Lines in range
 * 0 to 15
...
__STATIC_INLINE uint32_t LL_D3_EXTI_GetPendClearSel_16_31(uint32_t ExtiLine) {
  return (
      uint32_t)(READ_BIT(EXTI->D3PCR1H, (((ExtiLine >> EXTI_IMR1_IM16_Pos) *
...
__STATIC_INLINE uint32_t LL_D3_EXTI_GetPendClearSel_48_63(uint32_t ExtiLine) {
  return (
      uint32_t)(READ_BIT(EXTI->D3PCR2H, (((ExtiLine >> EXTI_IMR2_IM48_Pos) *
