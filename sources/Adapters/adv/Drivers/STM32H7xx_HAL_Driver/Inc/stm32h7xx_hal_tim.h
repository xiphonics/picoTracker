...
#define TIM_TS_ITR13                                                           \
  (TIM_SMCR_TS_0 | TIM_SMCR_TS_4) /*!< Internal Trigger 13 (ITR13) */
...
#define IS_TIM_TRIGGER_SELECTION(__SELECTION__)                                \
  (((__SELECTION__) == TIM_TS_ITR0) || ((__SELECTION__) == TIM_TS_ITR1) ||     \
   ...
   ((__SELECTION__) == TIM_TS_ITR8) || ((__SELECTION__) == TIM_TS_ITR12) ||    \
   ((__SELECTION__) == TIM_TS_ITR13) || ((__SELECTION__) == TIM_TS_TI1F_ED) || \
...
#define IS_TIM_INTERNAL_TRIGGEREVENT_SELECTION(__SELECTION__)                  \
  (((__SELECTION__) == TIM_TS_ITR0) || ((__SELECTION__) == TIM_TS_ITR1) ||     \
   ...
   ((__SELECTION__) == TIM_TS_ITR6) || ((__SELECTION__) == TIM_TS_ITR7) ||     \
   ((__SELECTION__) == TIM_TS_ITR8) || ((__SELECTION__) == TIM_TS_ITR12) ||    \
   ((__SELECTION__) == TIM_TS_ITR13) || ((__SELECTION__) == TIM_TS_NONE))
