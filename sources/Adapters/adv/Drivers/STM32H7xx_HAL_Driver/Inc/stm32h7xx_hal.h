...
#define SYSCFG_VREFBUF_HIGH_IMPEDANCE_DISABLE                                  \
  ((uint32_t)0x00000000) /*!< VREF_plus pin is internally connected to Voltage \
 ...
 */
#define SYSCFG_ADC2_ROUT0_DAC1_1                                               \
  ((uint32_t)0x00000000) /*!< DAC1_out1 connected to ADC2 VINP[16] */
#define SYSCFG_ADC2_ROUT0_VBAT4                                                \
  SYSCFG_ADC2ALT_ADC2_ROUT0 /*!< VBAT/4 connected to ADC2 VINP[16] */
#define SYSCFG_ADC2_ROUT1_DAC1_2                                               \
  ((uint32_t)0x00000000) /*!< DAC1_out2 connected to ADC2 VINP[17] */
...
#define SYSCFG_SWITCH_PA0_OPEN                                                 \
  SYSCFG_PMCR_PA0SO /*!< PA0 analog switch opened */
#define SYSCFG_SWITCH_PA0_CLOSE                                                \
  ((uint32_t)0x00000000) /*!< PA0 analog switch closed */
#define SYSCFG_SWITCH_PA1_OPEN                                                 \
  SYSCFG_PMCR_PA1SO /*!< PA1 analog switch opened */
#define SYSCFG_SWITCH_PA1_CLOSE                                                \
  ((uint32_t)0x00000000) /*!< PA1 analog switch closed*/
#define SYSCFG_SWITCH_PC2_OPEN                                                 \
  SYSCFG_PMCR_PC2SO /*!< PC2 analog switch opened */
#define SYSCFG_SWITCH_PC2_CLOSE                                                \
  ((uint32_t)0x00000000) /*!< PC2 analog switch closed */
#define SYSCFG_SWITCH_PC3_OPEN                                                 \
  SYSCFG_PMCR_PC3SO /*!< PC3 analog switch opened */
#define SYSCFG_SWITCH_PC3_CLOSE                                                \
  ((uint32_t)0x00000000) /*!< PC3 analog switch closed */
...
#define IS_EXTI_EDGE_LINE(EDGE)                                                \
  (((EDGE) == EXTI_RISING_EDGE) || ((EDGE) == EXTI_FALLING_EDGE))
#define IS_EXTI_MODE_LINE(MODE)                                                \
  (((MODE) == EXTI_MODE_IT) || ((MODE) == EXTI_MODE_EVT))
...
#define IS_EXTI_ALL_LINE(LINE)                                                 \
  (((LINE) == EXTI_LINE0) || ((LINE) == EXTI_LINE1) ||                         \
   ...
   ((LINE) == EXTI_LINE40) || ((LINE) == EXTI_LINE41) ||                       \
   ((LINE) == EXTI_LINE42) || ((LINE) == EXTI_LINE43) ||                       \
   ((LINE) == EXTI_LINE44) || ((LINE) == EXTI_LINE47) ||                       \
   ((LINE) == EXTI_LINE48) || ((LINE) == EXTI_LINE49) ||                       \
   ((LINE) == EXTI_LINE50) || ((LINE) == EXTI_LINE51) ||                       \
   ((LINE) == EXTI_LINE52) || ((LINE) == EXTI_LINE53) ||                       \
   ((LINE) == EXTI_LINE54) || ((LINE) == EXTI_LINE55) ||                       \
   ((LINE) == EXTI_LINE56) || ((LINE) == EXTI_LINE57) ||                       \
   ((LINE) == EXTI_LINE58) || ((LINE) == EXTI_LINE59) ||                       \
   ((LINE) == EXTI_LINE60) || ((LINE) == EXTI_LINE61) ||                       \
   ((LINE) == EXTI_LINE62) || ((LINE) == EXTI_LINE63) ||                       \
   ((LINE) == EXTI_LINE64) || ((LINE) == EXTI_LINE65) ||                       \
   ((LINE) == EXTI_LINE66) || ((LINE) == EXTI_LINE67) ||                       \
   ((LINE) == EXTI_LINE68) || ((LINE) == EXTI_LINE69) ||                       \
   ((LINE) == EXTI_LINE70) || ((LINE) == EXTI_LINE71) ||                       \
   ((LINE) == EXTI_LINE72) || ((LINE) == EXTI_LINE73) ||                       \
   ((LINE) == EXTI_LINE74) || ((LINE) == EXTI_LINE75) ||                       \
   ((LINE) == EXTI_LINE76) || ((LINE) == EXTI_LINE85) ||                       \
   ((LINE) == EXTI_LINE86) || ((LINE) == EXTI_LINE87) ||                       \
...
#define BDMA_CH6_CLEAR                                                         \
  ((uint32_t)0x00000000) /*!< BDMA ch6 event selected as D3 domain pendclear   \
                            source*/
#define BDMA_CH7_CLEAR                                                         \
  ((uint32_t)0x00000001) /*!< BDMA ch7 event selected as D3 domain pendclear   \
                            source*/
#if defined(LPTIM4)
#define LPTIM4_OUT_CLEAR                                                       \
  ((uint32_t)0x00000002) /*!< LPTIM4 out selected as D3 domain pendclear       \
                            source*/
#else
#define LPTIM2_OUT_CLEAR                                                       \
  ((uint32_t)0x00000002) /*!< LPTIM2 out selected as D3 domain pendclear       \
                            source*/
#endif                   /* LPTIM4 */
#if defined(LPTIM5)
#define LPTIM5_OUT_CLEAR                                                       \
  ((uint32_t)0x00000003) /*!< LPTIM5 out selected as D3 domain pendclear       \
                            source*/
#else
#define LPTIM3_OUT_CLEAR                                                       \
  ((uint32_t)0x00000003) /*!< LPTIM3 out selected as D3 domain pendclear       \
                            source*/
#endif                   /* LPTIM5 */
...
#define __HAL_ART_CONFIG_BASE_ADDRESS(__BASE_ADDRESS__)                        \
  MODIFY_REG(ART->CTR, ART_CTR_PCACHEADDR,                                     \
             (((__BASE_ADDRESS__) >> 12U) & 0x000FFF00UL))
...
/** @brief  SYSCFG Break AXIRAM double ECC lock.
  *         Enable and lock the connection of AXIRAM double ECC error to
  TIM1/8/15/16/17 and HRTIMER Break input.
  * @note   The selected configuration is locked and can be unlocked only by
  system reset. This feature is available on STM32H7 rev.B and above.
  */
#define __HAL_SYSCFG_BREAK_AXISRAM_DBL_ECC_LOCK()                              \
  SET_BIT(SYSCFG->CFGR, SYSCFG_CFGR_AXISRAML)

/** @brief  SYSCFG Break ITCM double ECC lock.
  *         Enable and lock the connection of ITCM double ECC error to
  TIM1/8/15/16/17 and HRTIMER Break input.
  * @note   The selected configuration is locked and can be unlocked only by
  system reset. This feature is available on STM32H7 rev.B and above.
  */
#define __HAL_SYSCFG_BREAK_ITCM_DBL_ECC_LOCK()                                 \
  SET_BIT(SYSCFG->CFGR, SYSCFG_CFGR_ITCML)

/** @brief  SYSCFG Break DTCM double ECC lock.
  *         Enable and lock the connection of DTCM double ECC error to
  TIM1/8/15/16/17 and HRTIMER Break input.
  * @note   The selected configuration is locked and can be unlocked only by
  system reset. This feature is available on STM32H7 rev.B and above.
  */
#define __HAL_SYSCFG_BREAK_DTCM_DBL_ECC_LOCK()                                 \
  SET_BIT(SYSCFG->CFGR, SYSCFG_CFGR_DTCML)

/** @brief  SYSCFG Break SRAM1 double ECC lock.
  *         Enable and lock the connection of SRAM1 double ECC error to
  TIM1/8/15/16/17 and HRTIMER Break input.
  * @note   The selected configuration is locked and can be unlocked only by
  system reset. This feature is available on STM32H7 rev.B and above.
  */
#define __HAL_SYSCFG_BREAK_SRAM1_DBL_ECC_LOCK()                                \
  SET_BIT(SYSCFG->CFGR, SYSCFG_CFGR_SRAM1L)

/** @brief  SYSCFG Break SRAM2 double ECC lock.
  *         Enable and lock the connection of SRAM2 double ECC error to
  TIM1/8/15/16/17 and HRTIMER Break input.
  * @note   The selected configuration is locked and can be unlocked only by
  system reset. This feature is available on STM32H7 rev.B and above.
  */
#define __HAL_SYSCFG_BREAK_SRAM2_DBL_ECC_LOCK()                                \
  SET_BIT(SYSCFG->CFGR, SYSCFG_CFGR_SRAM2L)

/** @brief  SYSCFG Break SRAM3 double ECC lock.
  *         Enable and lock the connection of SRAM3 double ECC error to
  TIM1/8/15/16/17 and HRTIMER Break input.
  * @note   The selected configuration is locked and can be unlocked only by
  system reset. This feature is available on STM32H7 rev.B and above.
  */
#define __HAL_SYSCFG_BREAK_SRAM3_DBL_ECC_LOCK()                                \
  SET_BIT(SYSCFG->CFGR, SYSCFG_CFGR_SRAM3L)

/** @brief  SYSCFG Break SRAM4 double ECC lock.
  *         Enable and lock the connection of SRAM4 double ECC error to
  TIM1/8/15/16/17 and HRTIMER Break input.
  * @note   The selected configuration is locked and can be unlocked only by
  system reset. This feature is available on STM32H7 rev.B and above.
  */
#define __HAL_SYSCFG_BREAK_SRAM4_DBL_ECC_LOCK()                                \
  SET_BIT(SYSCFG->CFGR, SYSCFG_CFGR_SRAM4L)

/** @brief  SYSCFG Break Backup SRAM double ECC lock.
  *         Enable and lock the connection of Backup SRAM double ECC error to
  TIM1/8/15/16/17 and HRTIMER Break input.
  * @note   The selected configuration is locked and can be unlocked only by
  system reset. This feature is available on STM32H7 rev.B and above.
  */
#define __HAL_SYSCFG_BREAK_BKRAM_DBL_ECC_LOCK()                                \
  SET_BIT(SYSCFG->CFGR, SYSCFG_CFGR_BKRAML)

/** @brief  SYSCFG Break Cortex-M7 Lockup lock.
  *         Enable and lock the connection of Cortex-M7 LOCKUP output to
  TIM1/8/15/16/17 and HRTIMER Break input.
  * @note   The selected configuration is locked and can be unlocked only by
  system reset. This feature is available on STM32H7 rev.B and above.
  */
#define __HAL_SYSCFG_BREAK_CM7_LOCKUP_LOCK()                                   \
  SET_BIT(SYSCFG->CFGR, SYSCFG_CFGR_CM7L)

/** @brief  SYSCFG Break FLASH double ECC lock.
  *         Enable and lock the connection of Flash double ECC error connection
  to TIM1/8/15/16/17 and HRTIMER Break input.
  * @note   The selected configuration is locked and can be unlocked only by
  system reset. This feature is available on STM32H7 rev.B and above.
  */
#define __HAL_SYSCFG_BREAK_FLASH_DBL_ECC_LOCK()                                \
  SET_BIT(SYSCFG->CFGR, SYSCFG_CFGR_FLASHL)

/** @brief  SYSCFG Break PVD lock.
  *         Enable and lock the PVD connection to Timer1/8/15/16/17 and HRTIMER
  Break input, as well as the PVDE and PLS[2:0] in the PWR_CR1 register.
  * @note   The selected configuration is locked and can be unlocked only by
  system reset. This feature is available on STM32H7 rev.B and above.
  */
...
/** @brief  SYSCFG Break Cortex-M4 Lockup lock.
  *         Enable and lock the connection of Cortex-M4 LOCKUP output to
  TIM1/8/15/16/17 and HRTIMER Break input.
  * @note   The selected configuration is locked and can be unlocked only by
  system reset. This feature is available on STM32H7 rev.B and above.
  */
#define __HAL_SYSCFG_BREAK_CM4_LOCKUP_LOCK()                                   \
  SET_BIT(SYSCFG->CFGR, SYSCFG_CFGR_CM4L)
#endif /* DUAL_CORE */
...
#define __HAL_DBGMCU_FREEZE_TIM12()                                            \
  (DBGMCU->APB1LFZ1 |= (DBGMCU_APB1LFZ1_DBG_TIM12))
#define __HAL_DBGMCU_FREEZE_TIM13()                                            \
  (DBGMCU->APB1LFZ1 |= (DBGMCU_APB1LFZ1_DBG_TIM13))
#define __HAL_DBGMCU_FREEZE_TIM14()                                            \
  (DBGMCU->APB1LFZ1 |= (DBGMCU_APB1LFZ1_DBG_TIM14))
#define __HAL_DBGMCU_FREEZE_LPTIM1()                                           \
  (DBGMCU->APB1LFZ1 |= (DBGMCU_APB1LFZ1_DBG_LPTIM1))
#define __HAL_DBGMCU_FREEZE_I2C1()                                             \
  (DBGMCU->APB1LFZ1 |= (DBGMCU_APB1LFZ1_DBG_I2C1))
#define __HAL_DBGMCU_FREEZE_I2C2()                                             \
  (DBGMCU->APB1LFZ1 |= (DBGMCU_APB1LFZ1_DBG_I2C2))
#define __HAL_DBGMCU_FREEZE_I2C3()                                             \
  (DBGMCU->APB1LFZ1 |= (DBGMCU_APB1LFZ1_DBG_I2C3))
#if defined(I2C5)
#define __HAL_DBGMCU_FREEZE_I2C5()                                             \
  (DBGMCU->APB1LFZ1 |= (DBGMCU_APB1LFZ1_DBG_I2C5))
#endif /*I2C5*/
#if defined(DBGMCU_APB1HFZ1_DBG_FDCAN)
#define __HAL_DBGMCU_FREEZE_FDCAN()                                            \
  (DBGMCU->APB1HFZ1 |= (DBGMCU_APB1HFZ1_DBG_FDCAN))
#endif /*DBGMCU_APB1HFZ1_DBG_FDCAN*/

#if defined(TIM23)
#define __HAL_DBGMCU_FREEZE_TIM23()                                            \
  (DBGMCU->APB1HFZ1 |= (DBGMCU_APB1HFZ1_DBG_TIM23))
#endif /*TIM23*/
#if defined(TIM24)
#define __HAL_DBGMCU_FREEZE_TIM24()                                            \
  (DBGMCU->APB1HFZ1 |= (DBGMCU_APB1HFZ1_DBG_TIM24))
#endif /*TIM24*/
...
#define __HAL_DBGMCU_FREEZE_TIM15()                                            \
  (DBGMCU->APB2FZ1 |= (DBGMCU_APB2FZ1_DBG_TIM15))
#define __HAL_DBGMCU_FREEZE_TIM16()                                            \
  (DBGMCU->APB2FZ1 |= (DBGMCU_APB2FZ1_DBG_TIM16))
#define __HAL_DBGMCU_FREEZE_TIM17()                                            \
  (DBGMCU->APB2FZ1 |= (DBGMCU_APB2FZ1_DBG_TIM17))
#define __HAL_DBGMCU_FREEZE_HRTIM()                                            \
  (DBGMCU->APB2FZ1 |= (DBGMCU_APB2FZ1_DBG_HRTIM))

#define __HAL_DBGMCU_FREEZE_I2C4()                                             \
  (DBGMCU->APB4FZ1 |= (DBGMCU_APB4FZ1_DBG_I2C4))
...
#if defined(TIM23)
#define __HAL_DBGMCU_UnFreeze_TIM23()                                          \
  (DBGMCU->APB1HFZ1 &= ~(DBGMCU_APB1HFZ1_DBG_TIM23))
#endif /*TIM23*/
#if defined(TIM24)
#define __HAL_DBGMCU_UnFreeze_TIM24()                                          \
  (DBGMCU->APB1HFZ1 &= ~(DBGMCU_APB1HFZ1_DBG_TIM24))
#endif /*TIM24*/
...
#define __HAL_DBGMCU_UnFreeze_TIM17()                                          \
  (DBGMCU->APB2FZ1 &= ~(DBGMCU_APB2FZ1_DBG_TIM17))
#define __HAL_DBGMCU_UnFreeze_HRTIM()                                          \
  (DBGMCU->APB2FZ1 &= ~(DBGMCU_APB2FZ1_DBG_HRTIM))
...
#if defined(DUAL_CORE)
#define __HAL_DBGMCU_FREEZE2_IWDG2()                                           \
  (DBGMCU->APB4FZ2 |= (DBGMCU_APB4FZ2_DBG_IWDG2))
#define __HAL_DBGMCU_FREEZE2_WWDG2()                                           \
  (DBGMCU->APB1LFZ2 |= (DBGMCU_APB1LFZ2_DBG_WWDG2))

#define __HAL_DBGMCU_UnFreeze2_IWDG2()                                         \
  (DBGMCU->APB4FZ2 &= ~(DBGMCU_APB4FZ2_DBG_IWDG2))
#define __HAL_DBGMCU_UnFreeze2_WWDG2()                                         \
  (DBGMCU->APB1LFZ2 &= ~(DBGMCU_APB1LFZ2_DBG_WWDG2))

#define __HAL_DBGMCU_FREEZE2_WWDG1()                                           \
  (DBGMCU->APB3FZ2 |= (DBGMCU_APB3FZ2_DBG_WWDG1))

#define __HAL_DBGMCU_FREEZE2_TIM2()                                            \
  (DBGMCU->APB1LFZ2 |= (DBGMCU_APB1LFZ2_DBG_TIM2))
#define __HAL_DBGMCU_FREEZE2_TIM3()                                            \
  (DBGMCU->APB1LFZ2 |= (DBGMCU_APB1LFZ2_DBG_TIM3))
#define __HAL_DBGMCU_FREEZE2_TIM4()                                            \
  (DBGMCU->APB1LFZ2 |= (DBGMCU_APB1LFZ2_DBG_TIM4))
#define __HAL_DBGMCU_FREEZE2_TIM5()                                            \
  (DBGMCU->APB1LFZ2 |= (DBGMCU_APB1LFZ2_DBG_TIM5))
#define __HAL_DBGMCU_FREEZE2_TIM6()                                            \
  (DBGMCU->APB1LFZ2 |= (DBGMCU_APB1LFZ2_DBG_TIM6))
#define __HAL_DBGMCU_FREEZE2_TIM7()                                            \
  (DBGMCU->APB1LFZ2 |= (DBGMCU_APB1LFZ2_DBG_TIM7))
#define __HAL_DBGMCU_FREEZE2_TIM12()                                           \
  (DBGMCU->APB1LFZ2 |= (DBGMCU_APB1LFZ2_DBG_TIM12))
#define __HAL_DBGMCU_FREEZE2_TIM13()                                           \
  (DBGMCU->APB1LFZ2 |= (DBGMCU_APB1LFZ2_DBG_TIM13))
#define __HAL_DBGMCU_FREEZE2_TIM14()                                           \
  (DBGMCU->APB1LFZ2 |= (DBGMCU_APB1LFZ2_DBG_TIM14))
#define __HAL_DBGMCU_FREEZE2_LPTIM1()                                          \
  (DBGMCU->APB1LFZ2 |= (DBGMCU_APB1LFZ2_DBG_LPTIM1))
#define __HAL_DBGMCU_FREEZE2_I2C1()                                            \
  (DBGMCU->APB1LFZ2 |= (DBGMCU_APB1LFZ2_DBG_I2C1))
#define __HAL_DBGMCU_FREEZE2_I2C2()                                            \
  (DBGMCU->APB1LFZ2 |= (DBGMCU_APB1LFZ2_DBG_I2C2))
#define __HAL_DBGMCU_FREEZE2_I2C3()                                            \
  (DBGMCU->APB1LFZ2 |= (DBGMCU_APB1LFZ2_DBG_I2C3))
#define __HAL_DBGMCU_FREEZE2_FDCAN()                                           \
  (DBGMCU->APB1HFZ2 |= (DBGMCU_APB1HFZ2_DBG_FDCAN))

#define __HAL_DBGMCU_FREEZE2_TIM1()                                            \
  (DBGMCU->APB2FZ2 |= (DBGMCU_APB2FZ2_DBG_TIM1))
#define __HAL_DBGMCU_FREEZE2_TIM8()                                            \
  (DBGMCU->APB2FZ2 |= (DBGMCU_APB2FZ2_DBG_TIM8))
#define __HAL_DBGMCU_FREEZE2_TIM15()                                           \
  (DBGMCU->APB2FZ2 |= (DBGMCU_APB2FZ2_DBG_TIM15))
#define __HAL_DBGMCU_FREEZE2_TIM16()                                           \
  (DBGMCU->APB2FZ2 |= (DBGMCU_APB2FZ2_DBG_TIM16))
#define __HAL_DBGMCU_FREEZE2_TIM17()                                           \
  (DBGMCU->APB2FZ2 |= (DBGMCU_APB2FZ2_DBG_TIM17))
#define __HAL_DBGMCU_FREEZE2_HRTIM()                                           \
  (DBGMCU->APB2FZ2 |= (DBGMCU_APB2FZ2_DBG_HRTIM))

#define __HAL_DBGMCU_FREEZE2_I2C4()                                            \
  (DBGMCU->APB4FZ2 |= (DBGMCU_APB4FZ2_DBG_I2C4))
#define __HAL_DBGMCU_FREEZE2_LPTIM2()                                          \
  (DBGMCU->APB4FZ2 |= (DBGMCU_APB4FZ2_DBG_LPTIM2))
#define __HAL_DBGMCU_FREEZE2_LPTIM3()                                          \
  (DBGMCU->APB4FZ2 |= (DBGMCU_APB4FZ2_DBG_LPTIM3))
#define __HAL_DBGMCU_FREEZE2_LPTIM4()                                          \
  (DBGMCU->APB4FZ2 |= (DBGMCU_APB4FZ2_DBG_LPTIM4))
#define __HAL_DBGMCU_FREEZE2_LPTIM5()                                          \
  (DBGMCU->APB4FZ2 |= (DBGMCU_APB4FZ2_DBG_LPTIM5))
#define __HAL_DBGMCU_FREEZE2_RTC() (DBGMCU->APB4FZ2 |= (DBGMCU_APB4FZ2_DBG_RTC))
#define __HAL_DBGMCU_FREEZE2_IWDG1()                                           \
  (DBGMCU->APB4FZ2 |= (DBGMCU_APB4FZ2_DBG_IWDG1))

#define __HAL_DBGMCU_UnFreeze2_WWDG1()                                         \
  (DBGMCU->APB3FZ2 &= ~(DBGMCU_APB3FZ2_DBG_WWDG1))

#define __HAL_DBGMCU_UnFreeze2_TIM2()                                          \
  (DBGMCU->APB1LFZ2 &= ~(DBGMCU_APB1LFZ2_DBG_TIM2))
#define __HAL_DBGMCU_UnFreeze2_TIM3()                                          \
  (DBGMCU->APB1LFZ2 &= ~(DBGMCU_APB1LFZ2_DBG_TIM3))
#define __HAL_DBGMCU_UnFreeze2_TIM4()                                          \
  (DBGMCU->APB1LFZ2 &= ~(DBGMCU_APB1LFZ2_DBG_TIM4))
#define __HAL_DBGMCU_UnFreeze2_TIM5()                                          \
  (DBGMCU->APB1LFZ2 &= ~(DBGMCU_APB1LFZ2_DBG_TIM5))
#define __HAL_DBGMCU_UnFreeze2_TIM6()                                          \
  (DBGMCU->APB1LFZ2 &= ~(DBGMCU_APB1LFZ2_DBG_TIM6))
#define __HAL_DBGMCU_UnFreeze2_TIM7()                                          \
  (DBGMCU->APB1LFZ2 &= ~(DBGMCU_APB1LFZ2_DBG_TIM7))
#define __HAL_DBGMCU_UnFreeze2_TIM12()                                         \
  (DBGMCU->APB1LFZ2 &= ~(DBGMCU_APB1LFZ2_DBG_TIM12))
#define __HAL_DBGMCU_UnFreeze2_TIM13()                                         \
  (DBGMCU->APB1LFZ2 &= ~(DBGMCU_APB1LFZ2_DBG_TIM13))
#define __HAL_DBGMCU_UnFreeze2_TIM14()                                         \
  (DBGMCU->APB1LFZ2 &= ~(DBGMCU_APB1LFZ2_DBG_TIM14))
#define __HAL_DBGMCU_UnFreeze2_LPTIM1()                                        \
  (DBGMCU->APB1LFZ2 &= ~(DBGMCU_APB1LFZ2_DBG_LPTIM1))
#define __HAL_DBGMCU_UnFreeze2_I2C1()                                          \
  (DBGMCU->APB1LFZ2 &= ~(DBGMCU_APB1LFZ2_DBG_I2C1))
#define __HAL_DBGMCU_UnFreeze2_I2C2()                                          \
  (DBGMCU->APB1LFZ2 &= ~(DBGMCU_APB1LFZ2_DBG_I2C2))
#define __HAL_DBGMCU_UnFreeze2_I2C3()                                          \
  (DBGMCU->APB1LFZ2 &= ~(DBGMCU_APB1LFZ2_DBG_I2C3))
#define __HAL_DBGMCU_UnFreeze2_FDCAN()                                         \
  (DBGMCU->APB1HFZ2 &= ~(DBGMCU_APB1HFZ2_DBG_FDCAN))

#define __HAL_DBGMCU_UnFreeze2_TIM1()                                          \
  (DBGMCU->APB2FZ2 &= ~(DBGMCU_APB2FZ2_DBG_TIM1))
#define __HAL_DBGMCU_UnFreeze2_TIM8()                                          \
  (DBGMCU->APB2FZ2 &= ~(DBGMCU_APB2FZ2_DBG_TIM8))
#define __HAL_DBGMCU_UnFreeze2_TIM15()                                         \
  (DBGMCU->APB2FZ2 &= ~(DBGMCU_APB2FZ2_DBG_TIM15))
#define __HAL_DBGMCU_UnFreeze2_TIM16()                                         \
  (DBGMCU->APB2FZ2 &= ~(DBGMCU_APB2FZ2_DBG_TIM16))
#define __HAL_DBGMCU_UnFreeze2_TIM17()                                         \
  (DBGMCU->APB2FZ2 &= ~(DBGMCU_APB2FZ2_DBG_TIM17))
#define __HAL_DBGMCU_UnFreeze2_HRTIM()                                         \
  (DBGMCU->APB2FZ2 &= ~(DBGMCU_APB2FZ2_DBG_HRTIM))

#define __HAL_DBGMCU_UnFreeze2_I2C4()                                          \
  (DBGMCU->APB4FZ2 &= ~(DBGMCU_APB4FZ2_DBG_I2C4))
#define __HAL_DBGMCU_UnFreeze2_LPTIM2()                                        \
  (DBGMCU->APB4FZ2 &= ~(DBGMCU_APB4FZ2_DBG_LPTIM2))
#define __HAL_DBGMCU_UnFreeze2_LPTIM3()                                        \
  (DBGMCU->APB4FZ2 &= ~(DBGMCU_APB4FZ2_DBG_LPTIM3))
#define __HAL_DBGMCU_UnFreeze2_LPTIM4()                                        \
  (DBGMCU->APB4FZ2 &= ~(DBGMCU_APB4FZ2_DBG_LPTIM4))
#define __HAL_DBGMCU_UnFreeze2_LPTIM5()                                        \
  (DBGMCU->APB4FZ2 &= ~(DBGMCU_APB4FZ2_DBG_LPTIM5))
#define __HAL_DBGMCU_UnFreeze2_RTC()                                           \
  (DBGMCU->APB4FZ2 &= ~(DBGMCU_APB4FZ2_DBG_RTC))
#define __HAL_DBGMCU_UnFreeze2_IWDG1()                                         \
  (DBGMCU->APB4FZ2 &= ~(DBGMCU_APB4FZ2_DBG_IWDG1))
