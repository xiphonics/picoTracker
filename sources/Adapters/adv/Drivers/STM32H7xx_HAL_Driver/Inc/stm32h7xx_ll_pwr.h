...
#endif                                        /* DUAL_CORE */
#define LL_PWR_FLAG_WKUPCR_WKUPC6                                              \
  PWR_WKUPCR_WKUPC6 /*!< Clear PC1 WKUP flag                                   \
                     */
#if defined(PWR_WKUPCR_WKUPC5)
#define LL_PWR_FLAG_WKUPCR_WKUPC5                                              \
  PWR_WKUPCR_WKUPC5 /*!< Clear PI11 WKUP flag                                  \
                     */
#endif              /* defined (PWR_WKUPCR_WKUPC5) */
#define LL_PWR_FLAG_WKUPCR_WKUPC4                                              \
  PWR_WKUPCR_WKUPC4 /*!< Clear PC13 WKUP flag                                  \
                     */
#if defined(PWR_WKUPCR_WKUPC3)
#define LL_PWR_FLAG_WKUPCR_WKUPC3                                              \
  PWR_WKUPCR_WKUPC3 /*!< Clear PI8 WKUP flag                                   \
                     */
#endif              /* defined (PWR_WKUPCR_WKUPC3) */
#define LL_PWR_FLAG_WKUPCR_WKUPC2                                              \
  PWR_WKUPCR_WKUPC2 /*!< Clear PA2 WKUP flag                                   \
                     */
#define LL_PWR_FLAG_WKUPCR_WKUPC1                                              \
  PWR_WKUPCR_WKUPC1 /*!< Clear PA0 WKUP flag                                   \
                     */
/**
 * @}
 */
...
#define LL_PWR_FLAG_AVDO                                                       \
  PWR_CSR1_AVDO /*!< Analog voltage detector output on VDDA flag */
#define LL_PWR_FLAG_PVDO                                                       \
  PWR_CSR1_PVDO /*!< Programmable voltage detect output flag */
#define LL_PWR_FLAG_ACTVOS                                                     \
  PWR_CSR1_ACTVOS /*!< Current VOS applied for VCORE voltage scaling flag */
#define LL_PWR_FLAG_ACTVOSRDY                                                  \
  PWR_CSR1_ACTVOSRDY /*!< Ready bit for current actual used VOS for VCORE      \
                        voltage scaling flag */
#if defined(PWR_CSR1_MMCVDO)
#define LL_PWR_FLAG_MMCVDO                                                     \
  PWR_CSR1_MMCVDO /*!< Voltage detector output on VDDMMC flag */
#endif            /* PWR_CSR1_MMCVDO */

#define LL_PWR_FLAG_TEMPH                                                      \
  PWR_CR2_TEMPH                         /*!< Temperature high threshold flag   \
                                         */
...
#define LL_PWR_FLAG_USBRDY                                                     \
  PWR_CR3_USB33RDY /*!< USB supply ready flag           */
#define LL_PWR_FLAG_SMPSEXTRDY                                                 \
  PWR_CR3_SMPSEXTRDY /*!< SMPS External supply ready flag */

#if defined(PWR_CPUCR_SBF_D2)
#define LL_PWR_FLAG_CPU_SBF_D2                                                 \
  PWR_CPUCR_SBF_D2 /*!< D2 domain DSTANDBY Flag                                \
                    */
#endif             /* PWR_CPUCR_SBF_D2 */
#if defined(PWR_CPUCR_SBF_D1)
#define LL_PWR_FLAG_CPU_SBF_D1                                                 \
  PWR_CPUCR_SBF_D1                            /*!< D1 domain DSTANDBY Flag     \
                                               */
...
#define LL_PWR_FLAG_CPU_HOLD2F                                                 \
  PWR_CPUCR_HOLD2F /*!< CPU2 in hold wakeup flag                               \
                    */
#endif             /* DUAL_CORE */

#if defined(DUAL_CORE)
#define LL_PWR_FLAG_CPU2_SBF_D2                                                \
  PWR_CPU2CR_SBF_D2 /*!< D2 domain DSTANDBY Flag  */
#define LL_PWR_FLAG_CPU2_SBF_D1                                                \
  PWR_CPU2CR_SBF_D1                             /*!< D1 domain DSTANDBY Flag  */
#define LL_PWR_FLAG_CPU2_SBF PWR_CPU2CR_SBF     /*!< System STANDBY Flag      */
#define LL_PWR_FLAG_CPU2_STOPF PWR_CPU2CR_STOPF /*!< STOP Flag */
#define LL_PWR_FLAG_CPU2_HOLD1F                                                \
  PWR_CPU2CR_HOLD1F /*!< CPU1 in hold wakeup flag */
#endif              /* DUAL_CORE */

#if defined(PWR_CPUCR_PDDS_D2)
#define LL_PWR_D3CR_VOSRDY PWR_D3CR_VOSRDY /*!< Voltage scaling ready flag */
#else
#define LL_PWR_SRDCR_VOSRDY                                                    \
  PWR_SRDCR_VOSRDY /*!< Voltage scaling ready flag                             \
                    */
 ...
 */
#if defined(PWR_CPUCR_PDDS_D2)
#define LL_PWR_CPU_MODE_D1STOP                                                 \
  0x00000000U /*!< Enter D1 domain to Stop mode when the CPU enters deepsleep  \
               */
#define LL_PWR_CPU_MODE_D1STANDBY                                              \
  PWR_CPUCR_PDDS_D1 /*!< Enter D1 domain to Standby mode when the CPU enters   \
                       deepsleep    */
#else
#define LL_PWR_CPU_MODE_CDSTOP                                                 \
  0x00000000U /*!< Enter CD domain to Stop mode when the CPU enters deepsleep  \
               */
#define LL_PWR_CPU_MODE_CDSTOP2                                                \
  PWR_CPUCR_RETDS_CD /*!< Enter CD domain to Stop2 mode when the CPU enters    \
                        deepsleep      */
#endif               /* PWR_CPUCR_PDDS_D2 */

#if defined(PWR_CPUCR_PDDS_D2)
#define LL_PWR_CPU_MODE_D2STOP                                                 \
  0x00000000U /*!< Enter D2 domain to Stop mode when the CPU enters deepsleep  \
               */
#define LL_PWR_CPU_MODE_D2STANDBY                                              \
  PWR_CPUCR_PDDS_D2 /*!< Enter D2 domain to Standby mode when the CPU enters   \
                       deepsleep    */
#endif              /* PWR_CPUCR_PDDS_D2 */

#if defined(PWR_CPUCR_PDDS_D2)
#define LL_PWR_CPU_MODE_D3RUN                                                  \
  PWR_CPUCR_RUN_D3 /*!< Keep system D3 domain in Run mode when the CPU enter   \
                      deepsleep   */
#define LL_PWR_CPU_MODE_D3STOP                                                 \
  0x00000000U /*!< Enter D3 domain to Stop mode when the CPU enters deepsleep  \
               */
#define LL_PWR_CPU_MODE_D3STANDBY                                              \
  PWR_CPUCR_PDDS_D3 /*!< Enter D3 domain to Standby mode when the CPU enters   \
                       deepsleep    */
#else
#define LL_PWR_CPU_MODE_SRDRUN                                                 \
  PWR_CPUCR_RUN_SRD /*!< Keep system SRD domain in Run mode when the CPU enter \
                       deepsleep  */
#define LL_PWR_CPU_MODE_SRDSTOP                                                \
  0x00000000U /*!< Enter SRD domain to Stop mode when the CPU enters deepsleep \
               */
#define LL_PWR_CPU_MODE_SRDSTANDBY                                             \
  PWR_CPUCR_PDDS_SRD /*!< Enter SRD domain to Standby mode when the CPU enters \
                        deepsleep   */
#endif               /* PWR_CPUCR_PDDS_D2 */

#if defined(DUAL_CORE)
#define LL_PWR_CPU2_MODE_D1STOP                                                \
  0x00000000U /*!< Enter D1 domain to Stop mode when the CPU2 enters deepsleep \
               */
#define LL_PWR_CPU2_MODE_D1STANDBY                                             \
  PWR_CPU2CR_PDDS_D1 /*!< Enter D1 domain to Standby mode when the CPU2 enters \
                        deepsleep   */
#define LL_PWR_CPU2_MODE_D2STOP                                                \
  0x00000000U /*!< Enter D2 domain to Stop mode when the CPU2 enters deepsleep \
               */
#define LL_PWR_CPU2_MODE_D2STANDBY                                             \
  PWR_CPU2CR_PDDS_D2 /*!< Enter D2 domain to Standby mode when the CPU2 enters \
                        deepsleep   */
#define LL_PWR_CPU2_MODE_D3RUN                                                 \
  PWR_CPU2CR_RUN_D3 /*!< Keep system D3 domain in RUN mode when the CPU2 enter \
                       deepsleep  */
#define LL_PWR_CPU2_MODE_D3STOP                                                \
  0x00000000U /*!< Enter D3 domain to Stop mode when the CPU2 enters deepsleep \
               */
#define LL_PWR_CPU2_MODE_D3STANDBY                                             \
  PWR_CPU2CR_PDDS_D3 /*!< Enter D3 domain to Standby mode when the CPU2 enter  \
                        deepsleep    */
#endif               /* DUAL_CORE */
/**
 * @}
...
#define LL_PWR_REGU_VOLTAGE_SCALE3                                             \
  PWR_D3CR_VOS_0 /*!< Select voltage scale 3                                   \
                  */
#define LL_PWR_REGU_VOLTAGE_SCALE2                                             \
  PWR_D3CR_VOS_1 /*!< Select voltage scale 2                                   \
                  */
#define LL_PWR_REGU_VOLTAGE_SCALE1                                             \
  (PWR_D3CR_VOS_0 | PWR_D3CR_VOS_1) /*!< Select voltage scale 1 */
#if defined(SYSCFG_PWRCR_ODEN)      /* STM32H74xxx and STM32H75xxx lines */
#define LL_PWR_REGU_VOLTAGE_SCALE0                                             \
  (PWR_D3CR_VOS_0 | PWR_D3CR_VOS_1) /*!< Select voltage scale 0 */
#else
...
#define LL_PWR_REGU_VOLTAGE_SCALE2                                             \
  PWR_D3CR_VOS_0 /*!< Select voltage scale 2                                   \
                  */
#define LL_PWR_REGU_VOLTAGE_SCALE1                                             \
  PWR_D3CR_VOS_1 /*!< Select voltage scale 1                                   \
                  */
#define LL_PWR_REGU_VOLTAGE_SCALE0                                             \
  (PWR_D3CR_VOS_0 | PWR_D3CR_VOS_1) /*!< Select voltage scale 0 */
#endif                              /* PWR_CPUCR_PDDS_D2 */
...
#define LL_PWR_REGU_VOLTAGE_SVOS_SCALE5                                        \
  PWR_CR1_SVOS_0 /*!< Select voltage scale 5 when system enters STOP mode */
#define LL_PWR_REGU_VOLTAGE_SVOS_SCALE4                                        \
  PWR_CR1_SVOS_1 /*!< Select voltage scale 4 when system enters STOP mode */
#define LL_PWR_REGU_VOLTAGE_SVOS_SCALE3                                        \
  (PWR_CR1_SVOS_0 |                                                            \
   PWR_CR1_SVOS_1) /*!< Select voltage scale 3 when system enters STOP mode */
/**
 * @}
 */
...
#define LL_PWR_PVDLEVEL_0                                                      \
  PWR_CR1_PLS_LEV0 /*!< Voltage threshold detected by PVD 1.95 V */
#define LL_PWR_PVDLEVEL_1                                                      \
  PWR_CR1_PLS_LEV1 /*!< Voltage threshold detected by PVD 2.1 V  */
#define LL_PWR_PVDLEVEL_2                                                      \
  PWR_CR1_PLS_LEV2 /*!< Voltage threshold detected by PVD 2.25 V */
#define LL_PWR_PVDLEVEL_3                                                      \
  PWR_CR1_PLS_LEV3 /*!< Voltage threshold detected by PVD 2.4 V  */
#define LL_PWR_PVDLEVEL_4                                                      \
  PWR_CR1_PLS_LEV4 /*!< Voltage threshold detected by PVD 2.55 V */
#define LL_PWR_PVDLEVEL_5                                                      \
  PWR_CR1_PLS_LEV5 /*!< Voltage threshold detected by PVD 2.7 V  */
#define LL_PWR_PVDLEVEL_6                                                      \
  PWR_CR1_PLS_LEV6 /*!< Voltage threshold detected by PVD 2.85 V */
#define LL_PWR_PVDLEVEL_7                                                      \
  PWR_CR1_PLS_LEV7 /*!< External voltage level on PVD_IN pin, compared to      \
                      internal VREFINT level. */
/**
 * @}
 */
...
#define LL_PWR_BATT_CHARG_RESISTOR_5K                                          \
  0x00000000U /*!< Charge the Battery through a 5 kO resistor    */
#define LL_PWR_BATT_CHARGRESISTOR_1_5K                                         \
  PWR_CR3_VBRS /*!< Charge the Battery through a 1.5 kO resistor  */
/**
 * @}
 */
 ...
 * @{
 */
#define LL_PWR_LDO_SUPPLY                                                      \
  PWR_CR3_LDOEN /*!< Core domains are supplied from the LDO */
#if defined(SMPS)
#define LL_PWR_DIRECT_SMPS_SUPPLY                                              \
  PWR_CR3_SMPSEN /*!< Core domains are supplied from the SMPS */
#define LL_PWR_SMPS_1V8_SUPPLIES_LDO                                           \
  (PWR_CR3_SMPSLEVEL_0 | PWR_CR3_SMPSEN |                                      \
   PWR_CR3_LDOEN) /*!< The SMPS 1.8V output supplies the LDO which supplies    \
                     the Core domains                                       */
#define LL_PWR_SMPS_2V5_SUPPLIES_LDO                                           \
  (PWR_CR3_SMPSLEVEL_1 | PWR_CR3_SMPSEN |                                      \
   PWR_CR3_LDOEN) /*!< The SMPS 2.5V output supplies the LDO which supplies    \
                     the Core domains                                       */
#define LL_PWR_SMPS_1V8_SUPPLIES_EXT_AND_LDO                                   \
  (PWR_CR3_SMPSLEVEL_0 | PWR_CR3_SMPSEXTHP | PWR_CR3_SMPSEN |                  \
   PWR_CR3_LDOEN) /*!< The SMPS 1.8V output supplies an external circuits and  \
                     the LDO. The Core domains are supplied from the LDO */
#define LL_PWR_SMPS_2V5_SUPPLIES_EXT_AND_LDO                                   \
  (PWR_CR3_SMPSLEVEL_1 | PWR_CR3_SMPSEXTHP | PWR_CR3_SMPSEN |                  \
   PWR_CR3_LDOEN) /*!< The SMPS 2.5V output supplies an external circuits and  \
                     the LDO. The Core domains are supplied from the LDO */
#define LL_PWR_SMPS_1V8_SUPPLIES_EXT                                           \
  (PWR_CR3_SMPSLEVEL_0 | PWR_CR3_SMPSEXTHP | PWR_CR3_SMPSEN |                  \
   PWR_CR3_BYPASS) /*!< The SMPS 1.8V output supplies an external source which \
                      supplies the Core domains                            */
#define LL_PWR_SMPS_2V5_SUPPLIES_EXT                                           \
  (PWR_CR3_SMPSLEVEL_1 | PWR_CR3_SMPSEXTHP | PWR_CR3_SMPSEN |                  \
   PWR_CR3_BYPASS) /*!< The SMPS 2.5V output supplies an external source which \
                      supplies the Core domains                            */
#endif             /* SMPS */
#define LL_PWR_EXTERNAL_SOURCE_SUPPLY                                          \
  PWR_CR3_BYPASS /*!< The SMPS and the LDO are Bypassed. The Core domains are  \
...
__STATIC_INLINE uint32_t LL_PWR_IsEnabledAnalogVoltageReady(void) {
  return ((READ_BIT(PWR->CR1, PWR_CR1_AVD_READY) == (PWR_CR1_AVD_READY)) ? 1UL
                                                                         : 0UL);
}
...
__STATIC_INLINE uint32_t LL_PWR_IsEnabledAXIRAM1ShutOff(void) {
  return ((READ_BIT(PWR->CR1, PWR_CR1_AXIRAM1SO) == (PWR_CR1_AXIRAM1SO)) ? 1UL
                                                                         : 0UL);
}
...
__STATIC_INLINE uint32_t LL_PWR_IsEnabledAXIRAM2ShutOff(void) {
  return ((READ_BIT(PWR->CR1, PWR_CR1_AXIRAM2SO) == (PWR_CR1_AXIRAM2SO)) ? 1UL
                                                                         : 0UL);
}
...
__STATIC_INLINE uint32_t LL_PWR_IsEnabledAXIRAM3ShutOff(void) {
  return ((READ_BIT(PWR->CR1, PWR_CR1_AXIRAM3SO) == (PWR_CR1_AXIRAM3SO)) ? 1UL
                                                                         : 0UL);
}
...
__STATIC_INLINE uint32_t LL_PWR_IsEnabledAHBRAM1ShutOff(void) {
  return ((READ_BIT(PWR->CR1, PWR_CR1_AHBRAM1SO) == (PWR_CR1_AHBRAM1SO)) ? 1UL
                                                                         : 0UL);
}
...
__STATIC_INLINE uint32_t LL_PWR_IsEnabledAHBRAM2ShutOff(void) {
  return ((READ_BIT(PWR->CR1, PWR_CR1_AHBRAM2SO) == (PWR_CR1_AHBRAM2SO)) ? 1UL
                                                                         : 0UL);
}
...
__STATIC_INLINE uint32_t LL_PWR_IsEnabledHSITFShutOff(void) {
  return ((READ_BIT(PWR->CR1, PWR_CR1_HSITFSO) == (PWR_CR1_HSITFSO)) ? 1UL
                                                                     : 0UL);
}
...
__STATIC_INLINE uint32_t LL_PWR_IsEnabledSRDRAMShutOff(void) {
  return ((READ_BIT(PWR->CR1, PWR_CR1_SRDRAMSO) == (PWR_CR1_SRDRAMSO)) ? 1UL
                                                                       : 0UL);
}
...
__STATIC_INLINE uint32_t LL_PWR_GetSupply(void) {
  ...
  return (uint32_t)(READ_BIT(PWR->CR3, (PWR_CR3_SMPSLEVEL | PWR_CR3_SMPSEXTHP |
...
__STATIC_INLINE uint32_t LL_PWR_IsEnabledUSBReg(void) {
  return ((READ_BIT(PWR->CR3, PWR_CR3_USBREGEN) == (PWR_CR3_USBREGEN)) ? 1UL
                                                                       : 0UL);
}
...
__STATIC_INLINE uint32_t LL_PWR_IsEnabledUSBVoltageDetector(void) {
  return ((READ_BIT(PWR->CR3, PWR_CR3_USB33DEN) == (PWR_CR3_USB33DEN)) ? 1UL
                                                                       : 0UL);
}
...
__STATIC_INLINE uint32_t LL_PWR_IsCPU1Held(void) {
  return ((READ_BIT(PWR->CPU2CR, PWR_CPU2CR_HOLD1) == (PWR_CPU2CR_HOLD1))
              ? 1UL
              : 0UL);
}
...
__STATIC_INLINE uint32_t LL_PWR_IsCPU2Held(void) {
  return ((READ_BIT(PWR->CPUCR, PWR_CPUCR_HOLD2) == (PWR_CPUCR_HOLD2)) ? 1UL
                                                                       : 0UL);
}
#endif /* DUAL_CORE */
...
__STATIC_INLINE uint32_t LL_PWR_CPU_IsEnabledD3RunInLowPowerMode(void) {
  return ((READ_BIT(PWR->CPUCR, PWR_CPUCR_RUN_D3) == (PWR_CPUCR_RUN_D3)) ? 1UL
                                                                         : 0UL);
}
#else
/**
...
__STATIC_INLINE uint32_t LL_PWR_CPU_IsEnabledSRDRunInLowPowerMode(void) {
  return ((READ_BIT(PWR->CPUCR, PWR_CPUCR_RUN_SRD) == (PWR_CPUCR_RUN_SRD))
              ? 1UL
              : 0UL);
}
#endif /* PWR_CPUCR_PDDS_D2 */
...
__STATIC_INLINE uint32_t LL_PWR_CPU2_IsEnabledD3RunInLowPowerMode(void) {
  return ((READ_BIT(PWR->CPU2CR, PWR_CPU2CR_RUN_D3) == (PWR_CPU2CR_RUN_D3))
              ? 1UL
              : 0UL);
}
#endif /* DUAL_CORE */
 ...
 *         is applied when PWR_D3CR_VOS[1:0] = 0b11 and  SYSCFG_PWRCR_ODEN =
 * 0b1.
 * @retval None
 */
 ...
 *         VOS0 need the check of PWR_D3CR_VOS[1:0] field and SYSCFG_PWRCR_ODEN
 * bit.
 * @retval Returned value can be one of the following values:
 *         @arg @ref LL_PWR_REGU_VOLTAGE_SCALE0
 *         @arg @ref LL_PWR_REGU_VOLTAGE_SCALE1
...
__STATIC_INLINE uint32_t LL_PWR_GetWakeUpPinPull(uint32_t WakeUpPin) {
  ...
  return (uint32_t)(regValue >> ((PWR_WKUPEPR_WKUPPUPD1_Pos +
...
/**
 * @brief  Indicate whether the voltage level is ready for current actual used
 * VOS
...
__STATIC_INLINE uint32_t LL_PWR_IsActiveFlag_MMCVDO(void) {
  return ((READ_BIT(PWR->CSR1, PWR_CSR1_MMCVDO) == (PWR_CSR1_MMCVDO)) ? 1UL
                                                                      : 0UL);
}
#endif /* PWR_CSR1_MMCVDO */
...
/**
 * @brief  Indicate whether the CPU temperature level is above or below low
 * threshold
...
/**
 * @brief  Indicate whether the CPU temperature level is above or below high
 * threshold
...
__STATIC_INLINE uint32_t LL_PWR_IsActiveFlag_SMPSEXT(void) {
  return ((READ_BIT(PWR->CR3, PWR_CR3_SMPSEXTRDY) == (PWR_CR3_SMPSEXTRDY))
              ? 1UL
              : 0UL);
}
#endif /* SMPS */
...
__STATIC_INLINE uint32_t LL_PWR_IsActiveFlag_USB(void) {
  return ((READ_BIT(PWR->CR3, PWR_CR3_USB33RDY) == (PWR_CR3_USB33RDY)) ? 1UL
                                                                       : 0UL);
}
...
__STATIC_INLINE uint32_t LL_PWR_IsActiveFlag_HOLD2(void) {
  return ((READ_BIT(PWR->CPUCR, PWR_CPUCR_HOLD2F) == (PWR_CPUCR_HOLD2F)) ? 1UL
                                                                         : 0UL);
}
...
__STATIC_INLINE uint32_t LL_PWR_IsActiveFlag_HOLD1(void) {
  return ((READ_BIT(PWR->CPU2CR, PWR_CPU2CR_HOLD1F) == (PWR_CPU2CR_HOLD1F))
              ? 1UL
              : 0UL);
}
#endif /* DUAL_CORE */
...
__STATIC_INLINE uint32_t LL_PWR_CPU_IsActiveFlag_STOP(void) {
  return ((READ_BIT(PWR->CPUCR, PWR_CPUCR_STOPF) == (PWR_CPUCR_STOPF)) ? 1UL
                                                                       : 0UL);
}
...
__STATIC_INLINE uint32_t LL_PWR_CPU2_IsActiveFlag_STOP(void) {
  return ((READ_BIT(PWR->CPU2CR, PWR_CPU2CR_STOPF) == (PWR_CPU2CR_STOPF))
              ? 1UL
              : 0UL);
}
#endif /* DUAL_CORE */
...
__STATIC_INLINE uint32_t LL_PWR_CPU2_IsActiveFlag_SB(void) {
  return ((READ_BIT(PWR->CPU2CR, PWR_CPU2CR_SBF) == (PWR_CPU2CR_SBF)) ? 1UL
                                                                      : 0UL);
}
#endif /* DUAL_CORE */
...
__STATIC_INLINE uint32_t LL_PWR_CPU_IsActiveFlag_SB_D1(void) {
  return ((READ_BIT(PWR->CPUCR, PWR_CPUCR_SBF_D1) == (PWR_CPUCR_SBF_D1)) ? 1UL
                                                                         : 0UL);
}
#endif /* PWR_CPUCR_SBF_D1 */
...
__STATIC_INLINE uint32_t LL_PWR_CPU2_IsActiveFlag_SB_D1(void) {
  return ((READ_BIT(PWR->CPU2CR, PWR_CPU2CR_SBF_D1) == (PWR_CPU2CR_SBF_D1))
              ? 1UL
              : 0UL);
}
#endif /* DUAL_CORE */
...
__STATIC_INLINE uint32_t LL_PWR_CPU_IsActiveFlag_SB_D2(void) {
  return ((READ_BIT(PWR->CPUCR, PWR_CPUCR_SBF_D2) == (PWR_CPUCR_SBF_D2)) ? 1UL
                                                                         : 0UL);
}
#endif /* PWR_CPUCR_SBF_D2 */
...
__STATIC_INLINE uint32_t LL_PWR_CPU2_IsActiveFlag_SB_D2(void) {
  return ((READ_BIT(PWR->CPU2CR, PWR_CPU2CR_SBF_D2) == (PWR_CPU2CR_SBF_D2))
              ? 1UL
              : 0UL);
}
#endif /* DUAL_CORE */
 ...
 *         or if its output voltage is still changing to the required voltage
 * level
...
#if defined(PWR_CPUCR_PDDS_D2)
  return ((READ_BIT(PWR->D3CR, PWR_D3CR_VOSRDY) == (PWR_D3CR_VOSRDY)) ? 1UL
                                                                      : 0UL);
#else
  return ((READ_BIT(PWR->SRDCR, PWR_SRDCR_VOSRDY) == (PWR_SRDCR_VOSRDY)) ? 1UL
                                                                         : 0UL);
#endif /* PWR_CPUCR_PDDS_D2 */
}
