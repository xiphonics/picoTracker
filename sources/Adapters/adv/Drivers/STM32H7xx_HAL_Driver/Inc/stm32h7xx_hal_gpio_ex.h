...
#define GPIO_AF0_NDSTOP2                                                       \
  ((uint8_t)0x00) /* NDSTOP2 Alternate Function mapping              */
#endif            /* PWR_CPUCR_RETDS_CD */
#if defined(PWR_CPUCR_PDDS_D2) /* PWR D1 and D2 domains exists */
#define GPIO_AF0_C1DSLEEP                                                      \
  ((uint8_t)0x00) /* Cortex-M7 Deep Sleep Alternate Function mapping :         \
                     available on STM32H7 Rev.B and above  */
#define GPIO_AF0_C1SLEEP                                                       \
  ((uint8_t)0x00) /* Cortex-M7 Sleep Alternate Function mapping : available on \
                     STM32H7 Rev.B and above       */
#define GPIO_AF0_D1PWREN                                                       \
  ((uint8_t)0x00) /* Domain 1 PWR enable Alternate Function mapping :          \
                     available on STM32H7 Rev.B and above   */
#define GPIO_AF0_D2PWREN                                                       \
  ((uint8_t)0x00) /* Domain 2 PWR enable Alternate Function mapping :          \
                     available on STM32H7 Rev.B and above   */
#if defined(DUAL_CORE)
#define GPIO_AF0_C2DSLEEP                                                      \
  ((uint8_t)0x00) /* Cortex-M4 Deep Sleep Alternate Function mapping :         \
                     available on STM32H7 Rev.B and above  */
#define GPIO_AF0_C2SLEEP                                                       \
  ((uint8_t)0x00) /* Cortex-M4 Sleep Alternate Function mapping : available on \
                     STM32H7 Rev.B and above       */
#endif            /* DUAL_CORE */
...
#define GPIO_AF1_LPTIM1                                                        \
  ((uint8_t)0x01) /* LPTIM1 Alternate Function mapping                         \
                   */
#if defined(HRTIM1)
#define GPIO_AF1_HRTIM1                                                        \
  ((uint8_t)0x01) /* HRTIM1 Alternate Function mapping                         \
                   */
#endif            /* HRTIM1 */
#if defined(SAI4)
#define GPIO_AF1_SAI4                                                          \
  ((uint8_t)0x01) /* SAI4 Alternate Function mapping : available on            \
                     STM32H72xxx/STM32H73xxx */
#endif            /* SAI4 */
#define GPIO_AF1_FMC                                                           \
  ((uint8_t)0x01) /* FMC Alternate Function mapping : available on             \
                     STM32H72xxx/STM32H73xxx */
...
#if defined(HRTIM1)
#define GPIO_AF2_HRTIM1                                                        \
  ((uint8_t)0x02) /* HRTIM1 Alternate Function mapping                         \
                   */
#endif            /* HRTIM1 */
#define GPIO_AF2_TIM15                                                         \
  ((uint8_t)0x02) /* TIM15 Alternate Function mapping : available on           \
                     STM32H7A3xxx/STM32H7B3xxx/STM32H7B0xxx and                \
                     STM32H72xxx/STM32H73xxx */
#if defined(FDCAN3)
#define GPIO_AF2_FDCAN3                                                        \
  ((uint8_t)0x02) /* FDCAN3 Alternate Function mapping                         \
                   */
#endif            /*FDCAN3*/
...
#define GPIO_AF3_LPTIM5                                                        \
  ((uint8_t)0x03) /* LPTIM5 Alternate Function mapping                         \
                   */
#define GPIO_AF3_LPUART                                                        \
  ((uint8_t)0x03) /* LPUART Alternate Function mapping                         \
                   */
#if defined(OCTOSPIM)
#define GPIO_AF3_OCTOSPIM_P1                                                   \
  ((uint8_t)0x03) /* OCTOSPI Manager Port 1 Alternate Function mapping */
#define GPIO_AF3_OCTOSPIM_P2                                                   \
  ((uint8_t)0x03) /* OCTOSPI Manager Port 2 Alternate Function mapping */
#endif            /* OCTOSPIM */
#if defined(HRTIM1)
#define GPIO_AF3_HRTIM1                                                        \
  ((uint8_t)0x03) /* HRTIM1 Alternate Function mapping                         \
                   */
#endif            /* HRTIM1 */
#define GPIO_AF3_LTDC                                                          \
  ((uint8_t)0x03) /* LTDC Alternate Function mapping : available on            \
                     STM32H72xxx/STM32H73xxx */
...
#define GPIO_AF4_USART1                                                        \
  ((uint8_t)0x04) /* USART1 Alternate Function mapping                         \
                   */
#if defined(USART10)
#define GPIO_AF4_USART10                                                       \
  ((uint8_t)0x04) /* USART10 Alternate Function mapping : available on         \
                     STM32H72xxx/STM32H73xxx */
#endif            /*USART10*/
#define GPIO_AF4_DFSDM1                                                        \
  ((uint8_t)0x04) /* DFSDM  Alternate Function mapping                         \
                   */
#if defined(DFSDM2_BASE)
#define GPIO_AF4_DFSDM2                                                        \
  ((uint8_t)0x04) /* DFSDM2 Alternate Function mapping                         \
                   */
#endif            /* DFSDM2_BASE */
#define GPIO_AF4_DCMI                                                          \
  ((uint8_t)0x04) /* DCMI Alternate Function mapping : available on            \
                     STM32H7A3xxx/STM32H7B3xxx/STM32H7B0xxx and                \
                     STM32H72xxx/STM32H73xxx */
#if defined(PSSI)
...
#endif                                /* PSSI */
#if defined(OCTOSPIM)
#define GPIO_AF4_OCTOSPIM_P1                                                   \
  ((uint8_t)0x04) /* OCTOSPI Manager Port 1 Alternate Function mapping  :      \
...
#if defined(FDCAN3)
#define GPIO_AF5_FDCAN3                                                        \
  ((uint8_t)0x05) /* FDCAN3 Alternate Function mapping                         \
                   */
#endif            /*FDCAN3*/
...
#define GPIO_AF8_LPUART                                                        \
  ((uint8_t)0x08) /* LPUART Alternate Function mapping                         \
                   */
...
#endif                                /* SAI4 */
#if defined(OCTOSPIM)
#define GPIO_AF9_OCTOSPIM_P1                                                   \
  ((uint8_t)0x09) /* OCTOSPI Manager Port 1 Alternate Function mapping */
#define GPIO_AF9_OCTOSPIM_P2                                                   \
  ((uint8_t)0x09) /* OCTOSPI Manager Port 2 Alternate Function mapping */
#endif            /* OCTOSPIM */
...
#define GPIO_AF10_OTG2_FS                                                      \
  ((uint8_t)0x0A)                       /* OTG2_FS Alternate Function mapping */
#endif                                  /*USB2_OTG_FS*/
...
#endif                                 /*LTDC*/
#define GPIO_AF10_CRS_SYNC                                                     \
  ((uint8_t)0x0A) /* CRS Sync Alternate Function mapping : available on        \
                     STM32H7 Rev.B and above  */
#if defined(QUADSPI)
...
#endif                                 /* SAI4 */
#if !defined(USB2_OTG_FS)
#define GPIO_AF10_OTG1_FS                                                      \
  ((uint8_t)0x0A) /* OTG1_FS Alternate Function mapping : available on         \
                     STM32H7A3xxx/STM32H7B3xxx/STM32H7B0xxx and                \
                     STM32H72xxx/STM32H73xxx */
#endif            /* !USB2_OTG_FS */
#define GPIO_AF10_OTG1_HS                                                      \
  ((uint8_t)0x0A) /* OTG1_HS Alternate Function mapping */
#if defined(OCTOSPIM)
...
#define GPIO_AF10_FMC                                                          \
  ((uint8_t)0x0A) /* FMC Alternate Function mapping : available on             \
                     STM32H7A3xxx/STM32H7B3xxx/STM32H7B0xxx and                \
                     STM32H72xxx/STM32H73xxx */
...
#define GPIO_AF11_DFSDM1                                                       \
  ((uint8_t)0x0B)                       /* DFSDM1 Alternate Function mapping  */
...
#if defined(DFSDM2_BASE)
#define GPIO_AF11_DFSDM2                                                       \
  ((uint8_t)0x0B) /* DFSDM2 Alternate Function mapping  */
#endif            /* DFSDM2_BASE */
#if defined(USART10)
#define GPIO_AF11_USART10                                                      \
  ((uint8_t)0x0B) /* USART10 Alternate Function mapping */
#endif            /* USART10 */
#if defined(UART9)
...
#endif                                /* ETH */
#if defined(LTDC)
#define GPIO_AF11_LTDC                                                         \
  ((uint8_t)0x0B) /* LTDC Alternate Function mapping : available on            \
                     STM32H7A3xxx/STM32H7B3xxx/STM32H7B0xxx and                \
                     STM32H72xxx/STM32H73xxx */
#endif            /*LTDC*/
#if defined(OCTOSPIM)
#define GPIO_AF11_OCTOSPIM_P1                                                  \
  ((uint8_t)0x0B) /* OCTOSPI Manager Port 1 Alternate Function mapping */
#endif            /* OCTOSPIM */
...
#endif                                 /*LTDC*/
#if defined(USB2_OTG_FS)
#define GPIO_AF12_OTG1_FS                                                      \
  ((uint8_t)0x0C) /* OTG1_FS Alternate Function mapping */
#endif            /* USB2_OTG_FS */
#if defined(OCTOSPIM)
#define GPIO_AF12_OCTOSPIM_P1                                                  \
  ((uint8_t)0x0C) /* OCTOSPI Manager Port 1 Alternate Function mapping */
#endif            /* OCTOSPIM */
