 ...
 * @{
 */
/** @defgroup SYSTEM_LL_EC_FLASH_BANK1_SECTORS SYSCFG Flash Bank1 sectors bits
 * status
 * @{
 */
...
/** @defgroup SYSTEM_LL_EC_FLASH_BANK2_SECTORS SYSCFG Flash Bank2 sectors bits
 * status
 * @{
 */
...
#define LL_SYSCFG_I2C_FASTMODEPLUS_I2C1                                        \
  SYSCFG_PMCR_I2C1_FMP /*!< Enable Fast Mode Plus for I2C1      */
#define LL_SYSCFG_I2C_FASTMODEPLUS_I2C2                                        \
  SYSCFG_PMCR_I2C2_FMP /*!< Enable Fast Mode Plus for I2C2      */
#define LL_SYSCFG_I2C_FASTMODEPLUS_I2C3                                        \
  SYSCFG_PMCR_I2C3_FMP /*!< Enable Fast Mode Plus for I2C3      */
#define LL_SYSCFG_I2C_FASTMODEPLUS_I2C4                                        \
  SYSCFG_PMCR_I2C4_FMP /*!< Enable Fast Mode Plus for I2C4      */
#if defined(I2C5)
#define LL_SYSCFG_I2C_FASTMODEPLUS_I2C5                                        \
  SYSCFG_PMCR_I2C5_FMP /*!< Enable Fast Mode Plus for I2C5      */
#endif                 /*I2C5*/
#define LL_SYSCFG_I2C_FASTMODEPLUS_PB6                                         \
  SYSCFG_PMCR_I2C_PB6_FMP /*!< Enable Fast Mode Plus on PB6        */
#define LL_SYSCFG_I2C_FASTMODEPLUS_PB7                                         \
  SYSCFG_PMCR_I2C_PB7_FMP /*!< Enable Fast Mode Plus on PB7        */
#define LL_SYSCFG_I2C_FASTMODEPLUS_PB8                                         \
  SYSCFG_PMCR_I2C_PB8_FMP /*!< Enable Fast Mode Plus on PB8        */
#define LL_SYSCFG_I2C_FASTMODEPLUS_PB9                                         \
  SYSCFG_PMCR_I2C_PB9_FMP /*!< Enable Fast Mode Plus on PB9        */
/**
 * @}
 */
...
#define LL_SYSCFG_ANALOG_SWITCH_BOOSTEN                                        \
  SYSCFG_PMCR_BOOSTEN /*!< I/O analog switch voltage booster enable */
...
#define LL_SYSCFG_ETH_RMII                                                     \
  SYSCFG_PMCR_EPIS_SEL_2 /*!< ETH Media RMII interface */
/**
 * @}
 */
...
#define LL_SYSCFG_EXTI_LINE0                                                   \
  ((0x000FUL << 16U) | 0U) /*!< EXTI_POSITION_0  | EXTICR[0] */
#define LL_SYSCFG_EXTI_LINE1                                                   \
  ((0x00F0UL << 16U) | 0U) /*!< EXTI_POSITION_4  | EXTICR[0] */
#define LL_SYSCFG_EXTI_LINE2                                                   \
  ((0x0F00UL << 16U) | 0U) /*!< EXTI_POSITION_8  | EXTICR[0] */
#define LL_SYSCFG_EXTI_LINE3                                                   \
  ((0xF000UL << 16U) | 0U) /*!< EXTI_POSITION_12 | EXTICR[0] */
#define LL_SYSCFG_EXTI_LINE4                                                   \
  ((0x000FUL << 16U) | 1U) /*!< EXTI_POSITION_0  | EXTICR[1] */
#define LL_SYSCFG_EXTI_LINE5                                                   \
  ((0x00F0UL << 16U) | 1U) /*!< EXTI_POSITION_4  | EXTICR[1] */
#define LL_SYSCFG_EXTI_LINE6                                                   \
  ((0x0F00UL << 16U) | 1U) /*!< EXTI_POSITION_8  | EXTICR[1] */
#define LL_SYSCFG_EXTI_LINE7                                                   \
  ((0xF000UL << 16U) | 1U) /*!< EXTI_POSITION_12 | EXTICR[1] */
#define LL_SYSCFG_EXTI_LINE8                                                   \
  ((0x000FUL << 16U) | 2U) /*!< EXTI_POSITION_0  | EXTICR[2] */
#define LL_SYSCFG_EXTI_LINE9                                                   \
  ((0x00F0UL << 16U) | 2U) /*!< EXTI_POSITION_4  | EXTICR[2] */
#define LL_SYSCFG_EXTI_LINE10                                                  \
  ((0x0F00UL << 16U) | 2U) /*!< EXTI_POSITION_8  | EXTICR[2] */
#define LL_SYSCFG_EXTI_LINE11                                                  \
  ((0xF000UL << 16U) | 2U) /*!< EXTI_POSITION_12 | EXTICR[2] */
#define LL_SYSCFG_EXTI_LINE12                                                  \
  ((0x000FUL << 16U) | 3U) /*!< EXTI_POSITION_0  | EXTICR[3] */
#define LL_SYSCFG_EXTI_LINE13                                                  \
  ((0x00F0UL << 16U) | 3U) /*!< EXTI_POSITION_4  | EXTICR[3] */
#define LL_SYSCFG_EXTI_LINE14                                                  \
  ((0x0F00UL << 16U) | 3U) /*!< EXTI_POSITION_8  | EXTICR[3] */
#define LL_SYSCFG_EXTI_LINE15                                                  \
  ((0xF000UL << 16U) | 3U) /*!< EXTI_POSITION_12 | EXTICR[3] */
/**
 * @}
 */
 ...
 * @{
 */
#define LL_SYSCFG_TIMBREAK_AXISRAM_DBL_ECC                                     \
  SYSCFG_CFGR_AXISRAML /*!< Enables and locks the AXIRAM double ECC error      \
                          signal with Break Input of TIM1/8/15/16/17 and HRTIM \
                        */

#define LL_SYSCFG_TIMBREAK_ITCM_DBL_ECC                                        \
  SYSCFG_CFGR_ITCML /*!< Enables and locks the ITCM double ECC error signal    \
                         with Break Input of TIM1/8/15/16/17 and HRTIM */

#define LL_SYSCFG_TIMBREAK_DTCM_DBL_ECC                                        \
  SYSCFG_CFGR_DTCML /*!< Enables and locks the DTCM double ECC error signal    \
                         with Break Input of TIM1/8/15/16/17 and HRTIM */

#define LL_SYSCFG_TIMBREAK_SRAM1_DBL_ECC                                       \
  SYSCFG_CFGR_SRAM1L /*!< Enables and locks the SRAM1 double ECC error signal  \
                          with Break Input of TIM1/8/15/16/17 and HRTIM */

#define LL_SYSCFG_TIMBREAK_SRAM2_DBL_ECC                                       \
  SYSCFG_CFGR_SRAM2L /*!< Enables and locks the SRAM2 double ECC error signal  \
                          with Break Input of TIM1/8/15/16/17 and HRTIM */

#if defined(SYSCFG_CFGR_SRAM3L)
#define LL_SYSCFG_TIMBREAK_SRAM3_DBL_ECC                                       \
  SYSCFG_CFGR_SRAM3L /*!< Enables and locks the SRAM3 double ECC error signal  \
                          with Break Input of TIM1/8/15/16/17 and HRTIM */
#endif               /*SYSCFG_CFGR_SRAM3L*/

#define LL_SYSCFG_TIMBREAK_SRAM4_DBL_ECC                                       \
  SYSCFG_CFGR_SRAM4L /*!< Enables and locks the SRAM4 double ECC error signal  \
                          with Break Input of TIM1/8/15/16/17 and HRTIM */

#define LL_SYSCFG_TIMBREAK_BKRAM_DBL_ECC                                       \
  SYSCFG_CFGR_BKRAML /*!< Enables and locks the BKRAM double ECC error signal  \
                          with Break Input of TIM1/8/15/16/17 and HRTIM */

#define LL_SYSCFG_TIMBREAK_CM7_LOCKUP                                          \
  SYSCFG_CFGR_CM7L /*!< Enables and locks the Cortex-M7 LOCKUP signal          \
                        with Break Input of TIM1/8/15/16/17 and HRTIM */

#define LL_SYSCFG_TIMBREAK_FLASH_DBL_ECC                                       \
  SYSCFG_CFGR_FLASHL /*!< Enables and locks the FLASH double ECC error signal  \
                          with Break Input of TIM1/8/15/16/17 and HRTIM */

#define LL_SYSCFG_TIMBREAK_PVD                                                 \
  SYSCFG_CFGR_PVDL /*!< Enables and locks the PVD connection                   \
...
#define LL_SYSCFG_TIMBREAK_CM4_LOCKUP                                          \
  SYSCFG_CFGR_CM4L /*!< Enables and locks the Cortex-M4 LOCKUP signal          \
                        with Break Input of TIM1/8/15/16/17 and HRTIM */
#endif             /* DUAL_CORE */
/**
 * @}
...
#define LL_DBGMCU_APB1_GRP1_TIM2_STOP                                          \
  DBGMCU_APB1LFZ1_DBG_TIM2 /*!< TIM2 counter stopped when core is halted */
#define LL_DBGMCU_APB1_GRP1_TIM3_STOP                                          \
  DBGMCU_APB1LFZ1_DBG_TIM3 /*!< TIM3 counter stopped when core is halted */
#define LL_DBGMCU_APB1_GRP1_TIM4_STOP                                          \
  DBGMCU_APB1LFZ1_DBG_TIM4 /*!< TIM4 counter stopped when core is halted */
#define LL_DBGMCU_APB1_GRP1_TIM5_STOP                                          \
  DBGMCU_APB1LFZ1_DBG_TIM5 /*!< TIM5 counter stopped when core is halted */
#define LL_DBGMCU_APB1_GRP1_TIM6_STOP                                          \
  DBGMCU_APB1LFZ1_DBG_TIM6 /*!< TIM6 counter stopped when core is halted */
#define LL_DBGMCU_APB1_GRP1_TIM7_STOP                                          \
  DBGMCU_APB1LFZ1_DBG_TIM7 /*!< TIM7 counter stopped when core is halted */
#define LL_DBGMCU_APB1_GRP1_TIM12_STOP                                         \
  DBGMCU_APB1LFZ1_DBG_TIM12 /*!< TIM12 counter stopped when core is halted */
#define LL_DBGMCU_APB1_GRP1_TIM13_STOP                                         \
  DBGMCU_APB1LFZ1_DBG_TIM13 /*!< TIM13 counter stopped when core is halted */
#define LL_DBGMCU_APB1_GRP1_TIM14_STOP                                         \
  DBGMCU_APB1LFZ1_DBG_TIM14 /*!< TIM14 counter stopped when core is halted */
#define LL_DBGMCU_APB1_GRP1_LPTIM1_STOP                                        \
  DBGMCU_APB1LFZ1_DBG_LPTIM1 /*!< LPTIM1 counter stopped when core is halted   \
                              */
#define LL_DBGMCU_APB1_GRP1_I2C1_STOP                                          \
  DBGMCU_APB1LFZ1_DBG_I2C1 /*!< I2C1 SMBUS timeout mode stopped when Core is   \
                              halted */
#define LL_DBGMCU_APB1_GRP1_I2C2_STOP                                          \
  DBGMCU_APB1LFZ1_DBG_I2C2 /*!< I2C2 SMBUS timeout mode stopped when Core is   \
                              halted */
#define LL_DBGMCU_APB1_GRP1_I2C3_STOP                                          \
  DBGMCU_APB1LFZ1_DBG_I2C3 /*!< I2C3 SMBUS timeout mode stopped when Core is   \
                              halted */
#if defined(I2C5)
#define LL_DBGMCU_APB1_GRP1_I2C5_STOP                                          \
  DBGMCU_APB1LFZ1_DBG_I2C5 /*!< I2C5 SMBUS timeout mode stopped when Core is   \
                              halted */
#endif                     /*I2C5*/
/**
 * @}
...
#define LL_DBGMCU_APB1_GRP2_FDCAN_STOP                                         \
  DBGMCU_APB1HFZ1_DBG_FDCAN /*!< FDCAN is frozen while the core is in debug    \
                               mode */
#endif                      /*DBGMCU_APB1HFZ1_DBG_FDCAN*/
#if defined(TIM23)
#define LL_DBGMCU_APB1_GRP2_TIM23_STOP                                         \
  DBGMCU_APB1HFZ1_DBG_TIM23 /*!< TIM23 is frozen while the core is in debug    \
                               mode */
#endif                      /*TIM23*/
#if defined(TIM24)
#define LL_DBGMCU_APB1_GRP2_TIM24_STOP                                         \
  DBGMCU_APB1HFZ1_DBG_TIM24 /*!< TIM24 is frozen while the core is in debug    \
                               mode */
#endif                      /*TIM24*/
/**
 * @}
...
#define LL_DBGMCU_APB2_GRP1_TIM1_STOP                                          \
  DBGMCU_APB2FZ1_DBG_TIM1 /*!< TIM1 counter stopped when core is halted */
#define LL_DBGMCU_APB2_GRP1_TIM8_STOP                                          \
  DBGMCU_APB2FZ1_DBG_TIM8 /*!< TIM8 counter stopped when core is halted */
#define LL_DBGMCU_APB2_GRP1_TIM15_STOP                                         \
  DBGMCU_APB2FZ1_DBG_TIM15 /*!< TIM15 counter stopped when core is halted */
#define LL_DBGMCU_APB2_GRP1_TIM16_STOP                                         \
  DBGMCU_APB2FZ1_DBG_TIM16 /*!< TIM16 counter stopped when core is halted */
#define LL_DBGMCU_APB2_GRP1_TIM17_STOP                                         \
  DBGMCU_APB2FZ1_DBG_TIM17 /*!< TIM17 counter stopped when core is halted */
#if defined(HRTIM1)
#define LL_DBGMCU_APB2_GRP1_HRTIM_STOP                                         \
  DBGMCU_APB2FZ1_DBG_HRTIM /*!< HRTIM counter stopped when core is halted */
#endif                     /*HRTIM1*/
/**
 * @}
 */
 ...
 * @{
 */
#define LL_DBGMCU_APB3_GRP1_WWDG1_STOP                                         \
  DBGMCU_APB3FZ1_DBG_WWDG1 /*!< WWDG1 is frozen while the core is in debug     \
                              mode */
/**
 * @}
 */
 ...
 * @{
 */
#define LL_DBGMCU_APB4_GRP1_I2C4_STOP                                          \
  DBGMCU_APB4FZ1_DBG_I2C4 /*!< I2C4 is frozen while the core is in debug mode  \
                           */
#define LL_DBGMCU_APB4_GRP1_LPTIM2_STOP                                        \
  DBGMCU_APB4FZ1_DBG_LPTIM2 /*!< LPTIM2 is frozen while the core is in debug   \
                               mode */
#define LL_DBGMCU_APB4_GRP1_LPTIM3_STOP                                        \
  DBGMCU_APB4FZ1_DBG_LPTIM3 /*!< LPTIM3 is frozen while the core is in debug   \
                               mode */
#define LL_DBGMCU_APB4_GRP1_LPTIM4_STOP                                        \
  DBGMCU_APB4FZ1_DBG_LPTIM4 /*!< LPTIM4 is frozen while the core is in debug   \
                               mode */
#define LL_DBGMCU_APB4_GRP1_LPTIM5_STOP                                        \
  DBGMCU_APB4FZ1_DBG_LPTIM5 /*!< LPTIM5 is frozen while the core is in debug   \
                               mode */
#define LL_DBGMCU_APB4_GRP1_RTC_STOP                                           \
  DBGMCU_APB4FZ1_DBG_RTC /*!< RTC is frozen while the core is in debug mode */
#define LL_DBGMCU_APB4_GRP1_IWDG1_STOP                                         \
  DBGMCU_APB4FZ1_DBG_IWDG1 /*!< IWDG1 is frozen while the core is in debug     \
                              mode */
/**
 * @}
 */
 ...
 *         @arg @ref LL_SYSCFG_TIMBREAK_CM4_LOCKUP (available for dual core
 * lines only)
 * @retval None
 *         (*) value not defined in all devices
 */
__STATIC_INLINE void LL_SYSCFG_SetTIMBreakInputs(uint32_t Break) {
  ...
  MODIFY_REG(SYSCFG->CFGR,
             SYSCFG_CFGR_AXISRAML | SYSCFG_CFGR_ITCML | SYSCFG_CFGR_DTCML |
  ...
  MODIFY_REG(SYSCFG->CFGR,
             SYSCFG_CFGR_AXISRAML | SYSCFG_CFGR_ITCML | SYSCFG_CFGR_DTCML |
                 SYSCFG_CFGR_SRAM1L | SYSCFG_CFGR_SRAM2L | SYSCFG_CFGR_SRAM4L |
                 SYSCFG_CFGR_BKRAML | SYSCFG_CFGR_CM7L | SYSCFG_CFGR_FLASHL |
                 SYSCFG_CFGR_PVDL,
             Break);
#else
  MODIFY_REG(SYSCFG->CFGR,
             SYSCFG_CFGR_ITCML | SYSCFG_CFGR_DTCML | SYSCFG_CFGR_CM7L |
                 SYSCFG_CFGR_FLASHL | SYSCFG_CFGR_PVDL,
             Break);
#endif /* DUAL_CORE */
}
...
__STATIC_INLINE uint32_t LL_SYSCFG_GetTIMBreakInputs(void) {
  ...
  return (uint32_t)(READ_BIT(SYSCFG->CFGR,
                             SYSCFG_CFGR_AXISRAML | SYSCFG_CFGR_ITCML |
                                 SYSCFG_CFGR_DTCML | SYSCFG_CFGR_SRAM1L |
                                 SYSCFG_CFGR_SRAM2L | SYSCFG_CFGR_SRAM4L |
                                 SYSCFG_CFGR_BKRAML | SYSCFG_CFGR_CM7L |
                                 SYSCFG_CFGR_FLASHL | SYSCFG_CFGR_PVDL));
#else
  return (uint32_t)(READ_BIT(
      SYSCFG->CFGR, SYSCFG_CFGR_ITCML | SYSCFG_CFGR_DTCML | SYSCFG_CFGR_CM7L |
                        SYSCFG_CFGR_FLASHL | SYSCFG_CFGR_PVDL));
#endif /* DUAL_CORE */
}
...
__STATIC_INLINE uint32_t LL_SYSCFG_IsEnabledCompensationCell(void) {
  return ((READ_BIT(SYSCFG->CCCSR, SYSCFG_CCCSR_EN) == SYSCFG_CCCSR_EN) ? 1UL
                                                                        : 0UL);
}
 ...
 * @note   This bit is active only if IO_HSLV user option bit is set. It must be
 * used only if the product supply voltage is below 2.7 V. Setting this bit when
 * VDD is higher than 2.7 V might be destructive.
 * @retval None
 */
...
__STATIC_INLINE uint32_t LL_SYSCFG_IsEnabledIOSpeedOptimization(void) {
  ...
  return ((READ_BIT(SYSCFG->CCCSR, SYSCFG_CCCSR_HSLV) == SYSCFG_CCCSR_HSLV)
              ...
              : 0UL);
#else
  return ((READ_BIT(SYSCFG->CCCSR, SYSCFG_CCCSR_HSLV0) == SYSCFG_CCCSR_HSLV0)
              ? 1UL
              : 0UL);
#endif /*SYSCFG_CCCSR_HSLV*/
}
...
__STATIC_INLINE uint32_t LL_SYSCFG_IsEnabledIOSpeedOptimization1(void) {
  return ((READ_BIT(SYSCFG->CCCSR, SYSCFG_CCCSR_HSLV1) == SYSCFG_CCCSR_HSLV1)
              ? 1UL
              : 0UL);
}
...
__STATIC_INLINE uint32_t LL_SYSCFG_IsEnabledIOSpeedOptimization2(void) {
  return ((READ_BIT(SYSCFG->CCCSR, SYSCFG_CCCSR_HSLV2) == SYSCFG_CCCSR_HSLV2)
              ? 1UL
              : 0UL);
}
...
__STATIC_INLINE uint32_t LL_SYSCFG_IsEnabledIOSpeedOptimization3(void) {
  return ((READ_BIT(SYSCFG->CCCSR, SYSCFG_CCCSR_HSLV3) == SYSCFG_CCCSR_HSLV3)
              ? 1UL
              : 0UL);
}
#endif /*SYSCFG_CCCSR_HSLV1*/
 ...
 * @param  CompCode: Selects the code to be applied for the I/O compensation
 * cell This parameter can be one of the following values:
 *   @arg LL_SYSCFG_CELL_CODE : Select Code from the cell (available in the
 * SYSCFG_CCVR)
 *   @arg LL_SYSCFG_REGISTER_CODE: Select Code from the SYSCFG compensation cell
 ...
 * @retval Returned value can be one of the following values:
 *   @arg LL_SYSCFG_CELL_CODE : Selected Code is from the cell (available in the
 * SYSCFG_CCVR)
 *   @arg LL_SYSCFG_REGISTER_CODE: Selected Code is from the SYSCFG compensation
...
/**
 * @brief  Get the code selected for the I/O Compensation cell on the VDDMMC
 * power rail
 * @rmtoll CCCSR   CS    LL_SYSCFG_GetCellCompensationCode
 * @retval Returned value can be one of the following values:
 *   @arg LL_SYSCFG_CELL_CODE : Selected Code is from the cell (available in the
 ...
 * @retval Returned value is the I/O compensation cell value for PMOS
 * transistors
 */
 ...
 * @retval Returned value is the I/O compensation cell value for NMOS
 * transistors
 */
...
/**
 * @brief  Set I/O compensation cell code for PMOS transistors corresponding to
 * the VDDMMC power rail
 * @rmtoll CCCR    PCC   LL_SYSCFG_SetPMOSCompensationCode
 * @param  PMOSCode PMOS compensation code
 *         This code is applied to the I/O compensation cell when the CS bit of
 * the SYSCFG_CMPCR is set
...
/**
 * @brief  Get I/O compensation cell code for PMOS transistors corresponding to
 * the VDDMMC power rail
 * @rmtoll CCCR    PCC   LL_SYSCFG_GetPMOSCompensationCode
 * @retval Returned value is the I/O compensation cell code for PMOS transistors
 */
...
/**
 * @brief  Set I/O compensation cell code for NMOS transistors on the VDDMMC
 * power rail.
 * @rmtoll CCCR    NCC   LL_SYSCFG_SetNMOSCompensationCode
 * @param  NMOSCode: NMOS compensation code
 *         This code is applied to the I/O compensation cell when the CS bit of
...
/**
 * @brief  Get I/O compensation cell code for NMOS transistors on the VDDMMC
 * power rail.
 * @rmtoll CCCR    NCC   LL_SYSCFG_GetNMOSCompensationCode
 * @retval Returned value is the I/O compensation cell code for NMOS transistors
 */
...
__STATIC_INLINE void LL_SYSCFG_SetCM7BootAddress0(uint16_t BootAddress) {
  ...
  MODIFY_REG(SYSCFG->UR2, SYSCFG_UR2_BCM7_ADD0,
             ((uint32_t)BootAddress << SYSCFG_UR2_BCM7_ADD0_Pos));
#else
...
__STATIC_INLINE uint16_t LL_SYSCFG_GetCM7BootAddress0(void) {
  /* Get CM7 BOOT ADD0 */
#if defined(DUAL_CORE)
  return (uint16_t)((uint32_t)READ_BIT(SYSCFG->UR2, SYSCFG_UR2_BCM7_ADD0) >>
...
__STATIC_INLINE void LL_SYSCFG_SetCM4BootAddress0(uint16_t BootAddress) {
  ...
  MODIFY_REG(SYSCFG->UR3, SYSCFG_UR3_BCM4_ADD0,
             ((uint32_t)BootAddress << SYSCFG_UR3_BCM4_ADD0_Pos));
}
...
__STATIC_INLINE uint16_t LL_SYSCFG_GetCM4BootAddress0(void) {
  /* Get CM4 BOOT ADD0 */
  return (uint16_t)((uint32_t)READ_BIT(SYSCFG->UR3, SYSCFG_UR3_BCM4_ADD0) >>
...
/**
 * @brief  Indicates if the flash protected area (Bank 1) is erased by a mass
 * erase
...
__STATIC_INLINE uint32_t LL_SYSCFG_IsFlashB1ProtectedAreaErasable(void) {
  return (
      (READ_BIT(SYSCFG->UR4, SYSCFG_UR4_MEPAD_BANK1) == SYSCFG_UR4_MEPAD_BANK1)
          ? 1UL
          : 0UL);
}

/**
 * @brief  Indicates if the flash secured area (Bank 1) is erased by a mass
 * erase
...
__STATIC_INLINE uint32_t LL_SYSCFG_IsFlashB1SecuredAreaErasable(void) {
  return (
      (READ_BIT(SYSCFG->UR5, SYSCFG_UR5_MESAD_BANK1) == SYSCFG_UR5_MESAD_BANK1)
          ? 1UL
          : 0UL);
}

/**
 * @brief  Indicates if the sector 0 of the Flash memory bank 1 is write
 * protected
...
/**
 * @brief  Indicates if the sector 1 of the Flash memory bank 1 is write
 * protected
...
/**
 * @brief  Indicates if the sector 2 of the Flash memory bank 1 is write
 * protected
...
/**
 * @brief  Indicates if the sector 3 of the Flash memory bank 1 is write
 * protected
...
/**
 * @brief  Indicates if the sector 4 of the Flash memory bank 1 is write
 * protected
...
/**
 * @brief  Indicates if the sector 5 of the Flash memory bank 1 is write
 * protected
...
/**
 * @brief  Indicates if the sector 6 of the Flash memory bank 1 is write
 * protected
...
/**
 * @brief  Indicates if the sector 7 of the Flash memory bank 1 is write
 * protected
...
/**
 * @brief  Indicates if the flash protected area (Bank 2) is erased by a mass
 * erase
...
__STATIC_INLINE uint32_t LL_SYSCFG_IsFlashB2ProtectedAreaErasable(void) {
  return (
      (READ_BIT(SYSCFG->UR8, SYSCFG_UR8_MEPAD_BANK2) == SYSCFG_UR8_MEPAD_BANK2)
          ? 1UL
          : 0UL);
}

/**
 * @brief  Indicates if the flash secured area (Bank 2) is erased by a mass
 * erase
...
__STATIC_INLINE uint32_t LL_SYSCFG_IsFlashB2SecuredAreaErasable(void) {
  return (
      (READ_BIT(SYSCFG->UR8, SYSCFG_UR8_MESAD_BANK2) == SYSCFG_UR8_MESAD_BANK2)
          ? 1UL
          : 0UL);
}
...
/**
 * @brief  Indicates if the sector 0 of the Flash memory bank 2 is write
 * protected
...
__STATIC_INLINE uint32_t LL_SYSCFG_IsFlashB2Sector0WriteProtected(void) {
  return ((READ_BIT(SYSCFG->UR9, SYSCFG_UR9_WRPN_BANK2) ==
           (SYSCFG_UR9_WRPN_BANK2 & LL_SYSCFG_FLASH_B2_SECTOR0_STATUS_BIT))
              ? 1UL
              : 0UL);
}

/**
 * @brief  Indicates if the sector 1 of the Flash memory bank 2 is write
 * protected
...
__STATIC_INLINE uint32_t LL_SYSCFG_IsFlashB2Sector1WriteProtected(void) {
  return ((READ_BIT(SYSCFG->UR9, SYSCFG_UR9_WRPN_BANK2) ==
           (SYSCFG_UR9_WRPN_BANK2 & LL_SYSCFG_FLASH_B2_SECTOR1_STATUS_BIT))
              ? 1UL
              : 0UL);
}

/**
 * @brief  Indicates if the sector 2 of the Flash memory bank 2 is write
 * protected
...
__STATIC_INLINE uint32_t LL_SYSCFG_IsFlashB2Sector2WriteProtected(void) {
  return ((READ_BIT(SYSCFG->UR9, SYSCFG_UR9_WRPN_BANK2) ==
           (SYSCFG_UR9_WRPN_BANK2 & LL_SYSCFG_FLASH_B2_SECTOR2_STATUS_BIT))
              ? 1UL
              : 0UL);
}

/**
 * @brief  Indicates if the sector 3 of the Flash memory bank 2 is write
 * protected
...
__STATIC_INLINE uint32_t LL_SYSCFG_IsFlashB2Sector3WriteProtected(void) {
  return ((READ_BIT(SYSCFG->UR9, SYSCFG_UR9_WRPN_BANK2) ==
           (SYSCFG_UR9_WRPN_BANK2 & LL_SYSCFG_FLASH_B2_SECTOR3_STATUS_BIT))
              ? 1UL
              : 0UL);
}

/**
 * @brief  Indicates if the sector 4 of the Flash memory bank 2 is write
 * protected
...
__STATIC_INLINE uint32_t LL_SYSCFG_IsFlashB2Sector4WriteProtected(void) {
  return ((READ_BIT(SYSCFG->UR9, SYSCFG_UR9_WRPN_BANK2) ==
           (SYSCFG_UR9_WRPN_BANK2 & LL_SYSCFG_FLASH_B2_SECTOR4_STATUS_BIT))
              ? 1UL
              : 0UL);
}

/**
 * @brief  Indicates if the sector 5 of the Flash memory bank 2 is write
 * protected
...
__STATIC_INLINE uint32_t LL_SYSCFG_IsFlashB2Sector5WriteProtected(void) {
  return ((READ_BIT(SYSCFG->UR9, SYSCFG_UR9_WRPN_BANK2) ==
           (SYSCFG_UR9_WRPN_BANK2 & LL_SYSCFG_FLASH_B2_SECTOR5_STATUS_BIT))
              ? 1UL
              : 0UL);
}

/**
 * @brief  Indicates if the sector 6 of the Flash memory bank 2 is write
 * protected
...
__STATIC_INLINE uint32_t LL_SYSCFG_IsFlashB2Sector6WriteProtected(void) {
  return ((READ_BIT(SYSCFG->UR9, SYSCFG_UR9_WRPN_BANK2) ==
           (SYSCFG_UR9_WRPN_BANK2 & LL_SYSCFG_FLASH_B2_SECTOR6_STATUS_BIT))
              ? 1UL
              : 0UL);
}

/**
 * @brief  Indicates if the sector 7 of the Flash memory bank 2 is write
 * protected
...
__STATIC_INLINE uint32_t LL_SYSCFG_IsFlashB2Sector7WriteProtected(void) {
  return ((READ_BIT(SYSCFG->UR9, SYSCFG_UR9_WRPN_BANK2) ==
           (SYSCFG_UR9_WRPN_BANK2 & LL_SYSCFG_FLASH_B2_SECTOR7_STATUS_BIT))
              ? 1UL
              : 0UL);
}
...
__STATIC_INLINE uint32_t LL_SYSCFG_IsPrivateKeyProgrammed(void) {
  return ((READ_BIT(SYSCFG->UR16, SYSCFG_UR16_PKP) == SYSCFG_UR16_PKP) ? 1UL
                                                                       : 0UL);
}
 ...
 * @rmtoll DBGMCU_CR    DBGSLEEP_D1/DBGSLEEP_CD
 ...
 * @rmtoll DBGMCU_CR    DBGSTOP_D1/DBGSLEEP_CD
 ...
 * @rmtoll DBGMCU_CR    DBGSTBY_D1/DBGSLEEP_CD
 ...
 * @rmtoll DBGMCU_CR    DBGSTOP_D3/DBGSTOP_SRD
 ...
 * @rmtoll DBGMCU_CR    DBGSTBY_D3/DBGSTBY_SRD
 ...
 */
__STATIC_INLINE void
LL_DBGMCU_SetExternalTriggerPinDirection(uint32_t PinDirection) {
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ART_Enable(void) { SET_BIT(ART->CTR, ART_CTR_EN); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ART_Disable(void) { CLEAR_BIT(ART->CTR, ART_CTR_EN); }
...
/**
  ...
  * @param  BaseAddress Specifies the Base address of 1 Mbyte address page
  (cacheable page) from which the ART accelerator loads code to the cache.
  * @retval None
  */
__STATIC_INLINE void LL_ART_SetBaseAddress(uint32_t BaseAddress) {
  MODIFY_REG(ART->CTR, ART_CTR_PCACHEADDR,
             (((BaseAddress) >> 12U) & 0x000FFF00UL));
}
