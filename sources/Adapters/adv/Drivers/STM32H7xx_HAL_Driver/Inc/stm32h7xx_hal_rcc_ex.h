...
typedef struct {
  ...
  uint32_t
      PLL2N; /*!< PLL2N: Multiplication factor for PLL2 VCO output clock.
...
typedef struct {
  ...
  uint32_t
      PLL3N; /*!< PLL3N: Multiplication factor for PLL3 VCO output clock.
                  This parameter must be a number between Min_Data = 4 and
                Max_Data = 512 or between Min_Data = 8 and Max_Data = 420(*)
                  (*) : For stm32h7a3xx and stm32h7b3xx family lines. */
...
typedef struct {
  ...
  uint32_t Usart234578ClockSelection; /*!< Specifies USART2/3/4/5/7/8 clock
                                         source This parameter can be a value of
                                         @ref RCCEx_USART234578_Clock_Source  */

  uint32_t Usart16ClockSelection; /*!< Specifies USART1/6 clock source
                                       This parameter can be a value of @ref
                                     RCCEx_USART16_Clock_Source  */
...
/*!< Alias for Inter STM32H7 lines compatibility regarding
 * RCC_PeriphCLKInitTypeDef field : I2C5 available on some lines only  */
#if defined(I2C5)
...
#define RCC_PLL2VCIRANGE_0                                                     \
  RCC_PLLCFGR_PLL2RGE_0 /*!< Clock range frequency between 1 and 2 MHz  */
#define RCC_PLL2VCIRANGE_1                                                     \
  RCC_PLLCFGR_PLL2RGE_1 /*!< Clock range frequency between 2 and 4 MHz  */
#define RCC_PLL2VCIRANGE_2                                                     \
  RCC_PLLCFGR_PLL2RGE_2 /*!< Clock range frequency between 4 and 8 MHz  */
#define RCC_PLL2VCIRANGE_3                                                     \
  RCC_PLLCFGR_PLL2RGE_3 /*!< Clock range frequency between 8 and 16 MHz */
...
#define RCC_PLL3VCIRANGE_0                                                     \
  RCC_PLLCFGR_PLL3RGE_0 /*!< Clock range frequency between 1 and 2 MHz  */
#define RCC_PLL3VCIRANGE_1                                                     \
  RCC_PLLCFGR_PLL3RGE_1 /*!< Clock range frequency between 2 and 4 MHz  */
#define RCC_PLL3VCIRANGE_2                                                     \
  RCC_PLLCFGR_PLL3RGE_2 /*!< Clock range frequency between 4 and 8 MHz  */
#define RCC_PLL3VCIRANGE_3                                                     \
  RCC_PLLCFGR_PLL3RGE_3 /*!< Clock range frequency between 8 and 16 MHz */
...
/** @defgroup RCCEx_USART234578_Clock_Source  RCCEx USART2/3/4/5/7/8 Clock
 * Source
 * @{
 */
...
#define RCC_LPUART1CLKSOURCE_LSE                                               \
  (RCC_D3CCIPR_LPUART1SEL_2 | RCC_D3CCIPR_LPUART1SEL_0)
#else
...
#define RCC_LPUART1CLKSOURCE_LSE                                               \
  (RCC_SRDCCIPR_LPUART1SEL_2 | RCC_SRDCCIPR_LPUART1SEL_0)
...
#define RCC_I2C123CLKSOURCE_CSI                                                \
...
#define RCC_I2C1235CLKSOURCE_CSI                                               \
...
/* aliases */
#define RCC_SPI45CLKSOURCE_D2PCLK2                                             \
  RCC_SPI45CLKSOURCE_CDPCLK2 /* D2PCLK2 is used in STM32H74xxx, STM32H75xxx,   \
                                STM32H72xxx and STM32H73xxx family lines */
...
#define RCC_SPI6CLKSOURCE_D3PCLK1                                              \
  RCC_SPI6CLKSOURCE_SRDPCLK4 /* D3PCLK1 is used in STM32H74xxx, STM32H75xxx,   \
                                STM32H72xxx and STM32H73xxx family lines */
...
#define RCC_SAI4ACLKSOURCE_SPDIF                                               \
...
#if defined(RCC_VER_3_0)
#define RCC_SAI4BCLKSOURCE_SPDIF                                               \
...
#define RCC_EXTI_LINE_LSECSS                                                   \
  EXTI_IMR1_IM18 /*!< External interrupt line 18 connected to the LSE CSS EXTI \
                    Line */
/**
 * @}
 */
...
#define RCC_CRS_SYNC_SOURCE_PIN                                                \
  (0x00000000U) /*!< Synchro Signal source external pin, Available on STM32H7  \
                   Rev.B and above devices only */
#define RCC_CRS_SYNC_SOURCE_LSE                                                \
  CRS_CFGR_SYNCSRC_0 /*!< Synchro Signal source LSE */
#define RCC_CRS_SYNC_SOURCE_USB1                                               \
  CRS_CFGR_SYNCSRC_1 /*!< Synchro Signal source USB1 SOF (default) */
#define RCC_CRS_SYNC_SOURCE_USB2                                               \
  (CRS_CFGR_SYNCSRC_1 |                                                        \
   CRS_CFGR_SYNCSRC_0) /*!< Synchro Signal source USB2 SOF */
...
#define RCC_CRS_RELOADVALUE_DEFAULT                                            \
  (0x0000BB7FU) /*!< The reset value of the RELOAD field corresponds           \
                   ...
                   synchronization signal frequency of 1 kHz (SOF signal from  \
                   USB). */
/**
 * @}
 */
...
#define RCC_CRS_HSI48CALIBRATION_DEFAULT                                       \
  (0x00000020U) /*!< The default value is 32, which corresponds to the middle  \
                   of the trimming interval. The trimming step is around 67    \
                   kHz between two consecutive TRIM steps. A higher TRIM value \
 ...
 * PLL2_R_CLK)
 * @note   Enabling/disabling  those Clocks can be done only when the PLL2 is
 * disabled, This is mainly used to save Power.
 * @param  __RCC_PLL2ClockOut__ Specifies the PLL2 clock to be outputted
 *          This parameter can be one of the following values:
 *            @arg RCC_PLL2_DIVP: This clock is used to generate peripherals
 * clock up to 550MHZ(*), 480MHZ(**) or 280MHZ(***)
 *            @arg RCC_PLL2_DIVQ: This clock is used to generate peripherals
 * clock up to 550MHZ(*), 480MHZ(**) or 280MHZ(***)
 *            @arg RCC_PLL2_DIVR: This clock is used to generate peripherals
 * clock up to 550MHZ(*), 480MHZ(**) or 280MHZ(***)
 *
...
#define __HAL_RCC_PLL2CLKOUT_ENABLE(__RCC_PLL2ClockOut__)                      \
  SET_BIT(RCC->PLLCFGR, (__RCC_PLL2ClockOut__))

#define __HAL_RCC_PLL2CLKOUT_DISABLE(__RCC_PLL2ClockOut__)                     \
  CLEAR_BIT(RCC->PLLCFGR, (__RCC_PLL2ClockOut__))
 ...
 * (DIVyEN) and assign lowest possible value to  __PLL2P__, __PLL2Q__ or
 * __PLL2R__ parameters.
 * @retval None
 *
 *  (*) : For stm32h7a3xx and stm32h7b3xx family lines.
 */

#define __HAL_RCC_PLL2_CONFIG(__PLL2M__, __PLL2N__, __PLL2P__, __PLL2Q__,      \
                              __PLL2R__)                                       \
  do {                                                                         \
    MODIFY_REG(RCC->PLLCKSELR, (RCC_PLLCKSELR_DIVM2), ((__PLL2M__) << 12U));   \
    WRITE_REG(RCC->PLL2DIVR, ((((__PLL2N__)-1U) & RCC_PLL2DIVR_N2) |           \
                              ((((__PLL2P__)-1U) << 9U) & RCC_PLL2DIVR_P2) |   \
                              ((((__PLL2Q__)-1U) << 16U) & RCC_PLL2DIVR_Q2) |  \
                              ((((__PLL2R__)-1U) << 24U) & RCC_PLL2DIVR_R2))); \
  } while (0)
 ...
 * of the PLL2 VCO
 *
 * @param  __RCC_PLL2FRACN__ Specifies Fractional Part Of The Multiplication
 * factor for PLL2 VCO It should be a value between 0 and 8191
 ...
 * to 836 MHz or 128 to 560 MHz(*) if PLL2VCOSEL = 0 150 to 420 MHz if
 * PLL2VCOSEL = 1.
 *
 * (*) : For stm32h7a3xx and stm32h7b3xx family lines.
 *
...
#define __HAL_RCC_PLL2FRACN_CONFIG(__RCC_PLL2FRACN__)                          \
  MODIFY_REG(RCC->PLL2FRACR, RCC_PLL2FRACR_FRACN2,                             \
             ((uint32_t)(__RCC_PLL2FRACN__) << RCC_PLL2FRACR_FRACN2_Pos))
 ...
 * PLL3_R_CLK)
 * @note   Enabling/disabling  those Clocks can be done only when the PLL3 is
 * disabled, This is mainly used to save Power.
 * @param  __RCC_PLL3ClockOut__ specifies the PLL3 clock to be outputted
 *          This parameter can be one of the following values:
 *            @arg RCC_PLL3_DIVP: This clock is used to generate peripherals
 * clock up to 550MHZ(*), 480MHZ(**) or 280MHZ(***)
 *            @arg RCC_PLL3_DIVQ: This clock is used to generate peripherals
 * clock up to 550MHZ(*), 480MHZ(**) or 280MHZ(***)
 *            @arg RCC_PLL3_DIVR: This clock is used to generate peripherals
 * clock up to 550MHZ(*), 480MHZ(**) or 280MHZ(***)
 *
 * (*) : For stm32h72xxx and stm32h73xxx family lines and requires to enable the
 * CPU_FREQ_BOOST flash option byte, 520MHZ otherwise.
...
#define __HAL_RCC_PLL3CLKOUT_ENABLE(__RCC_PLL3ClockOut__)                      \
  SET_BIT(RCC->PLLCFGR, (__RCC_PLL3ClockOut__))

#define __HAL_RCC_PLL3CLKOUT_DISABLE(__RCC_PLL3ClockOut__)                     \
  CLEAR_BIT(RCC->PLLCFGR, (__RCC_PLL3ClockOut__))
 ...
 *          This parameter must be a number between 2 and 128 (where odd numbers
 * not allowed)
 *
 ...
 * @note   To insure an optimal behavior of the PLL when one of the post-divider
 * (DIVP, DIVQ or DIVR) is not used, application shall clear the enable bit
 * (DIVyEN) and assign lowest possible value to  __PLL3P__, __PLL3Q__ or
 * __PLL3R__ parameters.
 * @retval None
 *
 *  (*) : For stm32h7a3xx and stm32h7b3xx family lines.
 */

#define __HAL_RCC_PLL3_CONFIG(__PLL3M__, __PLL3N__, __PLL3P__, __PLL3Q__,      \
                              __PLL3R__)                                       \
  do {                                                                         \
    MODIFY_REG(RCC->PLLCKSELR, (RCC_PLLCKSELR_DIVM3), ((__PLL3M__) << 20U));   \
    WRITE_REG(RCC->PLL3DIVR, ((((__PLL3N__)-1U) & RCC_PLL3DIVR_N3) |           \
                              ((((__PLL3P__)-1U) << 9U) & RCC_PLL3DIVR_P3) |   \
                              ((((__PLL3Q__)-1U) << 16U) & RCC_PLL3DIVR_Q3) |  \
                              ((((__PLL3R__)-1U) << 24U) & RCC_PLL3DIVR_R3))); \
  } while (0)
 ...
 * of the PLL3 VCO
 *
 * @param  __RCC_PLL3FRACN__ specifies Fractional Part Of The Multiplication
 * Factor for PLL3 VCO It should be a value between 0 and 8191
 * @note   Warning: the software has to set correctly these bits to insure that
 * the VCO output frequency is between its valid frequency range, which is: 192
 * to 836 MHz or 128 to 560 MHz(*) if PLL3VCOSEL = 0 150 to 420 MHz if
 * PLL3VCOSEL = 1.
 *
 * (*) : For stm32h7a3xx and stm32h7b3xx family lines.
 *
...
#define __HAL_RCC_PLL3FRACN_CONFIG(__RCC_PLL3FRACN__)                          \
  MODIFY_REG(RCC->PLL3FRACR, RCC_PLL3FRACR_FRACN3,                             \
             (uint32_t)(__RCC_PLL3FRACN__) << RCC_PLL3FRACR_FRACN3_Pos)
 ...
 * @param  __RCC_SAI1CLKSource__ defines the SAI1 clock source. This clock is
 * derived from system PLL, PLL2, PLL3, OSC or external clock (through a
 * dedicated PIN) This parameter can be one of the following values:
...
#define __HAL_RCC_GET_SAI1_SOURCE()                                            \
  ((uint32_t)(READ_BIT(RCC->D2CCIP1R, RCC_D2CCIP1R_SAI1SEL)))
#else
#define __HAL_RCC_GET_SAI1_SOURCE()                                            \
  ((uint32_t)(READ_BIT(RCC->CDCCIP1R, RCC_CDCCIP1R_SAI1SEL)))
#endif /* RCC_D2CCIP1R_SAI1SEL */

/**
 * @brief  Macro to Configure the SPDIFRX clock source.
 * @param  __RCC_SPDIFCLKSource__ defines the SPDIFRX clock source. This clock
 * is derived from system PLL, PLL2, PLL3,  or internal OSC clock This parameter
...
#define __HAL_RCC_GET_SPDIFRX_SOURCE()                                         \
  ((uint32_t)(READ_BIT(RCC->D2CCIP1R, RCC_D2CCIP1R_SPDIFSEL)))
#else
#define __HAL_RCC_GET_SPDIFRX_SOURCE()                                         \
  ((uint32_t)(READ_BIT(RCC->CDCCIP1R, RCC_CDCCIP1R_SPDIFSEL)))
#endif /* RCC_D2CCIP1R_SPDIFSEL */

#if defined(SAI3)
/**
 * @brief  Macro to Configure the SAI2/3 clock source.
 * @param  __RCC_SAI23CLKSource__ defines the SAI2/3 clock source. This clock is
 * derived from system PLL, PLL2, PLL3, OSC or external clock (through a
 * dedicated PIN) This parameter can be one of the following values:
 ...
 *             @arg RCC_SAI23CLKSOURCE_PIN: SAI2/3 clock = External Clock
 */
#define __HAL_RCC_GET_SAI23_SOURCE()                                           \
  ((uint32_t)(READ_BIT(RCC->D2CCIP1R, RCC_D2CCIP1R_SAI23SEL)))

/**
 * @brief  Macro to Configure the SAI2 clock source.
 * @param  __RCC_SAI2CLKSource__ defines the SAI2 clock source. This clock is
 * derived from system PLL, PLL2, PLL3, OSC or external clock (through a
 * dedicated PIN) This parameter can be one of the following values:
 ...
 * @param  __RCC_SAI3CLKSource__ defines the SAI3 clock source. This clock is
 * derived from system PLL, PLL2, PLL3, OSC or external clock (through a
 * dedicated PIN) This parameter can be one of the following values:
 ...
 * @param  __RCC_SAI2ACLKSource__ defines the SAI2A clock source. This clock is
 * derived from system PLL, PLL2, PLL3, OSC or external clock (through a
 * dedicated PIN) This parameter can be one of the following values:
 ...
 *             @arg RCC_SAI2ACLKSOURCE_SPDIF: SAI2A clock = SPDIF Clock
 */
#define __HAL_RCC_GET_SAI2A_SOURCE()                                           \
  ((uint32_t)(READ_BIT(RCC->CDCCIP1R, RCC_CDCCIP1R_SAI2ASEL)))
#endif /* defined(RCC_CDCCIP1R_SAI2ASEL) */

#if defined(RCC_CDCCIP1R_SAI2BSEL)
/**
 * @brief  Macro to Configure the SAI2B clock source.
 * @param  __RCC_SAI2BCLKSource__ defines the SAI2B clock source. This clock is
 * derived from system PLL, PLL2, PLL3, OSC or external clock (through a
 * dedicated PIN) This parameter can be one of the following values:
 ...
 *             @arg RCC_SAI2BCLKSOURCE_SPDIF: SAI2B clock = SPDIF Clock
 */
#define __HAL_RCC_GET_SAI2B_SOURCE()                                           \
  ((uint32_t)(READ_BIT(RCC->CDCCIP1R, RCC_CDCCIP1R_SAI2BSEL)))
#endif /* defined(RCC_CDCCIP1R_SAI2BSEL) */

#if defined(SAI4_Block_A)
/**
 * @brief  Macro to Configure the SAI4A clock source.
 * @param  __RCC_SAI4ACLKSource__ defines the SAI4A clock source. This clock is
 * derived from system PLL, PLL2, PLL3, OSC or external clock (through a
 * dedicated PIN) This parameter can be one of the following values:
 ...
 */
#define __HAL_RCC_GET_SAI4A_SOURCE()                                           \
  ((uint32_t)(READ_BIT(RCC->D3CCIPR, RCC_D3CCIPR_SAI4ASEL)))
#endif /* SAI4_Block_A */

#if defined(SAI4_Block_B)
/**
 * @brief  Macro to Configure the SAI4B clock source.
 * @param  __RCC_SAI4BCLKSource__ defines the SAI4B clock source. This clock is
 * derived from system PLL, PLL2, PLL3, OSC or external clock (through a
 * dedicated PIN) This parameter can be one of the following values:
 ...
 *             @arg RCC_SAI4BCLKSOURCE_PIN: SAI4B clock = External Clock
 */
#define __HAL_RCC_GET_SAI4B_SOURCE()                                           \
  ((uint32_t)(READ_BIT(RCC->D3CCIPR, RCC_D3CCIPR_SAI4BSEL)))
#endif /* SAI4_Block_B */
 ...
 *          This parameter can be one of the following values:
 *            @arg RCC_I2C123CLKSOURCE_D2PCLK1: D2PCLK1 selected as I2C1/2/3/5*
 * clock
...
#define __HAL_RCC_I2C123_CONFIG(__I2C1235CLKSource__)                          \
  MODIFY_REG(RCC->D2CCIP2R, RCC_D2CCIP2R_I2C123SEL,                            \
             (uint32_t)(__I2C1235CLKSource__))
#elif defined(RCC_CDCCIP2R_I2C123SEL)
#define __HAL_RCC_I2C123_CONFIG(__I2C1235CLKSource__)                          \
  MODIFY_REG(RCC->CDCCIP2R, RCC_CDCCIP2R_I2C123SEL,                            \
             (uint32_t)(__I2C1235CLKSource__))
#else /* RCC_D2CCIP2R_I2C1235SEL */
#define __HAL_RCC_I2C1235_CONFIG(__I2C1235CLKSource__)                         \
  MODIFY_REG(RCC->D2CCIP2R, RCC_D2CCIP2R_I2C1235SEL,                           \
             (uint32_t)(__I2C1235CLKSource__))
/* alias */
 ...
 */
#if defined(RCC_D2CCIP2R_I2C123SEL)
#define __HAL_RCC_GET_I2C123_SOURCE()                                          \
  ((uint32_t)(READ_BIT(RCC->D2CCIP2R, RCC_D2CCIP2R_I2C123SEL)))
#elif defined(RCC_CDCCIP2R_I2C123SEL)
#define __HAL_RCC_GET_I2C123_SOURCE()                                          \
  ((uint32_t)(READ_BIT(RCC->CDCCIP2R, RCC_CDCCIP2R_I2C123SEL)))
#else /* RCC_D2CCIP2R_I2C1235SEL */
#define __HAL_RCC_GET_I2C1235_SOURCE()                                         \
  ((uint32_t)(READ_BIT(RCC->D2CCIP2R, RCC_D2CCIP2R_I2C1235SEL)))
/* alias */
...
#define __HAL_RCC_GET_I2C4_SOURCE()                                            \
  ((uint32_t)(READ_BIT(RCC->D3CCIPR, RCC_D3CCIPR_I2C4SEL)))
#else
#define __HAL_RCC_GET_I2C4_SOURCE()                                            \
  ((uint32_t)(READ_BIT(RCC->SRDCCIPR, RCC_SRDCCIPR_I2C4SEL)))
#endif /* RCC_D3CCIPR_I2C4SEL */
 ...
 *          This parameter can be one of the following values:
 *            @arg RCC_USART16CLKSOURCE_D2PCLK2: APB2 Clock selected as
 * USART1/6/9* /10* clock
 *            @arg RCC_USART16CLKSOURCE_PLL2: PLL2_Q Clock selected as
 * USART1/6/9* /10* clock
 *            @arg RCC_USART16CLKSOURCE_PLL3: PLL3_Q Clock selected as
 * USART1/6/9* /10* clock
 *            @arg RCC_USART16CLKSOURCE_HSI: HSI selected as USART1/6/9* /10*
 * clock
 *            @arg RCC_USART16CLKSOURCE_CSI: CSI Clock selected as USART1/6/9*
 * /10* clock
 *            @arg RCC_USART16CLKSOURCE_LSE: LSE selected as USART1/6/9* /10*
 * clock
 *
...
#define __HAL_RCC_USART16_CONFIG(__USART16910CLKSource__)                      \
  MODIFY_REG(RCC->D2CCIP2R, RCC_D2CCIP2R_USART16SEL,                           \
             (uint32_t)(__USART16910CLKSource__))
#elif defined(RCC_CDCCIP2R_USART16910SEL)
#define __HAL_RCC_USART16910_CONFIG(__USART16910CLKSource__)                   \
  MODIFY_REG(RCC->CDCCIP2R, RCC_CDCCIP2R_USART16910SEL,                        \
             (uint32_t)(__USART16910CLKSource__))
/* alias */
#define __HAL_RCC_USART16_CONFIG __HAL_RCC_USART16910_CONFIG
#else /* RCC_D2CCIP2R_USART16910SEL */
#define __HAL_RCC_USART16910_CONFIG(__USART16910CLKSource__)                   \
  MODIFY_REG(RCC->D2CCIP2R, RCC_D2CCIP2R_USART16910SEL,                        \
             (uint32_t)(__USART16910CLKSource__))
/* alias */
#define __HAL_RCC_USART16_CONFIG __HAL_RCC_USART16910_CONFIG
#endif /* RCC_D2CCIP2R_USART16SEL */
...
#define __HAL_RCC_GET_USART16_SOURCE()                                         \
  ((uint32_t)(READ_BIT(RCC->D2CCIP2R, RCC_D2CCIP2R_USART16SEL)))
#elif defined(RCC_CDCCIP2R_USART16910SEL)
#define __HAL_RCC_GET_USART16910_SOURCE()                                      \
  ((uint32_t)(READ_BIT(RCC->CDCCIP2R, RCC_CDCCIP2R_USART16910SEL)))
/* alias*/
#define __HAL_RCC_GET_USART16_SOURCE __HAL_RCC_GET_USART16910_SOURCE
#else /* RCC_D2CCIP2R_USART16910SEL */
#define __HAL_RCC_GET_USART16910_SOURCE()                                      \
  ((uint32_t)(READ_BIT(RCC->D2CCIP2R, RCC_D2CCIP2R_USART16910SEL)))
/* alias */
#define __HAL_RCC_GET_USART16_SOURCE __HAL_RCC_GET_USART16910_SOURCE
#endif /* RCC_D2CCIP2R_USART16SEL */
 ...
 *          This parameter can be one of the following values:
 *            @arg RCC_USART234578CLKSOURCE_D2PCLK1: APB1 Clock selected as
 * USART2/3/4/5/7/8 clock
 *            @arg RCC_USART234578CLKSOURCE_PLL2: PLL2_Q Clock selected as
 * USART2/3/4/5/7/8 clock
 *            @arg RCC_USART234578CLKSOURCE_PLL3: PLL3_Q Clock selected as
 * USART2/3/4/5/7/8 clock
 *            @arg RCC_USART234578CLKSOURCE_HSI: HSI selected as
 * USART2/3/4/5/7/8 clock
 *            @arg RCC_USART234578CLKSOURCE_CSI: CSI Clock selected as
 * USART2/3/4/5/7/8 clock
 *            @arg RCC_USART234578CLKSOURCE_LSE: LSE selected as
 * USART2/3/4/5/7/8 clock
 */
#if defined(RCC_D2CCIP2R_USART28SEL)
#define __HAL_RCC_USART234578_CONFIG(__USART234578CLKSource__)                 \
  MODIFY_REG(RCC->D2CCIP2R, RCC_D2CCIP2R_USART28SEL,                           \
             (uint32_t)(__USART234578CLKSource__))
#else
#define __HAL_RCC_USART234578_CONFIG(__USART234578CLKSource__)                 \
  MODIFY_REG(RCC->CDCCIP2R, RCC_CDCCIP2R_USART234578SEL,                       \
             (uint32_t)(__USART234578CLKSource__))
#endif /* RCC_D2CCIP2R_USART28SEL */
...
#define __HAL_RCC_GET_USART234578_SOURCE()                                     \
  ((uint32_t)(READ_BIT(RCC->D2CCIP2R, RCC_D2CCIP2R_USART28SEL)))
#else
#define __HAL_RCC_GET_USART234578_SOURCE()                                     \
  ((uint32_t)(READ_BIT(RCC->CDCCIP2R, RCC_CDCCIP2R_USART234578SEL)))
#endif /* RCC_D2CCIP2R_USART28SEL */
 ...
 *          This parameter can be one of the following values:
 *            @arg RCC_USART1CLKSOURCE_D2PCLK2: APB2 Clock selected as USART1
 * clock
 *            @arg RCC_USART1CLKSOURCE_PLL2: PLL2_Q Clock selected as USART1
 * clock
 ...
 *          This parameter can be one of the following values:
 *            @arg RCC_USART2CLKSOURCE_D2PCLK1: APB1 Clock selected as USART2
 * clock
 *            @arg RCC_USART2CLKSOURCE_PLL2: PLL2_Q Clock selected as USART2
 * clock
 ...
 *          This parameter can be one of the following values:
 *            @arg RCC_USART3CLKSOURCE_D2PCLK1: APB1 Clock selected as USART3
 * clock
 *            @arg RCC_USART3CLKSOURCE_PLL2: PLL2_Q Clock selected as USART3
 * clock
 *            @arg RCC_USART3CLKSOURCE_PLL3: PLL3_Q Clock selected as USART3
 * clock
 ...
 * @retval The clock source can be one of the following values:
 *            @arg RCC_USART2CLKSOURCE_D2PCLK1: APB1 Clock selected as USART3
 * clock
 *            @arg RCC_USART3CLKSOURCE_PLL2: PLL2_Q Clock selected as USART3
 * clock
 *            @arg RCC_USART3CLKSOURCE_PLL3: PLL3_Q Clock selected as USART3
 ...
 *          This parameter can be one of the following values:
 *            @arg RCC_UART4CLKSOURCE_D2PCLK1: APB1 Clock selected as UART4
 * clock
 ...
 *          This parameter can be one of the following values:
 *            @arg RCC_UART5CLKSOURCE_D2PCLK1: APB1 Clock selected as UART5
 * clock
 ...
 *          This parameter can be one of the following values:
 *            @arg RCC_USART6CLKSOURCE_D2PCLK2: APB2 Clock selected as USART6
 * clock
 *            @arg RCC_USART6CLKSOURCE_PLL2: PLL2_Q Clock selected as USART6
 * clock
 *            @arg RCC_USART6CLKSOURCE_PLL3: PLL3_Q Clock selected as USART6
 * clock
 ...
 *          This parameter can be one of the following values:
 *            @arg RCC_UART7CLKSOURCE_D2PCLK1: APB1 Clock selected as UART7
 * clock
 ...
 *          This parameter can be one of the following values:
 *            @arg RCC_UART8CLKSOURCE_D2PCLK1: APB1 Clock selected as UART8
 * clock
 ...
 * @param  __UART8CLKSource__ specifies the UART8 clock source.
 *          This parameter can be one of the following values:
 *            @arg RCC_UART9CLKSOURCE_D2PCLK1: APB1 Clock selected as UART9
 * clock
 ...
 * @retval The clock source can be one of the following values:
 *            @arg RCC_UART9CLKSOURCE_D2PCLK1: APB1 Clock selected as UART99
 * clock
 *            @arg RCC_UART9CLKSOURCE_PLL2: PLL2_Q Clock selected as UART99
 * clock
 *            @arg RCC_UART9CLKSOURCE_PLL3: PLL3_Q Clock selected as UART99
 * clock
 *            @arg RCC_UART9CLKSOURCE_HSI: HSI selected as UART9 clock
 *            @arg RCC_UART9CLKSOURCE_CSI: CSI Clock selected as UART9 clock
 *            @arg RCC_UART9CLKSOURCE_LSE: LSE selected as UART9 clock
 ...
 * @param  __UART8CLKSource__ specifies the UART8 clock source.
 *          This parameter can be one of the following values:
 *            @arg RCC_USART10CLKSOURCE_D2PCLK1: APB1 Clock selected as USART10
 * clock
 *            @arg RCC_USART10CLKSOURCE_PLL2: PLL2_Q Clock selected as USART10
 * clock
 *            @arg RCC_USART10CLKSOURCE_PLL3: PLL3_Q Clock selected as USART10
 * clock
 ...
 *          This parameter can be one of the following values:
 *            @arg RCC_LPUART1CLKSOURCE_D3PCLK1: APB4 Clock selected as LPUART1
 * clock
 *            @arg RCC_LPUART1CLKSOURCE_PLL2: PLL2_Q Clock selected as LPUART1
 * clock
 *            @arg RCC_LPUART1CLKSOURCE_PLL3: PLL3_Q Clock selected as LPUART1
 * clock
...
#define __HAL_RCC_LPUART1_CONFIG(__LPUART1CLKSource__)                         \
  MODIFY_REG(RCC->D3CCIPR, RCC_D3CCIPR_LPUART1SEL,                             \
             (uint32_t)(__LPUART1CLKSource__))
#else
#define __HAL_RCC_LPUART1_CONFIG(__LPUART1CLKSource__)                         \
  MODIFY_REG(RCC->SRDCCIPR, RCC_SRDCCIPR_LPUART1SEL,                           \
             (uint32_t)(__LPUART1CLKSource__))
#endif /* RCC_D3CCIPR_LPUART1SEL */
...
#define __HAL_RCC_GET_LPUART1_SOURCE()                                         \
  ((uint32_t)(READ_BIT(RCC->D3CCIPR, RCC_D3CCIPR_LPUART1SEL)))
#else
#define __HAL_RCC_GET_LPUART1_SOURCE()                                         \
  ((uint32_t)(READ_BIT(RCC->SRDCCIPR, RCC_SRDCCIPR_LPUART1SEL)))
#endif /* RCC_D3CCIPR_LPUART1SEL */
 ...
 *          This parameter can be one of the following values:
 *            @arg RCC_LPTIM1CLKSOURCE_D2PCLK1: APB1 Clock selected as LPTIM1
 * clock
 *            @arg RCC_LPTIM1CLKSOURCE_PLL2: PLL2_P Clock selected as LPTIM1
 * clock
 *            @arg RCC_LPTIM1CLKSOURCE_PLL3: PLL3_R Clock selected as LPTIM1
 * clock
...
#define __HAL_RCC_LPTIM1_CONFIG(__LPTIM1CLKSource__)                           \
  MODIFY_REG(RCC->D2CCIP2R, RCC_D2CCIP2R_LPTIM1SEL,                            \
             (uint32_t)(__LPTIM1CLKSource__))
#else
#define __HAL_RCC_LPTIM1_CONFIG(__LPTIM1CLKSource__)                           \
  MODIFY_REG(RCC->CDCCIP2R, RCC_CDCCIP2R_LPTIM1SEL,                            \
             (uint32_t)(__LPTIM1CLKSource__))
#endif /* RCC_D2CCIP2R_LPTIM1SEL */
...
#define __HAL_RCC_GET_LPTIM1_SOURCE()                                          \
  ((uint32_t)(READ_BIT(RCC->D2CCIP2R, RCC_D2CCIP2R_LPTIM1SEL)))
#else
#define __HAL_RCC_GET_LPTIM1_SOURCE()                                          \
  ((uint32_t)(READ_BIT(RCC->CDCCIP2R, RCC_CDCCIP2R_LPTIM1SEL)))
#endif /* RCC_D2CCIP2R_LPTIM1SEL */
 ...
 *          This parameter can be one of the following values:
 *            @arg RCC_LPTIM2CLKSOURCE_D3PCLK1: APB4 Clock selected as LPTIM2
 * clock
 *            @arg RCC_LPTIM2CLKSOURCE_PLL2: PLL2_P Clock selected as LPTIM2
 * clock
 *            @arg RCC_LPTIM2CLKSOURCE_PLL3: PLL3_R Clock selected as LPTIM2
 * clock
...
#define __HAL_RCC_LPTIM2_CONFIG(__LPTIM2CLKSource__)                           \
  MODIFY_REG(RCC->D3CCIPR, RCC_D3CCIPR_LPTIM2SEL,                              \
             (uint32_t)(__LPTIM2CLKSource__))
#else
#define __HAL_RCC_LPTIM2_CONFIG(__LPTIM2CLKSource__)                           \
  MODIFY_REG(RCC->SRDCCIPR, RCC_SRDCCIPR_LPTIM2SEL,                            \
             (uint32_t)(__LPTIM2CLKSource__))
#endif /* RCC_D3CCIPR_LPTIM2SEL */
...
#define __HAL_RCC_GET_LPTIM2_SOURCE()                                          \
  ((uint32_t)(READ_BIT(RCC->D3CCIPR, RCC_D3CCIPR_LPTIM2SEL)))
#else
#define __HAL_RCC_GET_LPTIM2_SOURCE()                                          \
  ((uint32_t)(READ_BIT(RCC->SRDCCIPR, RCC_SRDCCIPR_LPTIM2SEL)))
#endif /* RCC_D3CCIPR_LPTIM2SEL */

/** @brief  macro to configure the LPTIM3/4/5 clock source.
 *
 * @param  __LPTIM345CLKSource__ specifies the LPTIM3/4/5 clock source.
 *            @arg RCC_LPTIM345CLKSOURCE_D3PCLK1: APB4 Clock selected as
 * LPTIM3/4/5 clock
 *            @arg RCC_LPTIM345CLKSOURCE_PLL2: PLL2_P Clock selected as
 * LPTIM3/4/5 clock
 *            @arg RCC_LPTIM345CLKSOURCE_PLL3: PLL3_R Clock selected as
 * LPTIM3/4/5 clock
 *            @arg RCC_LPTIM345CLKSOURCE_LSE: LSE selected as LPTIM3/4/5 clock
 *            @arg RCC_LPTIM345CLKSOURCE_LSI: LSI Clock selected as LPTIM3/4/5
 * clock
 *            @arg RCC_LPTIM345CLKSOURCE_CLKP: CLKP selected as LPTIM3/4/5 clock
 */
#if defined(RCC_D3CCIPR_LPTIM345SEL)
#define __HAL_RCC_LPTIM345_CONFIG(__LPTIM345CLKSource__)                       \
  MODIFY_REG(RCC->D3CCIPR, RCC_D3CCIPR_LPTIM345SEL,                            \
             (uint32_t)(__LPTIM345CLKSource__))
#else
#define __HAL_RCC_LPTIM345_CONFIG(__LPTIM345CLKSource__)                       \
  MODIFY_REG(RCC->SRDCCIPR, RCC_SRDCCIPR_LPTIM3SEL,                            \
             (uint32_t)(__LPTIM345CLKSource__))
#endif /* RCC_D3CCIPR_LPTIM345SEL */
...
#define __HAL_RCC_GET_LPTIM345_SOURCE()                                        \
  ((uint32_t)(READ_BIT(RCC->D3CCIPR, RCC_D3CCIPR_LPTIM345SEL)))
#else
#define __HAL_RCC_GET_LPTIM345_SOURCE()                                        \
  ((uint32_t)(READ_BIT(RCC->SRDCCIPR, RCC_SRDCCIPR_LPTIM3SEL)))
#endif /* RCC_D3CCIPR_LPTIM345SEL */

/** @brief  macro to configure the LPTIM3 clock source.
 *
 * @param  __LPTIM3CLKSource__ specifies the LPTIM3 clock source.
 *            @arg RCC_LPTIM3CLKSOURCE_D3PCLK1: APB4 Clock selected as LPTIM3
 * clock
 *            @arg RCC_LPTIM3CLKSOURCE_PLL2: PLL2_P Clock selected as LPTIM3
 * clock
 *            @arg RCC_LPTIM3CLKSOURCE_PLL3: PLL3_R Clock selected as LPTIM3
 * clock
 ...
 *            @arg RCC_LPTIM4CLKSOURCE_D3PCLK1: APB4 Clock selected as LPTIM4
 * clock
 *            @arg RCC_LPTIM4CLKSOURCE_PLL2: PLL2_P Clock selected as LPTIM4
 * clock
 *            @arg RCC_LPTIM4CLKSOURCE_PLL3: PLL3_R Clock selected as LPTIM4
 * clock
 ...
 *            @arg RCC_LPTIM5CLKSOURCE_D3PCLK1: APB4 Clock selected as LPTIM5
 * clock
 *            @arg RCC_LPTIM5CLKSOURCE_PLL2: PLL2_P Clock selected as LPTIM5
 * clock
 *            @arg RCC_LPTIM5CLKSOURCE_PLL3: PLL3_R Clock selected as LPTIM5
 * clock
 ...
 *            @arg RCC_RCC_QSPICLKSOURCE_D1HCLK: Domain1 HCLK Clock selected as
 * QSPI clock
 *            @arg RCC_RCC_QSPICLKSOURCE_PLL   : PLL1_Q Clock selected as QSPI
 * clock
 *            @arg RCC_RCC_QSPICLKSOURCE_PLL2  : PLL2_R Clock selected as QSPI
 * clock
...
#define __HAL_RCC_GET_QSPI_SOURCE()                                            \
  ((uint32_t)(READ_BIT(RCC->D1CCIPR, RCC_D1CCIPR_QSPISEL)))
#endif /* QUADSPI */
 ...
 *            @arg RCC_RCC_OSPICLKSOURCE_CDHCLK: Domain1 HCLK Clock selected as
 * OSPI clock
 *            @arg RCC_RCC_OSPICLKSOURCE_PLL   : PLL1_Q Clock selected as OSPI
 * clock
 *            @arg RCC_RCC_OSPICLKSOURCE_PLL2  : PLL2_R Clock selected as OSPI
 * clock
 *            @arg RCC_RCC_OSPICLKSOURCE_CLKP    CLKP selected as OSPI clock
 */
#if defined(RCC_CDCCIPR_OCTOSPISEL)
#define __HAL_RCC_OSPI_CONFIG(__OSPICLKSource__)                               \
  MODIFY_REG(RCC->CDCCIPR, RCC_CDCCIPR_OCTOSPISEL,                             \
             (uint32_t)(__OSPICLKSource__))
#else
#define __HAL_RCC_OSPI_CONFIG(__OSPICLKSource__)                               \
  MODIFY_REG(RCC->D1CCIPR, RCC_D1CCIPR_OCTOSPISEL,                             \
             (uint32_t)(__OSPICLKSource__))
#endif /* RCC_CDCCIPR_OCTOSPISEL */

/** @brief  macro to get the OSPI clock source.
 * @retval The clock source can be one of the following values:
 *            @arg RCC_RCC_OSPICLKSOURCE_D1HCLK: Domain1 HCLK Clock selected as
 * OSPI clock
 *            @arg RCC_RCC_OSPICLKSOURCE_PLL   : PLL1_Q Clock selected as OSPI
 * clock
 *            @arg RCC_RCC_OSPICLKSOURCE_PLL2  : PLL2_R Clock selected as OSPI
...
#define __HAL_RCC_GET_OSPI_SOURCE()                                            \
  ((uint32_t)(READ_BIT(RCC->CDCCIPR, RCC_CDCCIPR_OCTOSPISEL)))
#else
#define __HAL_RCC_GET_OSPI_SOURCE()                                            \
  ((uint32_t)(READ_BIT(RCC->D1CCIPR, RCC_D1CCIPR_OCTOSPISEL)))
#endif /* RCC_CDCCIPR_OCTOSPISEL */
#endif /* defined(OCTOSPI1) || defined(OCTOSPI2) */
 ...
 *            @arg RCC_RCC_DSICLKSOURCE_PHY:DSI clock from PHY is selected as
 * DSI byte lane clock
 *            @arg RCC_RCC_DSICLKSOURCE_PLL2   : PLL2_Q Clock clock is selected
 * as DSI byte lane clock
 */
 ...
 *            @arg RCC_RCC_DSICLKSOURCE_PHY: DSI clock from PHY is selected as
 * DSI byte lane clock
 *            @arg RCC_RCC_DSICLKSOURCE_PLL2: PLL2_Q Clock clock is selected as
 * DSI byte lane clock
 */
#define __HAL_RCC_GET_DSI_SOURCE()                                             \
  ((uint32_t)(READ_BIT(RCC->D1CCIPR, RCC_D1CCIPR_DSISEL)))
#endif /*DSI*/

/** @brief  macro to configure the FMC clock source.
 *
 * @param  __FMCCLKSource__ specifies the FMC clock source.
 *            @arg RCC_RCC_FMCCLKSOURCE_D1HCLK: Domain1 HCLK Clock selected as
 * FMC clock
 *            @arg RCC_RCC_FMCCLKSOURCE_PLL   : PLL1_Q Clock selected as FMC
 * clock
 *            @arg RCC_RCC_FMCCLKSOURCE_PLL2  : PLL2_R Clock selected as FMC
 * clock
...
#define __HAL_RCC_GET_FMC_SOURCE()                                             \
  ((uint32_t)(READ_BIT(RCC->D1CCIPR, RCC_D1CCIPR_FMCSEL)))
#else
#define __HAL_RCC_GET_FMC_SOURCE()                                             \
  ((uint32_t)(READ_BIT(RCC->CDCCIPR, RCC_CDCCIPR_FMCSEL)))
#endif /* RCC_D1CCIPR_FMCSEL */
...
#define __HAL_RCC_GET_USB_SOURCE()                                             \
  ((uint32_t)(READ_BIT(RCC->D2CCIP2R, RCC_D2CCIP2R_USBSEL)))
#else
#define __HAL_RCC_GET_USB_SOURCE()                                             \
  ((uint32_t)(READ_BIT(RCC->CDCCIP2R, RCC_CDCCIP2R_USBSEL)))
#endif /* RCC_D2CCIP2R_USBSEL */
...
#define __HAL_RCC_GET_ADC_SOURCE()                                             \
  ((uint32_t)(READ_BIT(RCC->D3CCIPR, RCC_D3CCIPR_ADCSEL)))
#else
#define __HAL_RCC_GET_ADC_SOURCE()                                             \
  ((uint32_t)(READ_BIT(RCC->SRDCCIPR, RCC_SRDCCIPR_ADCSEL)))
#endif /* RCC_D3CCIPR_ADCSEL */

/** @brief  Macro to configure the SWPMI1 clock
 * @param  __SWPMI1CLKSource__ specifies the SWPMI1  clock source.
 *         This parameter can be one of the following values:
 *            @arg RCC_SWPMI1CLKSOURCE_D2PCLK1:  D2PCLK1 Clock selected as
 * SWPMI1 clock
 *            @arg RCC_SWPMI1CLKSOURCE_HSI: HSI Clock selected as SWPMI1 clock
 */
#if defined(RCC_D2CCIP1R_SWPSEL)
#define __HAL_RCC_SWPMI1_CONFIG(__SWPMI1CLKSource__)                           \
  MODIFY_REG(RCC->D2CCIP1R, RCC_D2CCIP1R_SWPSEL,                               \
             (uint32_t)(__SWPMI1CLKSource__))
#else
#define __HAL_RCC_SWPMI1_CONFIG(__SWPMI1CLKSource__)                           \
  MODIFY_REG(RCC->CDCCIP1R, RCC_CDCCIP1R_SWPSEL,                               \
             (uint32_t)(__SWPMI1CLKSource__))
#endif /* RCC_D2CCIP1R_SWPSEL */
...
#define __HAL_RCC_GET_SWPMI1_SOURCE()                                          \
  ((uint32_t)(READ_BIT(RCC->D2CCIP1R, RCC_D2CCIP1R_SWPSEL)))
#else
#define __HAL_RCC_GET_SWPMI1_SOURCE()                                          \
  ((uint32_t)(READ_BIT(RCC->CDCCIP1R, RCC_CDCCIP1R_SWPSEL)))
#endif /* RCC_D2CCIP1R_SWPSEL */

/** @brief  Macro to configure the DFSDM1 clock
 * @param  __DFSDM1CLKSource__ specifies the DFSDM1  clock source.
 *         This parameter can be one of the following values:
 *            @arg RCC_DFSDM1CLKSOURCE_D2PCLK:  D2PCLK Clock selected as DFSDM1
 * clock
 *            @arg RCC_DFSDM1CLKSOURCE_SYS:     System Clock selected as DFSDM1
 * clock
 */
#if defined(RCC_D2CCIP1R_DFSDM1SEL)
#define __HAL_RCC_DFSDM1_CONFIG(__DFSDM1CLKSource__)                           \
  MODIFY_REG(RCC->D2CCIP1R, RCC_D2CCIP1R_DFSDM1SEL,                            \
             (uint32_t)(__DFSDM1CLKSource__))
#else
#define __HAL_RCC_DFSDM1_CONFIG(__DFSDM1CLKSource__)                           \
  MODIFY_REG(RCC->CDCCIP1R, RCC_CDCCIP1R_DFSDM1SEL,                            \
             (uint32_t)(__DFSDM1CLKSource__))
#endif /* RCC_D2CCIP1R_DFSDM1SEL */
...
#define __HAL_RCC_GET_DFSDM1_SOURCE()                                          \
  ((uint32_t)(READ_BIT(RCC->D2CCIP1R, RCC_D2CCIP1R_DFSDM1SEL)))
#else
#define __HAL_RCC_GET_DFSDM1_SOURCE()                                          \
  ((uint32_t)(READ_BIT(RCC->CDCCIP1R, RCC_CDCCIP1R_DFSDM1SEL)))
#endif /* RCC_D2CCIP1R_DFSDM1SEL */
 ...
 *         This parameter can be one of the following values:
 *            @arg RCC_DFSDM2CLKSOURCE_SRDPCLK1:  SRDPCLK1 (APB4) selected as
 * DFSDM2 clock
 *            @arg RCC_DFSDM2CLKSOURCE_SYS:   System Clock selected as DFSDM2
 * clock
 */
#define __HAL_RCC_DFSDM2_CONFIG(__DFSDM2CLKSource__)                           \
  MODIFY_REG(RCC->SRDCCIPR, RCC_SRDCCIPR_DFSDM2SEL,                            \
             (uint32_t)(__DFSDM2CLKSource__))

/** @brief  Macro to get the DFSDM2 clock source.
 * @retval The clock source can be one of the following values:
 *            @arg RCC_DFSDM2CLKSOURCE_SRDPCLK1:  SRDPCLK1 (APB4) Clock selected
 * as DFSDM2 clock
 *            @arg RCC_DFSDM2CLKSOURCE_SYS:   System Clock selected as DFSDM2
 * clock
 */
#define __HAL_RCC_GET_DFSDM2_SOURCE()                                          \
  ((uint32_t)(READ_BIT(RCC->SRDCCIPR, RCC_SRDCCIPR_DFSDM2SEL)))
#endif /* DFSDM2 */
...
#define __HAL_RCC_GET_CEC_SOURCE()                                             \
  ((uint32_t)(READ_BIT(RCC->D2CCIP2R, RCC_D2CCIP2R_CECSEL)))
#else
#define __HAL_RCC_GET_CEC_SOURCE()                                             \
  ((uint32_t)(READ_BIT(RCC->CDCCIP2R, RCC_CDCCIP2R_CECSEL)))
#endif /* RCC_D2CCIP2R_CECSEL */
...
#define __HAL_RCC_GET_CLKP_SOURCE()                                            \
  ((uint32_t)(READ_BIT(RCC->D1CCIPR, RCC_D1CCIPR_CKPERSEL)))
#else
#define __HAL_RCC_GET_CLKP_SOURCE()                                            \
  ((uint32_t)(READ_BIT(RCC->CDCCIPR, RCC_CDCCIPR_CKPERSEL)))
#endif /* RCC_D1CCIPR_CKPERSEL */
...
#define __HAL_RCC_FDCAN_CONFIG(__FDCANCLKSource__)                             \
  MODIFY_REG(RCC->D2CCIP1R, RCC_D2CCIP1R_FDCANSEL,                             \
             (uint32_t)(__FDCANCLKSource__))
#else
#define __HAL_RCC_FDCAN_CONFIG(__FDCANCLKSource__)                             \
  MODIFY_REG(RCC->CDCCIP1R, RCC_CDCCIP1R_FDCANSEL,                             \
             (uint32_t)(__FDCANCLKSource__))
...
#define __HAL_RCC_GET_FDCAN_SOURCE()                                           \
  ((uint32_t)(READ_BIT(RCC->D2CCIP1R, RCC_D2CCIP1R_FDCANSEL)))
#else
#define __HAL_RCC_GET_FDCAN_SOURCE()                                           \
  ((uint32_t)(READ_BIT(RCC->CDCCIP1R, RCC_CDCCIP1R_FDCANSEL)))
#endif /* RCC_D2CCIP1R_FDCANSEL */
 ...
 * @param  __RCC_SPI123CLKSource__ defines the SPI1/2/3 clock source. This clock
 * is derived from system PLL, PLL2, PLL3, OSC or external clock (through a
 * dedicated PIN) This parameter can be one of the following values:
...
#define __HAL_RCC_GET_SPI123_SOURCE()                                          \
  ((uint32_t)(READ_BIT(RCC->D2CCIP1R, RCC_D2CCIP1R_SPI123SEL)))
#else
#define __HAL_RCC_GET_SPI123_SOURCE()                                          \
  ((uint32_t)(READ_BIT(RCC->CDCCIP1R, RCC_CDCCIP1R_SPI123SEL)))
#endif /* RCC_D2CCIP1R_SPI123SEL */

/**
 * @brief  Macro to Configure the SPI1 clock source.
 * @param  __RCC_SPI1CLKSource__ defines the SPI1 clock source. This clock is
 * derived from system PLL, PLL2, PLL3, OSC or external clock (through a
 * dedicated PIN) This parameter can be one of the following values:
 ...
 * @param  __RCC_SPI2CLKSource__ defines the SPI2 clock source. This clock is
 * derived from system PLL, PLL2, PLL3, OSC or external clock (through a
 * dedicated PIN) This parameter can be one of the following values:
 ...
 * @param  __RCC_SPI3CLKSource__ defines the SPI3 clock source. This clock is
 * derived from system PLL, PLL2, PLL3, OSC or external clock (through a
 * dedicated PIN) This parameter can be one of the following values:
 ...
 * @param  __RCC_SPI45CLKSource__ defines the SPI4/5 clock source. This clock is
 * derived from system PCLK, PLL2, PLL3, OSC This parameter can be one of the
 * following values:
...
#define __HAL_RCC_GET_SPI45_SOURCE()                                           \
  ((uint32_t)(READ_BIT(RCC->D2CCIP1R, RCC_D2CCIP1R_SPI45SEL)))
#else
#define __HAL_RCC_GET_SPI45_SOURCE()                                           \
  ((uint32_t)(READ_BIT(RCC->CDCCIP1R, RCC_CDCCIP1R_SPI45SEL)))
#endif /* RCC_D2CCIP1R_SPI45SEL */

/**
 * @brief  Macro to Configure the SPI4 clock source.
 * @param  __RCC_SPI4CLKSource__ defines the SPI4 clock source. This clock is
 * derived from system PCLK, PLL2, PLL3, OSC This parameter can be one of the
 * following values:
 ...
 * @param  __RCC_SPI5CLKSource__ defines the SPI5 clock source. This clock is
 * derived from system PCLK, PLL2, PLL3, OSC This parameter can be one of the
 * following values:
 ...
 * @param  __RCC_SPI6CLKSource__ defines the SPI6 clock source. This clock is
 * derived from system PCLK, PLL2, PLL3, OSC This parameter can be one of the
 * following values:
...
#define __HAL_RCC_GET_SPI6_SOURCE()                                            \
  ((uint32_t)(READ_BIT(RCC->D3CCIPR, RCC_D3CCIPR_SPI6SEL)))
#else
#define __HAL_RCC_GET_SPI6_SOURCE()                                            \
  ((uint32_t)(READ_BIT(RCC->SRDCCIPR, RCC_SRDCCIPR_SPI6SEL)))
#endif /* RCC_D3CCIPR_SPI6SEL */
...
#define __HAL_RCC_GET_SDMMC_SOURCE()                                           \
  ((uint32_t)(READ_BIT(RCC->D1CCIPR, RCC_D1CCIPR_SDMMCSEL)))
#else
#define __HAL_RCC_GET_SDMMC_SOURCE()                                           \
  ((uint32_t)(READ_BIT(RCC->CDCCIPR, RCC_CDCCIPR_SDMMCSEL)))
#endif /* RCC_D1CCIPR_SDMMCSEL */
...
#define __HAL_RCC_GET_RNG_SOURCE()                                             \
  ((uint32_t)(READ_BIT(RCC->D2CCIP2R, RCC_D2CCIP2R_RNGSEL)))
#else
#define __HAL_RCC_GET_RNG_SOURCE()                                             \
  ((uint32_t)(READ_BIT(RCC->CDCCIP2R, RCC_CDCCIP2R_RNGSEL)))
#endif /* RCC_D2CCIP2R_RNGSEL */
 ...
 *         This parameter can be one of the following values:
 *            @arg @ref RCC_HRTIM1CLK_TIMCLK    Timers  clock  selected as
 * HRTIM1 prescaler clock
 ...
 * @retval The clock source can be one of the following values:
 *            @arg @ref RCC_HRTIM1CLK_TIMCLK   Timers  clock  selected as HRTIM1
 * prescaler clock
 *            @arg @ref RCC_HRTIM1CLK_CPUCLK CPU Clock selected as HRTIM1 clock
 */
#define __HAL_RCC_GET_HRTIM1_SOURCE()                                          \
  ((uint32_t)(READ_BIT(RCC->CFGR, RCC_CFGR_HRTIMSEL)))
#endif /* HRTIM1 */
 ...
 * is equal to rcc_hclk1 if D2PPREx is corresponding to division by 1 or 2, else
 * it is equal to 2 x Frcc_pclkx_d2 (default after reset)
 *            @arg RCC_TIMPRES_ACTIVATED: The Timers kernels clocks prescaler is
 *                 equal to rcc_hclk1 if D2PPREx is corresponding to division by
 * 1, 2 or 4, else it is equal to 4 x Frcc_pclkx_d2
 */
 ...
 * @retval None
 */
#define __HAL_RCC_C2_LSECSS_EXTI_ENABLE_IT()                                   \
  SET_BIT(EXTI->C2IMR1, RCC_EXTI_LINE_LSECSS)

/**
 * @brief Disable the RCC LSE CSS Extended Interrupt Line for CM4.
 * @retval None
 */
#define __HAL_RCC_C2_LSECSS_EXTI_DISABLE_IT()                                  \
  CLEAR_BIT(EXTI->C2IMR1, RCC_EXTI_LINE_LSECSS)

/**
 * @brief Enable the RCC LSE CSS Event Line for CM4.
 * @retval None.
 */
#define __HAL_RCC_C2_LSECSS_EXTI_ENABLE_EVENT()                                \
  SET_BIT(EXTI->C2EMR1, RCC_EXTI_LINE_LSECSS)

/**
 * @brief Disable the RCC LSE CSS Event Line for CM4.
 * @retval None.
 */
#define __HAL_RCC_C2_LSECSS_EXTI_DISABLE_EVENT()                               \
  CLEAR_BIT(EXTI->C2EMR1, RCC_EXTI_LINE_LSECSS)
#endif /* DUAL_CORE */
 ...
 * @retval EXTI RCC LSE CSS Line Status.
 */
#define __HAL_RCC_C2_LSECSS_EXTI_GET_FLAG()                                    \
  (READ_BIT(EXTI->C2PR1, RCC_EXTI_LINE_LSECSS) == RCC_EXTI_LINE_LSECSS)

/**
 * @brief Clear the RCC LSE CSS EXTI flag or not for CM4.
 * @retval None.
 */
#define __HAL_RCC_C2_LSECSS_EXTI_CLEAR_FLAG()                                  \
  WRITE_REG(EXTI->C2PR1, RCC_EXTI_LINE_LSECSS)
#endif /* DUAL_CORE */
/**
 ...
 * pre-scaling. It is then decreased by one in order to reach the expected
...
#define IS_RCC_PLL2CLOCKOUT_VALUE(VALUE)                                       \
  (((VALUE) == RCC_PLL2_DIVP) || ((VALUE) == RCC_PLL2_DIVQ) ||                 \
   ((VALUE) == RCC_PLL2_DIVR))
...
#define IS_RCC_I2C123CLKSOURCE                                                 \
  IS_RCC_I2C1235CLKSOURCE /* For  API Backward compatibility */
#else
...
#define IS_RCC_RNGCLKSOURCE(SOURCE)                                            \
  (((SOURCE) == RCC_RNGCLKSOURCE_HSI48) ||                                     \
   ((SOURCE) == RCC_RNGCLKSOURCE_PLL) || ((SOURCE) == RCC_RNGCLKSOURCE_LSE) || \
   ((SOURCE) == RCC_RNGCLKSOURCE_LSI))

#if defined(HRTIM1)
#define IS_RCC_HRTIM1CLKSOURCE(SOURCE)                                         \
  (((SOURCE) == RCC_HRTIM1CLK_TIMCLK) || ((SOURCE) == RCC_HRTIM1CLK_CPUCLK))
#endif
...
#define IS_RCC_PLL2RGE_VALUE(VALUE)                                            \
  (((VALUE) == RCC_PLL2VCIRANGE_0) || ((VALUE) == RCC_PLL2VCIRANGE_1) ||       \
   ((VALUE) == RCC_PLL2VCIRANGE_2) || ((VALUE) == RCC_PLL2VCIRANGE_3))

#define IS_RCC_PLL3RGE_VALUE(VALUE)                                            \
  (((VALUE) == RCC_PLL3VCIRANGE_0) || ((VALUE) == RCC_PLL3VCIRANGE_1) ||       \
   ((VALUE) == RCC_PLL3VCIRANGE_2) || ((VALUE) == RCC_PLL3VCIRANGE_3))

#define IS_RCC_PLL2VCO_VALUE(VALUE)                                            \
  (((VALUE) == RCC_PLL2VCOWIDE) || ((VALUE) == RCC_PLL2VCOMEDIUM))

#define IS_RCC_PLL3VCO_VALUE(VALUE)                                            \
  (((VALUE) == RCC_PLL3VCOWIDE) || ((VALUE) == RCC_PLL3VCOMEDIUM))
...
#define IS_RCC_ADCCLKSOURCE(SOURCE)                                            \
  (((SOURCE) == RCC_ADCCLKSOURCE_PLL2) ||                                      \
   ((SOURCE) == RCC_ADCCLKSOURCE_PLL3) || ((SOURCE) == RCC_ADCCLKSOURCE_CLKP))
...
#if defined(DUAL_CORE)
#define IS_RCC_SCOPE_WWDG(WWDG) (((WWDG) == RCC_WWDG1) || ((WWDG) == RCC_WWDG2))
#else
