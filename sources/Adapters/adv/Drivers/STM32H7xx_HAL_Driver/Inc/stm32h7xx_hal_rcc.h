...
typedef struct {
  ...
  uint32_t PLLN; /*!< PLLN: Multiplication factor for PLL VCO output clock.
                    ...
                    Max_Data = 512 or between Min_Data = 8 and Max_Data = 420(*)
  ...
  uint32_t
      PLLVCOSEL; /*!<PLLVCOSEL: PLL1 clock Output range
                   This parameter must be a value of @ref RCC_PLL1_VCO_Range */

  uint32_t
      PLLFRACN; /*!<PLLFRACN: Specifies Fractional Part Of The Multiplication
                 Factor for PLL1 VCO It should be a value between 0 and 8191 */
...
typedef struct {
  ...
  uint32_t
      HSICalibrationValue; /*!< The calibration trimming value.
                                This parameter must be a number between Min_Data
                              = 0x00 and Max_Data = 0x3F for STM32H7 rev.Y This
                              parameter must be a number between Min_Data = 0x00
                              and Max_Data = 0x7F for STM32H7 rev.B and above */
  ...
  uint32_t
      CSICalibrationValue; /*!< The calibration trimming value.
                                This parameter must be a number between Min_Data
                              = 0x00 and Max_Data = 0x1F for STM32H7 rev.Y This
                              parameter must be a number between Min_Data = 0x00
                              and Max_Data = 0x3F for STM32H7 rev.B and above */
...
typedef struct {
  ...
  uint32_t
      AHBCLKDivider; /*!< The AHB clock (HCLK) divider. This clock is derived
                        ...
                        value of @ref RCC_HCLK_Clock_Source */

  uint32_t APB3CLKDivider; /*!< The APB3 clock (D1PCLK1) divider. This clock is
                              derived from the AHB clock (HCLK). This parameter
                              can be a value of @ref RCC_APB3_Clock_Source */

  uint32_t APB1CLKDivider; /*!< The APB1 clock (PCLK1) divider. This clock is
                              derived from the AHB clock (HCLK). This parameter
                              can be a value of @ref RCC_APB1_Clock_Source */
  uint32_t APB2CLKDivider; /*!< The APB2 clock (PCLK2) divider. This clock is
                              derived from the AHB clock (HCLK). This parameter
                              can be a value of @ref RCC_APB2_Clock_Source */
  uint32_t APB4CLKDivider; /*!< The APB4 clock (D3PCLK1) divider. This clock is
                              derived from the AHB clock (HCLK). This parameter
                              can be a value of @ref RCC_APB4_Clock_Source */
} RCC_ClkInitTypeDef;
...
#define RCC_HSE_BYPASS_DIGITAL                                                 \
  ((uint32_t)(RCC_CR_HSEEXT | RCC_CR_HSEBYP | RCC_CR_HSEON))
#endif /* RCC_CR_HSEEXT */
...
#define RCC_LSE_BYPASS_DIGITAL                                                 \
  ((uint32_t)(RCC_BDCR_LSEEXT | RCC_BDCR_LSEBYP | RCC_BDCR_LSEON))
...
#define RCC_HSI_DIV1                                                           \
  (RCC_CR_HSIDIV_1 | RCC_CR_HSION) /*!< HSI_DIV1 clock activation */
#define RCC_HSI_DIV2                                                           \
  (RCC_CR_HSIDIV_2 | RCC_CR_HSION) /*!< HSI_DIV2 clock activation */
#define RCC_HSI_DIV4                                                           \
  (RCC_CR_HSIDIV_4 | RCC_CR_HSION) /*!< HSI_DIV4 clock activation */
#define RCC_HSI_DIV8                                                           \
  (RCC_CR_HSIDIV | RCC_CR_HSION) /*!< HSI_DIV8 clock activation */

#define RCC_HSICALIBRATION_DEFAULT                                             \
  (0x40U) /* Default HSI calibration trimming value for STM32H7 rev.V and      \
             above. (0x20 value for rev.Y handled within                       \
...
#define RCC_CSICALIBRATION_DEFAULT                                             \
  (0x20U) /* Default CSI calibration trimming value for STM32H7 rev.V and      \
             above. (0x10 value for rev.Y handled within                       \
             __HAL_RCC_CSI_CALIBRATIONVALUE_ADJUST macro ) */
/**
 * @}
 */
...
#define RCC_PLL1VCIRANGE_0                                                     \
  RCC_PLLCFGR_PLL1RGE_0 /*!< Clock range frequency between 1 and 2 MHz  */
#define RCC_PLL1VCIRANGE_1                                                     \
  RCC_PLLCFGR_PLL1RGE_1 /*!< Clock range frequency between 2 and 4 MHz  */
#define RCC_PLL1VCIRANGE_2                                                     \
  RCC_PLLCFGR_PLL1RGE_2 /*!< Clock range frequency between 4 and 8 MHz  */
#define RCC_PLL1VCIRANGE_3                                                     \
  RCC_PLLCFGR_PLL1RGE_3 /*!< Clock range frequency between 8 and 16 MHz */
...
#define RCC_MCODIV_7                                                           \
  ((uint32_t)RCC_CFGR_MCO1PRE_0 | RCC_CFGR_MCO1PRE_1 | RCC_CFGR_MCO1PRE_2)
...
#define RCC_MCODIV_11                                                          \
  ((uint32_t)RCC_CFGR_MCO1PRE_0 | RCC_CFGR_MCO1PRE_1 | RCC_CFGR_MCO1PRE_3)
#define RCC_MCODIV_12 ((uint32_t)RCC_CFGR_MCO1PRE_2 | RCC_CFGR_MCO1PRE_3)
#define RCC_MCODIV_13                                                          \
  ((uint32_t)RCC_CFGR_MCO1PRE_0 | RCC_CFGR_MCO1PRE_2 | RCC_CFGR_MCO1PRE_3)
#define RCC_MCODIV_14                                                          \
  ((uint32_t)RCC_CFGR_MCO1PRE_1 | RCC_CFGR_MCO1PRE_2 | RCC_CFGR_MCO1PRE_3)
...
#if defined(JPEG)
#define __HAL_RCC_JPGDECEN_CLK_DISABLE()                                       \
...
#if defined(OCTOSPIM)
#define __HAL_RCC_OCTOSPIM_CLK_DISABLE()                                       \
  (RCC->AHB3ENR &= ~(RCC_AHB3ENR_IOMNGREN))
#endif /* OCTOSPIM */
#if defined(OTFDEC1)
#define __HAL_RCC_OTFDEC1_CLK_DISABLE()                                        \
  (RCC->AHB3ENR &= ~(RCC_AHB3ENR_OTFDEC1EN))
#endif /* OTOFDEC1 */
#if defined(OTFDEC2)
#define __HAL_RCC_OTFDEC2_CLK_DISABLE()                                        \
...
#define __HAL_RCC_MDMA_IS_CLK_ENABLED()                                        \
  ((RCC->AHB3ENR & RCC_AHB3ENR_MDMAEN) != 0U)
#define __HAL_RCC_DMA2D_IS_CLK_ENABLED()                                       \
  ((RCC->AHB3ENR & RCC_AHB3ENR_DMA2DEN) != 0U)
#if defined(JPEG)
#define __HAL_RCC_JPGDECEN_IS_CLK_ENABLED()                                    \
  ((RCC->AHB3ENR & RCC_AHB3ENR_JPGDECEN) != 0U)
#endif /* JPEG */
#define __HAL_RCC_FMC_IS_CLK_ENABLED()                                         \
  ((RCC->AHB3ENR & RCC_AHB3ENR_FMCEN) != 0U)
#if defined(QUADSPI)
#define __HAL_RCC_QSPI_IS_CLK_ENABLED()                                        \
  ((RCC->AHB3ENR & RCC_AHB3ENR_QSPIEN) != 0U)
#endif /* QUADSPI */
#if defined(OCTOSPI1)
#define __HAL_RCC_OSPI1_IS_CLK_ENABLED()                                       \
  ((RCC->AHB3ENR & RCC_AHB3ENR_OSPI1EN) != 0U)
#endif /* OCTOSPII */
#if defined(OCTOSPI2)
#define __HAL_RCC_OSPI2_IS_CLK_ENABLED()                                       \
  ((RCC->AHB3ENR & RCC_AHB3ENR_OSPI2EN) != 0U)
#endif /* OCTOSPI2 */
#define __HAL_RCC_SDMMC1_IS_CLK_ENABLED()                                      \
  ((RCC->AHB3ENR & RCC_AHB3ENR_SDMMC1EN) != 0U)
#if defined(OCTOSPIM)
#define __HAL_RCC_OCTOSPIM_IS_CLK_ENABLED()                                    \
  ((RCC->AHB3ENR & RCC_AHB3ENR_IOMNGREN) != 0U)
#endif /* OCTOSPIM */
#if defined(OTFDEC1)
#define __HAL_RCC_OTFDEC1_IS_CLK_ENABLED()                                     \
  ((RCC->AHB3ENR & RCC_AHB3ENR_OTFDEC1EN) != 0U)
#endif /* OTOFDEC1 */
#if defined(OTFDEC2)
#define __HAL_RCC_OTFDEC2_IS_CLK_ENABLED()                                     \
  ((RCC->AHB3ENR & RCC_AHB3ENR_OTFDEC2EN) != 0U)
#endif /* OTOFDEC2 */
#if defined(GFXMMU)
#define __HAL_RCC_GFXMMU_IS_CLK_ENABLED()                                      \
  ((RCC->AHB3ENR & RCC_AHB3ENR_GFXMMUEN) != 0U)
#endif /* GFXMMU */

#define __HAL_RCC_MDMA_IS_CLK_DISABLED()                                       \
  ((RCC->AHB3ENR & RCC_AHB3ENR_MDMAEN) == 0U)
#define __HAL_RCC_DMA2D_IS_CLK_DISABLED()                                      \
  ((RCC->AHB3ENR & RCC_AHB3ENR_DMA2DEN) == 0U)
#if defined(JPEG)
#define __HAL_RCC_JPGDECEN_IS_CLK_DISABLED()                                   \
  ((RCC->AHB3ENR & RCC_AHB3ENR_JPGDECEN) == 0U)
#endif /* JPEG */
...
#endif
#if defined(OCTOSPIM)
#define __HAL_RCC_OCTOSPIM_IS_CLK_DISABLED()                                   \
  ((RCC->AHB3ENR & RCC_AHB3ENR_IOMNGREN) == 0U)
#endif
#if defined(OTFDEC1)
...
#endif
#if defined(OTFDEC2)
#define __HAL_RCC_OTFDEC2_IS_CLK_DISABLED()                                    \
  ((RCC->AHB3ENR & RCC_AHB3ENR_OTFDEC2EN) == 0U)
#endif
#if defined(GFXMMU)
...
#endif
#define __HAL_RCC_USB1_OTG_HS_CLK_DISABLE()                                    \
  (RCC->AHB1ENR &= ~(RCC_AHB1ENR_USB1OTGHSEN))
#define __HAL_RCC_USB1_OTG_HS_ULPI_CLK_DISABLE()                               \
  (RCC->AHB1ENR &= ~(RCC_AHB1ENR_USB1OTGHSULPIEN))
#if defined(USB2_OTG_FS)
#define __HAL_RCC_USB2_OTG_FS_CLK_DISABLE()                                    \
  (RCC->AHB1ENR &= ~(RCC_AHB1ENR_USB2OTGHSEN))
#define __HAL_RCC_USB2_OTG_FS_ULPI_CLK_DISABLE()                               \
...
#define __HAL_RCC_DMA1_IS_CLK_ENABLED()                                        \
  ((RCC->AHB1ENR & RCC_AHB1ENR_DMA1EN) != 0U)
#define __HAL_RCC_DMA2_IS_CLK_ENABLED()                                        \
  ((RCC->AHB1ENR & RCC_AHB1ENR_DMA2EN) != 0U)
#define __HAL_RCC_ADC12_IS_CLK_ENABLED()                                       \
  ((RCC->AHB1ENR & RCC_AHB1ENR_ADC12EN) != 0U)
#if defined(DUAL_CORE)
#define __HAL_RCC_ART_IS_CLK_ENABLED()                                         \
  ((RCC->AHB1ENR & RCC_AHB1ENR_ARTEN) != 0U)
#endif /*DUAL_CORE*/
#if defined(RCC_AHB1ENR_CRCEN)
#define __HAL_RCC_CRC_IS_CLK_ENABLED()                                         \
  ((RCC->AHB1ENR & RCC_AHB1ENR_CRCEN) != 0U)
#endif
#if defined(ETH)
#define __HAL_RCC_ETH1MAC_IS_CLK_ENABLED()                                     \
  ((RCC->AHB1ENR & RCC_AHB1ENR_ETH1MACEN) != 0U)
#define __HAL_RCC_ETH1TX_IS_CLK_ENABLED()                                      \
  ((RCC->AHB1ENR & RCC_AHB1ENR_ETH1TXEN) != 0U)
#define __HAL_RCC_ETH1RX_IS_CLK_ENABLED()                                      \
  ((RCC->AHB1ENR & RCC_AHB1ENR_ETH1RXEN) != 0U)
#endif
#define __HAL_RCC_USB1_OTG_HS_IS_CLK_ENABLED()                                 \
  ((RCC->AHB1ENR & RCC_AHB1ENR_USB1OTGHSEN) != 0U)
#define __HAL_RCC_USB1_OTG_HS_ULPI_IS_CLK_ENABLED()                            \
  ((RCC->AHB1ENR & RCC_AHB1ENR_USB1OTGHSULPIEN) != 0U)
#if defined(USB2_OTG_FS)
#define __HAL_RCC_USB2_OTG_FS_IS_CLK_ENABLED()                                 \
  ((RCC->AHB1ENR & RCC_AHB1ENR_USB2OTGHSEN) != 0U)
#define __HAL_RCC_USB2_OTG_FS_ULPI_IS_CLK_ENABLED()                            \
  ((RCC->AHB1ENR & RCC_AHB1ENR_USB2OTGHSULPIEN) != 0U)
#endif /* USB2_OTG_FS */
...
#define __HAL_RCC_ADC12_IS_CLK_DISABLED()                                      \
  ((RCC->AHB1ENR & RCC_AHB1ENR_ADC12EN) == 0U)
#if defined(DUAL_CORE)
#define __HAL_RCC_ART_IS_CLK_DISABLED()                                        \
  ((RCC->AHB1ENR & RCC_AHB1ENR_ARTEN) == 0U)
#endif /*DUAL_CORE*/
#if defined(RCC_AHB1ENR_CRCEN)
...
#endif
#if defined(ETH)
#define __HAL_RCC_ETH1MAC_IS_CLK_DISABLED()                                    \
  ((RCC->AHB1ENR & RCC_AHB1ENR_ETH1MACEN) == 0U)
#define __HAL_RCC_ETH1TX_IS_CLK_DISABLED()                                     \
  ((RCC->AHB1ENR & RCC_AHB1ENR_ETH1TXEN) == 0U)
#define __HAL_RCC_ETH1RX_IS_CLK_DISABLED()                                     \
  ((RCC->AHB1ENR & RCC_AHB1ENR_ETH1RXEN) == 0U)
#endif
#define __HAL_RCC_USB1_OTG_HS_IS_CLK_DISABLED()                                \
  ((RCC->AHB1ENR & RCC_AHB1ENR_USB1OTGHSEN) == 0U)
#define __HAL_RCC_USB1_OTG_HS_ULPI_IS_CLK_DISABLED()                           \
  ((RCC->AHB1ENR & RCC_AHB1ENR_USB1OTGHSULPIEN) == 0U)
#if defined(USB2_OTG_FS)
#define __HAL_RCC_USB2_OTG_FS_IS_CLK_DISABLED()                                \
  ((RCC->AHB1ENR & RCC_AHB1ENR_USB2OTGHSEN) == 0U)
#define __HAL_RCC_USB2_OTG_FS_ULPI_IS_CLK_DISABLED()                           \
  ((RCC->AHB1ENR & RCC_AHB1ENR_USB2OTGHSULPIEN) == 0U)
#endif /* USB2_OTG_FS */
...
#endif /* CORDIC */
#if defined(RCC_AHB2ENR_D2SRAM1EN)
#define __HAL_RCC_D2SRAM1_CLK_DISABLE()                                        \
  (RCC->AHB2ENR &= ~(RCC_AHB2ENR_D2SRAM1EN))
#else
#define __HAL_RCC_AHBSRAM1_CLK_DISABLE()                                       \
  (RCC->AHB2ENR &= ~(RCC_AHB2ENR_AHBSRAM1EN))
#endif /* RCC_AHB2ENR_D2SRAM1EN */
#if defined(RCC_AHB2ENR_D2SRAM2EN)
#define __HAL_RCC_D2SRAM2_CLK_DISABLE()                                        \
  (RCC->AHB2ENR &= ~(RCC_AHB2ENR_D2SRAM2EN))
#else
#define __HAL_RCC_AHBSRAM2_CLK_DISABLE()                                       \
  (RCC->AHB2ENR &= ~(RCC_AHB2ENR_AHBSRAM2EN))
#endif /* RCC_AHB2ENR_D2SRAM2EN */
#if defined(RCC_AHB2ENR_D2SRAM3EN)
#define __HAL_RCC_D2SRAM3_CLK_DISABLE()                                        \
...
#define __HAL_RCC_RNG_IS_CLK_ENABLED()                                         \
  ((RCC->AHB2ENR & RCC_AHB2ENR_RNGEN) != 0U)
#define __HAL_RCC_SDMMC2_IS_CLK_ENABLED()                                      \
  ((RCC->AHB2ENR & RCC_AHB2ENR_SDMMC2EN) != 0U)
#if defined(FMAC)
#define __HAL_RCC_FMAC_IS_CLK_ENABLED()                                        \
  ((RCC->AHB2ENR & RCC_AHB2ENR_FMACEN) != 0U)
#endif /* FMAC */
#if defined(CORDIC)
#define __HAL_RCC_CORDIC_IS_CLK_ENABLED()                                      \
  ((RCC->AHB2ENR & RCC_AHB2ENR_CORDICEN) != 0U)
#endif /* CORDIC */
#if defined(RCC_AHB2ENR_D2SRAM1EN)
#define __HAL_RCC_D2SRAM1_IS_CLK_ENABLED()                                     \
  ((RCC->AHB2ENR & RCC_AHB2ENR_D2SRAM1EN) != 0U)
#else
#define __HAL_RCC_AHBSRAM1_IS_CLK_ENABLED()                                    \
  ((RCC->AHB2ENR & RCC_AHB2ENR_AHBSRAM1EN) != 0U)
#endif /* RCC_AHB2ENR_D2SRAM1EN */
#if defined(RCC_AHB2ENR_D2SRAM2EN)
#define __HAL_RCC_D2SRAM2_IS_CLK_ENABLED()                                     \
  ((RCC->AHB2ENR & RCC_AHB2ENR_D2SRAM2EN) != 0U)
#else
#define __HAL_RCC_AHBSRAM2_IS_CLK_ENABLED()                                    \
  ((RCC->AHB2ENR & RCC_AHB2ENR_AHBSRAM2EN) != 0U)
#endif /* RCC_AHB2ENR_D2SRAM2EN */
#if defined(RCC_AHB2ENR_D2SRAM3EN)
#define __HAL_RCC_D2SRAM3_IS_CLK_ENABLED()                                     \
  ((RCC->AHB2ENR & RCC_AHB2ENR_D2SRAM3EN) != 0U)
#endif
#if defined(RCC_AHB2ENR_HSEMEN)
#define __HAL_RCC_HSEM_IS_CLK_ENABLED()                                        \
  ((RCC->AHB2ENR & RCC_AHB2ENR_HSEMEN) != 0U)
#endif
#if defined(BDMA1)
#define __HAL_RCC_BDMA1_IS_CLK_ENABLED()                                       \
  ((RCC->AHB2ENR & RCC_AHB2ENR_BDMA1EN) != 0U)
#endif
...
#endif /* CORDIC */
#if defined(RCC_AHB2ENR_D2SRAM1EN)
#define __HAL_RCC_D2SRAM1_IS_CLK_DISABLED()                                    \
  ((RCC->AHB2ENR & RCC_AHB2ENR_D2SRAM1EN) == 0U)
#else
#define __HAL_RCC_AHBSRAM1_IS_CLK_DISABLED()                                   \
  ((RCC->AHB2ENR & RCC_AHB2ENR_AHBSRAM1EN) == 0U)
#endif /* RCC_AHB2ENR_D2SRAM1EN */
#if defined(RCC_AHB2ENR_D2SRAM2EN)
#define __HAL_RCC_D2SRAM2_IS_CLK_DISABLED()                                    \
  ((RCC->AHB2ENR & RCC_AHB2ENR_D2SRAM2EN) == 0U)
#else
#define __HAL_RCC_AHBSRAM2_IS_CLK_DISABLED()                                   \
  ((RCC->AHB2ENR & RCC_AHB2ENR_AHBSRAM2EN) == 0U)
#endif /* RCC_AHB2ENR_D2SRAM2EN */
#if defined(RCC_AHB2ENR_D2SRAM3EN)
#define __HAL_RCC_D2SRAM3_IS_CLK_DISABLED()                                    \
  ((RCC->AHB2ENR & RCC_AHB2ENR_D2SRAM3EN) == 0U)
#endif
#if defined(RCC_AHB2ENR_HSEMEN)
#define __HAL_RCC_HSEM_IS_CLK_DISABLED()                                       \
  ((RCC->AHB2ENR & RCC_AHB2ENR_HSEMEN) == 0U)
#endif
#if defined(BDMA1)
#define __HAL_RCC_BDMA1_IS_CLK_DISABLED()                                      \
  ((RCC->AHB2ENR & RCC_AHB2ENR_BDMA1EN) == 0U)
#endif
...
#define __HAL_RCC_BDMA_CLK_ENABLE()                                            \
  __HAL_RCC_BDMA2_CLK_ENABLE() /* for API backward compatibility*/
#else
#define __HAL_RCC_BDMA_CLK_ENABLE()                                            \
  do {                                                                         \
    __IO uint32_t tmpreg;                                                      \
...
#define __HAL_RCC_BDMA_CLK_DISABLE()                                           \
  __HAL_RCC_BDMA2_CLK_DISABLE() /* for API backward compatibility*/
#else
...
#endif
#if defined(RCC_AHB4ENR_SRDSRAMEN)
#define __HAL_RCC_SRDSRAM_CLK_DISABLE()                                        \
...
#define __HAL_RCC_GPIOA_IS_CLK_ENABLED()                                       \
  ((RCC->AHB4ENR & RCC_AHB4ENR_GPIOAEN) != 0U)
#define __HAL_RCC_GPIOB_IS_CLK_ENABLED()                                       \
  ((RCC->AHB4ENR & RCC_AHB4ENR_GPIOBEN) != 0U)
#define __HAL_RCC_GPIOC_IS_CLK_ENABLED()                                       \
  ((RCC->AHB4ENR & RCC_AHB4ENR_GPIOCEN) != 0U)
#define __HAL_RCC_GPIOD_IS_CLK_ENABLED()                                       \
  ((RCC->AHB4ENR & RCC_AHB4ENR_GPIODEN) != 0U)
#define __HAL_RCC_GPIOE_IS_CLK_ENABLED()                                       \
  ((RCC->AHB4ENR & RCC_AHB4ENR_GPIOEEN) != 0U)
#define __HAL_RCC_GPIOF_IS_CLK_ENABLED()                                       \
  ((RCC->AHB4ENR & RCC_AHB4ENR_GPIOFEN) != 0U)
#define __HAL_RCC_GPIOG_IS_CLK_ENABLED()                                       \
  ((RCC->AHB4ENR & RCC_AHB4ENR_GPIOGEN) != 0U)
#define __HAL_RCC_GPIOH_IS_CLK_ENABLED()                                       \
  ((RCC->AHB4ENR & RCC_AHB4ENR_GPIOHEN) != 0U)
#if defined(GPIOI)
#define __HAL_RCC_GPIOI_IS_CLK_ENABLED()                                       \
  ((RCC->AHB4ENR & RCC_AHB4ENR_GPIOIEN) != 0U)
#endif /* GPIOI */
#define __HAL_RCC_GPIOJ_IS_CLK_ENABLED()                                       \
  ((RCC->AHB4ENR & RCC_AHB4ENR_GPIOJEN) != 0U)
#define __HAL_RCC_GPIOK_IS_CLK_ENABLED()                                       \
  ((RCC->AHB4ENR & RCC_AHB4ENR_GPIOKEN) != 0U)
#if defined(RCC_AHB4ENR_CRCEN)
#define __HAL_RCC_CRC_IS_CLK_ENABLED()                                         \
  ((RCC->AHB4ENR & RCC_AHB4ENR_CRCEN) != 0U)
#endif
#if defined(BDMA2)
#define __HAL_RCC_BDMA2_IS_CLK_ENABLED()                                       \
  ((RCC->AHB4ENR & RCC_AHB4ENR_BDMA2EN) != 0U)
#define __HAL_RCC_BDMA_IS_CLK_ENABLED()                                        \
  __HAL_RCC_BDMA2_IS_CLK_ENABLED() /* for API backward compatibility*/
#else
#define __HAL_RCC_BDMA_IS_CLK_ENABLED()                                        \
  ((RCC->AHB4ENR & RCC_AHB4ENR_BDMAEN) != 0U)
#endif
#if defined(ADC3)
#define __HAL_RCC_ADC3_IS_CLK_ENABLED()                                        \
  ((RCC->AHB4ENR & RCC_AHB4ENR_ADC3EN) != 0U)
#endif
#if defined(RCC_AHB4ENR_HSEMEN)
#define __HAL_RCC_HSEM_IS_CLK_ENABLED()                                        \
  ((RCC->AHB4ENR & RCC_AHB4ENR_HSEMEN) != 0U)
#endif
#if defined(RCC_AHB4ENR_SRDSRAMEN)
#define __HAL_RCC_SRDSRAM_IS_CLK_ENABLED()                                     \
  ((RCC->AHB4ENR & RCC_AHB4ENR_SRDSRAMEN) != 0U)
#endif
#define __HAL_RCC_BKPRAM_IS_CLK_ENABLED()                                      \
  ((RCC->AHB4ENR & RCC_AHB4ENR_BKPRAMEN) != 0U)
...
#endif
#if defined(BDMA2)
#define __HAL_RCC_BDMA2_IS_CLK_DISABLED()                                      \
  ((RCC->AHB4ENR & RCC_AHB4ENR_BDMA2EN) == 0U)
#define __HAL_RCC_BDMA_IS_CLK_DISABLED()                                       \
  __HAL_RCC_BDMA2_IS_CLK_DISABLED() /* for API backward compatibility*/
#else
#define __HAL_RCC_BDMA_IS_CLK_DISABLED()                                       \
  ((RCC->AHB4ENR & RCC_AHB4ENR_BDMAEN) == 0U)
#endif
...
#endif
#if defined(RCC_AHB4ENR_SRDSRAMEN)
#define __HAL_RCC_SRDSRAM_IS_CLK_DISABLED()                                    \
  ((RCC->AHB4ENR & RCC_AHB4ENR_SRDSRAMEN) == 0U)
#endif
...
#define __HAL_RCC_LTDC_IS_CLK_ENABLED()                                        \
  ((RCC->APB3ENR & RCC_APB3ENR_LTDCEN) != 0U)
#endif /* LTDC */
#if defined(DSI)
#define __HAL_RCC_DSI_IS_CLK_ENABLED()                                         \
  ((RCC->APB3ENR & RCC_APB3ENR_DSIEN) != 0U)
#endif /*DSI*/
#define __HAL_RCC_WWDG1_IS_CLK_ENABLED()                                       \
  ((RCC->APB3ENR & RCC_APB3ENR_WWDG1EN) != 0U)
#if defined(LTDC)
...
#define __HAL_RCC_DSI_IS_CLK_DISABLED()                                        \
  ((RCC->APB3ENR & RCC_APB3ENR_DSIEN) == 0U)
#endif /*DSI*/
#define __HAL_RCC_WWDG1_IS_CLK_DISABLED()                                      \
  ((RCC->APB3ENR & RCC_APB3ENR_WWDG1EN) == 0U)
...
#define __HAL_RCC_SWPMI1_CLK_DISABLE()                                         \
  (RCC->APB1HENR) &= ~(RCC_APB1HENR_SWPMIEN)
...
#define __HAL_RCC_TIM2_IS_CLK_ENABLED()                                        \
  ((RCC->APB1LENR & RCC_APB1LENR_TIM2EN) != 0U)
#define __HAL_RCC_TIM3_IS_CLK_ENABLED()                                        \
  ((RCC->APB1LENR & RCC_APB1LENR_TIM3EN) != 0U)
#define __HAL_RCC_TIM4_IS_CLK_ENABLED()                                        \
  ((RCC->APB1LENR & RCC_APB1LENR_TIM4EN) != 0U)
#define __HAL_RCC_TIM5_IS_CLK_ENABLED()                                        \
  ((RCC->APB1LENR & RCC_APB1LENR_TIM5EN) != 0U)
#define __HAL_RCC_TIM6_IS_CLK_ENABLED()                                        \
  ((RCC->APB1LENR & RCC_APB1LENR_TIM6EN) != 0U)
#define __HAL_RCC_TIM7_IS_CLK_ENABLED()                                        \
  ((RCC->APB1LENR & RCC_APB1LENR_TIM7EN) != 0U)
#define __HAL_RCC_TIM12_IS_CLK_ENABLED()                                       \
  ((RCC->APB1LENR & RCC_APB1LENR_TIM12EN) != 0U)
#define __HAL_RCC_TIM13_IS_CLK_ENABLED()                                       \
  ((RCC->APB1LENR & RCC_APB1LENR_TIM13EN) != 0U)
#define __HAL_RCC_TIM14_IS_CLK_ENABLED()                                       \
  ((RCC->APB1LENR & RCC_APB1LENR_TIM14EN) != 0U)
#define __HAL_RCC_LPTIM1_IS_CLK_ENABLED()                                      \
  ((RCC->APB1LENR & RCC_APB1LENR_LPTIM1EN) != 0U)
#if defined(DUAL_CORE)
#define __HAL_RCC_WWDG2_IS_CLK_ENABLED()                                       \
  ((RCC->APB1LENR & RCC_APB1LENR_WWDG2EN) != 0U)
#endif /*DUAL_CORE*/
#define __HAL_RCC_SPI2_IS_CLK_ENABLED()                                        \
  ((RCC->APB1LENR & RCC_APB1LENR_SPI2EN) != 0U)
#define __HAL_RCC_SPI3_IS_CLK_ENABLED()                                        \
  ((RCC->APB1LENR & RCC_APB1LENR_SPI3EN) != 0U)
#define __HAL_RCC_SPDIFRX_IS_CLK_ENABLED()                                     \
  ((RCC->APB1LENR & RCC_APB1LENR_SPDIFRXEN) != 0U)
#define __HAL_RCC_USART2_IS_CLK_ENABLED()                                      \
  ((RCC->APB1LENR & RCC_APB1LENR_USART2EN) != 0U)
#define __HAL_RCC_USART3_IS_CLK_ENABLED()                                      \
  ((RCC->APB1LENR & RCC_APB1LENR_USART3EN) != 0U)
#define __HAL_RCC_UART4_IS_CLK_ENABLED()                                       \
  ((RCC->APB1LENR & RCC_APB1LENR_UART4EN) != 0U)
#define __HAL_RCC_UART5_IS_CLK_ENABLED()                                       \
  ((RCC->APB1LENR & RCC_APB1LENR_UART5EN) != 0U)
#define __HAL_RCC_I2C1_IS_CLK_ENABLED()                                        \
  ((RCC->APB1LENR & RCC_APB1LENR_I2C1EN) != 0U)
#define __HAL_RCC_I2C2_IS_CLK_ENABLED()                                        \
  ((RCC->APB1LENR & RCC_APB1LENR_I2C2EN) != 0U)
#define __HAL_RCC_I2C3_IS_CLK_ENABLED()                                        \
  ((RCC->APB1LENR & RCC_APB1LENR_I2C3EN) != 0U)
#if defined(I2C5)
#define __HAL_RCC_I2C5_IS_CLK_ENABLED()                                        \
  ((RCC->APB1LENR & RCC_APB1LENR_I2C5EN) != 0U)
#endif /* I2C5 */
#define __HAL_RCC_CEC_IS_CLK_ENABLED()                                         \
  ((RCC->APB1LENR & RCC_APB1LENR_CECEN) != 0U)
#define __HAL_RCC_DAC12_IS_CLK_ENABLED()                                       \
  ((RCC->APB1LENR & RCC_APB1LENR_DAC12EN) != 0U)
#define __HAL_RCC_UART7_IS_CLK_ENABLED()                                       \
  ((RCC->APB1LENR & RCC_APB1LENR_UART7EN) != 0U)
#define __HAL_RCC_UART8_IS_CLK_ENABLED()                                       \
  ((RCC->APB1LENR & RCC_APB1LENR_UART8EN) != 0U)
#define __HAL_RCC_CRS_IS_CLK_ENABLED()                                         \
  ((RCC->APB1HENR & RCC_APB1HENR_CRSEN) != 0U)
#define __HAL_RCC_SWPMI1_IS_CLK_ENABLED()                                      \
  ((RCC->APB1HENR & RCC_APB1HENR_SWPMIEN) != 0U)
#define __HAL_RCC_OPAMP_IS_CLK_ENABLED()                                       \
  ((RCC->APB1HENR & RCC_APB1HENR_OPAMPEN) != 0U)
#define __HAL_RCC_MDIOS_IS_CLK_ENABLED()                                       \
  ((RCC->APB1HENR & RCC_APB1HENR_MDIOSEN) != 0U)
#define __HAL_RCC_FDCAN_IS_CLK_ENABLED()                                       \
  ((RCC->APB1HENR & RCC_APB1HENR_FDCANEN) != 0U)
#if defined(TIM23)
#define __HAL_RCC_TIM23_IS_CLK_ENABLED()                                       \
  ((RCC->APB1HENR & RCC_APB1HENR_TIM23EN) != 0U)
#endif /* TIM23 */
#if defined(TIM24)
#define __HAL_RCC_TIM24_IS_CLK_ENABLED()                                       \
  ((RCC->APB1HENR & RCC_APB1HENR_TIM24EN) != 0U)
#endif /* TIM24 */
...
#define __HAL_RCC_LPTIM1_IS_CLK_DISABLED()                                     \
  ((RCC->APB1LENR & RCC_APB1LENR_LPTIM1EN) == 0U)
#if defined(DUAL_CORE)
#define __HAL_RCC_WWDG2_IS_CLK_DISABLED()                                      \
  ((RCC->APB1LENR & RCC_APB1LENR_WWDG2EN) == 0U)
#endif /*DUAL_CORE*/
...
#define __HAL_RCC_I2C3_IS_CLK_DISABLED()                                       \
  ((RCC->APB1LENR & RCC_APB1LENR_I2C3EN) == 0U)
#if defined(I2C5)
#define __HAL_RCC_I2C5_IS_CLK_DISABLED()                                       \
  ((RCC->APB1LENR & RCC_APB1LENR_I2C5EN) == 0U)
#endif /* I2C5 */
#define __HAL_RCC_CEC_IS_CLK_DISABLED()                                        \
  ((RCC->APB1LENR & RCC_APB1LENR_CECEN) == 0U)
#define __HAL_RCC_DAC12_IS_CLK_DISABLED()                                      \
  ((RCC->APB1LENR & RCC_APB1LENR_DAC12EN) == 0U)
...
#define __HAL_RCC_OPAMP_IS_CLK_DISABLED()                                      \
  ((RCC->APB1HENR & RCC_APB1HENR_OPAMPEN) == 0U)
#define __HAL_RCC_MDIOS_IS_CLK_DISABLED()                                      \
  ((RCC->APB1HENR & RCC_APB1HENR_MDIOSEN) == 0U)
#define __HAL_RCC_FDCAN_IS_CLK_DISABLED()                                      \
  ((RCC->APB1HENR & RCC_APB1HENR_FDCANEN) == 0U)
#if defined(TIM23)
#define __HAL_RCC_TIM23_IS_CLK_DISABLED()                                      \
  ((RCC->APB1HENR & RCC_APB1HENR_TIM23EN) == 0U)
#endif /* TIM23 */
#if defined(TIM24)
#define __HAL_RCC_TIM24_IS_CLK_DISABLED()                                      \
  ((RCC->APB1HENR & RCC_APB1HENR_TIM24EN) == 0U)
#endif /* TIM24 */
...
#endif /*SAI2*/
#if defined(SAI3)
#define __HAL_RCC_SAI3_IS_CLK_DISABLED()                                       \
  ((RCC->APB2ENR & RCC_APB2ENR_SAI3EN) == 0U)
#endif /*SAI3*/
...
#define __HAL_RCC_SYSCFG_IS_CLK_ENABLED()                                      \
  ((RCC->APB4ENR & RCC_APB4ENR_SYSCFGEN) != 0U)
#define __HAL_RCC_LPUART1_IS_CLK_ENABLED()                                     \
  ((RCC->APB4ENR & RCC_APB4ENR_LPUART1EN) != 0U)
#define __HAL_RCC_SPI6_IS_CLK_ENABLED()                                        \
  ((RCC->APB4ENR & RCC_APB4ENR_SPI6EN) != 0U)
#define __HAL_RCC_I2C4_IS_CLK_ENABLED()                                        \
  ((RCC->APB4ENR & RCC_APB4ENR_I2C4EN) != 0U)
#define __HAL_RCC_LPTIM2_IS_CLK_ENABLED()                                      \
  ((RCC->APB4ENR & RCC_APB4ENR_LPTIM2EN) != 0U)
#define __HAL_RCC_LPTIM3_IS_CLK_ENABLED()                                      \
  ((RCC->APB4ENR & RCC_APB4ENR_LPTIM3EN) != 0U)
#if defined(LPTIM4)
#define __HAL_RCC_LPTIM4_IS_CLK_ENABLED()                                      \
  ((RCC->APB4ENR & RCC_APB4ENR_LPTIM4EN) != 0U)
#endif /*LPTIM4*/
#if defined(LPTIM5)
#define __HAL_RCC_LPTIM5_IS_CLK_ENABLED()                                      \
  ((RCC->APB4ENR & RCC_APB4ENR_LPTIM5EN) != 0U)
#endif /*LPTIM5*/
#if defined(DAC2)
#define __HAL_RCC_DAC2_IS_CLK_ENABLED()                                        \
  ((RCC->APB4ENR & RCC_APB4ENR_DAC2EN) != 0U)
#endif /*DAC2*/
#define __HAL_RCC_COMP12_IS_CLK_ENABLED()                                      \
  ((RCC->APB4ENR & RCC_APB4ENR_COMP12EN) != 0U)
#define __HAL_RCC_VREF_IS_CLK_ENABLED()                                        \
  ((RCC->APB4ENR & RCC_APB4ENR_VREFEN) != 0U)
#define __HAL_RCC_RTC_IS_CLK_ENABLED()                                         \
  ((RCC->APB4ENR & RCC_APB4ENR_RTCAPBEN) != 0U)
#if defined(SAI4)
#define __HAL_RCC_SAI4_IS_CLK_ENABLED()                                        \
  ((RCC->APB4ENR & RCC_APB4ENR_SAI4EN) != 0U)
#endif /*SAI4*/
#if defined(DTS)
#define __HAL_RCC_DTS_IS_CLK_ENABLED()                                         \
  ((RCC->APB4ENR & RCC_APB4ENR_DTSEN) != 0U)
#endif /*DTS*/
#if defined(DFSDM2_BASE)
#define __HAL_RCC_DFSDM2_IS_CLK_ENABLED()                                      \
  ((RCC->APB4ENR & RCC_APB4ENR_DFSDM2EN) != 0U)
#endif /*DFSDM2*/
...
#define __HAL_RCC_DAC2_IS_CLK_DISABLED()                                       \
  ((RCC->APB4ENR & RCC_APB4ENR_DAC2EN) == 0U)
#endif /*DAC2*/
#define __HAL_RCC_COMP12_IS_CLK_DISABLED()                                     \
  ((RCC->APB4ENR & RCC_APB4ENR_COMP12EN) == 0U)
...
#define __HAL_RCC_RTC_IS_CLK_DISABLED()                                        \
  ((RCC->APB4ENR & RCC_APB4ENR_RTCAPBEN) == 0U)
#if defined(SAI4)
#define __HAL_RCC_SAI4_IS_CLK_DISABLED()                                       \
  ((RCC->APB4ENR & RCC_APB4ENR_SAI4EN) == 0U)
#endif /*SAI4*/
#if defined(DTS)
...
#define __HAL_RCC_C1_MDMA_CLK_DISABLE()                                        \
  (RCC_C1->AHB3ENR &= ~(RCC_AHB3ENR_MDMAEN))
#define __HAL_RCC_C1_DMA2D_CLK_DISABLE()                                       \
  (RCC_C1->AHB3ENR &= ~(RCC_AHB3ENR_DMA2DEN))
#define __HAL_RCC_C1_JPGDECEN_CLK_DISABLE()                                    \
  (RCC_C1->AHB3ENR &= ~(RCC_AHB3ENR_JPGDECEN))
#define __HAL_RCC_C1_FMC_CLK_DISABLE() (RCC_C1->AHB3ENR &= ~(RCC_AHB3ENR_FMCEN))
#define __HAL_RCC_C1_QSPI_CLK_DISABLE()                                        \
  (RCC_C1->AHB3ENR &= ~(RCC_AHB3ENR_QSPIEN))
...
#define __HAL_RCC_C1_DMA1_CLK_DISABLE()                                        \
  (RCC_C1->AHB1ENR &= ~(RCC_AHB1ENR_DMA1EN))
#define __HAL_RCC_C1_DMA2_CLK_DISABLE()                                        \
  (RCC_C1->AHB1ENR &= ~(RCC_AHB1ENR_DMA2EN))
#define __HAL_RCC_C1_ADC12_CLK_DISABLE()                                       \
  (RCC_C1->AHB1ENR &= ~(RCC_AHB1ENR_ADC12EN))
#define __HAL_RCC_C1_ART_CLK_DISABLE() (RCC_C1->AHB1ENR &= ~(RCC_AHB1ENR_ARTEN))
#define __HAL_RCC_C1_ETH1MAC_CLK_DISABLE()                                     \
  (RCC_C1->AHB1ENR &= ~(RCC_AHB1ENR_ETH1MACEN))
#define __HAL_RCC_C1_ETH1TX_CLK_DISABLE()                                      \
  (RCC_C1->AHB1ENR &= ~(RCC_AHB1ENR_ETH1TXEN))
#define __HAL_RCC_C1_ETH1RX_CLK_DISABLE()                                      \
  (RCC_C1->AHB1ENR &= ~(RCC_AHB1ENR_ETH1RXEN))
#define __HAL_RCC_C1_USB1_OTG_HS_CLK_DISABLE()                                 \
  (RCC_C1->AHB1ENR &= ~(RCC_AHB1ENR_USB1OTGHSEN))
#define __HAL_RCC_C1_USB1_OTG_HS_ULPI_CLK_DISABLE()                            \
  (RCC_C1->AHB1ENR &= ~(RCC_AHB1ENR_USB1OTGHSULPIEN))
#define __HAL_RCC_C1_USB2_OTG_FS_CLK_DISABLE()                                 \
  (RCC_C1->AHB1ENR &= ~(RCC_AHB1ENR_USB2OTGHSEN))
#define __HAL_RCC_C1_USB2_OTG_FS_ULPI_CLK_DISABLE()                            \
...
#define __HAL_RCC_C1_DCMI_CLK_DISABLE()                                        \
  (RCC_C1->AHB2ENR &= ~(RCC_AHB2ENR_DCMIEN))
#if defined(CRYP)
#define __HAL_RCC_C1_CRYP_CLK_DISABLE()                                        \
  (RCC_C1->AHB2ENR &= ~(RCC_AHB2ENR_CRYPEN))
#endif /* CRYP */
#if defined(HASH)
#define __HAL_RCC_C1_HASH_CLK_DISABLE()                                        \
  (RCC_C1->AHB2ENR &= ~(RCC_AHB2ENR_HASHEN))
#endif /* HASH */
#define __HAL_RCC_C1_RNG_CLK_DISABLE() (RCC_C1->AHB2ENR &= ~(RCC_AHB2ENR_RNGEN))
#define __HAL_RCC_C1_SDMMC2_CLK_DISABLE()                                      \
  (RCC_C1->AHB2ENR &= ~(RCC_AHB2ENR_SDMMC2EN))
#define __HAL_RCC_C1_D2SRAM1_CLK_DISABLE()                                     \
  (RCC_C1->AHB2ENR &= ~(RCC_AHB2ENR_D2SRAM1EN))
#define __HAL_RCC_C1_D2SRAM2_CLK_DISABLE()                                     \
  (RCC_C1->AHB2ENR &= ~(RCC_AHB2ENR_D2SRAM2EN))
#define __HAL_RCC_C1_D2SRAM3_CLK_DISABLE()                                     \
  (RCC_C1->AHB2ENR &= ~(RCC_AHB2ENR_D2SRAM3EN))
...
#define __HAL_RCC_C1_GPIOA_CLK_DISABLE()                                       \
  (RCC_C1->AHB4ENR) &= ~(RCC_AHB4ENR_GPIOAEN)
#define __HAL_RCC_C1_GPIOB_CLK_DISABLE()                                       \
  (RCC_C1->AHB4ENR) &= ~(RCC_AHB4ENR_GPIOBEN)
#define __HAL_RCC_C1_GPIOC_CLK_DISABLE()                                       \
  (RCC_C1->AHB4ENR) &= ~(RCC_AHB4ENR_GPIOCEN)
#define __HAL_RCC_C1_GPIOD_CLK_DISABLE()                                       \
  (RCC_C1->AHB4ENR) &= ~(RCC_AHB4ENR_GPIODEN)
#define __HAL_RCC_C1_GPIOE_CLK_DISABLE()                                       \
  (RCC_C1->AHB4ENR) &= ~(RCC_AHB4ENR_GPIOEEN)
#define __HAL_RCC_C1_GPIOF_CLK_DISABLE()                                       \
  (RCC_C1->AHB4ENR) &= ~(RCC_AHB4ENR_GPIOFEN)
#define __HAL_RCC_C1_GPIOG_CLK_DISABLE()                                       \
  (RCC_C1->AHB4ENR) &= ~(RCC_AHB4ENR_GPIOGEN)
#define __HAL_RCC_C1_GPIOH_CLK_DISABLE()                                       \
  (RCC_C1->AHB4ENR) &= ~(RCC_AHB4ENR_GPIOHEN)
#define __HAL_RCC_C1_GPIOI_CLK_DISABLE()                                       \
  (RCC_C1->AHB4ENR) &= ~(RCC_AHB4ENR_GPIOIEN)
#define __HAL_RCC_C1_GPIOJ_CLK_DISABLE()                                       \
  (RCC_C1->AHB4ENR) &= ~(RCC_AHB4ENR_GPIOJEN)
#define __HAL_RCC_C1_GPIOK_CLK_DISABLE()                                       \
  (RCC_C1->AHB4ENR) &= ~(RCC_AHB4ENR_GPIOKEN)
#define __HAL_RCC_C1_CRC_CLK_DISABLE() (RCC_C1->AHB4ENR) &= ~(RCC_AHB4ENR_CRCEN)
#define __HAL_RCC_C1_BDMA_CLK_DISABLE()                                        \
  (RCC_C1->AHB4ENR) &= ~(RCC_AHB4ENR_BDMAEN)
#define __HAL_RCC_C1_ADC3_CLK_DISABLE()                                        \
  (RCC_C1->AHB4ENR) &= ~(RCC_AHB4ENR_ADC3EN)
#define __HAL_RCC_C1_HSEM_CLK_DISABLE()                                        \
  (RCC_C1->AHB4ENR) &= ~(RCC_AHB4ENR_HSEMEN)
#define __HAL_RCC_C1_BKPRAM_CLK_DISABLE()                                      \
  (RCC_C1->AHB4ENR) &= ~(RCC_AHB4ENR_BKPRAMEN)
...
#define __HAL_RCC_C1_LTDC_CLK_DISABLE()                                        \
  (RCC_C1->APB3ENR) &= ~(RCC_APB3ENR_LTDCEN)
#define __HAL_RCC_C1_DSI_CLK_DISABLE() (RCC_C1->APB3ENR) &= ~(RCC_APB3ENR_DSIEN)
#define __HAL_RCC_C1_WWDG1_CLK_DISABLE()                                       \
  (RCC_C1->APB3ENR) &= ~(RCC_APB3ENR_WWDG1EN)
...
#define __HAL_RCC_C1_TIM2_CLK_DISABLE()                                        \
  (RCC_C1->APB1LENR) &= ~(RCC_APB1LENR_TIM2EN)
#define __HAL_RCC_C1_TIM3_CLK_DISABLE()                                        \
  (RCC_C1->APB1LENR) &= ~(RCC_APB1LENR_TIM3EN)
#define __HAL_RCC_C1_TIM4_CLK_DISABLE()                                        \
  (RCC_C1->APB1LENR) &= ~(RCC_APB1LENR_TIM4EN)
#define __HAL_RCC_C1_TIM5_CLK_DISABLE()                                        \
  (RCC_C1->APB1LENR) &= ~(RCC_APB1LENR_TIM5EN)
#define __HAL_RCC_C1_TIM6_CLK_DISABLE()                                        \
  (RCC_C1->APB1LENR) &= ~(RCC_APB1LENR_TIM6EN)
#define __HAL_RCC_C1_TIM7_CLK_DISABLE()                                        \
  (RCC_C1->APB1LENR) &= ~(RCC_APB1LENR_TIM7EN)
#define __HAL_RCC_C1_TIM12_CLK_DISABLE()                                       \
  (RCC_C1->APB1LENR) &= ~(RCC_APB1LENR_TIM12EN)
#define __HAL_RCC_C1_TIM13_CLK_DISABLE()                                       \
  (RCC_C1->APB1LENR) &= ~(RCC_APB1LENR_TIM13EN)
#define __HAL_RCC_C1_TIM14_CLK_DISABLE()                                       \
  (RCC_C1->APB1LENR) &= ~(RCC_APB1LENR_TIM14EN)
#define __HAL_RCC_C1_LPTIM1_CLK_DISABLE()                                      \
  (RCC_C1->APB1LENR) &= ~(RCC_APB1LENR_LPTIM1EN)
#define __HAL_RCC_C1_WWDG2_CLK_DISABLE()                                       \
  (RCC_C1->APB1LENR) &= ~(RCC_APB1LENR_WWDG2EN)
#define __HAL_RCC_C1_SPI2_CLK_DISABLE()                                        \
  (RCC_C1->APB1LENR) &= ~(RCC_APB1LENR_SPI2EN)
#define __HAL_RCC_C1_SPI3_CLK_DISABLE()                                        \
  (RCC_C1->APB1LENR) &= ~(RCC_APB1LENR_SPI3EN)
#define __HAL_RCC_C1_SPDIFRX_CLK_DISABLE()                                     \
  (RCC_C1->APB1LENR) &= ~(RCC_APB1LENR_SPDIFRXEN)
#define __HAL_RCC_C1_USART2_CLK_DISABLE()                                      \
  (RCC_C1->APB1LENR) &= ~(RCC_APB1LENR_USART2EN)
#define __HAL_RCC_C1_USART3_CLK_DISABLE()                                      \
  (RCC_C1->APB1LENR) &= ~(RCC_APB1LENR_USART3EN)
#define __HAL_RCC_C1_UART4_CLK_DISABLE()                                       \
  (RCC_C1->APB1LENR) &= ~(RCC_APB1LENR_UART4EN)
#define __HAL_RCC_C1_UART5_CLK_DISABLE()                                       \
  (RCC_C1->APB1LENR) &= ~(RCC_APB1LENR_UART5EN)
#define __HAL_RCC_C1_I2C1_CLK_DISABLE()                                        \
  (RCC_C1->APB1LENR) &= ~(RCC_APB1LENR_I2C1EN)
#define __HAL_RCC_C1_I2C2_CLK_DISABLE()                                        \
  (RCC_C1->APB1LENR) &= ~(RCC_APB1LENR_I2C2EN)
#define __HAL_RCC_C1_I2C3_CLK_DISABLE()                                        \
  (RCC_C1->APB1LENR) &= ~(RCC_APB1LENR_I2C3EN)
#define __HAL_RCC_C1_CEC_CLK_DISABLE()                                         \
  (RCC_C1->APB1LENR) &= ~(RCC_APB1LENR_CECEN)
#define __HAL_RCC_C1_DAC12_CLK_DISABLE()                                       \
  (RCC_C1->APB1LENR) &= ~(RCC_APB1LENR_DAC12EN)
#define __HAL_RCC_C1_UART7_CLK_DISABLE()                                       \
  (RCC_C1->APB1LENR) &= ~(RCC_APB1LENR_UART7EN)
#define __HAL_RCC_C1_UART8_CLK_DISABLE()                                       \
  (RCC_C1->APB1LENR) &= ~(RCC_APB1LENR_UART8EN)
#define __HAL_RCC_C1_CRS_CLK_DISABLE()                                         \
  (RCC_C1->APB1HENR) &= ~(RCC_APB1HENR_CRSEN)
#define __HAL_RCC_C1_SWPMI_CLK_DISABLE()                                       \
  (RCC_C1->APB1HENR) &= ~(RCC_APB1HENR_SWPMIEN)
#define __HAL_RCC_C1_OPAMP_CLK_DISABLE()                                       \
  (RCC_C1->APB1HENR) &= ~(RCC_APB1HENR_OPAMPEN)
#define __HAL_RCC_C1_MDIOS_CLK_DISABLE()                                       \
  (RCC_C1->APB1HENR) &= ~(RCC_APB1HENR_MDIOSEN)
#define __HAL_RCC_C1_FDCAN_CLK_DISABLE()                                       \
  (RCC_C1->APB1HENR) &= ~(RCC_APB1HENR_FDCANEN)
...
#define __HAL_RCC_C1_TIM1_CLK_DISABLE()                                        \
  (RCC_C1->APB2ENR) &= ~(RCC_APB2ENR_TIM1EN)
#define __HAL_RCC_C1_TIM8_CLK_DISABLE()                                        \
  (RCC_C1->APB2ENR) &= ~(RCC_APB2ENR_TIM8EN)
#define __HAL_RCC_C1_USART1_CLK_DISABLE()                                      \
  (RCC_C1->APB2ENR) &= ~(RCC_APB2ENR_USART1EN)
#define __HAL_RCC_C1_USART6_CLK_DISABLE()                                      \
  (RCC_C1->APB2ENR) &= ~(RCC_APB2ENR_USART6EN)
#define __HAL_RCC_C1_SPI1_CLK_DISABLE()                                        \
  (RCC_C1->APB2ENR) &= ~(RCC_APB2ENR_SPI1EN)
#define __HAL_RCC_C1_SPI4_CLK_DISABLE()                                        \
  (RCC_C1->APB2ENR) &= ~(RCC_APB2ENR_SPI4EN)
#define __HAL_RCC_C1_TIM15_CLK_DISABLE()                                       \
  (RCC_C1->APB2ENR) &= ~(RCC_APB2ENR_TIM15EN)
#define __HAL_RCC_C1_TIM16_CLK_DISABLE()                                       \
  (RCC_C1->APB2ENR) &= ~(RCC_APB2ENR_TIM16EN)
#define __HAL_RCC_C1_TIM17_CLK_DISABLE()                                       \
  (RCC_C1->APB2ENR) &= ~(RCC_APB2ENR_TIM17EN)
#define __HAL_RCC_C1_SPI5_CLK_DISABLE()                                        \
  (RCC_C1->APB2ENR) &= ~(RCC_APB2ENR_SPI5EN)
#define __HAL_RCC_C1_SAI1_CLK_DISABLE()                                        \
  (RCC_C1->APB2ENR) &= ~(RCC_APB2ENR_SAI1EN)
#define __HAL_RCC_C1_SAI2_CLK_DISABLE()                                        \
  (RCC_C1->APB2ENR) &= ~(RCC_APB2ENR_SAI2EN)
#define __HAL_RCC_C1_SAI3_CLK_DISABLE()                                        \
  (RCC_C1->APB2ENR) &= ~(RCC_APB2ENR_SAI3EN)
#define __HAL_RCC_C1_DFSDM1_CLK_DISABLE()                                      \
  (RCC_C1->APB2ENR) &= ~(RCC_APB2ENR_DFSDM1EN)
#define __HAL_RCC_C1_HRTIM1_CLK_DISABLE()                                      \
  (RCC_C1->APB2ENR) &= ~(RCC_APB2ENR_HRTIMEN)
...
#define __HAL_RCC_C1_SYSCFG_CLK_DISABLE()                                      \
  (RCC_C1->APB4ENR) &= ~(RCC_APB4ENR_SYSCFGEN)
#define __HAL_RCC_C1_LPUART1_CLK_DISABLE()                                     \
  (RCC_C1->APB4ENR) &= ~(RCC_APB4ENR_LPUART1EN)
#define __HAL_RCC_C1_SPI6_CLK_DISABLE()                                        \
  (RCC_C1->APB4ENR) &= ~(RCC_APB4ENR_SPI6EN)
#define __HAL_RCC_C1_I2C4_CLK_DISABLE()                                        \
  (RCC_C1->APB4ENR) &= ~(RCC_APB4ENR_I2C4EN)
#define __HAL_RCC_C1_LPTIM2_CLK_DISABLE()                                      \
  (RCC_C1->APB4ENR) &= ~(RCC_APB4ENR_LPTIM2EN)
#define __HAL_RCC_C1_LPTIM3_CLK_DISABLE()                                      \
  (RCC_C1->APB4ENR) &= ~(RCC_APB4ENR_LPTIM3EN)
#define __HAL_RCC_C1_LPTIM4_CLK_DISABLE()                                      \
  (RCC_C1->APB4ENR) &= ~(RCC_APB4ENR_LPTIM4EN)
#define __HAL_RCC_C1_LPTIM5_CLK_DISABLE()                                      \
  (RCC_C1->APB4ENR) &= ~(RCC_APB4ENR_LPTIM5EN)
#define __HAL_RCC_C1_COMP12_CLK_DISABLE()                                      \
  (RCC_C1->APB4ENR) &= ~(RCC_APB4ENR_COMP12EN)
#define __HAL_RCC_C1_VREF_CLK_DISABLE()                                        \
  (RCC_C1->APB4ENR) &= ~(RCC_APB4ENR_VREFEN)
#define __HAL_RCC_C1_RTC_CLK_DISABLE()                                         \
  (RCC_C1->APB4ENR) &= ~(RCC_APB4ENR_RTCAPBEN)
#define __HAL_RCC_C1_SAI4_CLK_DISABLE()                                        \
...
#define __HAL_RCC_C2_MDMA_CLK_DISABLE()                                        \
  (RCC_C2->AHB3ENR &= ~(RCC_AHB3ENR_MDMAEN))
#define __HAL_RCC_C2_DMA2D_CLK_DISABLE()                                       \
  (RCC_C2->AHB3ENR &= ~(RCC_AHB3ENR_DMA2DEN))
#define __HAL_RCC_C2_JPGDECEN_CLK_DISABLE()                                    \
  (RCC_C2->AHB3ENR &= ~(RCC_AHB3ENR_JPGDECEN))
#define __HAL_RCC_C2_FMC_CLK_DISABLE() (RCC_C2->AHB3ENR &= ~(RCC_AHB3ENR_FMCEN))
#define __HAL_RCC_C2_QSPI_CLK_DISABLE()                                        \
  (RCC_C2->AHB3ENR &= ~(RCC_AHB3ENR_QSPIEN))
#define __HAL_RCC_C2_SDMMC1_CLK_DISABLE()                                      \
  (RCC_C2->AHB3ENR &= ~(RCC_AHB3ENR_SDMMC1EN))
#define __HAL_RCC_FLASH_C2_DEALLOCATE()                                        \
  (RCC_C2->AHB3ENR &= ~(RCC_AHB3ENR_FLASHEN))
#define __HAL_RCC_DTCM1_C2_DEALLOCATE()                                        \
  (RCC_C2->AHB3ENR &= ~(RCC_AHB3ENR_DTCM1EN))
#define __HAL_RCC_DTCM2_C2_DEALLOCATE()                                        \
  (RCC_C2->AHB3ENR &= ~(RCC_AHB3ENR_DTCM2EN))
#define __HAL_RCC_ITCM_C2_DEALLOCATE()                                         \
  (RCC_C2->AHB3ENR &= ~(RCC_AHB3ENR_ITCMEN))
#define __HAL_RCC_D1SRAM1_C2_DEALLOCATE()                                      \
  (RCC_C2->AHB3ENR &= ~(RCC_AHB3ENR_AXISRAMEN))
...
#define __HAL_RCC_C2_DMA1_CLK_DISABLE()                                        \
  (RCC_C2->AHB1ENR &= ~(RCC_AHB1ENR_DMA1EN))
#define __HAL_RCC_C2_DMA2_CLK_DISABLE()                                        \
  (RCC_C2->AHB1ENR &= ~(RCC_AHB1ENR_DMA2EN))
#define __HAL_RCC_C2_ADC12_CLK_DISABLE()                                       \
  (RCC_C2->AHB1ENR &= ~(RCC_AHB1ENR_ADC12EN))
#define __HAL_RCC_C2_ART_CLK_DISABLE() (RCC_C2->AHB1ENR &= ~(RCC_AHB1ENR_ARTEN))
#define __HAL_RCC_C2_ETH1MAC_CLK_DISABLE()                                     \
  (RCC_C2->AHB1ENR &= ~(RCC_AHB1ENR_ETH1MACEN))
#define __HAL_RCC_C2_ETH1TX_CLK_DISABLE()                                      \
  (RCC_C2->AHB1ENR &= ~(RCC_AHB1ENR_ETH1TXEN))
#define __HAL_RCC_C2_ETH1RX_CLK_DISABLE()                                      \
  (RCC_C2->AHB1ENR &= ~(RCC_AHB1ENR_ETH1RXEN))
#define __HAL_RCC_C2_USB1_OTG_HS_CLK_DISABLE()                                 \
  (RCC_C2->AHB1ENR &= ~(RCC_AHB1ENR_USB1OTGHSEN))
#define __HAL_RCC_C2_USB1_OTG_HS_ULPI_CLK_DISABLE()                            \
  (RCC_C2->AHB1ENR &= ~(RCC_AHB1ENR_USB1OTGHSULPIEN))
#define __HAL_RCC_C2_USB2_OTG_FS_CLK_DISABLE()                                 \
  (RCC_C2->AHB1ENR &= ~(RCC_AHB1ENR_USB2OTGHSEN))
#define __HAL_RCC_C2_USB2_OTG_FS_ULPI_CLK_DISABLE()                            \
  (RCC_C2->AHB1ENR &= ~(RCC_AHB1ENR_USB2OTGHSULPIEN))
...
#define __HAL_RCC_C2_DCMI_CLK_DISABLE()                                        \
  (RCC_C2->AHB2ENR &= ~(RCC_AHB2ENR_DCMIEN))
#if defined(CRYP)
#define __HAL_RCC_C2_CRYP_CLK_DISABLE()                                        \
  (RCC_C2->AHB2ENR &= ~(RCC_AHB2ENR_CRYPEN))
#endif /* CRYP */
#if defined(HASH)
#define __HAL_RCC_C2_HASH_CLK_DISABLE()                                        \
  (RCC_C2->AHB2ENR &= ~(RCC_AHB2ENR_HASHEN))
#endif /* HASH */
#define __HAL_RCC_C2_RNG_CLK_DISABLE() (RCC_C2->AHB2ENR &= ~(RCC_AHB2ENR_RNGEN))
#define __HAL_RCC_C2_SDMMC2_CLK_DISABLE()                                      \
  (RCC_C2->AHB2ENR &= ~(RCC_AHB2ENR_SDMMC2EN))
#define __HAL_RCC_C2_D2SRAM1_CLK_DISABLE()                                     \
  (RCC_C2->AHB2ENR &= ~(RCC_AHB2ENR_D2SRAM1EN))
#define __HAL_RCC_C2_D2SRAM2_CLK_DISABLE()                                     \
  (RCC_C2->AHB2ENR &= ~(RCC_AHB2ENR_D2SRAM2EN))
#define __HAL_RCC_C2_D2SRAM3_CLK_DISABLE()                                     \
  (RCC_C2->AHB2ENR &= ~(RCC_AHB2ENR_D2SRAM3EN))
...
#define __HAL_RCC_C2_GPIOA_CLK_DISABLE()                                       \
  (RCC_C2->AHB4ENR) &= ~(RCC_AHB4ENR_GPIOAEN)
#define __HAL_RCC_C2_GPIOB_CLK_DISABLE()                                       \
  (RCC_C2->AHB4ENR) &= ~(RCC_AHB4ENR_GPIOBEN)
#define __HAL_RCC_C2_GPIOC_CLK_DISABLE()                                       \
  (RCC_C2->AHB4ENR) &= ~(RCC_AHB4ENR_GPIOCEN)
#define __HAL_RCC_C2_GPIOD_CLK_DISABLE()                                       \
  (RCC_C2->AHB4ENR) &= ~(RCC_AHB4ENR_GPIODEN)
#define __HAL_RCC_C2_GPIOE_CLK_DISABLE()                                       \
  (RCC_C2->AHB4ENR) &= ~(RCC_AHB4ENR_GPIOEEN)
#define __HAL_RCC_C2_GPIOF_CLK_DISABLE()                                       \
  (RCC_C2->AHB4ENR) &= ~(RCC_AHB4ENR_GPIOFEN)
#define __HAL_RCC_C2_GPIOG_CLK_DISABLE()                                       \
  (RCC_C2->AHB4ENR) &= ~(RCC_AHB4ENR_GPIOGEN)
#define __HAL_RCC_C2_GPIOH_CLK_DISABLE()                                       \
  (RCC_C2->AHB4ENR) &= ~(RCC_AHB4ENR_GPIOHEN)
#define __HAL_RCC_C2_GPIOI_CLK_DISABLE()                                       \
  (RCC_C2->AHB4ENR) &= ~(RCC_AHB4ENR_GPIOIEN)
#define __HAL_RCC_C2_GPIOJ_CLK_DISABLE()                                       \
  (RCC_C2->AHB4ENR) &= ~(RCC_AHB4ENR_GPIOJEN)
#define __HAL_RCC_C2_GPIOK_CLK_DISABLE()                                       \
  (RCC_C2->AHB4ENR) &= ~(RCC_AHB4ENR_GPIOKEN)
#define __HAL_RCC_C2_CRC_CLK_DISABLE() (RCC_C2->AHB4ENR) &= ~(RCC_AHB4ENR_CRCEN)
#define __HAL_RCC_C2_BDMA_CLK_DISABLE()                                        \
  (RCC_C2->AHB4ENR) &= ~(RCC_AHB4ENR_BDMAEN)
#define __HAL_RCC_C2_ADC3_CLK_DISABLE()                                        \
  (RCC_C2->AHB4ENR) &= ~(RCC_AHB4ENR_ADC3EN)
#define __HAL_RCC_C2_HSEM_CLK_DISABLE()                                        \
  (RCC_C2->AHB4ENR) &= ~(RCC_AHB4ENR_HSEMEN)
#define __HAL_RCC_C2_BKPRAM_CLK_DISABLE()                                      \
  (RCC_C2->AHB4ENR) &= ~(RCC_AHB4ENR_BKPRAMEN)
...
#define __HAL_RCC_C2_LTDC_CLK_DISABLE()                                        \
  (RCC_C2->APB3ENR) &= ~(RCC_APB3ENR_LTDCEN)
#define __HAL_RCC_C2_DSI_CLK_DISABLE() (RCC_C2->APB3ENR) &= ~(RCC_APB3ENR_DSIEN)
#define __HAL_RCC_C2_WWDG1_CLK_DISABLE()                                       \
  (RCC_C2->APB3ENR) &= ~(RCC_APB3ENR_WWDG1EN)
...
#define __HAL_RCC_C2_TIM2_CLK_DISABLE()                                        \
  (RCC_C2->APB1LENR) &= ~(RCC_APB1LENR_TIM2EN)
#define __HAL_RCC_C2_TIM3_CLK_DISABLE()                                        \
  (RCC_C2->APB1LENR) &= ~(RCC_APB1LENR_TIM3EN)
#define __HAL_RCC_C2_TIM4_CLK_DISABLE()                                        \
  (RCC_C2->APB1LENR) &= ~(RCC_APB1LENR_TIM4EN)
#define __HAL_RCC_C2_TIM5_CLK_DISABLE()                                        \
  (RCC_C2->APB1LENR) &= ~(RCC_APB1LENR_TIM5EN)
#define __HAL_RCC_C2_TIM6_CLK_DISABLE()                                        \
  (RCC_C2->APB1LENR) &= ~(RCC_APB1LENR_TIM6EN)
#define __HAL_RCC_C2_TIM7_CLK_DISABLE()                                        \
  (RCC_C2->APB1LENR) &= ~(RCC_APB1LENR_TIM7EN)
#define __HAL_RCC_C2_TIM12_CLK_DISABLE()                                       \
  (RCC_C2->APB1LENR) &= ~(RCC_APB1LENR_TIM12EN)
#define __HAL_RCC_C2_TIM13_CLK_DISABLE()                                       \
  (RCC_C2->APB1LENR) &= ~(RCC_APB1LENR_TIM13EN)
#define __HAL_RCC_C2_TIM14_CLK_DISABLE()                                       \
  (RCC_C2->APB1LENR) &= ~(RCC_APB1LENR_TIM14EN)
#define __HAL_RCC_C2_LPTIM1_CLK_DISABLE()                                      \
  (RCC_C2->APB1LENR) &= ~(RCC_APB1LENR_LPTIM1EN)
#define __HAL_RCC_C2_WWDG2_CLK_DISABLE()                                       \
  (RCC_C2->APB1LENR) &= ~(RCC_APB1LENR_WWDG2EN)
#define __HAL_RCC_C2_SPI2_CLK_DISABLE()                                        \
  (RCC_C2->APB1LENR) &= ~(RCC_APB1LENR_SPI2EN)
#define __HAL_RCC_C2_SPI3_CLK_DISABLE()                                        \
  (RCC_C2->APB1LENR) &= ~(RCC_APB1LENR_SPI3EN)
#define __HAL_RCC_C2_SPDIFRX_CLK_DISABLE()                                     \
  (RCC_C2->APB1LENR) &= ~(RCC_APB1LENR_SPDIFRXEN)
#define __HAL_RCC_C2_USART2_CLK_DISABLE()                                      \
  (RCC_C2->APB1LENR) &= ~(RCC_APB1LENR_USART2EN)
#define __HAL_RCC_C2_USART3_CLK_DISABLE()                                      \
  (RCC_C2->APB1LENR) &= ~(RCC_APB1LENR_USART3EN)
#define __HAL_RCC_C2_UART4_CLK_DISABLE()                                       \
  (RCC_C2->APB1LENR) &= ~(RCC_APB1LENR_UART4EN)
#define __HAL_RCC_C2_UART5_CLK_DISABLE()                                       \
  (RCC_C2->APB1LENR) &= ~(RCC_APB1LENR_UART5EN)
#define __HAL_RCC_C2_I2C1_CLK_DISABLE()                                        \
  (RCC_C2->APB1LENR) &= ~(RCC_APB1LENR_I2C1EN)
#define __HAL_RCC_C2_I2C2_CLK_DISABLE()                                        \
  (RCC_C2->APB1LENR) &= ~(RCC_APB1LENR_I2C2EN)
#define __HAL_RCC_C2_I2C3_CLK_DISABLE()                                        \
  (RCC_C2->APB1LENR) &= ~(RCC_APB1LENR_I2C3EN)
#define __HAL_RCC_C2_CEC_CLK_DISABLE()                                         \
  (RCC_C2->APB1LENR) &= ~(RCC_APB1LENR_CECEN)
#define __HAL_RCC_C2_DAC12_CLK_DISABLE()                                       \
  (RCC_C2->APB1LENR) &= ~(RCC_APB1LENR_DAC12EN)
#define __HAL_RCC_C2_UART7_CLK_DISABLE()                                       \
  (RCC_C2->APB1LENR) &= ~(RCC_APB1LENR_UART7EN)
#define __HAL_RCC_C2_UART8_CLK_DISABLE()                                       \
  (RCC_C2->APB1LENR) &= ~(RCC_APB1LENR_UART8EN)
#define __HAL_RCC_C2_CRS_CLK_DISABLE()                                         \
  (RCC_C2->APB1HENR) &= ~(RCC_APB1HENR_CRSEN)
#define __HAL_RCC_C2_SWPMI_CLK_DISABLE()                                       \
  (RCC_C2->APB1HENR) &= ~(RCC_APB1HENR_SWPMIEN)
#define __HAL_RCC_C2_OPAMP_CLK_DISABLE()                                       \
  (RCC_C2->APB1HENR) &= ~(RCC_APB1HENR_OPAMPEN)
#define __HAL_RCC_C2_MDIOS_CLK_DISABLE()                                       \
  (RCC_C2->APB1HENR) &= ~(RCC_APB1HENR_MDIOSEN)
#define __HAL_RCC_C2_FDCAN_CLK_DISABLE()                                       \
  (RCC_C2->APB1HENR) &= ~(RCC_APB1HENR_FDCANEN)
...
#define __HAL_RCC_C2_TIM1_CLK_DISABLE()                                        \
  (RCC_C2->APB2ENR) &= ~(RCC_APB2ENR_TIM1EN)
#define __HAL_RCC_C2_TIM8_CLK_DISABLE()                                        \
  (RCC_C2->APB2ENR) &= ~(RCC_APB2ENR_TIM8EN)
#define __HAL_RCC_C2_USART1_CLK_DISABLE()                                      \
  (RCC_C2->APB2ENR) &= ~(RCC_APB2ENR_USART1EN)
#define __HAL_RCC_C2_USART6_CLK_DISABLE()                                      \
  (RCC_C2->APB2ENR) &= ~(RCC_APB2ENR_USART6EN)
#define __HAL_RCC_C2_SPI1_CLK_DISABLE()                                        \
  (RCC_C2->APB2ENR) &= ~(RCC_APB2ENR_SPI1EN)
#define __HAL_RCC_C2_SPI4_CLK_DISABLE()                                        \
  (RCC_C2->APB2ENR) &= ~(RCC_APB2ENR_SPI4EN)
#define __HAL_RCC_C2_TIM15_CLK_DISABLE()                                       \
  (RCC_C2->APB2ENR) &= ~(RCC_APB2ENR_TIM15EN)
#define __HAL_RCC_C2_TIM16_CLK_DISABLE()                                       \
  (RCC_C2->APB2ENR) &= ~(RCC_APB2ENR_TIM16EN)
#define __HAL_RCC_C2_TIM17_CLK_DISABLE()                                       \
  (RCC_C2->APB2ENR) &= ~(RCC_APB2ENR_TIM17EN)
#define __HAL_RCC_C2_SPI5_CLK_DISABLE()                                        \
  (RCC_C2->APB2ENR) &= ~(RCC_APB2ENR_SPI5EN)
#define __HAL_RCC_C2_SAI1_CLK_DISABLE()                                        \
  (RCC_C2->APB2ENR) &= ~(RCC_APB2ENR_SAI1EN)
#define __HAL_RCC_C2_SAI2_CLK_DISABLE()                                        \
  (RCC_C2->APB2ENR) &= ~(RCC_APB2ENR_SAI2EN)
#define __HAL_RCC_C2_SAI3_CLK_DISABLE()                                        \
  (RCC_C2->APB2ENR) &= ~(RCC_APB2ENR_SAI3EN)
#define __HAL_RCC_C2_DFSDM1_CLK_DISABLE()                                      \
  (RCC_C2->APB2ENR) &= ~(RCC_APB2ENR_DFSDM1EN)
#define __HAL_RCC_C2_HRTIM1_CLK_DISABLE()                                      \
  (RCC_C2->APB2ENR) &= ~(RCC_APB2ENR_HRTIMEN)
...
#define __HAL_RCC_C2_SYSCFG_CLK_DISABLE()                                      \
  (RCC_C2->APB4ENR) &= ~(RCC_APB4ENR_SYSCFGEN)
#define __HAL_RCC_C2_LPUART1_CLK_DISABLE()                                     \
  (RCC_C2->APB4ENR) &= ~(RCC_APB4ENR_LPUART1EN)
#define __HAL_RCC_C2_SPI6_CLK_DISABLE()                                        \
  (RCC_C2->APB4ENR) &= ~(RCC_APB4ENR_SPI6EN)
#define __HAL_RCC_C2_I2C4_CLK_DISABLE()                                        \
  (RCC_C2->APB4ENR) &= ~(RCC_APB4ENR_I2C4EN)
#define __HAL_RCC_C2_LPTIM2_CLK_DISABLE()                                      \
  (RCC_C2->APB4ENR) &= ~(RCC_APB4ENR_LPTIM2EN)
#define __HAL_RCC_C2_LPTIM3_CLK_DISABLE()                                      \
  (RCC_C2->APB4ENR) &= ~(RCC_APB4ENR_LPTIM3EN)
#define __HAL_RCC_C2_LPTIM4_CLK_DISABLE()                                      \
  (RCC_C2->APB4ENR) &= ~(RCC_APB4ENR_LPTIM4EN)
#define __HAL_RCC_C2_LPTIM5_CLK_DISABLE()                                      \
  (RCC_C2->APB4ENR) &= ~(RCC_APB4ENR_LPTIM5EN)
#define __HAL_RCC_C2_COMP12_CLK_DISABLE()                                      \
  (RCC_C2->APB4ENR) &= ~(RCC_APB4ENR_COMP12EN)
#define __HAL_RCC_C2_VREF_CLK_DISABLE()                                        \
  (RCC_C2->APB4ENR) &= ~(RCC_APB4ENR_VREFEN)
#define __HAL_RCC_C2_RTC_CLK_DISABLE()                                         \
  (RCC_C2->APB4ENR) &= ~(RCC_APB4ENR_RTCAPBEN)
#define __HAL_RCC_C2_SAI4_CLK_DISABLE()                                        \
  (RCC_C2->APB4ENR) &= ~(RCC_APB4ENR_SAI4EN)
...
#define __HAL_RCC_AHB3_FORCE_RESET()                                           \
  (RCC->AHB3RSTR =                                                             \
       0x00015031U) /* Resets MDMA, DMA2D, JPEG, FMC, QSPI and SDMMC1 */
#elif (STM32H7_DEV_ID == 0x480UL)
#define __HAL_RCC_AHB3_FORCE_RESET()                                           \
  (RCC->AHB3RSTR =                                                             \
       0x01E95031U) /* Resets MDMA, DMA2D, JPEG, FMC, OSPI1, SDMMC1, OSPI2,    \
                       IOMNGR, OTFD1, OTFD2 and GFXMMU */
#else
#define __HAL_RCC_AHB3_FORCE_RESET()                                           \
  (RCC->AHB3RSTR = 0x00E95011U) /* Resets MDMA, DMA2D, FMC, OSPI1, SDMMC1,     \
                                   OSPI2, IOMNGR, OTFD1, OTFD2 */
...
#if defined(JPEG)
#define __HAL_RCC_JPGDECRST_FORCE_RESET()                                      \
  (RCC->AHB3RSTR |= (RCC_AHB3RSTR_JPGDECRST))
#endif /* JPEG */
...
#endif /*OCTOSPI2*/
#if defined(OCTOSPIM)
#define __HAL_RCC_IOMNGR_FORCE_RESET()                                         \
  (RCC->AHB3RSTR |= (RCC_AHB3RSTR_IOMNGRRST))
#endif /*OCTOSPIM*/
#if defined(OTFDEC1)
#define __HAL_RCC_OTFDEC1_FORCE_RESET()                                        \
  (RCC->AHB3RSTR |= (RCC_AHB3RSTR_OTFDEC1RST))
#endif /*OTFDEC1*/
#if defined(OTFDEC2)
#define __HAL_RCC_OTFDEC2_FORCE_RESET()                                        \
  (RCC->AHB3RSTR |= (RCC_AHB3RSTR_OTFDEC2RST))
#endif /*OTFDEC2*/
#if defined(GFXMMU)
#define __HAL_RCC_GFXMMU_FORCE_RESET()                                         \
  (RCC->AHB3RSTR |= (RCC_AHB3RSTR_GFXMMURST))
#endif /*GFXMMU*/
...
#if defined(JPEG)
#define __HAL_RCC_JPGDECRST_RELEASE_RESET()                                    \
  (RCC->AHB3RSTR &= ~(RCC_AHB3RSTR_JPGDECRST))
#endif /* JPEG */
...
#endif /*OCTOSPI2*/
#if defined(OCTOSPIM)
#define __HAL_RCC_IOMNGR_RELEASE_RESET()                                       \
  (RCC->AHB3RSTR &= ~(RCC_AHB3RSTR_IOMNGRRST))
#endif /*OCTOSPIM*/
#if defined(OTFDEC1)
...
#endif /*OTFDEC1*/
#if defined(OTFDEC2)
#define __HAL_RCC_OTFDEC2_RELEASE_RESET()                                      \
  (RCC->AHB3RSTR &= ~(RCC_AHB3RSTR_OTFDEC2RST))
#endif /*OTFDEC2*/
#if defined(GFXMMU)
...
#define __HAL_RCC_AHB1_FORCE_RESET()                                           \
  (RCC->AHB1RSTR = 0x0A00C023U) /* Resets DMA1, DMA2, ADC12, ART, ETHMAC,      \
                                   USB1OTG and USB2OTG */
#elif (STM32H7_DEV_ID == 0x480UL)
#define __HAL_RCC_AHB1_FORCE_RESET()                                           \
  (RCC->AHB1RSTR = 0x02000223U) /* Resets DMA1, DMA2, ADC12, CRC and USB1OTG   \
                                 */
#else
#define __HAL_RCC_AHB1_FORCE_RESET()                                           \
  (RCC->AHB1RSTR =                                                             \
       0x02008023U) /* Resets DMA1, DMA2, ADC12, ETHMAC and USB1OTG */
#endif              /* STM32H7_DEV_ID == 0x450UL */
...
#endif /*ETH*/
#define __HAL_RCC_USB1_OTG_HS_FORCE_RESET()                                    \
  (RCC->AHB1RSTR |= (RCC_AHB1RSTR_USB1OTGHSRST))
#if defined(USB2_OTG_FS)
#define __HAL_RCC_USB2_OTG_FS_FORCE_RESET()                                    \
...
#define __HAL_RCC_ETH1MAC_RELEASE_RESET()                                      \
  (RCC->AHB1RSTR &= ~(RCC_AHB1RSTR_ETH1MACRST))
#endif /*ETH*/
#define __HAL_RCC_USB1_OTG_HS_RELEASE_RESET()                                  \
  (RCC->AHB1RSTR &= ~(RCC_AHB1RSTR_USB1OTGHSRST))
#if defined(USB2_OTG_FS)
#define __HAL_RCC_USB2_OTG_FS_RELEASE_RESET()                                  \
  (RCC->AHB1RSTR &= ~(RCC_AHB1RSTR_USB2OTGHSRST))
#endif /*USB2_OTG_FS*/
...
#define __HAL_RCC_AHB2_FORCE_RESET()                                           \
  (RCC->AHB2RSTR = 0x00000271U) /* Resets DCMI, CRYPT, HASH, RNG and SDMMC2 */
#elif (STM32H7_DEV_ID == 0x480UL)
#define __HAL_RCC_AHB2_FORCE_RESET()                                           \
  (RCC->AHB2RSTR = 0x00000A75U) /* Resets DCMI_PSSI, HSEM, CRYPT, HASH, RNG,   \
                                   SDMMC2 and BDMA1 */
#else
#define __HAL_RCC_AHB2_FORCE_RESET()                                           \
  (RCC->AHB2RSTR = 0x00030271U) /* Resets DCMI_PSSI, CRYPT, HASH, RNG, SDMMC2, \
                                   FMAC and CORDIC */
#endif                          /* STM32H7_DEV_ID == 0x450UL */
#if defined(DCMI) && defined(PSSI)
#define __HAL_RCC_DCMI_PSSI_FORCE_RESET()                                      \
  (RCC->AHB2RSTR |= (RCC_AHB2RSTR_DCMI_PSSIRST))
...
#endif /*CORDIC*/
#if defined(RCC_AHB2RSTR_HSEMRST)
#define __HAL_RCC_HSEM_RELEASE_RESET()                                         \
  (RCC->AHB2RSTR &= ~(RCC_AHB2RSTR_HSEMRST))
#endif
#if defined(BDMA1)
#define __HAL_RCC_BDMA1_RELEASE_RESET()                                        \
  (RCC->AHB2RSTR &= ~(RCC_AHB2RSTR_BDMA1RST))
#endif /*BDMA1*/
...
#define __HAL_RCC_AHB4_FORCE_RESET()                                           \
  (RCC->AHB4RSTR =                                                             \
       0x032807FFU) /* Resets GPIOA..GPIOK, CRC, BDMA, ADC3 and HSEM */
#elif (STM32H7_DEV_ID == 0x480UL)
#define __HAL_RCC_AHB4_FORCE_RESET()                                           \
  (RCC->AHB4RSTR = 0x002007FFU) /* Resets GPIOA..GPIOK and BDMA2 */
#else
#define __HAL_RCC_AHB4_FORCE_RESET()                                           \
  (RCC->AHB4RSTR = 0x032806FFU) /* Resets GPIOA..GPIOH, GPIOJ, GPIOK, CRC,     \
                                   BDMA, ADC3 and HSEM */
#endif                          /* STM32H7_DEV_ID == 0x450UL */
...
#define __HAL_RCC_BDMA_FORCE_RESET()                                           \
  __HAL_RCC_BDMA2_FORCE_RESET() /* for API backward compatibility*/
#else
...
#if defined(RCC_AHB4RSTR_HSEMRST)
#define __HAL_RCC_HSEM_RELEASE_RESET()                                         \
  (RCC->AHB4RSTR) &= ~(RCC_AHB4RSTR_HSEMRST)
#endif
...
#define __HAL_RCC_APB3_FORCE_RESET()                                           \
  (RCC->APB3RSTR = 0x00000018U) /* Rests LTDC and DSI */
#else
#define __HAL_RCC_APB3_FORCE_RESET()                                           \
  (RCC->APB3RSTR = 0x00000008U) /* Rests LTDC */
#endif                          /* STM32H7_DEV_ID == 0x450UL */
#if defined(LTDC)
...
#define __HAL_RCC_APB1L_FORCE_RESET()                                          \
  (RCC->APB1LRSTR =                                                            \
       0xE8FFC3FFU) /* Resets TIM2..TIM7, TIM12..TIM14, LPTIM1, SPI2, SPI3,    \
                       SPDIFRX, USART2, USART3, UART4, UART5, I2C1..I2C3, CEC, \
                       DAC1(2), UART7 and UART8 */
#else
#define __HAL_RCC_APB1L_FORCE_RESET()                                          \
  (RCC->APB1LRSTR =                                                            \
       0xEAFFC3FFU) /* Resets TIM2..TIM7, TIM12..TIM14, LPTIM1, SPI2, SPI3,    \
                       SPDIFRX, USART2, USART3, UART4, UART5, I2C1..I2C3,      \
                       I2C5, CEC, DAC12, UART7 and UART8 */
#endif              /* STM32H7_DEV_ID == 0x450UL */
#if (STM32H7_DEV_ID == 0x450UL) || (STM32H7_DEV_ID == 0x480UL)
#define __HAL_RCC_APB1H_FORCE_RESET()                                          \
  (RCC->APB1HRSTR = 0x00000136U) /* Resets CRS, SWP, OPAMP, MDIOS and FDCAN */
#else
#define __HAL_RCC_APB1H_FORCE_RESET()                                          \
  (RCC->APB1HRSTR = 0x03000136U) /* Resets CRS, SWP, OPAMP, MDIOS, FDCAN,      \
                                    TIM23 and TIM24 */
#endif                           /* STM32H7_DEV_ID == 0x450UL */
...
#define __HAL_RCC_DAC12_FORCE_RESET()                                          \
...
#define __HAL_RCC_CEC_RELEASE_RESET()                                          \
  (RCC->APB1LRSTR) &= ~(RCC_APB1LRSTR_CECRST)
#define __HAL_RCC_DAC12_RELEASE_RESET()                                        \
  (RCC->APB1LRSTR) &= ~(RCC_APB1LRSTR_DAC12RST)
...
#define __HAL_RCC_OPAMP_RELEASE_RESET()                                        \
  (RCC->APB1HRSTR) &= ~(RCC_APB1HRSTR_OPAMPRST)
#define __HAL_RCC_MDIOS_RELEASE_RESET()                                        \
  (RCC->APB1HRSTR) &= ~(RCC_APB1HRSTR_MDIOSRST)
#define __HAL_RCC_FDCAN_RELEASE_RESET()                                        \
  (RCC->APB1HRSTR) &= ~(RCC_APB1HRSTR_FDCANRST)
#if defined(TIM23)
#define __HAL_RCC_TIM23_RELEASE_RESET()                                        \
  (RCC->APB1HRSTR) &= ~(RCC_APB1HRSTR_TIM23RST)
#endif /* TIM23 */
#if defined(TIM24)
#define __HAL_RCC_TIM24_RELEASE_RESET()                                        \
  (RCC->APB1HRSTR) &= ~(RCC_APB1HRSTR_TIM24RST)
#endif /* TIM24 */
...
#define __HAL_RCC_APB2_FORCE_RESET()                                           \
  (RCC->APB2RSTR =                                                             \
       0x31D73033U) /* Resets TIM1, TIM8, USART1, USART6, SPI1, SPI4,          \
                       TIM15..TIM17, SPI5, SAI1..SAI3, DFSDM1 and HRTIM */
#elif (STM32H7_DEV_ID == 0x480UL)
#define __HAL_RCC_APB2_FORCE_RESET()                                           \
  (RCC->APB2RSTR = 0x40D730F3U) /* Resets TIM1, TIM8, USART1, USART6, UART9,   \
                                   USART10, SPI1, SPI4, TIM15..TIM17, SPI5,    \
                                   SAI1, SAI2 and DFSDM1 */
#else
#define __HAL_RCC_APB2_FORCE_RESET()                                           \
  (RCC->APB2RSTR =                                                             \
       0x405730F3U) /* Resets TIM1, TIM8, USART1, USART6, UART9, USART10,      \
                       SPI1, SPI4, TIM15..TIM17, SPI5, SAI1 and DFSDM1 */
#endif              /* STM32H7_DEV_ID == 0x450UL */
...
#define __HAL_RCC_HRTIM1_FORCE_RESET()                                         \
  (RCC->APB2RSTR) |= (RCC_APB2RSTR_HRTIMRST)
#endif /*HRTIM1*/
...
#endif /* SAI2 */
#if defined(SAI3)
#define __HAL_RCC_SAI3_RELEASE_RESET()                                         \
  (RCC->APB2RSTR) &= ~(RCC_APB2RSTR_SAI3RST)
#endif /*SAI3*/
...
#define __HAL_RCC_APB4_FORCE_RESET()                                           \
  (RCC->APB4RSTR = 0x0020DEAAU) /* Resets SYSCFG, LPUART1, SPI6, I2C4,         \
                                   LPTIM2..LPTIM5, COMP12, VREF and SAI4 */
#elif (STM32H7_DEV_ID == 0x480UL)
#define __HAL_RCC_APB4_FORCE_RESET()                                           \
  (RCC->APB4RSTR =                                                             \
       0x0C00E6AAU) /* Resets SYSCFG, LPUART1, SPI6, I2C4, LPTIM2, LPTIM3,     \
                       DAC2, COMP12, VREF, DTS and DFSDM2 */
#else
#define __HAL_RCC_APB4_FORCE_RESET()                                           \
  (RCC->APB4RSTR =                                                             \
       0x0420DEAAU) /* Resets SYSCFG, LPUART1, SPI6, I2C4, LPTIM2..LPTIM5,     \
                       COMP12, VREF, SAI4 and DTS */
#endif              /* STM32H7_DEV_ID == 0x450UL */
#define __HAL_RCC_SYSCFG_FORCE_RESET()                                         \
  (RCC->APB4RSTR) |= (RCC_APB4RSTR_SYSCFGRST)
...
#endif /*DAC2*/
#define __HAL_RCC_COMP12_FORCE_RESET()                                         \
...
#define __HAL_RCC_DFSDM2_FORCE_RESET()                                         \
  (RCC->APB4RSTR) |= (RCC_APB4RSTR_DFSDM2RST)
#endif /*DFSDM2*/
...
#define __HAL_RCC_DAC2_RELEASE_RESET()                                         \
  (RCC->APB4RSTR) &= ~(RCC_APB4RSTR_DAC2RST)
#endif
#define __HAL_RCC_COMP12_RELEASE_RESET()                                       \
  (RCC->APB4RSTR) &= ~(RCC_APB4RSTR_COMP12RST)
#define __HAL_RCC_VREF_RELEASE_RESET()                                         \
  (RCC->APB4RSTR) &= ~(RCC_APB4RSTR_VREFRST)
#if defined(SAI4)
#define __HAL_RCC_SAI4_RELEASE_RESET()                                         \
...
#define __HAL_RCC_MDMA_CLK_SLEEP_ENABLE()                                      \
  (RCC->AHB3LPENR |= (RCC_AHB3LPENR_MDMALPEN))
#define __HAL_RCC_DMA2D_CLK_SLEEP_ENABLE()                                     \
  (RCC->AHB3LPENR |= (RCC_AHB3LPENR_DMA2DLPEN))
#if defined(JPEG)
#define __HAL_RCC_JPGDEC_CLK_SLEEP_ENABLE()                                    \
  (RCC->AHB3LPENR |= (RCC_AHB3LPENR_JPGDECLPEN))
#endif /* JPEG */
#define __HAL_RCC_FLASH_CLK_SLEEP_ENABLE()                                     \
  (RCC->AHB3LPENR |= (RCC_AHB3LPENR_FLASHLPEN))
...
#define __HAL_RCC_SDMMC1_CLK_SLEEP_ENABLE()                                    \
  (RCC->AHB3LPENR |= (RCC_AHB3LPENR_SDMMC1LPEN))
#if defined(OCTOSPI1)
#define __HAL_RCC_OSPI1_CLK_SLEEP_ENABLE()                                     \
  (RCC->AHB3LPENR |= (RCC_AHB3LPENR_OSPI1LPEN))
#endif /*OCTOSPI1*/
#if defined(OCTOSPI2)
#define __HAL_RCC_OSPI2_CLK_SLEEP_ENABLE()                                     \
  (RCC->AHB3LPENR |= (RCC_AHB3LPENR_OSPI2LPEN))
#endif /*OCTOSPI2*/
#if defined(OCTOSPIM)
#define __HAL_RCC_IOMNGR_CLK_SLEEP_ENABLE()                                    \
  (RCC->AHB3LPENR |= (RCC_AHB3LPENR_IOMNGRLPEN))
#endif /*OCTOSPIM*/
#if defined(OTFDEC1)
#define __HAL_RCC_OTFDEC1_CLK_SLEEP_ENABLE()                                   \
  (RCC->AHB3LPENR |= (RCC_AHB3LPENR_OTFDEC1LPEN))
#endif /*OTFDEC1*/
#if defined(OTFDEC2)
#define __HAL_RCC_OTFDEC2_CLK_SLEEP_ENABLE()                                   \
  (RCC->AHB3LPENR |= (RCC_AHB3LPENR_OTFDEC2LPEN))
#endif /*OTFDEC2*/
#if defined(GFXMMU)
#define __HAL_RCC_GFXMMU_CLK_SLEEP_ENABLE()                                    \
  (RCC->AHB3LPENR |= (RCC_AHB3LPENR_GFXMMULPEN))
#endif /*GFXMMU*/
#if defined(CD_AXISRAM2_BASE)
#define __HAL_RCC_AXISRAM2_CLK_SLEEP_ENABLE()                                  \
  (RCC->AHB3LPENR |= (RCC_AHB3LPENR_AXISRAM2LPEN))
#endif
#if defined(CD_AXISRAM3_BASE)
#define __HAL_RCC_AXISRAM3_CLK_SLEEP_ENABLE()                                  \
  (RCC->AHB3LPENR |= (RCC_AHB3LPENR_AXISRAM3LPEN))
#endif
#define __HAL_RCC_DTCM1_CLK_SLEEP_ENABLE()                                     \
  (RCC->AHB3LPENR |= (RCC_AHB3LPENR_DTCM1LPEN))
#define __HAL_RCC_DTCM2_CLK_SLEEP_ENABLE()                                     \
  (RCC->AHB3LPENR |= (RCC_AHB3LPENR_DTCM2LPEN))
#define __HAL_RCC_ITCM_CLK_SLEEP_ENABLE()                                      \
  (RCC->AHB3LPENR |= (RCC_AHB3LPENR_ITCMLPEN))
#if defined(RCC_AHB3LPENR_AXISRAMLPEN)
#define __HAL_RCC_D1SRAM1_CLK_SLEEP_ENABLE()                                   \
  (RCC->AHB3LPENR |= (RCC_AHB3LPENR_AXISRAMLPEN))
#define __HAL_RCC_AXISRAM_CLK_SLEEP_ENABLE __HAL_RCC_D1SRAM1_CLK_SLEEP_ENABLE
#else
#define __HAL_RCC_AXISRAM1_CLK_SLEEP_ENABLE()                                  \
  (RCC->AHB3LPENR |= (RCC_AHB3LPENR_AXISRAM1LPEN))
#define __HAL_RCC_D1SRAM1_CLK_SLEEP_ENABLE                                     \
  __HAL_RCC_AXISRAM1_CLK_SLEEP_ENABLE /* For backward compatibility */
...
#define __HAL_RCC_DMA2D_CLK_SLEEP_DISABLE()                                    \
  (RCC->AHB3LPENR &= ~(RCC_AHB3LPENR_DMA2DLPEN))
#if defined(JPEG)
#define __HAL_RCC_JPGDEC_CLK_SLEEP_DISABLE()                                   \
  (RCC->AHB3LPENR &= ~(RCC_AHB3LPENR_JPGDECLPEN))
#endif /* JPEG */
...
#endif /*OCTOSPI2*/
#if defined(OCTOSPIM)
#define __HAL_RCC_IOMNGR_CLK_SLEEP_DISABLE()                                   \
  (RCC->AHB3LPENR &= ~(RCC_AHB3LPENR_IOMNGRLPEN))
#endif /*OCTOSPIM*/
#if defined(OTFDEC1)
...
#endif /*OTFDEC1*/
#if defined(OTFDEC2)
#define __HAL_RCC_OTFDEC2_CLK_SLEEP_DISABLE()                                  \
  (RCC->AHB3LPENR &= ~(RCC_AHB3LPENR_OTFDEC2LPEN))
#endif /*OTFDEC2*/
#if defined(GFXMMU)
...
#endif /*GFXMMU*/
#if defined(CD_AXISRAM2_BASE)
#define __HAL_RCC_AXISRAM2_CLK_SLEEP_DISABLE()                                 \
  (RCC->AHB3LPENR &= ~(RCC_AHB3LPENR_AXISRAM2LPEN))
#endif
#if defined(CD_AXISRAM3_BASE)
#define __HAL_RCC_AXISRAM3_CLK_SLEEP_DISABLE()                                 \
  (RCC->AHB3LPENR &= ~(RCC_AHB3LPENR_AXISRAM3LPEN))
#endif
#define __HAL_RCC_DTCM1_CLK_SLEEP_DISABLE()                                    \
  (RCC->AHB3LPENR &= ~(RCC_AHB3LPENR_DTCM1LPEN))
#define __HAL_RCC_DTCM2_CLK_SLEEP_DISABLE()                                    \
  (RCC->AHB3LPENR &= ~(RCC_AHB3LPENR_DTCM2LPEN))
#define __HAL_RCC_ITCM_CLK_SLEEP_DISABLE()                                     \
  (RCC->AHB3LPENR &= ~(RCC_AHB3LPENR_ITCMLPEN))
#if defined(RCC_AHB3LPENR_AXISRAMLPEN)
#define __HAL_RCC_D1SRAM1_CLK_SLEEP_DISABLE()                                  \
  (RCC->AHB3LPENR &= ~(RCC_AHB3LPENR_AXISRAMLPEN))
#define __HAL_RCC_AXISRAM_CLK_SLEEP_DISABLE __HAL_RCC_D1SRAM1_CLK_SLEEP_DISABLE
#else
#define __HAL_RCC_AXISRAM1_CLK_SLEEP_DISABLE()                                 \
  (RCC->AHB3LPENR &= ~(RCC_AHB3LPENR_AXISRAM1LPEN))
#define __HAL_RCC_D1SRAM1_CLK_SLEEP_DISABLE                                    \
  __HAL_RCC_AXISRAM1_CLK_SLEEP_DISABLE /* For backward compatibility */
#endif                                 /* RCC_AHB3LPENR_AXISRAMLPEN */

/** @brief  Get the enable or disable status of the AHB3 peripheral clock during
 * Low Poser (Sleep) mode.
 * @note   Peripheral clock gating in SLEEP mode can be used to further reduce
 *         power consumption.
 * @note   After wakeup from SLEEP mode, the peripheral clock is enabled again.
 * @note   By default, all peripheral clocks are enabled during SLEEP mode.
...
#define __HAL_RCC_MDMA_IS_CLK_SLEEP_ENABLED()                                  \
  ((RCC->AHB3LPENR & RCC_AHB3LPENR_MDMALPEN) != 0U)
#define __HAL_RCC_DMA2D_IS_CLK_SLEEP_ENABLED()                                 \
  ((RCC->AHB3LPENR & RCC_AHB3LPENR_DMA2DLPEN) != 0U)
#if defined(JPEG)
#define __HAL_RCC_JPGDEC_IS_CLK_SLEEP_ENABLED()                                \
  ((RCC->AHB3LPENR & RCC_AHB3LPENR_JPGDECLPEN) != 0U)
#endif /* JPEG */
#define __HAL_RCC_FLASH_IS_CLK_SLEEP_ENABLED()                                 \
  ((RCC->AHB3LPENR & RCC_AHB3LPENR_FLASHLPEN) != 0U)
#define __HAL_RCC_FMC_IS_CLK_SLEEP_ENABLED()                                   \
  ((RCC->AHB3LPENR & RCC_AHB3LPENR_FMCLPEN) != 0U)
#if defined(QUADSPI)
#define __HAL_RCC_QSPI_IS_CLK_SLEEP_ENABLED()                                  \
  ((RCC->AHB3LPENR & RCC_AHB3LPENR_QSPILPEN) != 0U)
#endif /*QUADSPI*/
#define __HAL_RCC_SDMMC1_IS_CLK_SLEEP_ENABLED()                                \
  ((RCC->AHB3LPENR & RCC_AHB3LPENR_SDMMC1LPEN) != 0U)
#if defined(OCTOSPI1)
#define __HAL_RCC_OSPI1_IS_CLK_SLEEP_ENABLED()                                 \
  ((RCC->AHB3LPENR & RCC_AHB3LPENR_OSPI1LPEN) != 0U)
#endif /*OCTOSPI1*/
#if defined(OCTOSPI2)
#define __HAL_RCC_OSPI2_IS_CLK_SLEEP_ENABLED()                                 \
  ((RCC->AHB3LPENR & RCC_AHB3LPENR_OSPI2LPEN) != 0U)
#endif /*OCTOSPI2*/
#if defined(OCTOSPIM)
#define __HAL_RCC_IOMNGR_IS_CLK_SLEEP_ENABLED()                                \
  ((RCC->AHB3LPENR & RCC_AHB3LPENR_IOMNGRLPEN) != 0U)
#endif /*OCTOSPIM*/
#if defined(OTFDEC1)
#define __HAL_RCC_OTFDEC1_IS_CLK_SLEEP_ENABLED()                               \
  ((RCC->AHB3LPENR & RCC_AHB3LPENR_OTFDEC1LPEN) != 0U)
#endif /*OTFDEC1*/
#if defined(OTFDEC2)
#define __HAL_RCC_OTFDEC2_IS_CLK_SLEEP_ENABLED()                               \
  ((RCC->AHB3LPENR & RCC_AHB3LPENR_OTFDEC2LPEN) != 0U)
#endif /*OTFDEC2*/
#if defined(GFXMMU)
#define __HAL_RCC_GFXMMU_IS_CLK_SLEEP_ENABLED()                                \
  ((RCC->AHB3LPENR & RCC_AHB3LPENR_GFXMMULPEN) != 0U)
#endif /*GFXMMU*/
#if defined(CD_AXISRAM2_BASE)
#define __HAL_RCC_AXISRAM2_IS_CLK_SLEEP_ENABLED()                              \
  ((RCC->AHB3LPENR & RCC_AHB3LPENR_AXISRAM2LPEN) != 0U)
#endif
#if defined(CD_AXISRAM3_BASE)
#define __HAL_RCC_AXISRAM3_IS_CLK_SLEEP_ENABLED()                              \
  ((RCC->AHB3LPENR & RCC_AHB3LPENR_AXISRAM3LPEN) != 0U)
#endif
#define __HAL_RCC_DTCM1_IS_CLK_SLEEP_ENABLED()                                 \
  ((RCC->AHB3LPENR & RCC_AHB3LPENR_DTCM1LPEN) != 0U)
#define __HAL_RCC_DTCM2_IS_CLK_SLEEP_ENABLED()                                 \
  ((RCC->AHB3LPENR & RCC_AHB3LPENR_DTCM2LPEN) != 0U)
#define __HAL_RCC_ITCM_IS_CLK_SLEEP_ENABLED()                                  \
  ((RCC->AHB3LPENR & RCC_AHB3LPENR_ITCMLPEN) != 0U)
#if defined(RCC_AHB3LPENR_AXISRAMLPEN)
#define __HAL_RCC_D1SRAM1_IS_CLK_SLEEP_ENABLED()                               \
  ((RCC->AHB3LPENR & RCC_AHB3LPENR_AXISRAMLPEN) != 0U)
#else
#define __HAL_RCC_AXISRAM1_IS_CLK_SLEEP_ENABLED()                              \
  ((RCC->AHB3LPENR & RCC_AHB3LPENR_AXISRAM1LPEN) != 0U)
#endif

#define __HAL_RCC_MDMA_IS_CLK_SLEEP_DISABLED()                                 \
  ((RCC->AHB3LPENR & RCC_AHB3LPENR_MDMALPEN) == 0U)
#define __HAL_RCC_DMA2D_IS_CLK_SLEEP_DISABLED()                                \
  ((RCC->AHB3LPENR & RCC_AHB3LPENR_DMA2DLPEN) == 0U)
#if defined(JPEG)
#define __HAL_RCC_JPGDEC_IS_CLK_SLEEP_DISABLED()                               \
  ((RCC->AHB3LPENR & RCC_AHB3LPENR_JPGDECLPEN) == 0U)
#endif /* JPEG */
...
#endif /*OCTOSPI2*/
#if defined(OCTOSPIM)
#define __HAL_RCC_IOMNGR_IS_CLK_SLEEP_DISABLED()                               \
  ((RCC->AHB3LPENR & RCC_AHB3LPENR_IOMNGRLPEN) == 0U)
#endif /*OCTOSPIM*/
#if defined(OTFDEC1)
#define __HAL_RCC_OTFDEC1_IS_CLK_SLEEP_DISABLED()                              \
  ((RCC->AHB3LPENR & RCC_AHB3LPENR_OTFDEC1LPEN) == 0U)
#endif /*OTFDEC1*/
#if defined(OTFDEC2)
#define __HAL_RCC_OTFDEC2_IS_CLK_SLEEP_DISABLED()                              \
  ((RCC->AHB3LPENR & RCC_AHB3LPENR_OTFDEC2LPEN) == 0U)
#endif /*OTFDEC2*/
#if defined(GFXMMU)
...
#endif /*GFXMMU*/
#if defined(CD_AXISRAM2_BASE)
#define __HAL_RCC_AXISRAM2_IS_CLK_SLEEP_DISABLED()                             \
  ((RCC->AHB3LPENR & RCC_AHB3LPENR_AXISRAM2LPEN) == 0U)
#endif
#if defined(CD_AXISRAM3_BASE)
#define __HAL_RCC_AXISRAM3_IS_CLK_SLEEP_DISABLED()                             \
  ((RCC->AHB3LPENR & RCC_AHB3LPENR_AXISRAM3LPEN) == 0U)
#endif
#define __HAL_RCC_DTCM1_IS_CLK_SLEEP_DISABLED()                                \
  ((RCC->AHB3LPENR & RCC_AHB3LPENR_DTCM1LPEN) == 0U)
#define __HAL_RCC_DTCM2_IS_CLK_SLEEP_DISABLED()                                \
  ((RCC->AHB3LPENR & RCC_AHB3LPENR_DTCM2LPEN) == 0U)
#define __HAL_RCC_ITCM_IS_CLK_SLEEP_DISABLED()                                 \
  ((RCC->AHB3LPENR & RCC_AHB3LPENR_ITCMLPEN) == 0U)
#if defined(RCC_AHB3LPENR_AXISRAMLPEN)
#define __HAL_RCC_D1SRAM1_IS_CLK_SLEEP_DISABLED()                              \
  ((RCC->AHB3LPENR & RCC_AHB3LPENR_AXISRAMLPEN) == 0U)
#else
#define __HAL_RCC_AXISRAM1_IS_CLK_SLEEP_DISABLED()                             \
  ((RCC->AHB3LPENR & RCC_AHB3LPENR_AXISRAML1PEN) == 0U)
#endif /* RCC_AHB3LPENR_AXISRAMLPEN */
...
#define __HAL_RCC_ADC12_CLK_SLEEP_ENABLE()                                     \
  (RCC->AHB1LPENR |= (RCC_AHB1LPENR_ADC12LPEN))
...
#define __HAL_RCC_ETH1MAC_CLK_SLEEP_ENABLE()                                   \
  (RCC->AHB1LPENR |= (RCC_AHB1LPENR_ETH1MACLPEN))
#endif /*ETH*/
#if defined(DUAL_CORE)
#define __HAL_RCC_ART_CLK_SLEEP_ENABLE()                                       \
  (RCC->AHB1LPENR |= (RCC_AHB1LPENR_ARTLPEN))
#endif /*DUAL_CORE*/
#if defined(ETH)
#define __HAL_RCC_ETH1TX_CLK_SLEEP_ENABLE()                                    \
  (RCC->AHB1LPENR |= (RCC_AHB1LPENR_ETH1TXLPEN))
#define __HAL_RCC_ETH1RX_CLK_SLEEP_ENABLE()                                    \
  (RCC->AHB1LPENR |= (RCC_AHB1LPENR_ETH1RXLPEN))
#endif /*ETH*/
#define __HAL_RCC_USB1_OTG_HS_CLK_SLEEP_ENABLE()                               \
  (RCC->AHB1LPENR |= (RCC_AHB1LPENR_USB1OTGHSLPEN))
#define __HAL_RCC_USB1_OTG_HS_ULPI_CLK_SLEEP_ENABLE()                          \
  (RCC->AHB1LPENR |= (RCC_AHB1LPENR_USB1OTGHSULPILPEN))
#if defined(USB2_OTG_FS)
#define __HAL_RCC_USB2_OTG_FS_CLK_SLEEP_ENABLE()                               \
...
#endif /*ETH*/
#if defined(DUAL_CORE)
#define __HAL_RCC_ART_CLK_SLEEP_DISABLE()                                      \
  (RCC->AHB1LPENR &= ~(RCC_AHB1LPENR_ARTLPEN))
#endif /*DUAL_CORE*/
#if defined(ETH)
...
#define __HAL_RCC_ETH1RX_CLK_SLEEP_DISABLE()                                   \
  (RCC->AHB1LPENR &= ~(RCC_AHB1LPENR_ETH1RXLPEN))
#endif /*ETH*/
#define __HAL_RCC_USB1_OTG_HS_CLK_SLEEP_DISABLE()                              \
  (RCC->AHB1LPENR &= ~(RCC_AHB1LPENR_USB1OTGHSLPEN))
#define __HAL_RCC_USB1_OTG_HS_ULPI_CLK_SLEEP_DISABLE()                         \
  (RCC->AHB1LPENR &= ~(RCC_AHB1LPENR_USB1OTGHSULPILPEN))
#if defined(USB2_OTG_FS)
#define __HAL_RCC_USB2_OTG_FS_CLK_SLEEP_DISABLE()                              \
  (RCC->AHB1LPENR &= ~(RCC_AHB1LPENR_USB2OTGHSLPEN))
#define __HAL_RCC_USB2_OTG_FS_ULPI_CLK_SLEEP_DISABLE()                         \
  (RCC->AHB1LPENR &= ~(RCC_AHB1LPENR_USB2OTGHSULPILPEN))
#endif /* USB2_OTG_FS */

/** @brief  Get the enable or disable status of the AHB1 peripheral clock during
 * Low Poser (Sleep) mode.
 * @note   Peripheral clock gating in SLEEP mode can be used to further reduce
 *         power consumption.
 * @note   After wakeup from SLEEP mode, the peripheral clock is enabled again.
...
#define __HAL_RCC_DMA1_IS_CLK_SLEEP_ENABLED()                                  \
  ((RCC->AHB1LPENR & (RCC_AHB1LPENR_DMA1LPEN)) != 0U)
#define __HAL_RCC_DMA2_IS_CLK_SLEEP_ENABLED()                                  \
  ((RCC->AHB1LPENR & (RCC_AHB1LPENR_DMA2LPEN)) != 0U)
#define __HAL_RCC_ADC12_IS_CLK_SLEEP_ENABLED()                                 \
  ((RCC->AHB1LPENR & (RCC_AHB1LPENR_ADC12LPEN)) != 0U)
#if defined(RCC_AHB1LPENR_CRCLPEN)
#define __HAL_RCC_CRC_IS_CLK_SLEEP_ENABLED()                                   \
  ((RCC->AHB1LPENR & (RCC_AHB1LPENR_CRCLPEN)) != 0U)
#endif
#if defined(ETH)
#define __HAL_RCC_ETH1MAC_IS_CLK_SLEEP_ENABLED()                               \
  ((RCC->AHB1LPENR & (RCC_AHB1LPENR_ETH1MACLPEN)) != 0U)
#endif /*ETH*/
#if defined(DUAL_CORE)
#define __HAL_RCC_ART_IS_CLK_SLEEP_ENABLED()                                   \
  ((RCC->AHB1LPENR & (RCC_AHB1LPENR_ARTLPEN)) != 0U)
#endif /*DUAL_CORE*/
#if defined(ETH)
#define __HAL_RCC_ETH1TX_IS_CLK_SLEEP_ENABLED()                                \
  ((RCC->AHB1LPENR & (RCC_AHB1LPENR_ETH1TXLPEN)) != 0U)
#define __HAL_RCC_ETH1RX_IS_CLK_SLEEP_ENABLED()                                \
  ((RCC->AHB1LPENR & (RCC_AHB1LPENR_ETH1RXLPEN)) != 0U)
#endif /*ETH*/
#define __HAL_RCC_USB1_OTG_HS_IS_CLK_SLEEP_ENABLED()                           \
  ((RCC->AHB1LPENR & (RCC_AHB1LPENR_USB1OTGHSLPEN)) != 0U)
#define __HAL_RCC_USB1_OTG_HS_ULPI_IS_CLK_SLEEP_ENABLED()                      \
  ((RCC->AHB1LPENR & (RCC_AHB1LPENR_USB1OTGHSULPILPEN)) != 0U)
#if defined(USB2_OTG_FS)
#define __HAL_RCC_USB2_OTG_FS_IS_CLK_SLEEP_ENABLED()                           \
  ((RCC->AHB1LPENR & (RCC_AHB1LPENR_USB2OTGHSLPEN)) != 0U)
#define __HAL_RCC_USB2_OTG_FS_ULPI_IS_CLK_SLEEP_ENABLED()                      \
  ((RCC->AHB1LPENR & (RCC_AHB1LPENR_USB2OTGHSULPILPEN)) != 0U)
#endif /* USB2_OTG_FS */
...
#endif
#if defined(ETH)
#define __HAL_RCC_ETH1MAC_IS_CLK_SLEEP_DISABLED()                              \
  ((RCC->AHB1LPENR & (RCC_AHB1LPENR_ETH1MACLPEN)) == 0U)
#endif /* ETH */
#if defined(DUAL_CORE)
#define __HAL_RCC_ART_IS_CLK_SLEEP_DISABLED()                                  \
  ((RCC->AHB1LPENR & (RCC_AHB1LPENR_ARTLPEN)) == 0U)
#endif /*DUAL_CORE*/
#if defined(ETH)
#define __HAL_RCC_ETH1TX_IS_CLK_SLEEP_DISABLED()                               \
  ((RCC->AHB1LPENR & (RCC_AHB1LPENR_ETH1TXLPEN)) == 0U)
#define __HAL_RCC_ETH1RX_IS_CLK_SLEEP_DISABLED()                               \
  ((RCC->AHB1LPENR & (RCC_AHB1LPENR_ETH1RXLPEN)) == 0U)
#endif /* ETH */
#define __HAL_RCC_USB1_OTG_HS_IS_CLK_SLEEP_DISABLED()                          \
  ((RCC->AHB1LPENR & (RCC_AHB1LPENR_USB1OTGHSLPEN)) == 0U)
#define __HAL_RCC_USB1_OTG_HS_ULPI_IS_CLK_SLEEP_DISABLED()                     \
  ((RCC->AHB1LPENR & (RCC_AHB1LPENR_USB1OTGHSULPILPEN)) == 0U)
#if defined(USB2_OTG_FS)
#define __HAL_RCC_USB2_OTG_FS_IS_CLK_SLEEP_DISABLED()                          \
  ((RCC->AHB1LPENR & (RCC_AHB1LPENR_USB2OTGHSLPEN)) == 0U)
#define __HAL_RCC_USB2_OTG_FS_ULPI_IS_CLK_SLEEP_DISABLED()                     \
  ((RCC->AHB1LPENR & (RCC_AHB1LPENR_USB2OTGHSULPILPEN)) == 0U)
#endif /* USB2_OTG_FS */
...
#define __HAL_RCC_DCMI_PSSI_CLK_SLEEP_ENABLE()                                 \
  (RCC->AHB2LPENR |= (RCC_AHB2LPENR_DCMI_PSSILPEN))
...
#define __HAL_RCC_SDMMC2_CLK_SLEEP_ENABLE()                                    \
  (RCC->AHB2LPENR |= (RCC_AHB2LPENR_SDMMC2LPEN))
#if defined(RCC_AHB2LPENR_DFSDMDMALPEN)
#define __HAL_RCC_DFSDMDMA_CLK_SLEEP_ENABLE()                                  \
  (RCC->AHB2LPENR |= (RCC_AHB2LPENR_DFSDMDMALPEN))
#endif
#if defined(FMAC)
#define __HAL_RCC_FMAC_CLK_SLEEP_ENABLE()                                      \
  (RCC->AHB2LPENR |= (RCC_AHB2LPENR_FMACLPEN))
#endif /* FMAC */
#if defined(CORDIC)
...
#define __HAL_RCC_D2SRAM1_CLK_SLEEP_ENABLE()                                   \
  (RCC->AHB2LPENR |= (RCC_AHB2LPENR_D2SRAM1LPEN))
#else
#define __HAL_RCC_AHBSRAM1_CLK_SLEEP_ENABLE()                                  \
  (RCC->AHB2LPENR |= (RCC_AHB2LPENR_AHBSRAM1LPEN))
#endif /* RCC_AHB2LPENR_D2SRAM1LPEN */
#if defined(RCC_AHB2LPENR_D2SRAM2LPEN)
#define __HAL_RCC_D2SRAM2_CLK_SLEEP_ENABLE()                                   \
  (RCC->AHB2LPENR |= (RCC_AHB2LPENR_D2SRAM2LPEN))
#else
#define __HAL_RCC_AHBSRAM2_CLK_SLEEP_ENABLE()                                  \
  (RCC->AHB2LPENR |= (RCC_AHB2LPENR_AHBSRAM2LPEN))
#endif /* RCC_AHB2LPENR_D2SRAM2LPEN */
#if defined(RCC_AHB2LPENR_D2SRAM3LPEN)
#define __HAL_RCC_D2SRAM3_CLK_SLEEP_ENABLE()                                   \
  (RCC->AHB2LPENR |= (RCC_AHB2LPENR_D2SRAM3LPEN))
#endif
...
#define __HAL_RCC_SDMMC2_CLK_SLEEP_DISABLE()                                   \
  (RCC->AHB2LPENR &= ~(RCC_AHB2LPENR_SDMMC2LPEN))
#if defined(RCC_AHB2LPENR_DFSDMDMALPEN)
#define __HAL_RCC_DFSDMDMA_CLK_SLEEP_DISABLE()                                 \
  (RCC->AHB2LPENR &= ~(RCC_AHB2LPENR_DFSDMDMALPEN))
#endif
#if defined(FMAC)
...
#endif /* CORDIC */
#if defined(RCC_AHB2LPENR_D2SRAM1LPEN)
#define __HAL_RCC_D2SRAM1_CLK_SLEEP_DISABLE()                                  \
  (RCC->AHB2LPENR &= ~(RCC_AHB2LPENR_D2SRAM1LPEN))
#else
#define __HAL_RCC_AHBSRAM1_CLK_SLEEP_DISABLE()                                 \
  (RCC->AHB2LPENR &= ~(RCC_AHB2LPENR_AHBSRAM1LPEN))
#endif /* RCC_AHB2LPENR_D2SRAM1LPEN */
#if defined(RCC_AHB2LPENR_D2SRAM2LPEN)
#define __HAL_RCC_D2SRAM2_CLK_SLEEP_DISABLE()                                  \
  (RCC->AHB2LPENR &= ~(RCC_AHB2LPENR_D2SRAM2LPEN))
#else
#define __HAL_RCC_AHBSRAM2_CLK_SLEEP_DISABLE()                                 \
  (RCC->AHB2LPENR &= ~(RCC_AHB2LPENR_AHBSRAM2LPEN))
#endif /* RCC_AHB2LPENR_D2SRAM2LPEN */
#if defined(RCC_AHB2LPENR_D2SRAM3LPEN)
#define __HAL_RCC_D2SRAM3_CLK_SLEEP_DISABLE()                                  \
  (RCC->AHB2LPENR &= ~(RCC_AHB2LPENR_D2SRAM3LPEN))
#endif

/** @brief  Get the enable or disable status of the AHB2 peripheral clock during
 * Low Poser (Sleep) mode.
 * @note   Peripheral clock gating in SLEEP mode can be used to further reduce
 *         power consumption.
 * @note   After wakeup from SLEEP mode, the peripheral clock is enabled again.
...
#if defined(DCMI) && defined(PSSI)
#define __HAL_RCC_DCMI_PSSI_IS_CLK_SLEEP_ENABLED()                             \
  ((RCC->AHB2LPENR & (RCC_AHB2LPENR_DCMI_PSSILPEN)) != 0U)
#define __HAL_RCC_DCMI_IS_CLK_SLEEP_ENABLED()                                  \
  __HAL_RCC_DCMI_PSSI_IS_CLK_SLEEP_ENABLED() /* for API backward               \
                                                compatibility*/
#else
#define __HAL_RCC_DCMI_IS_CLK_SLEEP_ENABLED()                                  \
  ((RCC->AHB2LPENR & (RCC_AHB2LPENR_DCMILPEN)) != 0U)
#endif /* DCMI && PSSI */
#if defined(CRYP)
#define __HAL_RCC_CRYP_IS_CLK_SLEEP_ENABLED()                                  \
  ((RCC->AHB2LPENR & (RCC_AHB2LPENR_CRYPLPEN)) != 0U)
#endif /* CRYP */
#if defined(HASH)
#define __HAL_RCC_HASH_IS_CLK_SLEEP_ENABLED()                                  \
  ((RCC->AHB2LPENR & (RCC_AHB2LPENR_HASHLPEN)) != 0U)
#endif /* HASH */
#define __HAL_RCC_RNG_IS_CLK_SLEEP_ENABLED()                                   \
  ((RCC->AHB2LPENR & (RCC_AHB2LPENR_RNGLPEN)) != 0U)
#define __HAL_RCC_SDMMC2_IS_CLK_SLEEP_ENABLED()                                \
  ((RCC->AHB2LPENR & (RCC_AHB2LPENR_SDMMC2LPEN)) != 0U)
#if defined(RCC_AHB2LPENR_DFSDMDMALPEN)
#define __HAL_RCC_DFSDMDMA_IS_CLK_SLEEP_ENABLED()                              \
  ((RCC->AHB2LPENR & (RCC_AHB2LPENR_DFSDMDMALPEN)) != 0U)
#endif
#if defined(FMAC)
#define __HAL_RCC_FMAC_IS_CLK_SLEEP_ENABLED()                                  \
  ((RCC->AHB2LPENR & (RCC_AHB2LPENR_FMACLPEN)) != 0U)
#endif /* FMAC */
#if defined(CORDIC)
#define __HAL_RCC_CORDIC_IS_CLK_SLEEP_ENABLED()                                \
  ((RCC->AHB2LPENR & (RCC_AHB2LPENR_CORDICLPEN)) != 0U)
#endif /* CORDIC */
#if defined(RCC_AHB2LPENR_D2SRAM1LPEN)
#define __HAL_RCC_D2SRAM1_IS_CLK_SLEEP_ENABLED()                               \
  ((RCC->AHB2LPENR & (RCC_AHB2LPENR_D2SRAM1LPEN)) != 0U)
#else
#define __HAL_RCC_AHBSRAM1_IS_CLK_SLEEP_ENABLED()                              \
  ((RCC->AHB2LPENR & (RCC_AHB2LPENR_AHBSRAM1LPEN)) != 0U)
#endif /* RCC_AHB2LPENR_D2SRAM1LPEN */
#if defined(RCC_AHB2LPENR_D2SRAM2LPEN)
#define __HAL_RCC_D2SRAM2_IS_CLK_SLEEP_ENABLED()                               \
  ((RCC->AHB2LPENR & (RCC_AHB2LPENR_D2SRAM2LPEN)) != 0U)
#else
#define __HAL_RCC_AHBSRAM2_IS_CLK_SLEEP_ENABLED()                              \
  ((RCC->AHB2LPENR & (RCC_AHB2LPENR_AHBSRAM2LPEN)) != 0U)
#endif /* RCC_AHB2LPENR_D2SRAM2LPEN */
#if defined(RCC_AHB2LPENR_D2SRAM3LPEN)
#define __HAL_RCC_D2SRAM3_IS_CLK_SLEEP_ENABLED()                               \
  ((RCC->AHB2LPENR & (RCC_AHB2LPENR_D2SRAM3LPEN)) != 0U)
#endif /* RCC_AHB2LPENR_D2SRAM3LPEN */

#if defined(DCMI) && defined(PSSI)
#define __HAL_RCC_DCMI_PSSI_IS_CLK_SLEEP_DISABLED()                            \
  ((RCC->AHB2LPENR & (RCC_AHB2LPENR_DCMI_PSSILPEN)) == 0U)
#define __HAL_RCC_DCMI_IS_CLK_SLEEP_DISABLED()                                 \
  __HAL_RCC_DCMI_PSSI_IS_CLK_SLEEP_DISABLED() /* for API backward              \
                                                 compatibility*/
#else
#define __HAL_RCC_DCMI_IS_CLK_SLEEP_DISABLED()                                 \
  ((RCC->AHB2LPENR & (RCC_AHB2LPENR_DCMILPEN)) == 0U)
...
#define __HAL_RCC_RNG_IS_CLK_SLEEP_DISABLED()                                  \
  ((RCC->AHB2LPENR & (RCC_AHB2LPENR_RNGLPEN)) == 0U)
#if defined(RCC_AHB2LPENR_DFSDMDMALPEN)
#define __HAL_RCC_DFSDMDMA_IS_CLK_SLEEP_DISABLED()                             \
  ((RCC->AHB2LPENR & (RCC_AHB2LPENR_DFSDMDMALPEN)) == 0U)
#endif
...
#endif /* CORDIC */
#if defined(RCC_AHB2LPENR_D2SRAM1LPEN)
#define __HAL_RCC_D2SRAM1_IS_CLK_SLEEP_DISABLED()                              \
  ((RCC->AHB2LPENR & (RCC_AHB2LPENR_D2SRAM1LPEN)) == 0U)
#else
#define __HAL_RCC_AHBSRAM1_IS_CLK_SLEEP_DISABLED()                             \
  ((RCC->AHB2LPENR & (RCC_AHB2LPENR_AHBSRAM1LPEN)) == 0U)
#endif /* RCC_AHB2LPENR_D2SRAM1LPEN */
#if defined(RCC_AHB2LPENR_D2SRAM2LPEN)
#define __HAL_RCC_D2SRAM2_IS_CLK_SLEEP_DISABLED()                              \
  ((RCC->AHB2LPENR & (RCC_AHB2LPENR_D2SRAM2LPEN)) == 0U)
#else
#define __HAL_RCC_AHBSRAM2_IS_CLK_SLEEP_DISABLED()                             \
  ((RCC->AHB2LPENR & (RCC_AHB2LPENR_AHBSRAM2LPEN)) == 0U)
#endif /* RCC_AHB2LPENR_D2SRAM2LPEN */
#if defined(RCC_AHB2LPENR_D2SRAM3LPEN)
#define __HAL_RCC_D2SRAM3_IS_CLK_SLEEP_DISABLED()                              \
  ((RCC->AHB2LPENR & (RCC_AHB2LPENR_D2SRAM3LPEN)) == 0U)
#endif /* RCC_AHB2LPENR_D2SRAM1LPEN*/
...
#define __HAL_RCC_GPIOB_CLK_SLEEP_ENABLE()                                     \
  (RCC->AHB4LPENR) |= (RCC_AHB4LPENR_GPIOBLPEN)
#define __HAL_RCC_GPIOC_CLK_SLEEP_ENABLE()                                     \
  (RCC->AHB4LPENR) |= (RCC_AHB4LPENR_GPIOCLPEN)
#define __HAL_RCC_GPIOD_CLK_SLEEP_ENABLE()                                     \
  (RCC->AHB4LPENR) |= (RCC_AHB4LPENR_GPIODLPEN)
#define __HAL_RCC_GPIOE_CLK_SLEEP_ENABLE()                                     \
  (RCC->AHB4LPENR) |= (RCC_AHB4LPENR_GPIOELPEN)
#define __HAL_RCC_GPIOF_CLK_SLEEP_ENABLE()                                     \
  (RCC->AHB4LPENR) |= (RCC_AHB4LPENR_GPIOFLPEN)
#define __HAL_RCC_GPIOG_CLK_SLEEP_ENABLE()                                     \
  (RCC->AHB4LPENR) |= (RCC_AHB4LPENR_GPIOGLPEN)
#define __HAL_RCC_GPIOH_CLK_SLEEP_ENABLE()                                     \
  (RCC->AHB4LPENR) |= (RCC_AHB4LPENR_GPIOHLPEN)
#if defined(GPIOI)
#define __HAL_RCC_GPIOI_CLK_SLEEP_ENABLE()                                     \
  (RCC->AHB4LPENR) |= (RCC_AHB4LPENR_GPIOILPEN)
#endif /* GPIOI */
#define __HAL_RCC_GPIOJ_CLK_SLEEP_ENABLE()                                     \
  (RCC->AHB4LPENR) |= (RCC_AHB4LPENR_GPIOJLPEN)
#define __HAL_RCC_GPIOK_CLK_SLEEP_ENABLE()                                     \
  (RCC->AHB4LPENR) |= (RCC_AHB4LPENR_GPIOKLPEN)
#if defined(RCC_AHB4LPENR_CRCLPEN)
#define __HAL_RCC_CRC_CLK_SLEEP_ENABLE()                                       \
  (RCC->AHB4LPENR) |= (RCC_AHB4LPENR_CRCLPEN)
#endif
#if defined(BDMA2)
#define __HAL_RCC_BDMA2_CLK_SLEEP_ENABLE()                                     \
  (RCC->AHB4LPENR) |= (RCC_AHB4LPENR_BDMA2LPEN)
#define __HAL_RCC_BDMA_CLK_SLEEP_ENABLE                                        \
  __HAL_RCC_BDMA2_CLK_SLEEP_ENABLE /* for API backward compatibility*/
#else
#define __HAL_RCC_BDMA_CLK_SLEEP_ENABLE()                                      \
...
#define __HAL_RCC_ADC3_CLK_SLEEP_ENABLE()                                      \
  (RCC->AHB4LPENR) |= (RCC_AHB4LPENR_ADC3LPEN)
#endif /* ADC3 */
#define __HAL_RCC_BKPRAM_CLK_SLEEP_ENABLE()                                    \
  (RCC->AHB4LPENR) |= (RCC_AHB4LPENR_BKPRAMLPEN)
#if defined(RCC_AHB4LPENR_SRDSRAMLPEN)
#define __HAL_RCC_SRDSRAM_CLK_SLEEP_ENABLE()                                   \
  (RCC->AHB4LPENR |= (RCC_AHB4LPENR_SRDSRAMLPEN))
#define __HAL_RCC_D3SRAM1_CLK_SLEEP_ENABLE                                     \
  __HAL_RCC_SRDSRAM_CLK_SLEEP_ENABLE /* for API backward compatibility*/
#else
#define __HAL_RCC_D3SRAM1_CLK_SLEEP_ENABLE()                                   \
  (RCC->AHB4LPENR |= (RCC_AHB4LPENR_D3SRAM1LPEN))
...
#endif
#if defined(BDMA2)
#define __HAL_RCC_BDMA2_CLK_SLEEP_DISABLE()                                    \
  (RCC->AHB4LPENR) &= ~(RCC_AHB4LPENR_BDMA2LPEN)
#define __HAL_RCC_BDMA_CLK_SLEEP_DISABLE                                       \
  __HAL_RCC_BDMA2_CLK_SLEEP_DISABLE /* For API backward compatibility*/
#else
#define __HAL_RCC_BDMA_CLK_SLEEP_DISABLE()                                     \
  (RCC->AHB4LPENR) &= ~(RCC_AHB4LPENR_BDMALPEN)
#endif /*BDMA2*/
...
#define __HAL_RCC_BKPRAM_CLK_SLEEP_DISABLE()                                   \
  (RCC->AHB4LPENR) &= ~(RCC_AHB4LPENR_BKPRAMLPEN)
#if defined(RCC_AHB4LPENR_SRDSRAMLPEN)
#define __HAL_RCC_SRDSRAM_CLK_SLEEP_DISABLE()                                  \
  (RCC->AHB4LPENR &= ~(RCC_AHB4LPENR_SRDSRAMLPEN))
#define __HAL_RCC_D3SRAM1_CLK_SLEEP_DISABLE __HAL_RCC_SRDSRAM_CLK_SLEEP_DISABLE
#else
#define __HAL_RCC_D3SRAM1_CLK_SLEEP_DISABLE()                                  \
  (RCC->AHB4LPENR &= ~(RCC_AHB4LPENR_D3SRAM1LPEN))
#endif

/** @brief  Get the enable or disable status of the AHB4 peripheral clock during
 * Low Poser (Sleep) mode.
 * @note   Peripheral clock gating in SLEEP mode can be used to further reduce
 *         power consumption.
 * @note   After wakeup from SLEEP mode, the peripheral clock is enabled again.
...
#define __HAL_RCC_GPIOA_IS_CLK_SLEEP_ENABLED()                                 \
  ((RCC->AHB4LPENR & (RCC_AHB4LPENR_GPIOALPEN)) != 0U)
#define __HAL_RCC_GPIOB_IS_CLK_SLEEP_ENABLED()                                 \
  ((RCC->AHB4LPENR & (RCC_AHB4LPENR_GPIOBLPEN)) != 0U)
#define __HAL_RCC_GPIOC_IS_CLK_SLEEP_ENABLED()                                 \
  ((RCC->AHB4LPENR & (RCC_AHB4LPENR_GPIOCLPEN)) != 0U)
#define __HAL_RCC_GPIOD_IS_CLK_SLEEP_ENABLED()                                 \
  ((RCC->AHB4LPENR & (RCC_AHB4LPENR_GPIODLPEN)) != 0U)
#define __HAL_RCC_GPIOE_IS_CLK_SLEEP_ENABLED()                                 \
  ((RCC->AHB4LPENR & (RCC_AHB4LPENR_GPIOELPEN)) != 0U)
#define __HAL_RCC_GPIOF_IS_CLK_SLEEP_ENABLED()                                 \
  ((RCC->AHB4LPENR & (RCC_AHB4LPENR_GPIOFLPEN)) != 0U)
#define __HAL_RCC_GPIOG_IS_CLK_SLEEP_ENABLED()                                 \
  ((RCC->AHB4LPENR & (RCC_AHB4LPENR_GPIOGLPEN)) != 0U)
#define __HAL_RCC_GPIOH_IS_CLK_SLEEP_ENABLED()                                 \
  ((RCC->AHB4LPENR & (RCC_AHB4LPENR_GPIOHLPEN)) != 0U)
#if defined(GPIOI)
#define __HAL_RCC_GPIOI_IS_CLK_SLEEP_ENABLED()                                 \
  ((RCC->AHB4LPENR & (RCC_AHB4LPENR_GPIOILPEN)) != 0U)
#endif /* GPIOI */
#define __HAL_RCC_GPIOJ_IS_CLK_SLEEP_ENABLED()                                 \
  ((RCC->AHB4LPENR & (RCC_AHB4LPENR_GPIOJLPEN)) != 0U)
#define __HAL_RCC_GPIOK_IS_CLK_SLEEP_ENABLED()                                 \
  ((RCC->AHB4LPENR & (RCC_AHB4LPENR_GPIOKLPEN)) != 0U)
#if defined(RCC_AHB4LPENR_CRCLPEN)
#define __HAL_RCC_CRC_IS_CLK_SLEEP_ENABLED()                                   \
  ((RCC->AHB4LPENR & (RCC_AHB4LPENR_CRCLPEN)) != 0U)
#endif
#if defined(BDMA2)
#define __HAL_RCC_BDMA2_IS_CLK_SLEEP_ENABLED()                                 \
  ((RCC->AHB4LPENR & (RCC_AHB4LPENR_BDMA2LPEN)) != 0U)
#define __HAL_RCC_BDMA_IS_CLK_SLEEP_ENABLED                                    \
  __HAL_RCC_BDMA2_IS_CLK_SLEEP_ENABLED /* For API backward compatibility*/
#else
#define __HAL_RCC_BDMA_IS_CLK_SLEEP_ENABLED()                                  \
  ((RCC->AHB4LPENR & (RCC_AHB4LPENR_BDMALPEN)) != 0U)
#endif /*BDMA2*/
#if defined(ADC3)
#define __HAL_RCC_ADC3_IS_CLK_SLEEP_ENABLED()                                  \
  ((RCC->AHB4LPENR & (RCC_AHB4LPENR_ADC3LPEN)) != 0U)
#endif /*ADC3*/
#define __HAL_RCC_BKPRAM_IS_CLK_SLEEP_ENABLED()                                \
  ((RCC->AHB4LPENR & (RCC_AHB4LPENR_BKPRAMLPEN)) != 0U)
#if defined(RCC_AHB4LPENR_SRDSRAMLPEN)
#define __HAL_RCC_SRDSRAM_IS_CLK_SLEEP_ENABLED()                               \
  ((RCC->AHB4LPENR & (RCC_AHB4LPENR_SRDSRAMLPEN)) != 0U)
#define __HAL_RCC_D3SRAM1_IS_CLK_SLEEP_ENABLED                                 \
  __HAL_RCC_SRDSRAM_IS_CLK_SLEEP_ENABLED /* For API backward compatibility*/
#else
#define __HAL_RCC_D3SRAM1_IS_CLK_SLEEP_ENABLED()                               \
  ((RCC->AHB4LPENR & (RCC_AHB4LPENR_D3SRAM1LPEN)) != 0U)
#endif
...
#endif
#if defined(BDMA2)
#define __HAL_RCC_BDMA2_IS_CLK_SLEEP_DISABLED()                                \
  ((RCC->AHB4LPENR & (RCC_AHB4LPENR_BDMA2LPEN)) == 0U)
#define __HAL_RCC_BDMA_IS_CLK_SLEEP_DISABLED                                   \
  __HAL_RCC_BDMA2_IS_CLK_SLEEP_DISABLED /* For API backward compatibility*/
#else
#define __HAL_RCC_BDMA_IS_CLK_SLEEP_DISABLED()                                 \
  ((RCC->AHB4LPENR & (RCC_AHB4LPENR_BDMALPEN)) == 0U)
#endif /*BDMA2*/
...
#define __HAL_RCC_ADC3_IS_CLK_SLEEP_DISABLED()                                 \
  ((RCC->AHB4LPENR & (RCC_AHB4LPENR_ADC3LPEN)) == 0U)
#endif /*ADC3*/
#define __HAL_RCC_BKPRAM_IS_CLK_SLEEP_DISABLED()                               \
  ((RCC->AHB4LPENR & (RCC_AHB4LPENR_BKPRAMLPEN)) == 0U)
#if defined(RCC_AHB4LPENR_SRDSRAMLPEN)
#define __HAL_RCC_SRDSRAM_IS_CLK_SLEEP_DISABLED()                              \
  ((RCC->AHB4LPENR & (RCC_AHB4LPENR_SRDSRAMLPEN)) == 0U)
#define __HAL_RCC_D3SRAM1_IS_CLK_SLEEP_DISABLED                                \
  __HAL_RCC_SRDSRAM_IS_CLK_SLEEP_DISABLED /* For API backward compatibility*/
#else
#define __HAL_RCC_D3SRAM1_IS_CLK_SLEEP_DISABLED()                              \
  ((RCC->AHB4LPENR & (RCC_AHB4LPENR_D3SRAM1LPEN)) == 0U)
#endif
...
#define __HAL_RCC_DSI_CLK_SLEEP_ENABLE()                                       \
  (RCC->APB3LPENR) |= (RCC_APB3LPENR_DSILPEN)
#endif /*DSI*/
#define __HAL_RCC_WWDG1_CLK_SLEEP_ENABLE()                                     \
  (RCC->APB3LPENR) |= (RCC_APB3LPENR_WWDG1LPEN)
...
/** @brief  Get the enable or disable status of the APB3 peripheral clock during
 * Low Poser (Sleep) mode.
 * @note   Peripheral clock gating in SLEEP mode can be used to further reduce
 *         power consumption.
 * @note   After wakeup from SLEEP mode, the peripheral clock is enabled again.
...
#define __HAL_RCC_LTDC_IS_CLK_SLEEP_ENABLED()                                  \
  ((RCC->APB3LPENR & (RCC_APB3LPENR_LTDCLPEN)) != 0U)
#endif /* LTDC */
#if defined(DSI)
#define __HAL_RCC_DSI_IS_CLK_SLEEP_ENABLED()                                   \
  ((RCC->APB3LPENR & (RCC_APB3LPENR_DSILPEN)) != 0U)
#endif /*DSI*/
#define __HAL_RCC_WWDG1_IS_CLK_SLEEP_ENABLED()                                 \
  ((RCC->APB3LPENR & (RCC_APB3LPENR_WWDG1LPEN)) != 0U)
...
#define __HAL_RCC_DSI_IS_CLK_SLEEP_DISABLED()                                  \
  ((RCC->APB3LPENR & (RCC_APB3LPENR_DSILPEN)) == 0U)
#endif /*DSI*/
#define __HAL_RCC_WWDG1_IS_CLK_SLEEP_DISABLED()                                \
  ((RCC->APB3LPENR & (RCC_APB3LPENR_WWDG1LPEN)) == 0U)
...
#define __HAL_RCC_TIM3_CLK_SLEEP_ENABLE()                                      \
  (RCC->APB1LLPENR) |= (RCC_APB1LLPENR_TIM3LPEN)
#define __HAL_RCC_TIM4_CLK_SLEEP_ENABLE()                                      \
  (RCC->APB1LLPENR) |= (RCC_APB1LLPENR_TIM4LPEN)
#define __HAL_RCC_TIM5_CLK_SLEEP_ENABLE()                                      \
  (RCC->APB1LLPENR) |= (RCC_APB1LLPENR_TIM5LPEN)
#define __HAL_RCC_TIM6_CLK_SLEEP_ENABLE()                                      \
  (RCC->APB1LLPENR) |= (RCC_APB1LLPENR_TIM6LPEN)
...
#define __HAL_RCC_TIM13_CLK_SLEEP_ENABLE()                                     \
  (RCC->APB1LLPENR) |= (RCC_APB1LLPENR_TIM13LPEN)
#define __HAL_RCC_TIM14_CLK_SLEEP_ENABLE()                                     \
  (RCC->APB1LLPENR) |= (RCC_APB1LLPENR_TIM14LPEN)
#define __HAL_RCC_LPTIM1_CLK_SLEEP_ENABLE()                                    \
  (RCC->APB1LLPENR) |= (RCC_APB1LLPENR_LPTIM1LPEN)

#if defined(DUAL_CORE)
#define __HAL_RCC_WWDG2_CLK_SLEEP_ENABLE()                                     \
  (RCC->APB1LLPENR) |= (RCC_APB1LLPENR_WWDG2LPEN)
#endif /*DUAL_CORE*/

#define __HAL_RCC_SPI2_CLK_SLEEP_ENABLE()                                      \
  (RCC->APB1LLPENR) |= (RCC_APB1LLPENR_SPI2LPEN)
#define __HAL_RCC_SPI3_CLK_SLEEP_ENABLE()                                      \
  (RCC->APB1LLPENR) |= (RCC_APB1LLPENR_SPI3LPEN)
...
#define __HAL_RCC_FDCAN_CLK_SLEEP_DISABLE()                                    \
  (RCC->APB1HLPENR) &= ~(RCC_APB1HLPENR_FDCANLPEN)
#if defined(TIM23)
#define __HAL_RCC_TIM23_CLK_SLEEP_DISABLE()                                    \
  (RCC->APB1HLPENR) &= ~(RCC_APB1HLPENR_TIM23LPEN)
#endif /* TIM23 */
#if defined(TIM24)
#define __HAL_RCC_TIM24_CLK_SLEEP_DISABLE()                                    \
  (RCC->APB1HLPENR) &= ~(RCC_APB1HLPENR_TIM24LPEN)
#endif /* TIM24 */

/** @brief  Get the enable or disable status of the APB1 peripheral clock during
 * Low Poser (Sleep) mode.
 * @note   Peripheral clock gating in SLEEP mode can be used to further reduce
 *         power consumption.
 * @note   After wakeup from SLEEP mode, the peripheral clock is enabled again.
...
#define __HAL_RCC_TIM2_IS_CLK_SLEEP_ENABLED()                                  \
  ((RCC->APB1LLPENR & (RCC_APB1LLPENR_TIM2LPEN)) != 0U)
#define __HAL_RCC_TIM3_IS_CLK_SLEEP_ENABLED()                                  \
  ((RCC->APB1LLPENR & (RCC_APB1LLPENR_TIM3LPEN)) != 0U)
#define __HAL_RCC_TIM4_IS_CLK_SLEEP_ENABLED()                                  \
  ((RCC->APB1LLPENR & (RCC_APB1LLPENR_TIM4LPEN)) != 0U)
#define __HAL_RCC_TIM5_IS_CLK_SLEEP_ENABLED()                                  \
  ((RCC->APB1LLPENR & (RCC_APB1LLPENR_TIM5LPEN)) != 0U)
#define __HAL_RCC_TIM6_IS_CLK_SLEEP_ENABLED()                                  \
  ((RCC->APB1LLPENR & (RCC_APB1LLPENR_TIM6LPEN)) != 0U)
#define __HAL_RCC_TIM7_IS_CLK_SLEEP_ENABLED()                                  \
  ((RCC->APB1LLPENR & (RCC_APB1LLPENR_TIM7LPEN)) != 0U)
#define __HAL_RCC_TIM12_IS_CLK_SLEEP_ENABLED()                                 \
  ((RCC->APB1LLPENR & (RCC_APB1LLPENR_TIM12LPEN)) != 0U)
#define __HAL_RCC_TIM13_IS_CLK_SLEEP_ENABLED()                                 \
  ((RCC->APB1LLPENR & (RCC_APB1LLPENR_TIM13LPEN)) != 0U)
#define __HAL_RCC_TIM14_IS_CLK_SLEEP_ENABLED()                                 \
  ((RCC->APB1LLPENR & (RCC_APB1LLPENR_TIM14LPEN)) != 0U)
#define __HAL_RCC_LPTIM1_IS_CLK_SLEEP_ENABLED()                                \
  ((RCC->APB1LLPENR & (RCC_APB1LLPENR_LPTIM1LPEN)) != 0U)
#if defined(DUAL_CORE)
#define __HAL_RCC_WWDG2_IS_CLK_SLEEP_ENABLED()                                 \
  ((RCC->APB1LLPENR & (RCC_APB1LLPENR_WWDG2LPEN)) != 0U)
#endif /*DUAL_CORE*/
#define __HAL_RCC_SPI2_IS_CLK_SLEEP_ENABLED()                                  \
  ((RCC->APB1LLPENR & (RCC_APB1LLPENR_SPI2LPEN)) != 0U)
#define __HAL_RCC_SPI3_IS_CLK_SLEEP_ENABLED()                                  \
  ((RCC->APB1LLPENR & (RCC_APB1LLPENR_SPI3LPEN)) != 0U)
#define __HAL_RCC_SPDIFRX_IS_CLK_SLEEP_ENABLED()                               \
  ((RCC->APB1LLPENR & (RCC_APB1LLPENR_SPDIFRXLPEN)) != 0U)
#define __HAL_RCC_USART2_IS_CLK_SLEEP_ENABLED()                                \
  ((RCC->APB1LLPENR & (RCC_APB1LLPENR_USART2LPEN)) != 0U)
#define __HAL_RCC_USART3_IS_CLK_SLEEP_ENABLED()                                \
  ((RCC->APB1LLPENR & (RCC_APB1LLPENR_USART3LPEN)) != 0U)
#define __HAL_RCC_UART4_IS_CLK_SLEEP_ENABLED()                                 \
  ((RCC->APB1LLPENR & (RCC_APB1LLPENR_UART4LPEN)) != 0U)
#define __HAL_RCC_UART5_IS_CLK_SLEEP_ENABLED()                                 \
  ((RCC->APB1LLPENR & (RCC_APB1LLPENR_UART5LPEN)) != 0U)
#define __HAL_RCC_I2C1_IS_CLK_SLEEP_ENABLED()                                  \
  ((RCC->APB1LLPENR & (RCC_APB1LLPENR_I2C1LPEN)) != 0U)
#define __HAL_RCC_I2C2_IS_CLK_SLEEP_ENABLED()                                  \
  ((RCC->APB1LLPENR & (RCC_APB1LLPENR_I2C2LPEN)) != 0U)
#define __HAL_RCC_I2C3_IS_CLK_SLEEP_ENABLED()                                  \
  ((RCC->APB1LLPENR & (RCC_APB1LLPENR_I2C3LPEN)) != 0U)
#if defined(I2C5)
#define __HAL_RCC_I2C5_IS_CLK_SLEEP_ENABLED()                                  \
  ((RCC->APB1LLPENR & (RCC_APB1LLPENR_I2C5LPEN)) != 0U)
#endif /* I2C5 */
#define __HAL_RCC_CEC_IS_CLK_SLEEP_ENABLED()                                   \
  ((RCC->APB1LLPENR & (RCC_APB1LLPENR_CECLPEN)) != 0U)
#define __HAL_RCC_DAC12_IS_CLK_SLEEP_ENABLED()                                 \
  ((RCC->APB1LLPENR & (RCC_APB1LLPENR_DAC12LPEN)) != 0U)
#define __HAL_RCC_UART7_IS_CLK_SLEEP_ENABLED()                                 \
  ((RCC->APB1LLPENR & (RCC_APB1LLPENR_UART7LPEN)) != 0U)
#define __HAL_RCC_UART8_IS_CLK_SLEEP_ENABLED()                                 \
  ((RCC->APB1LLPENR & (RCC_APB1LLPENR_UART8LPEN)) != 0U)
#define __HAL_RCC_CRS_IS_CLK_SLEEP_ENABLED()                                   \
  ((RCC->APB1HLPENR & (RCC_APB1HLPENR_CRSLPEN)) != 0U)
#define __HAL_RCC_SWPMI1_IS_CLK_SLEEP_ENABLED()                                \
  ((RCC->APB1HLPENR & (RCC_APB1HLPENR_SWPMILPEN)) != 0U)
#define __HAL_RCC_OPAMP_IS_CLK_SLEEP_ENABLED()                                 \
  ((RCC->APB1HLPENR & (RCC_APB1HLPENR_OPAMPLPEN)) != 0U)
#define __HAL_RCC_MDIOS_IS_CLK_SLEEP_ENABLED()                                 \
  ((RCC->APB1HLPENR & (RCC_APB1HLPENR_MDIOSLPEN)) != 0U)
#define __HAL_RCC_FDCAN_IS_CLK_SLEEP_ENABLED()                                 \
  ((RCC->APB1HLPENR & (RCC_APB1HLPENR_FDCANLPEN)) != 0U)
#if defined(TIM23)
#define __HAL_RCC_TIM23_IS_CLK_SLEEP_ENABLED()                                 \
  ((RCC->APB1HLPENR & (RCC_APB1HLPENR_TIM23LPEN)) != 0U)
#endif /* TIM23 */
#if defined(TIM24)
#define __HAL_RCC_TIM24_IS_CLK_SLEEP_ENABLED()                                 \
  ((RCC->APB1HLPENR & (RCC_APB1HLPENR_TIM24LPEN)) != 0U)
#endif /* TIM24 */
...
#define __HAL_RCC_LPTIM1_IS_CLK_SLEEP_DISABLED()                               \
  ((RCC->APB1LLPENR & (RCC_APB1LLPENR_LPTIM1LPEN)) == 0U)
#if defined(DUAL_CORE)
#define __HAL_RCC_WWDG2_IS_CLK_SLEEP_DISABLED()                                \
  ((RCC->APB1LLPENR & (RCC_APB1LLPENR_WWDG2LPEN)) == 0U)
#endif /*DUAL_CORE*/
...
#define __HAL_RCC_I2C3_IS_CLK_SLEEP_DISABLED()                                 \
  ((RCC->APB1LLPENR & (RCC_APB1LLPENR_I2C3LPEN)) == 0U)
#if defined(I2C5)
#define __HAL_RCC_I2C5_IS_CLK_SLEEP_DISABLED()                                 \
  ((RCC->APB1LLPENR & (RCC_APB1LLPENR_I2C5LPEN)) == 0U)
#endif /* I2C5 */
#define __HAL_RCC_CEC_IS_CLK_SLEEP_DISABLED()                                  \
  ((RCC->APB1LLPENR & (RCC_APB1LLPENR_CECLPEN)) == 0U)
#define __HAL_RCC_DAC12_IS_CLK_SLEEP_DISABLED()                                \
  ((RCC->APB1LLPENR & (RCC_APB1LLPENR_DAC12LPEN)) == 0U)
...
#define __HAL_RCC_OPAMP_IS_CLK_SLEEP_DISABLED()                                \
  ((RCC->APB1HLPENR & (RCC_APB1HLPENR_OPAMPLPEN)) == 0U)
#define __HAL_RCC_MDIOS_IS_CLK_SLEEP_DISABLED()                                \
  ((RCC->APB1HLPENR & (RCC_APB1HLPENR_MDIOSLPEN)) == 0U)
#define __HAL_RCC_FDCAN_IS_CLK_SLEEP_DISABLED()                                \
  ((RCC->APB1HLPENR & (RCC_APB1HLPENR_FDCANLPEN)) == 0U)
#if defined(TIM23)
#define __HAL_RCC_TIM23_IS_CLK_SLEEP_DISABLED()                                \
  ((RCC->APB1HLPENR & (RCC_APB1HLPENR_TIM23LPEN)) == 0U)
#endif /* TIM23 */
#if defined(TIM24)
#define __HAL_RCC_TIM24_IS_CLK_SLEEP_DISABLED()                                \
  ((RCC->APB1HLPENR & (RCC_APB1HLPENR_TIM24LPEN)) == 0U)
#endif /* TIM24 */
...
#define __HAL_RCC_USART10_CLK_SLEEP_ENABLE()                                   \
  (RCC->APB2LPENR) |= (RCC_APB2LPENR_USART10LPEN)
#endif /*USART10*/
...
#define __HAL_RCC_TIM15_CLK_SLEEP_ENABLE()                                     \
  (RCC->APB2LPENR) |= (RCC_APB2LPENR_TIM15LPEN)
#define __HAL_RCC_TIM16_CLK_SLEEP_ENABLE()                                     \
  (RCC->APB2LPENR) |= (RCC_APB2LPENR_TIM16LPEN)
#define __HAL_RCC_TIM17_CLK_SLEEP_ENABLE()                                     \
  (RCC->APB2LPENR) |= (RCC_APB2LPENR_TIM17LPEN)
...
#define __HAL_RCC_HRTIM1_CLK_SLEEP_ENABLE()                                    \
  (RCC->APB2LPENR) |= (RCC_APB2LPENR_HRTIMLPEN)
#endif /*HRTIM1*/
...
/** @brief  Get the enable or disable status of the APB2 peripheral clock during
 * Low Poser (Sleep) mode.
 * @note   Peripheral clock gating in SLEEP mode can be used to further reduce
 *         power consumption.
 * @note   After wakeup from SLEEP mode, the peripheral clock is enabled again.
...
#define __HAL_RCC_TIM1_IS_CLK_SLEEP_ENABLED()                                  \
  ((RCC->APB2LPENR & (RCC_APB2LPENR_TIM1LPEN)) != 0U)
#define __HAL_RCC_TIM8_IS_CLK_SLEEP_ENABLED()                                  \
  ((RCC->APB2LPENR & (RCC_APB2LPENR_TIM8LPEN)) != 0U)
#define __HAL_RCC_USART1_IS_CLK_SLEEP_ENABLED()                                \
  ((RCC->APB2LPENR & (RCC_APB2LPENR_USART1LPEN)) != 0U)
#define __HAL_RCC_USART6_IS_CLK_SLEEP_ENABLED()                                \
  ((RCC->APB2LPENR & (RCC_APB2LPENR_USART6LPEN)) != 0U)
#if defined(UART9)
#define __HAL_RCC_UART9_IS_CLK_SLEEP_ENABLED()                                 \
  ((RCC->APB2LPENR & (RCC_APB2LPENR_UART9LPEN)) != 0U)
#endif /*UART9*/
#if defined(USART10)
#define __HAL_RCC_USART10_IS_CLK_SLEEP_ENABLED()                               \
  ((RCC->APB2LPENR & (RCC_APB2LPENR_USART10LPEN)) != 0U)
#endif /*USART10*/
#define __HAL_RCC_SPI1_IS_CLK_SLEEP_ENABLED()                                  \
  ((RCC->APB2LPENR & (RCC_APB2LPENR_SPI1LPEN)) != 0U)
#define __HAL_RCC_SPI4_IS_CLK_SLEEP_ENABLED()                                  \
  ((RCC->APB2LPENR & (RCC_APB2LPENR_SPI4LPEN)) != 0U)
#define __HAL_RCC_TIM15_IS_CLK_SLEEP_ENABLED()                                 \
  ((RCC->APB2LPENR & (RCC_APB2LPENR_TIM15LPEN)) != 0U)
#define __HAL_RCC_TIM16_IS_CLK_SLEEP_ENABLED()                                 \
  ((RCC->APB2LPENR & (RCC_APB2LPENR_TIM16LPEN)) != 0U)
#define __HAL_RCC_TIM17_IS_CLK_SLEEP_ENABLED()                                 \
  ((RCC->APB2LPENR & (RCC_APB2LPENR_TIM17LPEN)) != 0U)
#define __HAL_RCC_SPI5_IS_CLK_SLEEP_ENABLED()                                  \
  ((RCC->APB2LPENR & (RCC_APB2LPENR_SPI5LPEN)) != 0U)
#define __HAL_RCC_SAI1_IS_CLK_SLEEP_ENABLED()                                  \
  ((RCC->APB2LPENR & (RCC_APB2LPENR_SAI1LPEN)) != 0U)
#if defined(SAI2)
#define __HAL_RCC_SAI2_IS_CLK_SLEEP_ENABLED()                                  \
  ((RCC->APB2LPENR & (RCC_APB2LPENR_SAI2LPEN)) != 0U)
#endif /* SAI2 */
#if defined(SAI3)
#define __HAL_RCC_SAI3_IS_CLK_SLEEP_ENABLED()                                  \
  ((RCC->APB2LPENR & (RCC_APB2LPENR_SAI3LPEN)) != 0U)
#endif /*SAI3*/
#define __HAL_RCC_DFSDM1_IS_CLK_SLEEP_ENABLED()                                \
  ((RCC->APB2LPENR & (RCC_APB2LPENR_DFSDM1LPEN)) != 0U)
#if defined(HRTIM1)
#define __HAL_RCC_HRTIM1_IS_CLK_SLEEP_ENABLED()                                \
  ((RCC->APB2LPENR & (RCC_APB2LPENR_HRTIMLPEN)) != 0U)
#endif /*HRTIM1*/
...
#define __HAL_RCC_USART6_IS_CLK_SLEEP_DISABLED()                               \
  ((RCC->APB2LPENR & (RCC_APB2LPENR_USART6LPEN)) == 0U)
#if defined(UART9)
#define __HAL_RCC_USART9_IS_CLK_SLEEP_DISABLED()                               \
  ((RCC->APB2LPENR & (RCC_APB2LPENR_USART9LPEN)) == 0U)
#endif /*UART9*/
#if defined(USART10)
#define __HAL_RCC_USART10_IS_CLK_SLEEP_DISABLED()                              \
  ((RCC->APB2LPENR & (RCC_APB2LPENR_USART10LPEN)) == 0U)
#endif /*USART10*/
...
#endif /* SAI2 */
#if defined(SAI3)
#define __HAL_RCC_SAI3_IS_CLK_SLEEP_DISABLED()                                 \
  ((RCC->APB2LPENR & (RCC_APB2LPENR_SAI3LPEN)) == 0U)
#endif /*SAI3*/
...
/** @brief  ENABLE or disable the APB4 peripheral clock during Low Power (Sleep)
 * mode.
 * @note   Peripheral clock gating in SLEEP mode can be used to further reduce
 *         power consumption.
 * @note   After wakeup from SLEEP mode, the peripheral clock is ENABLEd again.
...
#define __HAL_RCC_LPUART1_CLK_SLEEP_ENABLE()                                   \
  (RCC->APB4LPENR) |= (RCC_APB4LPENR_LPUART1LPEN)
#define __HAL_RCC_SPI6_CLK_SLEEP_ENABLE()                                      \
  (RCC->APB4LPENR) |= (RCC_APB4LPENR_SPI6LPEN)
#define __HAL_RCC_I2C4_CLK_SLEEP_ENABLE()                                      \
  (RCC->APB4LPENR) |= (RCC_APB4LPENR_I2C4LPEN)
#define __HAL_RCC_LPTIM2_CLK_SLEEP_ENABLE()                                    \
  (RCC->APB4LPENR) |= (RCC_APB4LPENR_LPTIM2LPEN)
#define __HAL_RCC_LPTIM3_CLK_SLEEP_ENABLE()                                    \
  (RCC->APB4LPENR) |= (RCC_APB4LPENR_LPTIM3LPEN)
#if defined(LPTIM4)
...
#define __HAL_RCC_LPTIM5_CLK_SLEEP_ENABLE()                                    \
  (RCC->APB4LPENR) |= (RCC_APB4LPENR_LPTIM5LPEN)
#endif /*LPTIM5*/
#if defined(DAC2)
#define __HAL_RCC_DAC2_CLK_SLEEP_ENABLE()                                      \
  (RCC->APB4LPENR) |= (RCC_APB4LPENR_DAC2LPEN)
#endif /*DAC2*/
#define __HAL_RCC_COMP12_CLK_SLEEP_ENABLE()                                    \
  (RCC->APB4LPENR) |= (RCC_APB4LPENR_COMP12LPEN)
#define __HAL_RCC_VREF_CLK_SLEEP_ENABLE()                                      \
  (RCC->APB4LPENR) |= (RCC_APB4LPENR_VREFLPEN)
...
#define __HAL_RCC_DTS_CLK_SLEEP_ENABLE()                                       \
  (RCC->APB4LPENR) |= (RCC_APB4LPENR_DTSLPEN)
#endif /*DTS*/
#if defined(DFSDM2_BASE)
...
#define __HAL_RCC_DAC2_CLK_SLEEP_DISABLE()                                     \
  (RCC->APB4LPENR) &= ~(RCC_APB4LPENR_DAC2LPEN)
#endif /*DAC2*/
#define __HAL_RCC_COMP12_CLK_SLEEP_DISABLE()                                   \
  (RCC->APB4LPENR) &= ~(RCC_APB4LPENR_COMP12LPEN)
...
/** @brief  Get the enable or disable status of the APB4 peripheral clock during
 * Low Poser (Sleep) mode.
 * @note   Peripheral clock gating in SLEEP mode can be used to further reduce
 *         power consumption.
 * @note   After wakeup from SLEEP mode, the peripheral clock is enabled again.
...
#define __HAL_RCC_SYSCFG_IS_CLK_SLEEP_ENABLED()                                \
  ((RCC->APB4LPENR & (RCC_APB4LPENR_SYSCFGLPEN)) != 0U)
#define __HAL_RCC_LPUART1_IS_CLK_SLEEP_ENABLED()                               \
  ((RCC->APB4LPENR & (RCC_APB4LPENR_LPUART1LPEN)) != 0U)
#define __HAL_RCC_SPI6_IS_CLK_SLEEP_ENABLED()                                  \
  ((RCC->APB4LPENR & (RCC_APB4LPENR_SPI6LPEN)) != 0U)
#define __HAL_RCC_I2C4_IS_CLK_SLEEP_ENABLED()                                  \
  ((RCC->APB4LPENR & (RCC_APB4LPENR_I2C4LPEN)) != 0U)
#define __HAL_RCC_LPTIM2_IS_CLK_SLEEP_ENABLED()                                \
  ((RCC->APB4LPENR & (RCC_APB4LPENR_LPTIM2LPEN)) != 0U)
#define __HAL_RCC_LPTIM3_IS_CLK_SLEEP_ENABLED()                                \
  ((RCC->APB4LPENR & (RCC_APB4LPENR_LPTIM3LPEN)) != 0U)
#if defined(LPTIM4)
#define __HAL_RCC_LPTIM4_IS_CLK_SLEEP_ENABLED()                                \
  ((RCC->APB4LPENR & (RCC_APB4LPENR_LPTIM4LPEN)) != 0U)
#endif /*LPTIM4*/
#if defined(LPTIM5)
#define __HAL_RCC_LPTIM5_IS_CLK_SLEEP_ENABLED()                                \
  ((RCC->APB4LPENR & (RCC_APB4LPENR_LPTIM5LPEN)) != 0U)
#endif /*LPTIM5*/
#if defined(DAC2)
#define __HAL_RCC_DAC2_IS_CLK_SLEEP_ENABLED()                                  \
  ((RCC->APB4LPENR & (RCC_APB4LPENR_DAC2LPEN)) != 0U)
#endif /*DAC2*/
#define __HAL_RCC_COMP12_IS_CLK_SLEEP_ENABLED()                                \
  ((RCC->APB4LPENR & (RCC_APB4LPENR_COMP12LPEN)) != 0U)
#define __HAL_RCC_VREF_IS_CLK_SLEEP_ENABLED()                                  \
  ((RCC->APB4LPENR & (RCC_APB4LPENR_VREFLPEN)) != 0U)
#define __HAL_RCC_RTC_IS_CLK_SLEEP_ENABLED()                                   \
  ((RCC->APB4LPENR & (RCC_APB4LPENR_RTCAPBLPEN)) != 0U)
#if defined(SAI4)
#define __HAL_RCC_SAI4_IS_CLK_SLEEP_ENABLED()                                  \
  ((RCC->APB4LPENR & (RCC_APB4LPENR_SAI4LPEN)) != 0U)
#endif /*SAI4*/
#if defined(DTS)
#define __HAL_RCC_DTS_IS_CLK_SLEEP_ENABLED()                                   \
  ((RCC->APB4LPENR & (RCC_APB4LPENR_DTSLPEN)) != 0U)
#endif /*DTS*/
#if defined(DFSDM2_BASE)
#define __HAL_RCC_DFSDM2_IS_CLK_SLEEP_ENABLED()                                \
  ((RCC->APB4LPENR & (RCC_APB4LPENR_DFSDM2LPEN)) != 0U)
#endif /*DFSDM2*/
...
#define __HAL_RCC_LPTIM2_IS_CLK_SLEEP_DISABLED()                               \
  ((RCC->APB4LPENR & (RCC_APB4LPENR_LPTIM2LPEN)) == 0U)
#define __HAL_RCC_LPTIM3_IS_CLK_SLEEP_DISABLED()                               \
  ((RCC->APB4LPENR & (RCC_APB4LPENR_LPTIM3LPEN)) == 0U)
#if defined(LPTIM4)
#define __HAL_RCC_LPTIM4_IS_CLK_SLEEP_DISABLED()                               \
  ((RCC->APB4LPENR & (RCC_APB4LPENR_LPTIM4LPEN)) == 0U)
#endif /*LPTIM4*/
#if defined(LPTIM5)
#define __HAL_RCC_LPTIM5_IS_CLK_SLEEP_DISABLED()                               \
  ((RCC->APB4LPENR & (RCC_APB4LPENR_LPTIM5LPEN)) == 0U)
#endif /*LPTIM5*/
#if defined(DAC2)
#define __HAL_RCC_DAC2_IS_CLK_SLEEP_DISABLED()                                 \
  ((RCC->APB4LPENR & (RCC_APB4LPENR_DAC2LPEN)) == 0U)
#endif /*DAC2*/
#define __HAL_RCC_COMP12_IS_CLK_SLEEP_DISABLED()                               \
  ((RCC->APB4LPENR & (RCC_APB4LPENR_COMP12LPEN)) == 0U)
#define __HAL_RCC_VREF_IS_CLK_SLEEP_DISABLED()                                 \
  ((RCC->APB4LPENR & (RCC_APB4LPENR_VREFLPEN)) == 0U)
#define __HAL_RCC_RTC_IS_CLK_SLEEP_DISABLED()                                  \
  ((RCC->APB4LPENR & (RCC_APB4LPENR_RTCAPBLPEN)) == 0U)
#if defined(SAI4)
#define __HAL_RCC_SAI4_IS_CLK_SLEEP_DISABLED()                                 \
  ((RCC->APB4LPENR & (RCC_APB4LPENR_SAI4LPEN)) == 0U)
#endif /*SAI4*/
#if defined(DTS)
#define __HAL_RCC_DTS_IS_CLK_SLEEP_DISABLED()                                  \
  ((RCC->APB4LPENR & (RCC_APB4LPENR_DTSLPEN)) == 0U)
#endif /*DTS*/
#if defined(DFSDM2_BASE)
#define __HAL_RCC_DFSDM2_IS_CLK_SLEEP_DISABLED()                               \
  ((RCC->APB4LPENR & (RCC_APB4LPENR_DFSDM2LPEN)) == 0U)
#endif /*DFSDM2*/

#if defined(DUAL_CORE)

/** @brief  Enable or disable the RCC_C1 AHB3 peripheral clock during Low Power
 * (Sleep) mode.
 * @note   Peripheral clock gating in SLEEP mode can be used to further reduce
 *         power consumption.
 * @note   After wakeup from SLEEP mode, the peripheral clock is enabled again.
 * @note   By default, all peripheral clocks are enabled during SLEEP mode.
 */
#define __HAL_RCC_C1_MDMA_CLK_SLEEP_ENABLE()                                   \
  (RCC_C1->AHB3LPENR |= (RCC_AHB3LPENR_MDMALPEN))
#define __HAL_RCC_C1_DMA2D_CLK_SLEEP_ENABLE()                                  \
  (RCC_C1->AHB3LPENR |= (RCC_AHB3LPENR_DMA2DLPEN))
#define __HAL_RCC_C1_JPGDEC_CLK_SLEEP_ENABLE()                                 \
  (RCC_C1->AHB3LPENR |= (RCC_AHB3LPENR_JPGDECLPEN))
#define __HAL_RCC_C1_FLASH_CLK_SLEEP_ENABLE()                                  \
  (RCC_C1->AHB3LPENR |= (RCC_AHB3LPENR_FLASHLPEN))
#define __HAL_RCC_C1_FMC_CLK_SLEEP_ENABLE()                                    \
  (RCC_C1->AHB3LPENR |= (RCC_AHB3LPENR_FMCLPEN))
#define __HAL_RCC_C1_QSPI_CLK_SLEEP_ENABLE()                                   \
  (RCC_C1->AHB3LPENR |= (RCC_AHB3LPENR_QSPILPEN))
#define __HAL_RCC_C1_SDMMC1_CLK_SLEEP_ENABLE()                                 \
  (RCC_C1->AHB3LPENR |= (RCC_AHB3LPENR_SDMMC1LPEN))
#define __HAL_RCC_C1_DTCM1_CLK_SLEEP_ENABLE()                                  \
  (RCC_C1->AHB3LPENR |= (RCC_AHB3LPENR_DTCM1LPEN))
#define __HAL_RCC_C1_DTCM2_CLK_SLEEP_ENABLE()                                  \
  (RCC_C1->AHB3LPENR |= (RCC_AHB3LPENR_DTCM2LPEN))
#define __HAL_RCC_C1_ITCM_CLK_SLEEP_ENABLE()                                   \
  (RCC_C1->AHB3LPENR |= (RCC_AHB3LPENR_ITCMLPEN))
#define __HAL_RCC_C1_D1SRAM1_CLK_SLEEP_ENABLE()                                \
  (RCC_C1->AHB3LPENR |= (RCC_AHB3LPENR_AXISRAMLPEN))

#define __HAL_RCC_C1_MDMA_CLK_SLEEP_DISABLE()                                  \
  (RCC_C1->AHB3LPENR &= ~(RCC_AHB3LPENR_MDMALPEN))
#define __HAL_RCC_C1_DMA2D_CLK_SLEEP_DISABLE()                                 \
  (RCC_C1->AHB3LPENR &= ~(RCC_AHB3LPENR_DMA2DLPEN))
#define __HAL_RCC_C1_JPGDEC_CLK_SLEEP_DISABLE()                                \
  (RCC_C1->AHB3LPENR &= ~(RCC_AHB3LPENR_JPGDECLPEN))
#define __HAL_RCC_C1_FLASH_CLK_SLEEP_DISABLE()                                 \
  (RCC_C1->AHB3LPENR &= ~(RCC_AHB3LPENR_FLASHLPEN))
#define __HAL_RCC_C1_FMC_CLK_SLEEP_DISABLE()                                   \
  (RCC_C1->AHB3LPENR &= ~(RCC_AHB3LPENR_FMCLPEN))
#define __HAL_RCC_C1_QSPI_CLK_SLEEP_DISABLE()                                  \
  (RCC_C1->AHB3LPENR &= ~(RCC_AHB3LPENR_QSPILPEN))
#define __HAL_RCC_C1_SDMMC1_CLK_SLEEP_DISABLE()                                \
  (RCC_C1->AHB3LPENR &= ~(RCC_AHB3LPENR_SDMMC1LPEN))
#define __HAL_RCC_C1_DTCM1_CLK_SLEEP_DISABLE()                                 \
  (RCC_C1->AHB3LPENR &= ~(RCC_AHB3LPENR_DTCM1LPEN))
#define __HAL_RCC_C1_DTCM2_CLK_SLEEP_DISABLE()                                 \
  (RCC_C1->AHB3LPENR &= ~(RCC_AHB3LPENR_DTCM2LPEN))
#define __HAL_RCC_C1_ITCM_CLK_SLEEP_DISABLE()                                  \
  (RCC_C1->AHB3LPENR &= ~(RCC_AHB3LPENR_ITCMLPEN))
#define __HAL_RCC_C1_D1SRAM1_CLK_SLEEP_DISABLE()                               \
  (RCC_C1->AHB3LPENR &= ~(RCC_AHB3LPENR_AXISRAMLPEN))
...
#define __HAL_RCC_C1_DMA1_CLK_SLEEP_ENABLE()                                   \
  (RCC_C1->AHB1LPENR |= (RCC_AHB1LPENR_DMA1LPEN))
#define __HAL_RCC_C1_DMA2_CLK_SLEEP_ENABLE()                                   \
  (RCC_C1->AHB1LPENR |= (RCC_AHB1LPENR_DMA2LPEN))
#define __HAL_RCC_C1_ADC12_CLK_SLEEP_ENABLE()                                  \
  (RCC_C1->AHB1LPENR |= (RCC_AHB1LPENR_ADC12LPEN))
#define __HAL_RCC_C1_ETH1MAC_CLK_SLEEP_ENABLE()                                \
  (RCC_C1->AHB1LPENR |= (RCC_AHB1LPENR_ETH1MACLPEN))
#define __HAL_RCC_C1_ETH1TX_CLK_SLEEP_ENABLE()                                 \
  (RCC_C1->AHB1LPENR |= (RCC_AHB1LPENR_ETH1TXLPEN))
#define __HAL_RCC_C1_ETH1RX_CLK_SLEEP_ENABLE()                                 \
  (RCC_C1->AHB1LPENR |= (RCC_AHB1LPENR_ETH1RXLPEN))
#define __HAL_RCC_C1_USB1_OTG_HS_CLK_SLEEP_ENABLE()                            \
  (RCC_C1->AHB1LPENR |= (RCC_AHB1LPENR_USB1OTGHSLPEN))
#define __HAL_RCC_C1_USB1_OTG_HS_ULPI_CLK_SLEEP_ENABLE()                       \
  (RCC_C1->AHB1LPENR |= (RCC_AHB1LPENR_USB1OTGHSULPILPEN))
#define __HAL_RCC_C1_USB2_OTG_FS_CLK_SLEEP_ENABLE()                            \
  (RCC_C1->AHB1LPENR |= (RCC_AHB1LPENR_USB2OTGHSLPEN))
#define __HAL_RCC_C1_USB2_OTG_FS_ULPI_CLK_SLEEP_ENABLE()                       \
  (RCC_C1->AHB1LPENR |= (RCC_AHB1LPENR_USB2OTGHSULPILPEN))

#define __HAL_RCC_C1_DMA1_CLK_SLEEP_DISABLE()                                  \
  (RCC_C1->AHB1LPENR &= ~(RCC_AHB1LPENR_DMA1LPEN))
#define __HAL_RCC_C1_DMA2_CLK_SLEEP_DISABLE()                                  \
  (RCC_C1->AHB1LPENR &= ~(RCC_AHB1LPENR_DMA2LPEN))
#define __HAL_RCC_C1_ADC12_CLK_SLEEP_DISABLE()                                 \
  (RCC_C1->AHB1LPENR &= ~(RCC_AHB1LPENR_ADC12LPEN))
#define __HAL_RCC_C1_ETH1MAC_CLK_SLEEP_DISABLE()                               \
  (RCC_C1->AHB1LPENR &= ~(RCC_AHB1LPENR_ETH1MACLPEN))
#define __HAL_RCC_C1_ETH1TX_CLK_SLEEP_DISABLE()                                \
  (RCC_C1->AHB1LPENR &= ~(RCC_AHB1LPENR_ETH1TXLPEN))
#define __HAL_RCC_C1_ETH1RX_CLK_SLEEP_DISABLE()                                \
  (RCC_C1->AHB1LPENR &= ~(RCC_AHB1LPENR_ETH1RXLPEN))
#define __HAL_RCC_C1_USB1_OTG_HS_CLK_SLEEP_DISABLE()                           \
  (RCC_C1->AHB1LPENR &= ~(RCC_AHB1LPENR_USB1OTGHSLPEN))
#define __HAL_RCC_C1_USB1_OTG_HS_ULPI_CLK_SLEEP_DISABLE()                      \
  (RCC_C1->AHB1LPENR &= ~(RCC_AHB1LPENR_USB1OTGHSULPILPEN))
#define __HAL_RCC_C1_USB2_OTG_FS_CLK_SLEEP_DISABLE()                           \
  (RCC_C1->AHB1LPENR &= ~(RCC_AHB1LPENR_USB2OTGHSLPEN))
#define __HAL_RCC_C1_USB2_OTG_FS_ULPI_CLK_SLEEP_DISABLE()                      \
  (RCC_C1->AHB1LPENR &= ~(RCC_AHB1LPENR_USB2OTGHSULPILPEN))
...
#define __HAL_RCC_C1_DCMI_CLK_SLEEP_ENABLE()                                   \
  (RCC_C1->AHB2LPENR |= (RCC_AHB2LPENR_DCMILPEN))
#if defined(CRYP)
#define __HAL_RCC_C1_CRYP_CLK_SLEEP_ENABLE()                                   \
  (RCC_C1->AHB2LPENR |= (RCC_AHB2LPENR_CRYPLPEN))
#endif /* CRYP */
#if defined(HASH)
#define __HAL_RCC_C1_HASH_CLK_SLEEP_ENABLE()                                   \
  (RCC_C1->AHB2LPENR |= (RCC_AHB2LPENR_HASHLPEN))
#endif /* HASH */
#define __HAL_RCC_C1_RNG_CLK_SLEEP_ENABLE()                                    \
  (RCC_C1->AHB2LPENR |= (RCC_AHB2LPENR_RNGLPEN))
#define __HAL_RCC_C1_SDMMC2_CLK_SLEEP_ENABLE()                                 \
  (RCC_C1->AHB2LPENR |= (RCC_AHB2LPENR_SDMMC2LPEN))
#define __HAL_RCC_C1_D2SRAM1_CLK_SLEEP_ENABLE()                                \
  (RCC_C1->AHB2LPENR |= (RCC_AHB2LPENR_D2SRAM1LPEN))
#define __HAL_RCC_C1_D2SRAM2_CLK_SLEEP_ENABLE()                                \
  (RCC_C1->AHB2LPENR |= (RCC_AHB2LPENR_D2SRAM2LPEN))
#define __HAL_RCC_C1_D2SRAM3_CLK_SLEEP_ENABLE()                                \
  (RCC_C1->AHB2LPENR |= (RCC_AHB2LPENR_D2SRAM3LPEN))

#define __HAL_RCC_C1_DCMI_CLK_SLEEP_DISABLE()                                  \
  (RCC_C1->AHB2LPENR &= ~(RCC_AHB2LPENR_DCMILPEN))
#if defined(CRYP)
#define __HAL_RCC_C1_CRYP_CLK_SLEEP_DISABLE()                                  \
  (RCC_C1->AHB2LPENR &= ~(RCC_AHB2LPENR_CRYPLPEN))
#endif /* CRYP */
#if defined(HASH)
#define __HAL_RCC_C1_HASH_CLK_SLEEP_DISABLE()                                  \
  (RCC_C1->AHB2LPENR &= ~(RCC_AHB2LPENR_HASHLPEN))
#endif /* HASH */
#define __HAL_RCC_C1_RNG_CLK_SLEEP_DISABLE()                                   \
  (RCC_C1->AHB2LPENR &= ~(RCC_AHB2LPENR_RNGLPEN))
#define __HAL_RCC_C1_SDMMC2_CLK_SLEEP_DISABLE()                                \
  (RCC_C1->AHB2LPENR &= ~(RCC_AHB2LPENR_SDMMC2LPEN))
#define __HAL_RCC_C1_D2SRAM1_CLK_SLEEP_DISABLE()                               \
  (RCC_C1->AHB2LPENR &= ~(RCC_AHB2LPENR_D2SRAM1LPEN))
#define __HAL_RCC_C1_D2SRAM2_CLK_SLEEP_DISABLE()                               \
  (RCC_C1->AHB2LPENR &= ~(RCC_AHB2LPENR_D2SRAM2LPEN))
#define __HAL_RCC_C1_D2SRAM3_CLK_SLEEP_DISABLE()                               \
  (RCC_C1->AHB2LPENR &= ~(RCC_AHB2LPENR_D2SRAM3LPEN))
...
#define __HAL_RCC_C1_GPIOA_CLK_SLEEP_ENABLE()                                  \
  (RCC_C1->AHB4LPENR) |= (RCC_AHB4LPENR_GPIOALPEN)
#define __HAL_RCC_C1_GPIOB_CLK_SLEEP_ENABLE()                                  \
  (RCC_C1->AHB4LPENR) |= (RCC_AHB4LPENR_GPIOBLPEN)
#define __HAL_RCC_C1_GPIOC_CLK_SLEEP_ENABLE()                                  \
  (RCC_C1->AHB4LPENR) |= (RCC_AHB4LPENR_GPIOCLPEN)
#define __HAL_RCC_C1_GPIOD_CLK_SLEEP_ENABLE()                                  \
  (RCC_C1->AHB4LPENR) |= (RCC_AHB4LPENR_GPIODLPEN)
#define __HAL_RCC_C1_GPIOE_CLK_SLEEP_ENABLE()                                  \
  (RCC_C1->AHB4LPENR) |= (RCC_AHB4LPENR_GPIOELPEN)
#define __HAL_RCC_C1_GPIOF_CLK_SLEEP_ENABLE()                                  \
  (RCC_C1->AHB4LPENR) |= (RCC_AHB4LPENR_GPIOFLPEN)
#define __HAL_RCC_C1_GPIOG_CLK_SLEEP_ENABLE()                                  \
  (RCC_C1->AHB4LPENR) |= (RCC_AHB4LPENR_GPIOGLPEN)
#define __HAL_RCC_C1_GPIOH_CLK_SLEEP_ENABLE()                                  \
  (RCC_C1->AHB4LPENR) |= (RCC_AHB4LPENR_GPIOHLPEN)
#define __HAL_RCC_C1_GPIOI_CLK_SLEEP_ENABLE()                                  \
  (RCC_C1->AHB4LPENR) |= (RCC_AHB4LPENR_GPIOILPEN)
#define __HAL_RCC_C1_GPIOJ_CLK_SLEEP_ENABLE()                                  \
  (RCC_C1->AHB4LPENR) |= (RCC_AHB4LPENR_GPIOJLPEN)
#define __HAL_RCC_C1_GPIOK_CLK_SLEEP_ENABLE()                                  \
  (RCC_C1->AHB4LPENR) |= (RCC_AHB4LPENR_GPIOKLPEN)
#define __HAL_RCC_C1_CRC_CLK_SLEEP_ENABLE()                                    \
  (RCC_C1->AHB4LPENR) |= (RCC_AHB4LPENR_CRCLPEN)
...
#define __HAL_RCC_C1_ADC3_CLK_SLEEP_ENABLE()                                   \
  (RCC_C1->AHB4LPENR) |= (RCC_AHB4LPENR_ADC3LPEN)
#define __HAL_RCC_C1_BKPRAM_CLK_SLEEP_ENABLE()                                 \
  (RCC_C1->AHB4LPENR) |= (RCC_AHB4LPENR_BKPRAMLPEN)
#define __HAL_RCC_C1_D3SRAM1_CLK_SLEEP_ENABLE()                                \
  (RCC_C1->AHB4LPENR |= (RCC_AHB4LPENR_D3SRAM1LPEN))

#define __HAL_RCC_C1_GPIOA_CLK_SLEEP_DISABLE()                                 \
  (RCC_C1->AHB4LPENR) &= ~(RCC_AHB4LPENR_GPIOALPEN)
#define __HAL_RCC_C1_GPIOB_CLK_SLEEP_DISABLE()                                 \
  (RCC_C1->AHB4LPENR) &= ~(RCC_AHB4LPENR_GPIOBLPEN)
#define __HAL_RCC_C1_GPIOC_CLK_SLEEP_DISABLE()                                 \
  (RCC_C1->AHB4LPENR) &= ~(RCC_AHB4LPENR_GPIOCLPEN)
#define __HAL_RCC_C1_GPIOD_CLK_SLEEP_DISABLE()                                 \
  (RCC_C1->AHB4LPENR) &= ~(RCC_AHB4LPENR_GPIODLPEN)
#define __HAL_RCC_C1_GPIOE_CLK_SLEEP_DISABLE()                                 \
  (RCC_C1->AHB4LPENR) &= ~(RCC_AHB4LPENR_GPIOELPEN)
#define __HAL_RCC_C1_GPIOF_CLK_SLEEP_DISABLE()                                 \
  (RCC_C1->AHB4LPENR) &= ~(RCC_AHB4LPENR_GPIOFLPEN)
#define __HAL_RCC_C1_GPIOG_CLK_SLEEP_DISABLE()                                 \
  (RCC_C1->AHB4LPENR) &= ~(RCC_AHB4LPENR_GPIOGLPEN)
#define __HAL_RCC_C1_GPIOH_CLK_SLEEP_DISABLE()                                 \
  (RCC_C1->AHB4LPENR) &= ~(RCC_AHB4LPENR_GPIOHLPEN)
#define __HAL_RCC_C1_GPIOI_CLK_SLEEP_DISABLE()                                 \
  (RCC_C1->AHB4LPENR) &= ~(RCC_AHB4LPENR_GPIOILPEN)
#define __HAL_RCC_C1_GPIOJ_CLK_SLEEP_DISABLE()                                 \
  (RCC_C1->AHB4LPENR) &= ~(RCC_AHB4LPENR_GPIOJLPEN)
#define __HAL_RCC_C1_GPIOK_CLK_SLEEP_DISABLE()                                 \
  (RCC_C1->AHB4LPENR) &= ~(RCC_AHB4LPENR_GPIOKLPEN)
#define __HAL_RCC_C1_CRC_CLK_SLEEP_DISABLE()                                   \
  (RCC_C1->AHB4LPENR) &= ~(RCC_AHB4LPENR_CRCLPEN)
#define __HAL_RCC_C1_BDMA_CLK_SLEEP_DISABLE()                                  \
  (RCC_C1->AHB4LPENR) &= ~(RCC_AHB4LPENR_BDMALPEN)
#define __HAL_RCC_C1_ADC3_CLK_SLEEP_DISABLE()                                  \
  (RCC_C1->AHB4LPENR) &= ~(RCC_AHB4LPENR_ADC3LPEN)
#define __HAL_RCC_C1_BKPRAM_CLK_SLEEP_DISABLE()                                \
  (RCC_C1->AHB4LPENR) &= ~(RCC_AHB4LPENR_BKPRAMLPEN)
#define __HAL_RCC_C1_D3SRAM1_CLK_SLEEP_DISABLE()                               \
  (RCC_C1->AHB4LPENR &= ~(RCC_AHB4LPENR_D3SRAM1LPEN))
...
#define __HAL_RCC_C1_LTDC_CLK_SLEEP_ENABLE()                                   \
  (RCC_C1->APB3LPENR) |= (RCC_APB3LPENR_LTDCLPEN)
#define __HAL_RCC_C1_DSI_CLK_SLEEP_ENABLE()                                    \
  (RCC_C1->APB3LPENR) |= (RCC_APB3LPENR_DSILPEN)
#define __HAL_RCC_C1_WWDG1_CLK_SLEEP_ENABLE()                                  \
  (RCC_C1->APB3LPENR) |= (RCC_APB3LPENR_WWDG1LPEN)

#define __HAL_RCC_C1_LTDC_CLK_SLEEP_DISABLE()                                  \
  (RCC_C1->APB3LPENR) &= ~(RCC_APB3LPENR_LTDCLPEN)
#define __HAL_RCC_C1_DSI_CLK_SLEEP_DISABLE()                                   \
  (RCC_C1->APB3LPENR) &= ~(RCC_APB3LPENR_DSILPEN)
#define __HAL_RCC_C1_WWDG1_CLK_SLEEP_DISABLE()                                 \
  (RCC_C1->APB3LPENR) &= ~(RCC_APB3LPENR_WWDG1LPEN)
...
#define __HAL_RCC_C1_TIM2_CLK_SLEEP_ENABLE()                                   \
  (RCC_C1->APB1LLPENR) |= (RCC_APB1LLPENR_TIM2LPEN)
#define __HAL_RCC_C1_TIM3_CLK_SLEEP_ENABLE()                                   \
  (RCC_C1->APB1LLPENR) |= (RCC_APB1LLPENR_TIM3LPEN)
#define __HAL_RCC_C1_TIM4_CLK_SLEEP_ENABLE()                                   \
  (RCC_C1->APB1LLPENR) |= (RCC_APB1LLPENR_TIM4LPEN)
#define __HAL_RCC_C1_TIM5_CLK_SLEEP_ENABLE()                                   \
  (RCC_C1->APB1LLPENR) |= (RCC_APB1LLPENR_TIM5LPEN)
#define __HAL_RCC_C1_TIM6_CLK_SLEEP_ENABLE()                                   \
  (RCC_C1->APB1LLPENR) |= (RCC_APB1LLPENR_TIM6LPEN)
#define __HAL_RCC_C1_TIM7_CLK_SLEEP_ENABLE()                                   \
...
#define __HAL_RCC_C1_TIM13_CLK_SLEEP_ENABLE()                                  \
  (RCC_C1->APB1LLPENR) |= (RCC_APB1LLPENR_TIM13LPEN)
#define __HAL_RCC_C1_TIM14_CLK_SLEEP_ENABLE()                                  \
  (RCC_C1->APB1LLPENR) |= (RCC_APB1LLPENR_TIM14LPEN)
#define __HAL_RCC_C1_LPTIM1_CLK_SLEEP_ENABLE()                                 \
  (RCC_C1->APB1LLPENR) |= (RCC_APB1LLPENR_LPTIM1LPEN)
#define __HAL_RCC_C1_WWDG2_CLK_SLEEP_ENABLE()                                  \
  (RCC_C1->APB1LLPENR) |= (RCC_APB1LLPENR_WWDG2LPEN)
#define __HAL_RCC_C1_SPI2_CLK_SLEEP_ENABLE()                                   \
  (RCC_C1->APB1LLPENR) |= (RCC_APB1LLPENR_SPI2LPEN)
#define __HAL_RCC_C1_SPI3_CLK_SLEEP_ENABLE()                                   \
  (RCC_C1->APB1LLPENR) |= (RCC_APB1LLPENR_SPI3LPEN)
#define __HAL_RCC_C1_SPDIFRX_CLK_SLEEP_ENABLE()                                \
  (RCC_C1->APB1LLPENR) |= (RCC_APB1LLPENR_SPDIFRXLPEN)
#define __HAL_RCC_C1_USART2_CLK_SLEEP_ENABLE()                                 \
  (RCC_C1->APB1LLPENR) |= (RCC_APB1LLPENR_USART2LPEN)
#define __HAL_RCC_C1_USART3_CLK_SLEEP_ENABLE()                                 \
  (RCC_C1->APB1LLPENR) |= (RCC_APB1LLPENR_USART3LPEN)
#define __HAL_RCC_C1_UART4_CLK_SLEEP_ENABLE()                                  \
  (RCC_C1->APB1LLPENR) |= (RCC_APB1LLPENR_UART4LPEN)
#define __HAL_RCC_C1_UART5_CLK_SLEEP_ENABLE()                                  \
  (RCC_C1->APB1LLPENR) |= (RCC_APB1LLPENR_UART5LPEN)
#define __HAL_RCC_C1_I2C1_CLK_SLEEP_ENABLE()                                   \
  (RCC_C1->APB1LLPENR) |= (RCC_APB1LLPENR_I2C1LPEN)
#define __HAL_RCC_C1_I2C2_CLK_SLEEP_ENABLE()                                   \
  (RCC_C1->APB1LLPENR) |= (RCC_APB1LLPENR_I2C2LPEN)
#define __HAL_RCC_C1_I2C3_CLK_SLEEP_ENABLE()                                   \
  (RCC_C1->APB1LLPENR) |= (RCC_APB1LLPENR_I2C3LPEN)
#define __HAL_RCC_C1_CEC_CLK_SLEEP_ENABLE()                                    \
  (RCC_C1->APB1LLPENR) |= (RCC_APB1LLPENR_CECLPEN)
#define __HAL_RCC_C1_DAC12_CLK_SLEEP_ENABLE()                                  \
  (RCC_C1->APB1LLPENR) |= (RCC_APB1LLPENR_DAC12LPEN)
#define __HAL_RCC_C1_UART7_CLK_SLEEP_ENABLE()                                  \
  (RCC_C1->APB1LLPENR) |= (RCC_APB1LLPENR_UART7LPEN)
#define __HAL_RCC_C1_UART8_CLK_SLEEP_ENABLE()                                  \
  (RCC_C1->APB1LLPENR) |= (RCC_APB1LLPENR_UART8LPEN)
#define __HAL_RCC_C1_CRS_CLK_SLEEP_ENABLE()                                    \
  (RCC_C1->APB1HLPENR) |= (RCC_APB1HLPENR_CRSLPEN)
#define __HAL_RCC_C1_SWPMI_CLK_SLEEP_ENABLE()                                  \
  (RCC_C1->APB1HLPENR) |= (RCC_APB1HLPENR_SWPMILPEN)
#define __HAL_RCC_C1_OPAMP_CLK_SLEEP_ENABLE()                                  \
  (RCC_C1->APB1HLPENR) |= (RCC_APB1HLPENR_OPAMPLPEN)
#define __HAL_RCC_C1_MDIOS_CLK_SLEEP_ENABLE()                                  \
  (RCC_C1->APB1HLPENR) |= (RCC_APB1HLPENR_MDIOSLPEN)
#define __HAL_RCC_C1_FDCAN_CLK_SLEEP_ENABLE()                                  \
  (RCC_C1->APB1HLPENR) |= (RCC_APB1HLPENR_FDCANLPEN)

#define __HAL_RCC_C1_TIM2_CLK_SLEEP_DISABLE()                                  \
  (RCC_C1->APB1LLPENR) &= ~(RCC_APB1LLPENR_TIM2LPEN)
#define __HAL_RCC_C1_TIM3_CLK_SLEEP_DISABLE()                                  \
  (RCC_C1->APB1LLPENR) &= ~(RCC_APB1LLPENR_TIM3LPEN)
#define __HAL_RCC_C1_TIM4_CLK_SLEEP_DISABLE()                                  \
  (RCC_C1->APB1LLPENR) &= ~(RCC_APB1LLPENR_TIM4LPEN)
#define __HAL_RCC_C1_TIM5_CLK_SLEEP_DISABLE()                                  \
  (RCC_C1->APB1LLPENR) &= ~(RCC_APB1LLPENR_TIM5LPEN)
#define __HAL_RCC_C1_TIM6_CLK_SLEEP_DISABLE()                                  \
  (RCC_C1->APB1LLPENR) &= ~(RCC_APB1LLPENR_TIM6LPEN)
#define __HAL_RCC_C1_TIM7_CLK_SLEEP_DISABLE()                                  \
  (RCC_C1->APB1LLPENR) &= ~(RCC_APB1LLPENR_TIM7LPEN)
#define __HAL_RCC_C1_TIM12_CLK_SLEEP_DISABLE()                                 \
  (RCC_C1->APB1LLPENR) &= ~(RCC_APB1LLPENR_TIM12LPEN)
#define __HAL_RCC_C1_TIM13_CLK_SLEEP_DISABLE()                                 \
  (RCC_C1->APB1LLPENR) &= ~(RCC_APB1LLPENR_TIM13LPEN)
#define __HAL_RCC_C1_TIM14_CLK_SLEEP_DISABLE()                                 \
  (RCC_C1->APB1LLPENR) &= ~(RCC_APB1LLPENR_TIM14LPEN)
#define __HAL_RCC_C1_LPTIM1_CLK_SLEEP_DISABLE()                                \
  (RCC_C1->APB1LLPENR) &= ~(RCC_APB1LLPENR_LPTIM1LPEN)
#define __HAL_RCC_C1_WWDG2_CLK_SLEEP_DISABLE()                                 \
  (RCC_C1->APB1LLPENR) &= ~(RCC_APB1LLPENR_WWDG2LPEN)
#define __HAL_RCC_C1_SPI2_CLK_SLEEP_DISABLE()                                  \
  (RCC_C1->APB1LLPENR) &= ~(RCC_APB1LLPENR_SPI2LPEN)
#define __HAL_RCC_C1_SPI3_CLK_SLEEP_DISABLE()                                  \
  (RCC_C1->APB1LLPENR) &= ~(RCC_APB1LLPENR_SPI3LPEN)
#define __HAL_RCC_C1_SPDIFRX_CLK_SLEEP_DISABLE()                               \
  (RCC_C1->APB1LLPENR) &= ~(RCC_APB1LLPENR_SPDIFRXLPEN)
#define __HAL_RCC_C1_USART2_CLK_SLEEP_DISABLE()                                \
  (RCC_C1->APB1LLPENR) &= ~(RCC_APB1LLPENR_USART2LPEN)
#define __HAL_RCC_C1_USART3_CLK_SLEEP_DISABLE()                                \
  (RCC_C1->APB1LLPENR) &= ~(RCC_APB1LLPENR_USART3LPEN)
#define __HAL_RCC_C1_UART4_CLK_SLEEP_DISABLE()                                 \
  (RCC_C1->APB1LLPENR) &= ~(RCC_APB1LLPENR_UART4LPEN)
#define __HAL_RCC_C1_UART5_CLK_SLEEP_DISABLE()                                 \
  (RCC_C1->APB1LLPENR) &= ~(RCC_APB1LLPENR_UART5LPEN)
#define __HAL_RCC_C1_I2C1_CLK_SLEEP_DISABLE()                                  \
  (RCC_C1->APB1LLPENR) &= ~(RCC_APB1LLPENR_I2C1LPEN)
#define __HAL_RCC_C1_I2C2_CLK_SLEEP_DISABLE()                                  \
  (RCC_C1->APB1LLPENR) &= ~(RCC_APB1LLPENR_I2C2LPEN)
#define __HAL_RCC_C1_I2C3_CLK_SLEEP_DISABLE()                                  \
  (RCC_C1->APB1LLPENR) &= ~(RCC_APB1LLPENR_I2C3LPEN)
#define __HAL_RCC_C1_CEC_CLK_SLEEP_DISABLE()                                   \
  (RCC_C1->APB1LLPENR) &= ~(RCC_APB1LLPENR_CECLPEN)
#define __HAL_RCC_C1_DAC12_CLK_SLEEP_DISABLE()                                 \
  (RCC_C1->APB1LLPENR) &= ~(RCC_APB1LLPENR_DAC12LPEN)
#define __HAL_RCC_C1_UART7_CLK_SLEEP_DISABLE()                                 \
  (RCC_C1->APB1LLPENR) &= ~(RCC_APB1LLPENR_UART7LPEN)
#define __HAL_RCC_C1_UART8_CLK_SLEEP_DISABLE()                                 \
  (RCC_C1->APB1LLPENR) &= ~(RCC_APB1LLPENR_UART8LPEN)
#define __HAL_RCC_C1_CRS_CLK_SLEEP_DISABLE()                                   \
  (RCC_C1->APB1HLPENR) &= ~(RCC_APB1HLPENR_CRSLPEN)
#define __HAL_RCC_C1_SWPMI_CLK_SLEEP_DISABLE()                                 \
  (RCC_C1->APB1HLPENR) &= ~(RCC_APB1HLPENR_SWPMILPEN)
#define __HAL_RCC_C1_OPAMP_CLK_SLEEP_DISABLE()                                 \
  (RCC_C1->APB1HLPENR) &= ~(RCC_APB1HLPENR_OPAMPLPEN)
#define __HAL_RCC_C1_MDIOS_CLK_SLEEP_DISABLE()                                 \
  (RCC_C1->APB1HLPENR) &= ~(RCC_APB1HLPENR_MDIOSLPEN)
#define __HAL_RCC_C1_FDCAN_CLK_SLEEP_DISABLE()                                 \
  (RCC_C1->APB1HLPENR) &= ~(RCC_APB1HLPENR_FDCANLPEN)
...
#define __HAL_RCC_C1_TIM1_CLK_SLEEP_ENABLE()                                   \
  (RCC_C1->APB2LPENR) |= (RCC_APB2LPENR_TIM1LPEN)
#define __HAL_RCC_C1_TIM8_CLK_SLEEP_ENABLE()                                   \
  (RCC_C1->APB2LPENR) |= (RCC_APB2LPENR_TIM8LPEN)
#define __HAL_RCC_C1_USART1_CLK_SLEEP_ENABLE()                                 \
  (RCC_C1->APB2LPENR) |= (RCC_APB2LPENR_USART1LPEN)
#define __HAL_RCC_C1_USART6_CLK_SLEEP_ENABLE()                                 \
  (RCC_C1->APB2LPENR) |= (RCC_APB2LPENR_USART6LPEN)
#define __HAL_RCC_C1_SPI1_CLK_SLEEP_ENABLE()                                   \
  (RCC_C1->APB2LPENR) |= (RCC_APB2LPENR_SPI1LPEN)
#define __HAL_RCC_C1_SPI4_CLK_SLEEP_ENABLE()                                   \
  (RCC_C1->APB2LPENR) |= (RCC_APB2LPENR_SPI4LPEN)
#define __HAL_RCC_C1_TIM15_CLK_SLEEP_ENABLE()                                  \
  (RCC_C1->APB2LPENR) |= (RCC_APB2LPENR_TIM15LPEN)
#define __HAL_RCC_C1_TIM16_CLK_SLEEP_ENABLE()                                  \
  (RCC_C1->APB2LPENR) |= (RCC_APB2LPENR_TIM16LPEN)
#define __HAL_RCC_C1_TIM17_CLK_SLEEP_ENABLE()                                  \
  (RCC_C1->APB2LPENR) |= (RCC_APB2LPENR_TIM17LPEN)
#define __HAL_RCC_C1_SPI5_CLK_SLEEP_ENABLE()                                   \
  (RCC_C1->APB2LPENR) |= (RCC_APB2LPENR_SPI5LPEN)
#define __HAL_RCC_C1_SAI1_CLK_SLEEP_ENABLE()                                   \
  (RCC_C1->APB2LPENR) |= (RCC_APB2LPENR_SAI1LPEN)
#define __HAL_RCC_C1_SAI2_CLK_SLEEP_ENABLE()                                   \
  (RCC_C1->APB2LPENR) |= (RCC_APB2LPENR_SAI2LPEN)
#define __HAL_RCC_C1_SAI3_CLK_SLEEP_ENABLE()                                   \
  (RCC_C1->APB2LPENR) |= (RCC_APB2LPENR_SAI3LPEN)
#define __HAL_RCC_C1_DFSDM1_CLK_SLEEP_ENABLE()                                 \
  (RCC_C1->APB2LPENR) |= (RCC_APB2LPENR_DFSDM1LPEN)
#define __HAL_RCC_C1_HRTIM1_CLK_SLEEP_ENABLE()                                 \
  (RCC_C1->APB2LPENR) |= (RCC_APB2LPENR_HRTIMLPEN)

#define __HAL_RCC_C1_TIM1_CLK_SLEEP_DISABLE()                                  \
  (RCC_C1->APB2LPENR) &= ~(RCC_APB2LPENR_TIM1LPEN)
#define __HAL_RCC_C1_TIM8_CLK_SLEEP_DISABLE()                                  \
  (RCC_C1->APB2LPENR) &= ~(RCC_APB2LPENR_TIM8LPEN)
#define __HAL_RCC_C1_USART1_CLK_SLEEP_DISABLE()                                \
  (RCC_C1->APB2LPENR) &= ~(RCC_APB2LPENR_USART1LPEN)
#define __HAL_RCC_C1_USART6_CLK_SLEEP_DISABLE()                                \
  (RCC_C1->APB2LPENR) &= ~(RCC_APB2LPENR_USART6LPEN)
#define __HAL_RCC_C1_SPI1_CLK_SLEEP_DISABLE()                                  \
  (RCC_C1->APB2LPENR) &= ~(RCC_APB2LPENR_SPI1LPEN)
#define __HAL_RCC_C1_SPI4_CLK_SLEEP_DISABLE()                                  \
  (RCC_C1->APB2LPENR) &= ~(RCC_APB2LPENR_SPI4LPEN)
#define __HAL_RCC_C1_TIM15_CLK_SLEEP_DISABLE()                                 \
  (RCC_C1->APB2LPENR) &= ~(RCC_APB2LPENR_TIM15LPEN)
#define __HAL_RCC_C1_TIM16_CLK_SLEEP_DISABLE()                                 \
  (RCC_C1->APB2LPENR) &= ~(RCC_APB2LPENR_TIM16LPEN)
#define __HAL_RCC_C1_TIM17_CLK_SLEEP_DISABLE()                                 \
  (RCC_C1->APB2LPENR) &= ~(RCC_APB2LPENR_TIM17LPEN)
#define __HAL_RCC_C1_SPI5_CLK_SLEEP_DISABLE()                                  \
  (RCC_C1->APB2LPENR) &= ~(RCC_APB2LPENR_SPI5LPEN)
#define __HAL_RCC_C1_SAI1_CLK_SLEEP_DISABLE()                                  \
  (RCC_C1->APB2LPENR) &= ~(RCC_APB2LPENR_SAI1LPEN)
#define __HAL_RCC_C1_SAI2_CLK_SLEEP_DISABLE()                                  \
  (RCC_C1->APB2LPENR) &= ~(RCC_APB2LPENR_SAI2LPEN)
#define __HAL_RCC_C1_SAI3_CLK_SLEEP_DISABLE()                                  \
  (RCC_C1->APB2LPENR) &= ~(RCC_APB2LPENR_SAI3LPEN)
#define __HAL_RCC_C1_DFSDM1_CLK_SLEEP_DISABLE()                                \
  (RCC_C1->APB2LPENR) &= ~(RCC_APB2LPENR_DFSDM1LPEN)
#define __HAL_RCC_C1_HRTIM1_CLK_SLEEP_DISABLE()                                \
  (RCC_C1->APB2LPENR) &= ~(RCC_APB2LPENR_HRTIMLPEN)
...
#define __HAL_RCC_C1_SYSCFG_CLK_SLEEP_ENABLE()                                 \
  (RCC_C1->APB4LPENR) |= (RCC_APB4LPENR_SYSCFGLPEN)
#define __HAL_RCC_C1_LPUART1_CLK_SLEEP_ENABLE()                                \
  (RCC_C1->APB4LPENR) |= (RCC_APB4LPENR_LPUART1LPEN)
#define __HAL_RCC_C1_SPI6_CLK_SLEEP_ENABLE()                                   \
  (RCC_C1->APB4LPENR) |= (RCC_APB4LPENR_SPI6LPEN)
#define __HAL_RCC_C1_I2C4_CLK_SLEEP_ENABLE()                                   \
  (RCC_C1->APB4LPENR) |= (RCC_APB4LPENR_I2C4LPEN)
#define __HAL_RCC_C1_LPTIM2_CLK_SLEEP_ENABLE()                                 \
  (RCC_C1->APB4LPENR) |= (RCC_APB4LPENR_LPTIM2LPEN)
#define __HAL_RCC_C1_LPTIM3_CLK_SLEEP_ENABLE()                                 \
  (RCC_C1->APB4LPENR) |= (RCC_APB4LPENR_LPTIM3LPEN)
#define __HAL_RCC_C1_LPTIM4_CLK_SLEEP_ENABLE()                                 \
  (RCC_C1->APB4LPENR) |= (RCC_APB4LPENR_LPTIM4LPEN)
#define __HAL_RCC_C1_LPTIM5_CLK_SLEEP_ENABLE()                                 \
  (RCC_C1->APB4LPENR) |= (RCC_APB4LPENR_LPTIM5LPEN)
#define __HAL_RCC_C1_COMP12_CLK_SLEEP_ENABLE()                                 \
  (RCC_C1->APB4LPENR) |= (RCC_APB4LPENR_COMP12LPEN)
#define __HAL_RCC_C1_VREF_CLK_SLEEP_ENABLE()                                   \
  (RCC_C1->APB4LPENR) |= (RCC_APB4LPENR_VREFLPEN)
#define __HAL_RCC_C1_SAI4_CLK_SLEEP_ENABLE()                                   \
  (RCC_C1->APB4LPENR) |= (RCC_APB4LPENR_SAI4LPEN)
#define __HAL_RCC_C1_RTC_CLK_SLEEP_ENABLE()                                    \
  (RCC_C1->APB4LPENR) |= (RCC_APB4LPENR_RTCAPBLPEN)

#define __HAL_RCC_C1_SYSCFG_CLK_SLEEP_DISABLE()                                \
  (RCC_C1->APB4LPENR) &= ~(RCC_APB4LPENR_SYSCFGLPEN)
#define __HAL_RCC_C1_LPUART1_CLK_SLEEP_DISABLE()                               \
  (RCC_C1->APB4LPENR) &= ~(RCC_APB4LPENR_LPUART1LPEN)
#define __HAL_RCC_C1_SPI6_CLK_SLEEP_DISABLE()                                  \
  (RCC_C1->APB4LPENR) &= ~(RCC_APB4LPENR_SPI6LPEN)
#define __HAL_RCC_C1_I2C4_CLK_SLEEP_DISABLE()                                  \
  (RCC_C1->APB4LPENR) &= ~(RCC_APB4LPENR_I2C4LPEN)
#define __HAL_RCC_C1_LPTIM2_CLK_SLEEP_DISABLE()                                \
  (RCC_C1->APB4LPENR) &= ~(RCC_APB4LPENR_LPTIM2LPEN)
#define __HAL_RCC_C1_LPTIM3_CLK_SLEEP_DISABLE()                                \
  (RCC_C1->APB4LPENR) &= ~(RCC_APB4LPENR_LPTIM3LPEN)
#define __HAL_RCC_C1_LPTIM4_CLK_SLEEP_DISABLE()                                \
  (RCC_C1->APB4LPENR) &= ~(RCC_APB4LPENR_LPTIM4LPEN)
#define __HAL_RCC_C1_LPTIM5_CLK_SLEEP_DISABLE()                                \
  (RCC_C1->APB4LPENR) &= ~(RCC_APB4LPENR_LPTIM5LPEN)
#define __HAL_RCC_C1_COMP12_CLK_SLEEP_DISABLE()                                \
  (RCC_C1->APB4LPENR) &= ~(RCC_APB4LPENR_COMP12LPEN)
#define __HAL_RCC_C1_VREF_CLK_SLEEP_DISABLE()                                  \
  (RCC_C1->APB4LPENR) &= ~(RCC_APB4LPENR_VREFLPEN)
#define __HAL_RCC_C1_SAI4_CLK_SLEEP_DISABLE()                                  \
  (RCC_C1->APB4LPENR) &= ~(RCC_APB4LPENR_SAI4LPEN)
#define __HAL_RCC_C1_RTC_CLK_SLEEP_DISABLE()                                   \
  (RCC_C1->APB4LPENR) &= ~(RCC_APB4LPENR_RTCAPBLPEN)

/** @brief  Enable or disable the RCC_C2 AHB3 peripheral clock during Low Power
 * (Sleep) mode.
 * @note   Peripheral clock gating in SLEEP mode can be used to further reduce
 *         power consumption.
 * @note   After wakeup from SLEEP mode, the peripheral clock is enabled again.
...
#define __HAL_RCC_C2_MDMA_CLK_SLEEP_ENABLE()                                   \
  (RCC_C2->AHB3LPENR |= (RCC_AHB3LPENR_MDMALPEN))
#define __HAL_RCC_C2_DMA2D_CLK_SLEEP_ENABLE()                                  \
  (RCC_C2->AHB3LPENR |= (RCC_AHB3LPENR_DMA2DLPEN))
#define __HAL_RCC_C2_JPGDEC_CLK_SLEEP_ENABLE()                                 \
  (RCC_C2->AHB3LPENR |= (RCC_AHB3LPENR_JPGDECLPEN))
#define __HAL_RCC_C2_FLASH_CLK_SLEEP_ENABLE()                                  \
  (RCC_C2->AHB3LPENR |= (RCC_AHB3LPENR_FLASHLPEN))
#define __HAL_RCC_C2_FMC_CLK_SLEEP_ENABLE()                                    \
  (RCC_C2->AHB3LPENR |= (RCC_AHB3LPENR_FMCLPEN))
#define __HAL_RCC_C2_QSPI_CLK_SLEEP_ENABLE()                                   \
  (RCC_C2->AHB3LPENR |= (RCC_AHB3LPENR_QSPILPEN))
#define __HAL_RCC_C2_SDMMC1_CLK_SLEEP_ENABLE()                                 \
  (RCC_C2->AHB3LPENR |= (RCC_AHB3LPENR_SDMMC1LPEN))
#define __HAL_RCC_C2_DTCM1_CLK_SLEEP_ENABLE()                                  \
  (RCC_C2->AHB3LPENR |= (RCC_AHB3LPENR_DTCM1LPEN))
#define __HAL_RCC_C2_DTCM2_CLK_SLEEP_ENABLE()                                  \
  (RCC_C2->AHB3LPENR |= (RCC_AHB3LPENR_DTCM2LPEN))
#define __HAL_RCC_C2_ITCM_CLK_SLEEP_ENABLE()                                   \
  (RCC_C2->AHB3LPENR |= (RCC_AHB3LPENR_ITCMLPEN))
#define __HAL_RCC_C2_D1SRAM1_CLK_SLEEP_ENABLE()                                \
  (RCC_C2->AHB3LPENR |= (RCC_AHB3LPENR_AXISRAMLPEN))

#define __HAL_RCC_C2_MDMA_CLK_SLEEP_DISABLE()                                  \
  (RCC_C2->AHB3LPENR &= ~(RCC_AHB3LPENR_MDMALPEN))
#define __HAL_RCC_C2_DMA2D_CLK_SLEEP_DISABLE()                                 \
  (RCC_C2->AHB3LPENR &= ~(RCC_AHB3LPENR_DMA2DLPEN))
#define __HAL_RCC_C2_JPGDEC_CLK_SLEEP_DISABLE()                                \
  (RCC_C2->AHB3LPENR &= ~(RCC_AHB3LPENR_JPGDECLPEN))
#define __HAL_RCC_C2_FLASH_CLK_SLEEP_DISABLE()                                 \
  (RCC_C2->AHB3LPENR &= ~(RCC_AHB3LPENR_FLASHLPEN))
#define __HAL_RCC_C2_FMC_CLK_SLEEP_DISABLE()                                   \
  (RCC_C2->AHB3LPENR &= ~(RCC_AHB3LPENR_FMCLPEN))
#define __HAL_RCC_C2_QSPI_CLK_SLEEP_DISABLE()                                  \
  (RCC_C2->AHB3LPENR &= ~(RCC_AHB3LPENR_QSPILPEN))
#define __HAL_RCC_C2_SDMMC1_CLK_SLEEP_DISABLE()                                \
  (RCC_C2->AHB3LPENR &= ~(RCC_AHB3LPENR_SDMMC1LPEN))
#define __HAL_RCC_C2_DTCM1_CLK_SLEEP_DISABLE()                                 \
  (RCC_C2->AHB3LPENR &= ~(RCC_AHB3LPENR_DTCM1LPEN))
#define __HAL_RCC_C2_DTCM2_CLK_SLEEP_DISABLE()                                 \
  (RCC_C2->AHB3LPENR &= ~(RCC_AHB3LPENR_DTCM2LPEN))
#define __HAL_RCC_C2_ITCM_CLK_SLEEP_DISABLE()                                  \
  (RCC_C2->AHB3LPENR &= ~(RCC_AHB3LPENR_ITCMLPEN))
#define __HAL_RCC_C2_D1SRAM1_CLK_SLEEP_DISABLE()                               \
  (RCC_C2->AHB3LPENR &= ~(RCC_AHB3LPENR_AXISRAMLPEN))
...
#define __HAL_RCC_C2_DMA1_CLK_SLEEP_ENABLE()                                   \
  (RCC_C2->AHB1LPENR |= (RCC_AHB1LPENR_DMA1LPEN))
#define __HAL_RCC_C2_DMA2_CLK_SLEEP_ENABLE()                                   \
  (RCC_C2->AHB1LPENR |= (RCC_AHB1LPENR_DMA2LPEN))
#define __HAL_RCC_C2_ADC12_CLK_SLEEP_ENABLE()                                  \
  (RCC_C2->AHB1LPENR |= (RCC_AHB1LPENR_ADC12LPEN))
#define __HAL_RCC_C2_ETH1MAC_CLK_SLEEP_ENABLE()                                \
  (RCC_C2->AHB1LPENR |= (RCC_AHB1LPENR_ETH1MACLPEN))
#define __HAL_RCC_C2_ETH1TX_CLK_SLEEP_ENABLE()                                 \
  (RCC_C2->AHB1LPENR |= (RCC_AHB1LPENR_ETH1TXLPEN))
#define __HAL_RCC_C2_ETH1RX_CLK_SLEEP_ENABLE()                                 \
  (RCC_C2->AHB1LPENR |= (RCC_AHB1LPENR_ETH1RXLPEN))
#define __HAL_RCC_C2_USB1_OTG_HS_CLK_SLEEP_ENABLE()                            \
  (RCC_C2->AHB1LPENR |= (RCC_AHB1LPENR_USB1OTGHSLPEN))
#define __HAL_RCC_C2_USB1_OTG_HS_ULPI_CLK_SLEEP_ENABLE()                       \
  (RCC_C2->AHB1LPENR |= (RCC_AHB1LPENR_USB1OTGHSULPILPEN))
#define __HAL_RCC_C2_USB2_OTG_FS_CLK_SLEEP_ENABLE()                            \
  (RCC_C2->AHB1LPENR |= (RCC_AHB1LPENR_USB2OTGHSLPEN))
#define __HAL_RCC_C2_USB2_OTG_FS_ULPI_CLK_SLEEP_ENABLE()                       \
  (RCC_C2->AHB1LPENR |= (RCC_AHB1LPENR_USB2OTGHSULPILPEN))

#define __HAL_RCC_C2_DMA1_CLK_SLEEP_DISABLE()                                  \
  (RCC_C2->AHB1LPENR &= ~(RCC_AHB1LPENR_DMA1LPEN))
#define __HAL_RCC_C2_DMA2_CLK_SLEEP_DISABLE()                                  \
  (RCC_C2->AHB1LPENR &= ~(RCC_AHB1LPENR_DMA2LPEN))
#define __HAL_RCC_C2_ADC12_CLK_SLEEP_DISABLE()                                 \
  (RCC_C2->AHB1LPENR &= ~(RCC_AHB1LPENR_ADC12LPEN))
#define __HAL_RCC_C2_ETH1MAC_CLK_SLEEP_DISABLE()                               \
  (RCC_C2->AHB1LPENR &= ~(RCC_AHB1LPENR_ETH1MACLPEN))
#define __HAL_RCC_C2_ETH1TX_CLK_SLEEP_DISABLE()                                \
  (RCC_C2->AHB1LPENR &= ~(RCC_AHB1LPENR_ETH1TXLPEN))
#define __HAL_RCC_C2_ETH1RX_CLK_SLEEP_DISABLE()                                \
  (RCC_C2->AHB1LPENR &= ~(RCC_AHB1LPENR_ETH1RXLPEN))
#define __HAL_RCC_C2_USB1_OTG_HS_CLK_SLEEP_DISABLE()                           \
  (RCC_C2->AHB1LPENR &= ~(RCC_AHB1LPENR_USB1OTGHSLPEN))
#define __HAL_RCC_C2_USB1_OTG_HS_ULPI_CLK_SLEEP_DISABLE()                      \
  (RCC_C2->AHB1LPENR &= ~(RCC_AHB1LPENR_USB1OTGHSULPILPEN))
#define __HAL_RCC_C2_USB2_OTG_FS_CLK_SLEEP_DISABLE()                           \
  (RCC_C2->AHB1LPENR &= ~(RCC_AHB1LPENR_USB2OTGHSLPEN))
#define __HAL_RCC_C2_USB2_OTG_FS_ULPI_CLK_SLEEP_DISABLE()                      \
  (RCC_C2->AHB1LPENR &= ~(RCC_AHB1LPENR_USB2OTGHSULPILPEN))
...
#define __HAL_RCC_C2_DCMI_CLK_SLEEP_ENABLE()                                   \
  (RCC_C2->AHB2LPENR |= (RCC_AHB2LPENR_DCMILPEN))
#if defined(CRYP)
#define __HAL_RCC_C2_CRYP_CLK_SLEEP_ENABLE()                                   \
  (RCC_C2->AHB2LPENR |= (RCC_AHB2LPENR_CRYPLPEN))
#endif /* CRYP */
#if defined(HASH)
#define __HAL_RCC_C2_HASH_CLK_SLEEP_ENABLE()                                   \
  (RCC_C2->AHB2LPENR |= (RCC_AHB2LPENR_HASHLPEN))
#endif /* HASH */
#define __HAL_RCC_C2_RNG_CLK_SLEEP_ENABLE()                                    \
  (RCC_C2->AHB2LPENR |= (RCC_AHB2LPENR_RNGLPEN))
#define __HAL_RCC_C2_SDMMC2_CLK_SLEEP_ENABLE()                                 \
  (RCC_C2->AHB2LPENR |= (RCC_AHB2LPENR_SDMMC2LPEN))
#define __HAL_RCC_C2_D2SRAM1_CLK_SLEEP_ENABLE()                                \
  (RCC_C2->AHB2LPENR |= (RCC_AHB2LPENR_D2SRAM1LPEN))
#define __HAL_RCC_C2_D2SRAM2_CLK_SLEEP_ENABLE()                                \
  (RCC_C2->AHB2LPENR |= (RCC_AHB2LPENR_D2SRAM2LPEN))
#define __HAL_RCC_C2_D2SRAM3_CLK_SLEEP_ENABLE()                                \
  (RCC_C2->AHB2LPENR |= (RCC_AHB2LPENR_D2SRAM3LPEN))

#define __HAL_RCC_C2_DCMI_CLK_SLEEP_DISABLE()                                  \
  (RCC_C2->AHB2LPENR &= ~(RCC_AHB2LPENR_DCMILPEN))
#if defined(CRYP)
#define __HAL_RCC_C2_CRYP_CLK_SLEEP_DISABLE()                                  \
  (RCC_C2->AHB2LPENR &= ~(RCC_AHB2LPENR_CRYPLPEN))
#endif /* CRYP */
#if defined(HASH)
#define __HAL_RCC_C2_HASH_CLK_SLEEP_DISABLE()                                  \
  (RCC_C2->AHB2LPENR &= ~(RCC_AHB2LPENR_HASHLPEN))
#endif /* HASH */
#define __HAL_RCC_C2_RNG_CLK_SLEEP_DISABLE()                                   \
  (RCC_C2->AHB2LPENR &= ~(RCC_AHB2LPENR_RNGLPEN))
#define __HAL_RCC_C2_SDMMC2_CLK_SLEEP_DISABLE()                                \
  (RCC_C2->AHB2LPENR &= ~(RCC_AHB2LPENR_SDMMC2LPEN))
#define __HAL_RCC_C2_D2SRAM1_CLK_SLEEP_DISABLE()                               \
  (RCC_C2->AHB2LPENR &= ~(RCC_AHB2LPENR_D2SRAM1LPEN))
#define __HAL_RCC_C2_D2SRAM2_CLK_SLEEP_DISABLE()                               \
  (RCC_C2->AHB2LPENR &= ~(RCC_AHB2LPENR_D2SRAM2LPEN))
#define __HAL_RCC_C2_D2SRAM3_CLK_SLEEP_DISABLE()                               \
  (RCC_C2->AHB2LPENR &= ~(RCC_AHB2LPENR_D2SRAM3LPEN))
...
#define __HAL_RCC_C2_GPIOA_CLK_SLEEP_ENABLE()                                  \
  (RCC_C2->AHB4LPENR) |= (RCC_AHB4LPENR_GPIOALPEN)
#define __HAL_RCC_C2_GPIOB_CLK_SLEEP_ENABLE()                                  \
  (RCC_C2->AHB4LPENR) |= (RCC_AHB4LPENR_GPIOBLPEN)
#define __HAL_RCC_C2_GPIOC_CLK_SLEEP_ENABLE()                                  \
  (RCC_C2->AHB4LPENR) |= (RCC_AHB4LPENR_GPIOCLPEN)
#define __HAL_RCC_C2_GPIOD_CLK_SLEEP_ENABLE()                                  \
  (RCC_C2->AHB4LPENR) |= (RCC_AHB4LPENR_GPIODLPEN)
#define __HAL_RCC_C2_GPIOE_CLK_SLEEP_ENABLE()                                  \
  (RCC_C2->AHB4LPENR) |= (RCC_AHB4LPENR_GPIOELPEN)
#define __HAL_RCC_C2_GPIOF_CLK_SLEEP_ENABLE()                                  \
  (RCC_C2->AHB4LPENR) |= (RCC_AHB4LPENR_GPIOFLPEN)
#define __HAL_RCC_C2_GPIOG_CLK_SLEEP_ENABLE()                                  \
  (RCC_C2->AHB4LPENR) |= (RCC_AHB4LPENR_GPIOGLPEN)
#define __HAL_RCC_C2_GPIOH_CLK_SLEEP_ENABLE()                                  \
  (RCC_C2->AHB4LPENR) |= (RCC_AHB4LPENR_GPIOHLPEN)
#define __HAL_RCC_C2_GPIOI_CLK_SLEEP_ENABLE()                                  \
  (RCC_C2->AHB4LPENR) |= (RCC_AHB4LPENR_GPIOILPEN)
#define __HAL_RCC_C2_GPIOJ_CLK_SLEEP_ENABLE()                                  \
  (RCC_C2->AHB4LPENR) |= (RCC_AHB4LPENR_GPIOJLPEN)
#define __HAL_RCC_C2_GPIOK_CLK_SLEEP_ENABLE()                                  \
  (RCC_C2->AHB4LPENR) |= (RCC_AHB4LPENR_GPIOKLPEN)
#define __HAL_RCC_C2_CRC_CLK_SLEEP_ENABLE()                                    \
  (RCC_C2->AHB4LPENR) |= (RCC_AHB4LPENR_CRCLPEN)
#define __HAL_RCC_C2_BDMA_CLK_SLEEP_ENABLE()                                   \
  (RCC_C2->AHB4LPENR) |= (RCC_AHB4LPENR_BDMALPEN)
#define __HAL_RCC_C2_ADC3_CLK_SLEEP_ENABLE()                                   \
  (RCC_C2->AHB4LPENR) |= (RCC_AHB4LPENR_ADC3LPEN)
#define __HAL_RCC_C2_BKPRAM_CLK_SLEEP_ENABLE()                                 \
  (RCC_C2->AHB4LPENR) |= (RCC_AHB4LPENR_BKPRAMLPEN)
#define __HAL_RCC_C2_D3SRAM1_CLK_SLEEP_ENABLE()                                \
  (RCC_C2->AHB4LPENR |= (RCC_AHB4LPENR_D3SRAM1LPEN))

#define __HAL_RCC_C2_GPIOA_CLK_SLEEP_DISABLE()                                 \
  (RCC_C2->AHB4LPENR) &= ~(RCC_AHB4LPENR_GPIOALPEN)
#define __HAL_RCC_C2_GPIOB_CLK_SLEEP_DISABLE()                                 \
  (RCC_C2->AHB4LPENR) &= ~(RCC_AHB4LPENR_GPIOBLPEN)
#define __HAL_RCC_C2_GPIOC_CLK_SLEEP_DISABLE()                                 \
  (RCC_C2->AHB4LPENR) &= ~(RCC_AHB4LPENR_GPIOCLPEN)
#define __HAL_RCC_C2_GPIOD_CLK_SLEEP_DISABLE()                                 \
  (RCC_C2->AHB4LPENR) &= ~(RCC_AHB4LPENR_GPIODLPEN)
#define __HAL_RCC_C2_GPIOE_CLK_SLEEP_DISABLE()                                 \
  (RCC_C2->AHB4LPENR) &= ~(RCC_AHB4LPENR_GPIOELPEN)
#define __HAL_RCC_C2_GPIOF_CLK_SLEEP_DISABLE()                                 \
  (RCC_C2->AHB4LPENR) &= ~(RCC_AHB4LPENR_GPIOFLPEN)
#define __HAL_RCC_C2_GPIOG_CLK_SLEEP_DISABLE()                                 \
  (RCC_C2->AHB4LPENR) &= ~(RCC_AHB4LPENR_GPIOGLPEN)
#define __HAL_RCC_C2_GPIOH_CLK_SLEEP_DISABLE()                                 \
  (RCC_C2->AHB4LPENR) &= ~(RCC_AHB4LPENR_GPIOHLPEN)
#define __HAL_RCC_C2_GPIOI_CLK_SLEEP_DISABLE()                                 \
  (RCC_C2->AHB4LPENR) &= ~(RCC_AHB4LPENR_GPIOILPEN)
#define __HAL_RCC_C2_GPIOJ_CLK_SLEEP_DISABLE()                                 \
  (RCC_C2->AHB4LPENR) &= ~(RCC_AHB4LPENR_GPIOJLPEN)
#define __HAL_RCC_C2_GPIOK_CLK_SLEEP_DISABLE()                                 \
  (RCC_C2->AHB4LPENR) &= ~(RCC_AHB4LPENR_GPIOKLPEN)
#define __HAL_RCC_C2_CRC_CLK_SLEEP_DISABLE()                                   \
  (RCC_C2->AHB4LPENR) &= ~(RCC_AHB4LPENR_CRCLPEN)
#define __HAL_RCC_C2_BDMA_CLK_SLEEP_DISABLE()                                  \
  (RCC_C2->AHB4LPENR) &= ~(RCC_AHB4LPENR_BDMALPEN)
#define __HAL_RCC_C2_ADC3_CLK_SLEEP_DISABLE()                                  \
  (RCC_C2->AHB4LPENR) &= ~(RCC_AHB4LPENR_ADC3LPEN)
#define __HAL_RCC_C2_BKPRAM_CLK_SLEEP_DISABLE()                                \
  (RCC_C2->AHB4LPENR) &= ~(RCC_AHB4LPENR_BKPRAMLPEN)
#define __HAL_RCC_C2_D3SRAM1_CLK_SLEEP_DISABLE()                               \
  (RCC_C2->AHB4LPENR &= ~(RCC_AHB4LPENR_D3SRAM1LPEN))
...
#define __HAL_RCC_C2_LTDC_CLK_SLEEP_ENABLE()                                   \
  (RCC_C2->APB3LPENR) |= (RCC_APB3LPENR_LTDCLPEN)
#define __HAL_RCC_C2_DSI_CLK_SLEEP_ENABLE()                                    \
  (RCC_C2->APB3LPENR) |= (RCC_APB3LPENR_DSILPEN)
#define __HAL_RCC_C2_WWDG1_CLK_SLEEP_ENABLE()                                  \
  (RCC_C2->APB3LPENR) |= (RCC_APB3LPENR_WWDG1LPEN)

#define __HAL_RCC_C2_LTDC_CLK_SLEEP_DISABLE()                                  \
  (RCC_C2->APB3LPENR) &= ~(RCC_APB3LPENR_LTDCLPEN)
#define __HAL_RCC_C2_DSI_CLK_SLEEP_DISABLE()                                   \
  (RCC_C2->APB3LPENR) &= ~(RCC_APB3LPENR_DSILPEN)
#define __HAL_RCC_C2_WWDG1_CLK_SLEEP_DISABLE()                                 \
  (RCC_C2->APB3LPENR) &= ~(RCC_APB3LPENR_WWDG1LPEN)
...
#define __HAL_RCC_C2_TIM2_CLK_SLEEP_ENABLE()                                   \
  (RCC_C2->APB1LLPENR) |= (RCC_APB1LLPENR_TIM2LPEN)
#define __HAL_RCC_C2_TIM3_CLK_SLEEP_ENABLE()                                   \
  (RCC_C2->APB1LLPENR) |= (RCC_APB1LLPENR_TIM3LPEN)
#define __HAL_RCC_C2_TIM4_CLK_SLEEP_ENABLE()                                   \
  (RCC_C2->APB1LLPENR) |= (RCC_APB1LLPENR_TIM4LPEN)
#define __HAL_RCC_C2_TIM5_CLK_SLEEP_ENABLE()                                   \
  (RCC_C2->APB1LLPENR) |= (RCC_APB1LLPENR_TIM5LPEN)
#define __HAL_RCC_C2_TIM6_CLK_SLEEP_ENABLE()                                   \
  (RCC_C2->APB1LLPENR) |= (RCC_APB1LLPENR_TIM6LPEN)
#define __HAL_RCC_C2_TIM7_CLK_SLEEP_ENABLE()                                   \
...
#define __HAL_RCC_C2_TIM13_CLK_SLEEP_ENABLE()                                  \
  (RCC_C2->APB1LLPENR) |= (RCC_APB1LLPENR_TIM13LPEN)
#define __HAL_RCC_C2_TIM14_CLK_SLEEP_ENABLE()                                  \
  (RCC_C2->APB1LLPENR) |= (RCC_APB1LLPENR_TIM14LPEN)
#define __HAL_RCC_C2_LPTIM1_CLK_SLEEP_ENABLE()                                 \
  (RCC_C2->APB1LLPENR) |= (RCC_APB1LLPENR_LPTIM1LPEN)
#define __HAL_RCC_C2_WWDG2_CLK_SLEEP_ENABLE()                                  \
  (RCC_C2->APB1LLPENR) |= (RCC_APB1LLPENR_WWDG2LPEN)
#define __HAL_RCC_C2_SPI2_CLK_SLEEP_ENABLE()                                   \
  (RCC_C2->APB1LLPENR) |= (RCC_APB1LLPENR_SPI2LPEN)
#define __HAL_RCC_C2_SPI3_CLK_SLEEP_ENABLE()                                   \
  (RCC_C2->APB1LLPENR) |= (RCC_APB1LLPENR_SPI3LPEN)
#define __HAL_RCC_C2_SPDIFRX_CLK_SLEEP_ENABLE()                                \
  (RCC_C2->APB1LLPENR) |= (RCC_APB1LLPENR_SPDIFRXLPEN)
#define __HAL_RCC_C2_USART2_CLK_SLEEP_ENABLE()                                 \
  (RCC_C2->APB1LLPENR) |= (RCC_APB1LLPENR_USART2LPEN)
#define __HAL_RCC_C2_USART3_CLK_SLEEP_ENABLE()                                 \
  (RCC_C2->APB1LLPENR) |= (RCC_APB1LLPENR_USART3LPEN)
#define __HAL_RCC_C2_UART4_CLK_SLEEP_ENABLE()                                  \
  (RCC_C2->APB1LLPENR) |= (RCC_APB1LLPENR_UART4LPEN)
#define __HAL_RCC_C2_UART5_CLK_SLEEP_ENABLE()                                  \
  (RCC_C2->APB1LLPENR) |= (RCC_APB1LLPENR_UART5LPEN)
#define __HAL_RCC_C2_I2C1_CLK_SLEEP_ENABLE()                                   \
  (RCC_C2->APB1LLPENR) |= (RCC_APB1LLPENR_I2C1LPEN)
#define __HAL_RCC_C2_I2C2_CLK_SLEEP_ENABLE()                                   \
  (RCC_C2->APB1LLPENR) |= (RCC_APB1LLPENR_I2C2LPEN)
#define __HAL_RCC_C2_I2C3_CLK_SLEEP_ENABLE()                                   \
  (RCC_C2->APB1LLPENR) |= (RCC_APB1LLPENR_I2C3LPEN)
#define __HAL_RCC_C2_CEC_CLK_SLEEP_ENABLE()                                    \
  (RCC_C2->APB1LLPENR) |= (RCC_APB1LLPENR_CECLPEN)
#define __HAL_RCC_C2_DAC12_CLK_SLEEP_ENABLE()                                  \
  (RCC_C2->APB1LLPENR) |= (RCC_APB1LLPENR_DAC12LPEN)
#define __HAL_RCC_C2_UART7_CLK_SLEEP_ENABLE()                                  \
  (RCC_C2->APB1LLPENR) |= (RCC_APB1LLPENR_UART7LPEN)
#define __HAL_RCC_C2_UART8_CLK_SLEEP_ENABLE()                                  \
  (RCC_C2->APB1LLPENR) |= (RCC_APB1LLPENR_UART8LPEN)
#define __HAL_RCC_C2_CRS_CLK_SLEEP_ENABLE()                                    \
  (RCC_C2->APB1HLPENR) |= (RCC_APB1HLPENR_CRSLPEN)
#define __HAL_RCC_C2_SWPMI_CLK_SLEEP_ENABLE()                                  \
  (RCC_C2->APB1HLPENR) |= (RCC_APB1HLPENR_SWPMILPEN)
#define __HAL_RCC_C2_OPAMP_CLK_SLEEP_ENABLE()                                  \
  (RCC_C2->APB1HLPENR) |= (RCC_APB1HLPENR_OPAMPLPEN)
#define __HAL_RCC_C2_MDIOS_CLK_SLEEP_ENABLE()                                  \
  (RCC_C2->APB1HLPENR) |= (RCC_APB1HLPENR_MDIOSLPEN)
#define __HAL_RCC_C2_FDCAN_CLK_SLEEP_ENABLE()                                  \
  (RCC_C2->APB1HLPENR) |= (RCC_APB1HLPENR_FDCANLPEN)

#define __HAL_RCC_C2_TIM2_CLK_SLEEP_DISABLE()                                  \
  (RCC_C2->APB1LLPENR) &= ~(RCC_APB1LLPENR_TIM2LPEN)
#define __HAL_RCC_C2_TIM3_CLK_SLEEP_DISABLE()                                  \
  (RCC_C2->APB1LLPENR) &= ~(RCC_APB1LLPENR_TIM3LPEN)
#define __HAL_RCC_C2_TIM4_CLK_SLEEP_DISABLE()                                  \
  (RCC_C2->APB1LLPENR) &= ~(RCC_APB1LLPENR_TIM4LPEN)
#define __HAL_RCC_C2_TIM5_CLK_SLEEP_DISABLE()                                  \
  (RCC_C2->APB1LLPENR) &= ~(RCC_APB1LLPENR_TIM5LPEN)
#define __HAL_RCC_C2_TIM6_CLK_SLEEP_DISABLE()                                  \
  (RCC_C2->APB1LLPENR) &= ~(RCC_APB1LLPENR_TIM6LPEN)
#define __HAL_RCC_C2_TIM7_CLK_SLEEP_DISABLE()                                  \
  (RCC_C2->APB1LLPENR) &= ~(RCC_APB1LLPENR_TIM7LPEN)
#define __HAL_RCC_C2_TIM12_CLK_SLEEP_DISABLE()                                 \
  (RCC_C2->APB1LLPENR) &= ~(RCC_APB1LLPENR_TIM12LPEN)
#define __HAL_RCC_C2_TIM13_CLK_SLEEP_DISABLE()                                 \
  (RCC_C2->APB1LLPENR) &= ~(RCC_APB1LLPENR_TIM13LPEN)
#define __HAL_RCC_C2_TIM14_CLK_SLEEP_DISABLE()                                 \
  (RCC_C2->APB1LLPENR) &= ~(RCC_APB1LLPENR_TIM14LPEN)
#define __HAL_RCC_C2_LPTIM1_CLK_SLEEP_DISABLE()                                \
  (RCC_C2->APB1LLPENR) &= ~(RCC_APB1LLPENR_LPTIM1LPEN)
#define __HAL_RCC_C2_WWDG2_CLK_SLEEP_DISABLE()                                 \
  (RCC_C2->APB1LLPENR) &= ~(RCC_APB1LLPENR_WWDG2LPEN)
#define __HAL_RCC_C2_SPI2_CLK_SLEEP_DISABLE()                                  \
  (RCC_C2->APB1LLPENR) &= ~(RCC_APB1LLPENR_SPI2LPEN)
#define __HAL_RCC_C2_SPI3_CLK_SLEEP_DISABLE()                                  \
  (RCC_C2->APB1LLPENR) &= ~(RCC_APB1LLPENR_SPI3LPEN)
#define __HAL_RCC_C2_SPDIFRX_CLK_SLEEP_DISABLE()                               \
  (RCC_C2->APB1LLPENR) &= ~(RCC_APB1LLPENR_SPDIFRXLPEN)
#define __HAL_RCC_C2_USART2_CLK_SLEEP_DISABLE()                                \
  (RCC_C2->APB1LLPENR) &= ~(RCC_APB1LLPENR_USART2LPEN)
#define __HAL_RCC_C2_USART3_CLK_SLEEP_DISABLE()                                \
  (RCC_C2->APB1LLPENR) &= ~(RCC_APB1LLPENR_USART3LPEN)
#define __HAL_RCC_C2_UART4_CLK_SLEEP_DISABLE()                                 \
  (RCC_C2->APB1LLPENR) &= ~(RCC_APB1LLPENR_UART4LPEN)
#define __HAL_RCC_C2_UART5_CLK_SLEEP_DISABLE()                                 \
  (RCC_C2->APB1LLPENR) &= ~(RCC_APB1LLPENR_UART5LPEN)
#define __HAL_RCC_C2_I2C1_CLK_SLEEP_DISABLE()                                  \
  (RCC_C2->APB1LLPENR) &= ~(RCC_APB1LLPENR_I2C1LPEN)
#define __HAL_RCC_C2_I2C2_CLK_SLEEP_DISABLE()                                  \
  (RCC_C2->APB1LLPENR) &= ~(RCC_APB1LLPENR_I2C2LPEN)
#define __HAL_RCC_C2_I2C3_CLK_SLEEP_DISABLE()                                  \
  (RCC_C2->APB1LLPENR) &= ~(RCC_APB1LLPENR_I2C3LPEN)
#define __HAL_RCC_C2_CEC_CLK_SLEEP_DISABLE()                                   \
  (RCC_C2->APB1LLPENR) &= ~(RCC_APB1LLPENR_CECLPEN)
#define __HAL_RCC_C2_DAC12_CLK_SLEEP_DISABLE()                                 \
  (RCC_C2->APB1LLPENR) &= ~(RCC_APB1LLPENR_DAC12LPEN)
#define __HAL_RCC_C2_UART7_CLK_SLEEP_DISABLE()                                 \
  (RCC_C2->APB1LLPENR) &= ~(RCC_APB1LLPENR_UART7LPEN)
#define __HAL_RCC_C2_UART8_CLK_SLEEP_DISABLE()                                 \
  (RCC_C2->APB1LLPENR) &= ~(RCC_APB1LLPENR_UART8LPEN)
#define __HAL_RCC_C2_CRS_CLK_SLEEP_DISABLE()                                   \
  (RCC_C2->APB1HLPENR) &= ~(RCC_APB1HLPENR_CRSLPEN)
#define __HAL_RCC_C2_SWPMI_CLK_SLEEP_DISABLE()                                 \
  (RCC_C2->APB1HLPENR) &= ~(RCC_APB1HLPENR_SWPMILPEN)
#define __HAL_RCC_C2_OPAMP_CLK_SLEEP_DISABLE()                                 \
  (RCC_C2->APB1HLPENR) &= ~(RCC_APB1HLPENR_OPAMPLPEN)
#define __HAL_RCC_C2_MDIOS_CLK_SLEEP_DISABLE()                                 \
  (RCC_C2->APB1HLPENR) &= ~(RCC_APB1HLPENR_MDIOSLPEN)
#define __HAL_RCC_C2_FDCAN_CLK_SLEEP_DISABLE()                                 \
  (RCC_C2->APB1HLPENR) &= ~(RCC_APB1HLPENR_FDCANLPEN)
...
#define __HAL_RCC_C2_TIM1_CLK_SLEEP_ENABLE()                                   \
  (RCC_C2->APB2LPENR) |= (RCC_APB2LPENR_TIM1LPEN)
#define __HAL_RCC_C2_TIM8_CLK_SLEEP_ENABLE()                                   \
  (RCC_C2->APB2LPENR) |= (RCC_APB2LPENR_TIM8LPEN)
#define __HAL_RCC_C2_USART1_CLK_SLEEP_ENABLE()                                 \
  (RCC_C2->APB2LPENR) |= (RCC_APB2LPENR_USART1LPEN)
#define __HAL_RCC_C2_USART6_CLK_SLEEP_ENABLE()                                 \
  (RCC_C2->APB2LPENR) |= (RCC_APB2LPENR_USART6LPEN)
#define __HAL_RCC_C2_SPI1_CLK_SLEEP_ENABLE()                                   \
  (RCC_C2->APB2LPENR) |= (RCC_APB2LPENR_SPI1LPEN)
#define __HAL_RCC_C2_SPI4_CLK_SLEEP_ENABLE()                                   \
  (RCC_C2->APB2LPENR) |= (RCC_APB2LPENR_SPI4LPEN)
#define __HAL_RCC_C2_TIM15_CLK_SLEEP_ENABLE()                                  \
  (RCC_C2->APB2LPENR) |= (RCC_APB2LPENR_TIM15LPEN)
#define __HAL_RCC_C2_TIM16_CLK_SLEEP_ENABLE()                                  \
  (RCC_C2->APB2LPENR) |= (RCC_APB2LPENR_TIM16LPEN)
#define __HAL_RCC_C2_TIM17_CLK_SLEEP_ENABLE()                                  \
  (RCC_C2->APB2LPENR) |= (RCC_APB2LPENR_TIM17LPEN)
#define __HAL_RCC_C2_SPI5_CLK_SLEEP_ENABLE()                                   \
  (RCC_C2->APB2LPENR) |= (RCC_APB2LPENR_SPI5LPEN)
#define __HAL_RCC_C2_SAI1_CLK_SLEEP_ENABLE()                                   \
  (RCC_C2->APB2LPENR) |= (RCC_APB2LPENR_SAI1LPEN)
#define __HAL_RCC_C2_SAI2_CLK_SLEEP_ENABLE()                                   \
  (RCC_C2->APB2LPENR) |= (RCC_APB2LPENR_SAI2LPEN)
#define __HAL_RCC_C2_SAI3_CLK_SLEEP_ENABLE()                                   \
  (RCC_C2->APB2LPENR) |= (RCC_APB2LPENR_SAI3LPEN)
#define __HAL_RCC_C2_DFSDM1_CLK_SLEEP_ENABLE()                                 \
  (RCC_C2->APB2LPENR) |= (RCC_APB2LPENR_DFSDM1LPEN)
#define __HAL_RCC_C2_HRTIM1_CLK_SLEEP_ENABLE()                                 \
  (RCC_C2->APB2LPENR) |= (RCC_APB2LPENR_HRTIMLPEN)

#define __HAL_RCC_C2_TIM1_CLK_SLEEP_DISABLE()                                  \
  (RCC_C2->APB2LPENR) &= ~(RCC_APB2LPENR_TIM1LPEN)
#define __HAL_RCC_C2_TIM8_CLK_SLEEP_DISABLE()                                  \
  (RCC_C2->APB2LPENR) &= ~(RCC_APB2LPENR_TIM8LPEN)
#define __HAL_RCC_C2_USART1_CLK_SLEEP_DISABLE()                                \
  (RCC_C2->APB2LPENR) &= ~(RCC_APB2LPENR_USART1LPEN)
#define __HAL_RCC_C2_USART6_CLK_SLEEP_DISABLE()                                \
  (RCC_C2->APB2LPENR) &= ~(RCC_APB2LPENR_USART6LPEN)
#define __HAL_RCC_C2_SPI1_CLK_SLEEP_DISABLE()                                  \
  (RCC_C2->APB2LPENR) &= ~(RCC_APB2LPENR_SPI1LPEN)
#define __HAL_RCC_C2_SPI4_CLK_SLEEP_DISABLE()                                  \
  (RCC_C2->APB2LPENR) &= ~(RCC_APB2LPENR_SPI4LPEN)
#define __HAL_RCC_C2_TIM15_CLK_SLEEP_DISABLE()                                 \
  (RCC_C2->APB2LPENR) &= ~(RCC_APB2LPENR_TIM15LPEN)
#define __HAL_RCC_C2_TIM16_CLK_SLEEP_DISABLE()                                 \
  (RCC_C2->APB2LPENR) &= ~(RCC_APB2LPENR_TIM16LPEN)
#define __HAL_RCC_C2_TIM17_CLK_SLEEP_DISABLE()                                 \
  (RCC_C2->APB2LPENR) &= ~(RCC_APB2LPENR_TIM17LPEN)
#define __HAL_RCC_C2_SPI5_CLK_SLEEP_DISABLE()                                  \
  (RCC_C2->APB2LPENR) &= ~(RCC_APB2LPENR_SPI5LPEN)
#define __HAL_RCC_C2_SAI1_CLK_SLEEP_DISABLE()                                  \
  (RCC_C2->APB2LPENR) &= ~(RCC_APB2LPENR_SAI1LPEN)
#define __HAL_RCC_C2_SAI2_CLK_SLEEP_DISABLE()                                  \
  (RCC_C2->APB2LPENR) &= ~(RCC_APB2LPENR_SAI2LPEN)
#define __HAL_RCC_C2_SAI3_CLK_SLEEP_DISABLE()                                  \
  (RCC_C2->APB2LPENR) &= ~(RCC_APB2LPENR_SAI3LPEN)
#define __HAL_RCC_C2_DFSDM1_CLK_SLEEP_DISABLE()                                \
  (RCC_C2->APB2LPENR) &= ~(RCC_APB2LPENR_DFSDM1LPEN)
#define __HAL_RCC_C2_HRTIM1_CLK_SLEEP_DISABLE()                                \
  (RCC_C2->APB2LPENR) &= ~(RCC_APB2LPENR_HRTIMLPEN)
...
#define __HAL_RCC_C2_SYSCFG_CLK_SLEEP_ENABLE()                                 \
  (RCC_C2->APB4LPENR) |= (RCC_APB4LPENR_SYSCFGLPEN)
#define __HAL_RCC_C2_LPUART1_CLK_SLEEP_ENABLE()                                \
  (RCC_C2->APB4LPENR) |= (RCC_APB4LPENR_LPUART1LPEN)
#define __HAL_RCC_C2_SPI6_CLK_SLEEP_ENABLE()                                   \
  (RCC_C2->APB4LPENR) |= (RCC_APB4LPENR_SPI6LPEN)
#define __HAL_RCC_C2_I2C4_CLK_SLEEP_ENABLE()                                   \
  (RCC_C2->APB4LPENR) |= (RCC_APB4LPENR_I2C4LPEN)
#define __HAL_RCC_C2_LPTIM2_CLK_SLEEP_ENABLE()                                 \
  (RCC_C2->APB4LPENR) |= (RCC_APB4LPENR_LPTIM2LPEN)
#define __HAL_RCC_C2_LPTIM3_CLK_SLEEP_ENABLE()                                 \
  (RCC_C2->APB4LPENR) |= (RCC_APB4LPENR_LPTIM3LPEN)
#define __HAL_RCC_C2_LPTIM4_CLK_SLEEP_ENABLE()                                 \
  (RCC_C2->APB4LPENR) |= (RCC_APB4LPENR_LPTIM4LPEN)
#define __HAL_RCC_C2_LPTIM5_CLK_SLEEP_ENABLE()                                 \
  (RCC_C2->APB4LPENR) |= (RCC_APB4LPENR_LPTIM5LPEN)
#define __HAL_RCC_C2_COMP12_CLK_SLEEP_ENABLE()                                 \
  (RCC_C2->APB4LPENR) |= (RCC_APB4LPENR_COMP12LPEN)
#define __HAL_RCC_C2_VREF_CLK_SLEEP_ENABLE()                                   \
  (RCC_C2->APB4LPENR) |= (RCC_APB4LPENR_VREFLPEN)
#define __HAL_RCC_C2_SAI4_CLK_SLEEP_ENABLE()                                   \
  (RCC_C2->APB4LPENR) |= (RCC_APB4LPENR_SAI4LPEN)
#define __HAL_RCC_C2_RTC_CLK_SLEEP_ENABLE()                                    \
  (RCC_C2->APB4LPENR) |= (RCC_APB4LPENR_RTCAPBLPEN)

#define __HAL_RCC_C2_SYSCFG_CLK_SLEEP_DISABLE()                                \
  (RCC_C2->APB4LPENR) &= ~(RCC_APB4LPENR_SYSCFGLPEN)
#define __HAL_RCC_C2_LPUART1_CLK_SLEEP_DISABLE()                               \
  (RCC_C2->APB4LPENR) &= ~(RCC_APB4LPENR_LPUART1LPEN)
#define __HAL_RCC_C2_SPI6_CLK_SLEEP_DISABLE()                                  \
  (RCC_C2->APB4LPENR) &= ~(RCC_APB4LPENR_SPI6LPEN)
#define __HAL_RCC_C2_I2C4_CLK_SLEEP_DISABLE()                                  \
  (RCC_C2->APB4LPENR) &= ~(RCC_APB4LPENR_I2C4LPEN)
#define __HAL_RCC_C2_LPTIM2_CLK_SLEEP_DISABLE()                                \
  (RCC_C2->APB4LPENR) &= ~(RCC_APB4LPENR_LPTIM2LPEN)
#define __HAL_RCC_C2_LPTIM3_CLK_SLEEP_DISABLE()                                \
  (RCC_C2->APB4LPENR) &= ~(RCC_APB4LPENR_LPTIM3LPEN)
#define __HAL_RCC_C2_LPTIM4_CLK_SLEEP_DISABLE()                                \
  (RCC_C2->APB4LPENR) &= ~(RCC_APB4LPENR_LPTIM4LPEN)
#define __HAL_RCC_C2_LPTIM5_CLK_SLEEP_DISABLE()                                \
  (RCC_C2->APB4LPENR) &= ~(RCC_APB4LPENR_LPTIM5LPEN)
#define __HAL_RCC_C2_COMP12_CLK_SLEEP_DISABLE()                                \
  (RCC_C2->APB4LPENR) &= ~(RCC_APB4LPENR_COMP12LPEN)
#define __HAL_RCC_C2_VREF_CLK_SLEEP_DISABLE()                                  \
  (RCC_C2->APB4LPENR) &= ~(RCC_APB4LPENR_VREFLPEN)
#define __HAL_RCC_C2_SAI4_CLK_SLEEP_DISABLE()                                  \
  (RCC_C2->APB4LPENR) &= ~(RCC_APB4LPENR_SAI4LPEN)
#define __HAL_RCC_C2_RTC_CLK_SLEEP_DISABLE()                                   \
  (RCC_C2->APB4LPENR) &= ~(RCC_APB4LPENR_RTCAPBLPEN)
 ...
 * @note   After reset (default config), peripheral clock is disabled when both
 * CPUs are in CSTOP
 */
#else
/** @brief  Enable or disable peripheral bus clock  when D3 domain is in DRUN
 * @note   After reset (default config), peripheral clock is disabled when CPU
 * is in CSTOP
 */
#endif /*DUAL_CORE*/
...
#define __HAL_RCC_LPUART1_CLKAM_ENABLE()                                       \
  (RCC->SRDAMR) |= (RCC_SRDAMR_LPUART1AMEN)
#endif
...
#define __HAL_RCC_SRDSRAM_CLKAM_ENABLE()                                       \
  (RCC->SRDAMR) |= (RCC_SRDAMR_SRDSRAMAMEN)
#endif
...
#endif
#if defined(RCC_D3AMR_LPUART1AMEN)
#define __HAL_RCC_LPUART1_CLKAM_DISABLE()                                      \
  (RCC->D3AMR) &= ~(RCC_D3AMR_LPUART1AMEN)
#endif
#if defined(RCC_D3AMR_SPI6AMEN)
...
#endif
#if defined(RCC_SRDAMR_LPTIM2AMEN)
#define __HAL_RCC_LPTIM2_CLKAM_DISABLE()                                       \
  (RCC->SRDAMR) &= ~(RCC_SRDAMR_LPTIM2AMEN)
#endif
#if defined(RCC_SRDAMR_LPTIM3AMEN)
...
#endif
#if defined(RCC_SRDAMR_COMP12AMEN)
#define __HAL_RCC_COMP12_CLKAM_DISABLE()                                       \
  (RCC->SRDAMR) &= ~(RCC_SRDAMR_COMP12AMEN)
#endif
#if defined(RCC_SRDAMR_VREFAMEN)
...
#endif
#if defined(DFSDM2_BASE)
#define __HAL_RCC_DFSDM2_CLKAM_DISABLE()                                       \
  (RCC->SRDAMR) &= ~(RCC_SRDAMR_DFSDM2AMEN)
#endif
#if defined(RCC_SRDAMR_BKPRAMAMEN)
#define __HAL_RCC_BKPRAM_CLKAM_DISABLE()                                       \
  (RCC->SRDAMR) &= ~(RCC_SRDAMR_BKPRAMAMEN)
#endif
#if defined(RCC_SRDAMR_SRDSRAMAMEN)
#define __HAL_RCC_SRDSRAM_CLKAM_DISABLE()                                      \
  (RCC->SRDAMR) &= ~(RCC_SRDAMR_SRDSRAMAMEN)
#endif

#if defined(RCC_CKGAENR_AXICKG)
/** @brief  Macro to enable or disable the RCC_CKGAENR bits (AXI clocks gating
 * enable register).
 */
...
#define __HAL_RCC_GFXMMUM_CLKGA_ENABLE()                                       \
  (RCC->CKGAENR) |= (RCC_CKGAENR_GFXMMUMCKG)
...
#define __HAL_RCC_OCTOSPI2_CLKGA_ENABLE()                                      \
  (RCC->CKGAENR) |= (RCC_CKGAENR_OCTOSPI2CKG)
#define __HAL_RCC_FMC_CLKGA_ENABLE() (RCC->CKGAENR) |= (RCC_CKGAENR_FMCCKG)
#define __HAL_RCC_OCTOSPI1_CLKGA_ENABLE()                                      \
  (RCC->CKGAENR) |= (RCC_CKGAENR_OCTOSPI1CKG)
#define __HAL_RCC_AXIRAM1_CLKGA_ENABLE()                                       \
  (RCC->CKGAENR) |= (RCC_CKGAENR_AXIRAM1CKG)
#define __HAL_RCC_AXIRAM2_CLKGA_ENABLE()                                       \
  (RCC->CKGAENR) |= (RCC_CKGAENR_AXIRAM2CKG)
#define __HAL_RCC_AXIRAM3_CLKGA_ENABLE()                                       \
  (RCC->CKGAENR) |= (RCC_CKGAENR_AXIRAM3CKG)
#define __HAL_RCC_GFXMMUS_CLKGA_ENABLE()                                       \
  (RCC->CKGAENR) |= (RCC_CKGAENR_GFXMMUSCKG)
#define __HAL_RCC_ECCRAM_CLKGA_ENABLE()                                        \
  (RCC->CKGAENR) |= (RCC_CKGAENR_ECCRAMCKG)
...
#define __HAL_RCC_SDMMC_CLKGA_DISABLE()                                        \
  (RCC->CKGAENR) &= ~(RCC_CKGAENR_SDMMCCKG)
#define __HAL_RCC_MDMA_CLKGA_DISABLE() (RCC->CKGAENR) &= ~(RCC_CKGAENR_MDMACKG)
#define __HAL_RCC_DMA2D_CLKGA_DISABLE()                                        \
  (RCC->CKGAENR) &= ~(RCC_CKGAENR_DMA2DCKG)
#define __HAL_RCC_LTDC_CLKGA_DISABLE() (RCC->CKGAENR) &= ~(RCC_CKGAENR_LTDCCKG)
#define __HAL_RCC_GFXMMUM_CLKGA_DISABLE()                                      \
  (RCC->CKGAENR) &= ~(RCC_CKGAENR_GFXMMUMCKG)
#define __HAL_RCC_AHB12_CLKGA_DISABLE()                                        \
  (RCC->CKGAENR) &= ~(RCC_CKGAENR_AHB12CKG)
#define __HAL_RCC_AHB34_CLKGA_DISABLE()                                        \
  (RCC->CKGAENR) &= ~(RCC_CKGAENR_AHB34CKG)
#define __HAL_RCC_FLIFT_CLKGA_DISABLE()                                        \
  (RCC->CKGAENR) &= ~(RCC_CKGAENR_FLIFTCKG)
#define __HAL_RCC_OCTOSPI2_CLKGA_DISABLE()                                     \
  (RCC->CKGAENR) &= ~(RCC_CKGAENR_OCTOSPI2CKG)
#define __HAL_RCC_FMC_CLKGA_DISABLE() (RCC->CKGAENR) &= ~(RCC_CKGAENR_FMCCKG)
#define __HAL_RCC_OCTOSPI1_CLKGA_DISABLE()                                     \
  (RCC->CKGAENR) &= ~(RCC_CKGAENR_OCTOSPI1CKG)
#define __HAL_RCC_AXIRAM1_CLKGA_DISABLE()                                      \
  (RCC->CKGAENR) &= ~(RCC_CKGAENR_AXIRAM1CKG)
#define __HAL_RCC_AXIRAM2_CLKGA_DISABLE()                                      \
  (RCC->CKGAENR) &= ~(RCC_CKGAENR_AXIRAM2CKG)
#define __HAL_RCC_AXIRAM3_CLKGA_DISABLE()                                      \
  (RCC->CKGAENR) &= ~(RCC_CKGAENR_AXIRAM3CKG)
#define __HAL_RCC_GFXMMUS_CLKGA_DISABLE()                                      \
  (RCC->CKGAENR) &= ~(RCC_CKGAENR_GFXMMUSCKG)
 ...
 * @note     The HSI is stopped by hardware when entering STOP and STANDBY
 * modes.
 ...
 *            @arg RCC_HSI_DIV1 turn ON the HSI oscillator and divide it by 1
 * (default after reset)
 ...
 *         of the following:
 *            - RCC_CR_HSIDIV_1  HSI oscillator divided by 1 (default after
 * reset)
 ...
 * start-up from Reset, wakeup from STOP and STANDBY mode, or in case of failure
 ...
 *         This parameter must be a number between 0 and 0x7F (3F for Rev Y
 * device).
 */
#if defined(RCC_VER_X)
  ...
  do {                                                                         \
    if (HAL_GetREVID() <= REV_ID_Y) {                                          \
      if ((__HSICalibrationValue__) == RCC_HSICALIBRATION_DEFAULT) {           \
        MODIFY_REG(RCC->HSICFGR, HAL_RCC_REV_Y_HSITRIM_Msk,                    \
                   ((uint32_t)0x20) << HAL_RCC_REV_Y_HSITRIM_Pos);             \
      } else {                                                                 \
        MODIFY_REG(RCC->HSICFGR, HAL_RCC_REV_Y_HSITRIM_Msk,                    \
                   (uint32_t)(__HSICalibrationValue__)                         \
 ...
 * communication speed because of the HSI start-up time.
...
/**
 * @brief  Macro to enable or disable the Internal High Speed oscillator for USB
 * (HSI48).
 ...
 * modes. It is used (enabled by hardware) as system clock source after start-up
 ...
 * @note     When the CSI is stopped, CSIRDY flag goes low after 6 CSI
  ...
  do {                                                                         \
    if (HAL_GetREVID() <= REV_ID_Y) {                                          \
      if ((__CSICalibrationValue__) == RCC_CSICALIBRATION_DEFAULT) {           \
        MODIFY_REG(RCC->HSICFGR, HAL_RCC_REV_Y_CSITRIM_Msk,                    \
                   ((uint32_t)0x10) << HAL_RCC_REV_Y_CSITRIM_Pos);             \
      } else {                                                                 \
        MODIFY_REG(RCC->HSICFGR, HAL_RCC_REV_Y_CSITRIM_Msk,                    \
 ...
 * @note   After enabling the HSE (RCC_HSE_ON, RCC_HSE_BYPASS or
 * RCC_HSE_BYPASS_DIGITAL), the application software should wait on HSERDY flag
 * to be set indicating that HSE clock is stable and can be used to clock the
 * PLL and/or system clock.
 ...
 *            @arg RCC_HSE_BYPASS_DIGITAL: HSE oscillator bypassed with digital
 * external clock. (*)
 *
...
/**
  ...
  *         User should request a transition to LSE Off first and then LSE On or
  LSE Bypass.
  * @note   The external input clock can have a frequency up to 1 MHz and be low
  swing (analog) or digital(*). A duty cycle close to 50% is recommended.
  * @note   As the LSE is in the Backup domain and write access is denied to
  *         this domain after reset, you have to enable write access using
  *         HAL_PWR_EnableBkUpAccess() function before to configure the LSE
  *         (to be done once after reset).
  * @note   After enabling the LSE (RCC_LSE_ON, RCC_LSE_BYPASS or
  RCC_LSE_BYPASS_DIGITAL*), the application
  *         software should wait on LSERDY flag to be set indicating that LSE
  clock
  *         is stable and can be used to clock the RTC.
  * @note   If the RTC is used, the LSE bypass must not be configured in digital
  mode but in low swing analog mode (*)
  ...
  *            @arg RCC_LSE_BYPASS_DIGITAL: LSE oscillator bypassed with
...
/**
 * @brief  Enables or disables each clock output (PLL_P_CLK, PLL_Q_CLK,
 * PLL_R_CLK)
 * @note   Enabling/disabling  those Clocks can be done only when the PLL is
 * disabled. This is mainly used to save Power. (The ck_pll_p of the System PLL
 * cannot be stopped if used as System Clock).
 * @param  __RCC_PLL1ClockOut__: specifies the PLL clock to be outputted
 *          This parameter can be one of the following values:
 *            @arg RCC_PLL1_DIVP: This clock is used to generate system clock up
 * to 550MHZ(*), 480MHZ(**) or 280MHZ(***)
 *            @arg RCC_PLL1_DIVQ: This clock is used to generate peripherals
 * clock up to 550MHZ(*), 480MHZ(**) or 280MHZ(***)
 *            @arg RCC_PLL1_DIVR: This clock is used to generate peripherals
 * clock up to 550MHZ(*), 480MHZ(**) or 280MHZ(***)
 *
 * (*) : For stm32h72xxx and stm32h73xxx family lines and requires to enable the
 * CPU_FREQ_BOOST flash option byte, 520MHZ otherwise.
 * (**) : For stm32h74xx and stm32h75xx family lines and requires the board to
 * be connected on LDO regulator not SMPS, 400MHZ otherwise.
...
#define __HAL_RCC_PLLCLKOUT_DISABLE(__RCC_PLL1ClockOut__)                      \
  CLEAR_BIT(RCC->PLLCFGR, (__RCC_PLL1ClockOut__))
...
/**
 * @brief  Macro to configures the main PLL clock source, multiplication and
 * division factors.
 * @note   This function must be used only when the main PLL is disabled.
 *
 * @param  __RCC_PLLSOURCE__: specifies the PLL entry clock source.
 *          This parameter can be one of the following values:
 *            @arg RCC_PLLSOURCE_CSI: CSI oscillator clock selected as PLL clock
 * entry
 ...
 * entry
 * @note   This clock source (__RCC_PLLSource__) is common for the main PLL1
 * (main PLL) and PLL2 & PLL3 .
 *
 ...
 * input frequency ranges from 1 to 16 MHz.
 *
 * @param  __PLLN1__: specifies the multiplication factor for PLL VCO output
 * clock This parameter must be a number between 4 and 512 or between 8 and
 * 420(*).
 * @note   You have to set the PLLN parameter correctly to ensure that the VCO
 *         output frequency is between 150 and 420 MHz (when in medium VCO
 * range) or between 192 and 836 MHZ or between 128 and 560 MHZ(*) (when in wide
 * VCO range)
 *
 * @param  __PLLP1__: specifies the division factor for system  clock.
 *          This parameter must be a number between 2 or 1(**) and 128 (where
 ...
 *          This parameter must be a number between 1 and 128
 *
 * @note   To insure an optimal behavior of the PLL when one of the post-divider
 * (DIVP, DIVQ or DIVR) is not used, application shall clear the enable bit
 * (DIVyEN) and assign lowest possible value to  __PLL1P__, __PLL1Q__ or
 * __PLL1R__ parameters.
 * @retval None
 *
 *  (*) : For stm32h7a3xx and stm32h7b3xx family lines.
...
#define __HAL_RCC_PLL_CONFIG(__RCC_PLLSOURCE__, __PLLM1__, __PLLN1__,          \
                             __PLLP1__, __PLLQ1__, __PLLR1__)                  \
  do {                                                                         \
    MODIFY_REG(RCC->PLLCKSELR, (RCC_PLLCKSELR_PLLSRC | RCC_PLLCKSELR_DIVM1),   \
               ((__RCC_PLLSOURCE__) | ((__PLLM1__) << 4U)));                   \
    WRITE_REG(RCC->PLL1DIVR, ((((__PLLN1__)-1U) & RCC_PLL1DIVR_N1) |           \
                              ((((__PLLP1__)-1U) << 9U) & RCC_PLL1DIVR_P1) |   \
                              ((((__PLLQ1__)-1U) << 16U) & RCC_PLL1DIVR_Q1) |  \
                              ((((__PLLR1__)-1U) << 24U) & RCC_PLL1DIVR_R1))); \
  } while (0)
 ...
 * of the PLL1 VCO
 *
 * @param  __RCC_PLL1FRACN__: specifies Fractional Part Of The Multiplication
 * Factor for PLL1 VCO It should be a value between 0 and 8191
 ...
 * to 836 MHz or 128 to 560 MHz(*) if PLL1VCOSEL = 0 150 to 420 MHz if
 * PLL1VCOSEL = 1.
 *
 * (*) : For stm32h7a3xx and stm32h7b3xx family lines.
 *
...
#define __HAL_RCC_GET_PLL_OSCSOURCE()                                          \
  ((uint32_t)(RCC->PLLCKSELR & RCC_PLLCKSELR_PLLSRC))
 ...
 *         HAL_PWR_EnableBkUpAccess() function before to configure the LSE
 *         (to be done once after reset).
 * @note   On STM32H7 Rev.B and above devices this can't be updated while LSE is
 * ON.
...
#define __HAL_RCC_LSEDRIVE_CONFIG(__LSEDRIVE__)                                \
  do {                                                                         \
    if ((HAL_GetREVID() <= REV_ID_Y) &&                                        \
        (((__LSEDRIVE__) == RCC_LSEDRIVE_MEDIUMLOW) ||                         \
         ((__LSEDRIVE__) == RCC_LSEDRIVE_MEDIUMHIGH))) {                       \
      MODIFY_REG(RCC->BDCR, RCC_BDCR_LSEDRV,                                   \
                 (~(uint32_t)(__LSEDRIVE__)) & RCC_BDCR_LSEDRV_Msk);           \
    } else {                                                                   \
 ...
 * @param  __RCC_STOPWUCLK__: specifies the clock source used after wake up from
 ...
 *            @arg RCC_FLAG_LPWR1RST: Reset due to illegal D1 DSTANDBY or CPU
 * CSTOP flag
 *            @arg RCC_FLAG_LPWR2RST: Reset due to illegal D2 DSTANDBY or CPU2
 * CSTOP flag
 ...
 *            @arg RCC_FLAG_D1CKRDY:  Domain1 clock ready (*)
 *            @arg RCC_FLAG_D2CKRDY:  Domain2 clock ready (*)
 *            @arg RCC_FLAG_CPUCKRDY: CPU Domain clock ready (CPU, APB3, bus
 * matrix1 and related memories) (*)
...
#define RCC_GET_PLL_OSCSOURCE()                                                \
  ((RCC->PLLCKSELR & RCC_PLLCKSELR_PLLSRC) >> RCC_PLLCKSELR_PLLSRC_Pos)
...
#define IS_RCC_HSI48(HSI48)                                                    \
  (((HSI48) == RCC_HSI48_OFF) || ((HSI48) == RCC_HSI48_ON))
...
#define IS_RCC_PLLSOURCE(SOURCE)                                               \
  (((SOURCE) == RCC_PLLSOURCE_CSI) || ((SOURCE) == RCC_PLLSOURCE_HSI) ||       \
   ((SOURCE) == RCC_PLLSOURCE_NONE) || ((SOURCE) == RCC_PLLSOURCE_HSE))

#define IS_RCC_PLLRGE_VALUE(VALUE)                                             \
  (((VALUE) == RCC_PLL1VCIRANGE_0) || ((VALUE) == RCC_PLL1VCIRANGE_1) ||       \
   ((VALUE) == RCC_PLL1VCIRANGE_2) || ((VALUE) == RCC_PLL1VCIRANGE_3))

#define IS_RCC_PLLVCO_VALUE(VALUE)                                             \
  (((VALUE) == RCC_PLL1VCOWIDE) || ((VALUE) == RCC_PLL1VCOMEDIUM))
...
#define IS_RCC_SYSCLKSOURCE(SOURCE)                                            \
  (((SOURCE) == RCC_SYSCLKSOURCE_CSI) || ((SOURCE) == RCC_SYSCLKSOURCE_HSI) || \
...
#define IS_RCC_D1PCLK1                                                         \
  IS_RCC_CDPCLK1 /* for legacy compatibility between H7 lines */
...
#define IS_RCC_D3PCLK1                                                         \
  IS_RCC_SRDPCLK1 /* for legacy compatibility between H7 lines*/
...
#define IS_RCC_MCO2SOURCE(SOURCE)                                              \
  (((SOURCE) == RCC_MCO2SOURCE_SYSCLK) ||                                      \
   ((SOURCE) == RCC_MCO2SOURCE_PLL2PCLK) ||                                    \
...
#define IS_RCC_FLAG(FLAG)                                                      \
  (((FLAG) == RCC_FLAG_HSIRDY) || ((FLAG) == RCC_FLAG_CSIRDY) ||               \
   ...
   ((FLAG) == RCC_FLAG_LSIRDY) || ((FLAG) == RCC_FLAG_C1RST) ||                \
   ((FLAG) == RCC_FLAG_C2RST) || ((FLAG) == RCC_FLAG_SFTR2ST) ||               \
   ((FLAG) == RCC_FLAG_WWDG2RST) || ((FLAG) == RCC_FLAG_IWDG2RST) ||           \
   ((FLAG) == RCC_FLAG_D1RST) || ((FLAG) == RCC_FLAG_D2RST) ||                 \
   ((FLAG) == RCC_FLAG_BORRST) || ((FLAG) == RCC_FLAG_PINRST) ||               \
   ((FLAG) == RCC_FLAG_PORRST) || ((FLAG) == RCC_FLAG_SFTR1ST) ||              \
   ((FLAG) == RCC_FLAG_IWDG1RST) || ((FLAG) == RCC_FLAG_WWDG1RST) ||           \
   ((FLAG) == RCC_FLAG_LPWR1RST) || ((FLAG) == RCC_FLAG_LPWR2RST) ||           \
   ((FLAG) == RCC_FLAG_HSIDIV))
...
#define IS_RCC_FLAG(FLAG)                                                      \
  (((FLAG) == RCC_FLAG_HSIRDY) || ((FLAG) == RCC_FLAG_CSIRDY) ||               \
   ...
   ((FLAG) == RCC_FLAG_PLLRDY) || ((FLAG) == RCC_FLAG_PLL2RDY) ||              \
   ((FLAG) == RCC_FLAG_PLL3RDY) || ((FLAG) == RCC_FLAG_LSERDY) ||              \
   ((FLAG) == RCC_FLAG_LSIRDY) || ((FLAG) == RCC_FLAG_CPURST) ||               \
   ((FLAG) == RCC_FLAG_D1RST) || ((FLAG) == RCC_FLAG_D2RST) ||                 \
   ((FLAG) == RCC_FLAG_BORRST) || ((FLAG) == RCC_FLAG_PINRST) ||               \
...
#define IS_RCC_FLAG(FLAG)                                                      \
  (((FLAG) == RCC_FLAG_HSIRDY) || ((FLAG) == RCC_FLAG_CSIRDY) ||               \
   ...
   ((FLAG) == RCC_FLAG_PLLRDY) || ((FLAG) == RCC_FLAG_PLL2RDY) ||              \
   ((FLAG) == RCC_FLAG_PLL3RDY) || ((FLAG) == RCC_FLAG_LSERDY) ||              \
   ((FLAG) == RCC_FLAG_LSIRDY) || ((FLAG) == RCC_FLAG_CDRST) ||                \
   ((FLAG) == RCC_FLAG_BORRST) || ((FLAG) == RCC_FLAG_PINRST) ||               \
   ((FLAG) == RCC_FLAG_PORRST) || ((FLAG) == RCC_FLAG_SFTRST) ||               \
   ((FLAG) == RCC_FLAG_IWDG1RST) || ((FLAG) == RCC_FLAG_WWDG1RST) ||           \
   ((FLAG) == RCC_FLAG_LPWR1RST) || ((FLAG) == RCC_FLAG_LPWR2RST) ||           \
