...
typedef struct {
  ...
  uint32_t
      OutputRed; /*!< Specifies the Red value of the output image.
                      - This parameter must be a number between:
                        Min_Data = 0x00 and Max_Data = 0xFF if ARGB8888 color
                    mode is selected.
                      - This parameter must be a number between:
                        Min_Data = 0x00 and Max_Data = 0xFF if RGB888 color mode
                    is selected.
                      - This parameter must be a number between:
                        Min_Data = 0x00 and Max_Data = 0x1F if RGB565 color mode
                    is selected.
                      - This parameter must be a number between:
                        Min_Data = 0x00 and Max_Data = 0x1F if ARGB1555 color
                    mode is selected.
                      - This parameter must be a number between:
                        Min_Data = 0x00 and Max_Data = 0x0F if ARGB4444 color
                    mode is selected.

                      This parameter can be modified afterwards
                      using unitary function @ref LL_DMA2D_SetOutputColor() or
                    configuration function @ref LL_DMA2D_ConfigOutputColor(). */
  ...
  uint32_t
      OutputMemoryAddress; /*!< Specifies the memory address.
                                - This parameter must be a number between:
  ...
  uint32_t OutputSwapMode; /*!< Specifies the output swap mode color format of
                          the output image.
                          - This parameter can be one value of @ref
  ...
  uint32_t
      NbrOfLines; /*!< Specifies the number of lines of the area to be
                     transferred.
                       - This parameter must be a number between:
  ...
  uint32_t NbrOfPixelsPerLines; /*!< Specifies the number of pixels per lines of
...
typedef struct {
  uint32_t
      MemoryAddress; /*!< Specifies the foreground or background memory address.
                          - This parameter must be a number between:
                            Min_Data = 0x0000 and Max_Data = 0xFFFFFFFF.
  ...
  uint32_t
      LineOffset; /*!< Specifies the foreground or background line offset value.
                     ...
                     functions
                       - @ref LL_DMA2D_FGND_SetLineOffset() for foreground
                     layer,
                       - @ref LL_DMA2D_BGND_SetLineOffset() for background
                     layer. */

  uint32_t
      ColorMode; /*!< Specifies the foreground or background color mode.
                      - This parameter can be one value of @ref
  ...
  uint32_t CLUTColorMode; /*!< Specifies the foreground or background CLUT color
                             mode.
                                - This parameter can be one value of @ref
  ...
  uint32_t
      CLUTSize; /*!< Specifies the foreground or background CLUT size.
  ...
  uint32_t
      AlphaMode; /*!< Specifies the foreground or background alpha mode.
                       - This parameter can be one value of @ref
  ...
  uint32_t
      CLUTMemoryAddress; /*!< Specifies the foreground or background CLUT memory
                            address.
                              - This parameter must be a number between:
                                Min_Data = 0x0000 and Max_Data = 0xFFFFFFFF.
                              ...
                              This parameter can be modified afterwards using
                            unitary functions
                              - @ref LL_DMA2D_FGND_SetCLUTMemAddr() for
                            foreground layer,
                              - @ref LL_DMA2D_BGND_SetCLUTMemAddr() for
                            background layer. */

  uint32_t AlphaInversionMode; /*!< Specifies the foreground or background alpha
                                  inversion mode.
                                    - This parameter can be one value of @ref
                                  DMA2D_LL_EC_ALPHA_INVERSION.
                                  ...
                                  using unitary functions
                                    - @ref LL_DMA2D_FGND_SetAlphaInvMode() for
                                  foreground layer,
                                    - @ref LL_DMA2D_BGND_SetAlphaInvMode() for
                                  background layer. */

  uint32_t RBSwapMode; /*!< Specifies the foreground or background Red Blue swap
                          mode. This parameter can be one value of @ref
                          DMA2D_LL_EC_RED_BLUE_SWAP .

                            This parameter can be modified afterwards using
                          unitary functions
                            - @ref LL_DMA2D_FGND_SetRBSwapMode() for foreground
                          layer,
                            - @ref LL_DMA2D_BGND_SetRBSwapMode() for background
                          layer. */

  uint32_t
      ChromaSubSampling; /*!< Configure the chroma sub-sampling mode for the
                            YCbCr color mode This parameter is applicable for
                            foreground layer only. This parameter can be one
                            value of @ref DMA2D_LL_CHROMA_SUB_SAMPLING

                              This parameter can be modified afterwards using
                            unitary functions
                              - @ref LL_DMA2D_FGND_SetChrSubSampling() for
                            foreground layer. */
...
#define LL_DMA2D_IT_CTCIE                                                      \
  DMA2D_CR_CTCIE /*!< CLUT Transfer Complete Interrupt */
 ...
 * @{
 */
#define LL_DMA2D_MODE_M2M                                                      \
  0x00000000U /*!< DMA2D memory to memory transfer mode */
#define LL_DMA2D_MODE_M2M_PFC                                                  \
  DMA2D_CR_MODE_0 /*!< DMA2D memory to memory with pixel format conversion     \
                     transfer mode */
#define LL_DMA2D_MODE_M2M_BLEND                                                \
  DMA2D_CR_MODE_1 /*!< DMA2D memory to memory with blending transfer mode */
#define LL_DMA2D_MODE_R2M                                                      \
  (DMA2D_CR_MODE_0 |                                                           \
   DMA2D_CR_MODE_1) /*!< DMA2D register to memory transfer mode */
#define LL_DMA2D_MODE_M2M_BLEND_FIXED_COLOR_FG                                 \
  DMA2D_CR_MODE_2 /*!< DMA2D memory to memory with blending transfer mode and  \
                     fixed color foreground */
#define LL_DMA2D_MODE_M2M_BLEND_FIXED_COLOR_BG                                 \
  (DMA2D_CR_MODE_0 |                                                           \
   DMA2D_CR_MODE_2) /*!< DMA2D memory to memory with blending transfer mode    \
...
#define LL_DMA2D_OUTPUT_MODE_ARGB1555                                          \
  (DMA2D_OPFCCR_CM_0 | DMA2D_OPFCCR_CM_1)               /*!< ARGB1555 */
...
#define LL_DMA2D_INPUT_MODE_ARGB1555                                           \
  (DMA2D_FGPFCCR_CM_0 | DMA2D_FGPFCCR_CM_1)             /*!< ARGB1555 */
#define LL_DMA2D_INPUT_MODE_ARGB4444 DMA2D_FGPFCCR_CM_2 /*!< ARGB4444 */
#define LL_DMA2D_INPUT_MODE_L8                                                 \
  (DMA2D_FGPFCCR_CM_0 | DMA2D_FGPFCCR_CM_2) /*!< L8       */
#define LL_DMA2D_INPUT_MODE_AL44                                               \
  (DMA2D_FGPFCCR_CM_1 | DMA2D_FGPFCCR_CM_2) /*!< AL44     */
...
#define LL_DMA2D_INPUT_MODE_A8                                                 \
  (DMA2D_FGPFCCR_CM_0 | DMA2D_FGPFCCR_CM_3) /*!< A8       */
#define LL_DMA2D_INPUT_MODE_A4                                                 \
  (DMA2D_FGPFCCR_CM_1 | DMA2D_FGPFCCR_CM_3) /*!< A4       */
#define LL_DMA2D_INPUT_MODE_YCBCR                                              \
  (DMA2D_FGPFCCR_CM_0 | DMA2D_FGPFCCR_CM_1 | DMA2D_FGPFCCR_CM_3) /*!< YCbCr */
/**
 * @}
 */
...
#define LL_DMA2D_SWAP_MODE_TWO_BY_TWO                                          \
  DMA2D_OPFCCR_SB /*!< Bytes swapped two by two */
/**
 * @}
 */
 ...
 * @{
 */
#define LL_DMA2D_LINE_OFFSET_PIXELS                                            \
  0x00000000U /*!< Line offsets are expressed in pixels  */
#define LL_DMA2D_LINE_OFFSET_BYTES                                             \
  DMA2D_CR_LOM /*!< Line offsets are expressed in bytes   */
/**
 * @}
 */
 ...
 */
#define LL_DMA2D_ReadReg(__INSTANCE__, __REG__)                                \
...
LL_DMA2D_IsTransferOngoing(const DMA2D_TypeDef *DMA2Dx) {
  return ((READ_BIT(DMA2Dx->CR, DMA2D_CR_START) == (DMA2D_CR_START)) ? 1UL
                                                                     : 0UL);
}
...
__STATIC_INLINE uint32_t LL_DMA2D_IsAborted(const DMA2D_TypeDef *DMA2Dx) {
  return ((READ_BIT(DMA2Dx->CR, DMA2D_CR_ABORT) == (DMA2D_CR_ABORT)) ? 1UL
                                                                     : 0UL);
}
 ...
 */
__STATIC_INLINE uint32_t
LL_DMA2D_GetOutputColorMode(const DMA2D_TypeDef *DMA2Dx) {
 ...
 */
__STATIC_INLINE uint32_t
LL_DMA2D_GetOutputRBSwapMode(const DMA2D_TypeDef *DMA2Dx) {
...
LL_DMA2D_SetOutputAlphaInvMode(DMA2D_TypeDef *DMA2Dx,
 ...
 */
__STATIC_INLINE uint32_t
LL_DMA2D_GetOutputAlphaInvMode(const DMA2D_TypeDef *DMA2Dx) {
 ...
 */
__STATIC_INLINE uint32_t
LL_DMA2D_GetOutputSwapMode(const DMA2D_TypeDef *DMA2Dx) {
 ...
 */
__STATIC_INLINE uint32_t
LL_DMA2D_GetLineOffsetMode(const DMA2D_TypeDef *DMA2Dx) {
 ...
 */
__STATIC_INLINE void
LL_DMA2D_SetNbrOfPixelsPerLines(DMA2D_TypeDef *DMA2Dx,
 ...
 */
__STATIC_INLINE uint32_t
LL_DMA2D_GetNbrOfPixelsPerLines(const DMA2D_TypeDef *DMA2Dx) {
 ...
 */
__STATIC_INLINE uint32_t
LL_DMA2D_GetOutputMemAddr(const DMA2D_TypeDef *DMA2Dx) {
...
__STATIC_INLINE uint32_t LL_DMA2D_GetOutputColor(const DMA2D_TypeDef *DMA2Dx) {
  return (uint32_t)(READ_BIT(DMA2Dx->OCOLR,
                             (DMA2D_OCOLR_BLUE_1 | DMA2D_OCOLR_GREEN_1 |
 ...
 */
__STATIC_INLINE uint32_t
LL_DMA2D_GetLineWatermark(const DMA2D_TypeDef *DMA2Dx) {
 ...
 */
__STATIC_INLINE uint32_t
LL_DMA2D_IsEnabledDeadTime(const DMA2D_TypeDef *DMA2Dx) {
  return ((READ_BIT(DMA2Dx->AMTCR, DMA2D_AMTCR_EN) == (DMA2D_AMTCR_EN)) ? 1UL
                                                                        : 0UL);
}
 ...
 */
__STATIC_INLINE uint32_t
LL_DMA2D_FGND_IsEnabledCLUTLoad(const DMA2D_TypeDef *DMA2Dx) {
  return (
      (READ_BIT(DMA2Dx->FGPFCCR, DMA2D_FGPFCCR_START) == (DMA2D_FGPFCCR_START))
          ? 1UL
          : 0UL);
}
 ...
 */
__STATIC_INLINE uint32_t
LL_DMA2D_FGND_GetColorMode(const DMA2D_TypeDef *DMA2Dx) {
 ...
 */
__STATIC_INLINE uint32_t
LL_DMA2D_FGND_GetAlphaMode(const DMA2D_TypeDef *DMA2Dx) {
 ...
 */
__STATIC_INLINE uint32_t
LL_DMA2D_FGND_GetRBSwapMode(const DMA2D_TypeDef *DMA2Dx) {
 ...
 */
__STATIC_INLINE void
LL_DMA2D_FGND_SetAlphaInvMode(DMA2D_TypeDef *DMA2Dx,
                              uint32_t AlphaInversionMode) {
 ...
 */
__STATIC_INLINE uint32_t
LL_DMA2D_FGND_GetAlphaInvMode(const DMA2D_TypeDef *DMA2Dx) {
 ...
 */
__STATIC_INLINE uint32_t
LL_DMA2D_FGND_GetLineOffset(const DMA2D_TypeDef *DMA2Dx) {
...
__STATIC_INLINE void LL_DMA2D_FGND_SetColor(DMA2D_TypeDef *DMA2Dx, uint32_t Red,
  ...
  MODIFY_REG(DMA2Dx->FGCOLR,
             ...
             ((Red << DMA2D_FGCOLR_RED_Pos) |
              (Green << DMA2D_FGCOLR_GREEN_Pos) | Blue));
}
 ...
 */
__STATIC_INLINE uint32_t
LL_DMA2D_FGND_GetRedColor(const DMA2D_TypeDef *DMA2Dx) {
 ...
 */
__STATIC_INLINE uint32_t
LL_DMA2D_FGND_GetGreenColor(const DMA2D_TypeDef *DMA2Dx) {
 ...
 */
__STATIC_INLINE uint32_t
LL_DMA2D_FGND_GetBlueColor(const DMA2D_TypeDef *DMA2Dx) {
 ...
 */
__STATIC_INLINE uint32_t
LL_DMA2D_FGND_GetCLUTMemAddr(const DMA2D_TypeDef *DMA2Dx) {
 ...
 */
__STATIC_INLINE uint32_t
LL_DMA2D_FGND_GetCLUTSize(const DMA2D_TypeDef *DMA2Dx) {
 ...
 */
__STATIC_INLINE uint32_t
LL_DMA2D_FGND_GetCLUTColorMode(const DMA2D_TypeDef *DMA2Dx) {
  return (uint32_t)(READ_BIT(DMA2Dx->FGPFCCR, DMA2D_FGPFCCR_CCM));
}

/**
 * @brief  Set DMA2D foreground Chroma Sub Sampling (for YCbCr input color
 * mode).
 ...
 */
__STATIC_INLINE void
LL_DMA2D_FGND_SetChrSubSampling(DMA2D_TypeDef *DMA2Dx,
                                uint32_t ChromaSubSampling) {
  MODIFY_REG(DMA2Dx->FGPFCCR, DMA2D_FGPFCCR_CSS, ChromaSubSampling);
}

/**
 * @brief  Return DMA2D foreground Chroma Sub Sampling (for YCbCr input color
 * mode).
 ...
 */
__STATIC_INLINE uint32_t
LL_DMA2D_FGND_GetChrSubSampling(const DMA2D_TypeDef *DMA2Dx) {
 ...
 */
__STATIC_INLINE uint32_t
LL_DMA2D_BGND_IsEnabledCLUTLoad(const DMA2D_TypeDef *DMA2Dx) {
  return (
      (READ_BIT(DMA2Dx->BGPFCCR, DMA2D_BGPFCCR_START) == (DMA2D_BGPFCCR_START))
          ? 1UL
          : 0UL);
}
 ...
 */
__STATIC_INLINE uint32_t
LL_DMA2D_BGND_GetColorMode(const DMA2D_TypeDef *DMA2Dx) {
 ...
 */
__STATIC_INLINE uint32_t
LL_DMA2D_BGND_GetAlphaMode(const DMA2D_TypeDef *DMA2Dx) {
 ...
 */
__STATIC_INLINE uint32_t
LL_DMA2D_BGND_GetRBSwapMode(const DMA2D_TypeDef *DMA2Dx) {
 ...
 */
__STATIC_INLINE void
LL_DMA2D_BGND_SetAlphaInvMode(DMA2D_TypeDef *DMA2Dx,
                              uint32_t AlphaInversionMode) {
 ...
 */
__STATIC_INLINE uint32_t
LL_DMA2D_BGND_GetAlphaInvMode(const DMA2D_TypeDef *DMA2Dx) {
 ...
 */
__STATIC_INLINE uint32_t
LL_DMA2D_BGND_GetLineOffset(const DMA2D_TypeDef *DMA2Dx) {
...
__STATIC_INLINE void LL_DMA2D_BGND_SetColor(DMA2D_TypeDef *DMA2Dx, uint32_t Red,
  ...
  MODIFY_REG(DMA2Dx->BGCOLR,
             ...
             ((Red << DMA2D_BGCOLR_RED_Pos) |
              (Green << DMA2D_BGCOLR_GREEN_Pos) | Blue));
}
 ...
 */
__STATIC_INLINE uint32_t
LL_DMA2D_BGND_GetRedColor(const DMA2D_TypeDef *DMA2Dx) {
 ...
 */
__STATIC_INLINE uint32_t
LL_DMA2D_BGND_GetGreenColor(const DMA2D_TypeDef *DMA2Dx) {
 ...
 */
__STATIC_INLINE uint32_t
LL_DMA2D_BGND_GetBlueColor(const DMA2D_TypeDef *DMA2Dx) {
 ...
 */
__STATIC_INLINE uint32_t
LL_DMA2D_BGND_GetCLUTMemAddr(const DMA2D_TypeDef *DMA2Dx) {
 ...
 */
__STATIC_INLINE uint32_t
LL_DMA2D_BGND_GetCLUTSize(const DMA2D_TypeDef *DMA2Dx) {
 ...
 */
__STATIC_INLINE uint32_t
LL_DMA2D_BGND_GetCLUTColorMode(const DMA2D_TypeDef *DMA2Dx) {
...
__STATIC_INLINE uint32_t LL_DMA2D_IsActiveFlag_CE(const DMA2D_TypeDef *DMA2Dx) {
  return ((READ_BIT(DMA2Dx->ISR, DMA2D_ISR_CEIF) == (DMA2D_ISR_CEIF)) ? 1UL
                                                                      : 0UL);
}
 ...
 */
__STATIC_INLINE uint32_t
LL_DMA2D_IsActiveFlag_CTC(const DMA2D_TypeDef *DMA2Dx) {
  return ((READ_BIT(DMA2Dx->ISR, DMA2D_ISR_CTCIF) == (DMA2D_ISR_CTCIF)) ? 1UL
                                                                        : 0UL);
}
 ...
 */
__STATIC_INLINE uint32_t
LL_DMA2D_IsActiveFlag_CAE(const DMA2D_TypeDef *DMA2Dx) {
  return ((READ_BIT(DMA2Dx->ISR, DMA2D_ISR_CAEIF) == (DMA2D_ISR_CAEIF)) ? 1UL
                                                                        : 0UL);
}
...
__STATIC_INLINE uint32_t LL_DMA2D_IsActiveFlag_TW(const DMA2D_TypeDef *DMA2Dx) {
  return ((READ_BIT(DMA2Dx->ISR, DMA2D_ISR_TWIF) == (DMA2D_ISR_TWIF)) ? 1UL
                                                                      : 0UL);
}
...
__STATIC_INLINE uint32_t LL_DMA2D_IsActiveFlag_TC(const DMA2D_TypeDef *DMA2Dx) {
  return ((READ_BIT(DMA2Dx->ISR, DMA2D_ISR_TCIF) == (DMA2D_ISR_TCIF)) ? 1UL
                                                                      : 0UL);
}
...
__STATIC_INLINE uint32_t LL_DMA2D_IsActiveFlag_TE(const DMA2D_TypeDef *DMA2Dx) {
  return ((READ_BIT(DMA2Dx->ISR, DMA2D_ISR_TEIF) == (DMA2D_ISR_TEIF)) ? 1UL
                                                                      : 0UL);
}
...
__STATIC_INLINE uint32_t LL_DMA2D_IsEnabledIT_CTC(const DMA2D_TypeDef *DMA2Dx) {
  return ((READ_BIT(DMA2Dx->CR, DMA2D_CR_CTCIE) == (DMA2D_CR_CTCIE)) ? 1UL
                                                                     : 0UL);
}
...
__STATIC_INLINE uint32_t LL_DMA2D_IsEnabledIT_CAE(const DMA2D_TypeDef *DMA2Dx) {
  return ((READ_BIT(DMA2Dx->CR, DMA2D_CR_CAEIE) == (DMA2D_CR_CAEIE)) ? 1UL
                                                                     : 0UL);
}
...
uint32_t LL_DMA2D_GetOutputBlueColor(const DMA2D_TypeDef *DMA2Dx,
                                     uint32_t ColorMode);
uint32_t LL_DMA2D_GetOutputGreenColor(const DMA2D_TypeDef *DMA2Dx,
                                      uint32_t ColorMode);
uint32_t LL_DMA2D_GetOutputRedColor(const DMA2D_TypeDef *DMA2Dx,
                                    uint32_t ColorMode);
uint32_t LL_DMA2D_GetOutputAlphaColor(const DMA2D_TypeDef *DMA2Dx,
                                      uint32_t ColorMode);
void LL_DMA2D_ConfigSize(DMA2D_TypeDef *DMA2Dx, uint32_t NbrOfLines,
                         uint32_t NbrOfPixelsPerLines);
