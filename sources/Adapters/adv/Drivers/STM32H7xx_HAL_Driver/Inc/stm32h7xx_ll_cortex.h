...
#define LL_SYSTICK_CLKSOURCE_HCLK_DIV8                                         \
  0x00000000UL /*!< AHB clock divided by 8 selected as SysTick clock source.*/
...
#define LL_MPU_CTRL_HFNMI_PRIVDEF_NONE                                         \
  0x00000000UL /*!< Disable NMI and privileged SW access */
...
#define LL_MPU_REGION_SIZE_32B                                                 \
  (0x04UL << MPU_RASR_SIZE_Pos) /*!< 32B Size of the MPU protection region */
#define LL_MPU_REGION_SIZE_64B                                                 \
  (0x05UL << MPU_RASR_SIZE_Pos) /*!< 64B Size of the MPU protection region */
#define LL_MPU_REGION_SIZE_128B                                                \
  (0x06UL << MPU_RASR_SIZE_Pos) /*!< 128B Size of the MPU protection region */
#define LL_MPU_REGION_SIZE_256B                                                \
  (0x07UL << MPU_RASR_SIZE_Pos) /*!< 256B Size of the MPU protection region */
#define LL_MPU_REGION_SIZE_512B                                                \
  (0x08UL << MPU_RASR_SIZE_Pos) /*!< 512B Size of the MPU protection region */
#define LL_MPU_REGION_SIZE_1KB                                                 \
  (0x09UL << MPU_RASR_SIZE_Pos) /*!< 1KB Size of the MPU protection region */
#define LL_MPU_REGION_SIZE_2KB                                                 \
  (0x0AUL << MPU_RASR_SIZE_Pos) /*!< 2KB Size of the MPU protection region */
#define LL_MPU_REGION_SIZE_4KB                                                 \
  (0x0BUL << MPU_RASR_SIZE_Pos) /*!< 4KB Size of the MPU protection region */
#define LL_MPU_REGION_SIZE_8KB                                                 \
  (0x0CUL << MPU_RASR_SIZE_Pos) /*!< 8KB Size of the MPU protection region */
#define LL_MPU_REGION_SIZE_16KB                                                \
  (0x0DUL << MPU_RASR_SIZE_Pos) /*!< 16KB Size of the MPU protection region */
#define LL_MPU_REGION_SIZE_32KB                                                \
  (0x0EUL << MPU_RASR_SIZE_Pos) /*!< 32KB Size of the MPU protection region */
#define LL_MPU_REGION_SIZE_64KB                                                \
  (0x0FUL << MPU_RASR_SIZE_Pos) /*!< 64KB Size of the MPU protection region */
#define LL_MPU_REGION_SIZE_128KB                                               \
  (0x10UL << MPU_RASR_SIZE_Pos) /*!< 128KB Size of the MPU protection region   \
                                 */
#define LL_MPU_REGION_SIZE_256KB                                               \
  (0x11UL << MPU_RASR_SIZE_Pos) /*!< 256KB Size of the MPU protection region   \
                                 */
#define LL_MPU_REGION_SIZE_512KB                                               \
  (0x12UL << MPU_RASR_SIZE_Pos) /*!< 512KB Size of the MPU protection region   \
                                 */
#define LL_MPU_REGION_SIZE_1MB                                                 \
  (0x13UL << MPU_RASR_SIZE_Pos) /*!< 1MB Size of the MPU protection region */
#define LL_MPU_REGION_SIZE_2MB                                                 \
  (0x14UL << MPU_RASR_SIZE_Pos) /*!< 2MB Size of the MPU protection region */
#define LL_MPU_REGION_SIZE_4MB                                                 \
  (0x15UL << MPU_RASR_SIZE_Pos) /*!< 4MB Size of the MPU protection region */
#define LL_MPU_REGION_SIZE_8MB                                                 \
  (0x16UL << MPU_RASR_SIZE_Pos) /*!< 8MB Size of the MPU protection region */
#define LL_MPU_REGION_SIZE_16MB                                                \
  (0x17UL << MPU_RASR_SIZE_Pos) /*!< 16MB Size of the MPU protection region */
#define LL_MPU_REGION_SIZE_32MB                                                \
  (0x18UL << MPU_RASR_SIZE_Pos) /*!< 32MB Size of the MPU protection region */
#define LL_MPU_REGION_SIZE_64MB                                                \
  (0x19UL << MPU_RASR_SIZE_Pos) /*!< 64MB Size of the MPU protection region */
#define LL_MPU_REGION_SIZE_128MB                                               \
  (0x1AUL << MPU_RASR_SIZE_Pos) /*!< 128MB Size of the MPU protection region   \
                                 */
#define LL_MPU_REGION_SIZE_256MB                                               \
  (0x1BUL << MPU_RASR_SIZE_Pos) /*!< 256MB Size of the MPU protection region   \
                                 */
#define LL_MPU_REGION_SIZE_512MB                                               \
  (0x1CUL << MPU_RASR_SIZE_Pos) /*!< 512MB Size of the MPU protection region   \
                                 */
#define LL_MPU_REGION_SIZE_1GB                                                 \
  (0x1DUL << MPU_RASR_SIZE_Pos) /*!< 1GB Size of the MPU protection region */
#define LL_MPU_REGION_SIZE_2GB                                                 \
  (0x1EUL << MPU_RASR_SIZE_Pos) /*!< 2GB Size of the MPU protection region */
#define LL_MPU_REGION_SIZE_4GB                                                 \
  (0x1FUL << MPU_RASR_SIZE_Pos) /*!< 4GB Size of the MPU protection region */
/**
 * @}
 */
...
#define LL_MPU_REGION_PRIV_RW                                                  \
  (0x01UL << MPU_RASR_AP_Pos) /*!< RW privileged (privileged access only)*/
#define LL_MPU_REGION_PRIV_RW_URO                                              \
  (0x02UL << MPU_RASR_AP_Pos) /*!< RW privileged - RO user (Write in a user    \
                                 program generates a fault) */
#define LL_MPU_REGION_FULL_ACCESS                                              \
  (0x03UL << MPU_RASR_AP_Pos) /*!< RW privileged & user (Full access) */
#define LL_MPU_REGION_PRIV_RO                                                  \
  (0x05UL << MPU_RASR_AP_Pos) /*!< RO privileged (privileged read only)*/
#define LL_MPU_REGION_PRIV_RO_URO                                              \
  (0x06UL << MPU_RASR_AP_Pos) /*!< RO privileged & user (read only) */
/**
 * @}
 */
...
#define LL_MPU_TEX_LEVEL0                                                      \
  (0x00UL << MPU_RASR_TEX_Pos) /*!< b000 for TEX bits                          \
                                */
#define LL_MPU_TEX_LEVEL1                                                      \
  (0x01UL << MPU_RASR_TEX_Pos) /*!< b001 for TEX bits                          \
                                */
#define LL_MPU_TEX_LEVEL2                                                      \
  (0x02UL << MPU_RASR_TEX_Pos) /*!< b010 for TEX bits                          \
                                */

/* Legacy Define */
#define LL_MPU_TEX_LEVEL4                                                      \
  (0x04UL << MPU_RASR_TEX_Pos) /*!< b100 for TEX bits                          \
                                */
/**
 * @}
 */
...
#define LL_MPU_INSTRUCTION_ACCESS_ENABLE                                       \
  0x00UL /*!< Instruction fetches enabled */
...
#define LL_MPU_ACCESS_NOT_SHAREABLE                                            \
  0x00UL /*!< Not Shareable memory attribute */
/**
 * @}
 */
...
#define LL_MPU_ACCESS_NOT_CACHEABLE                                            \
  0x00UL /*!< Not Cacheable memory attribute */
/**
 * @}
 */
...
#define LL_MPU_ACCESS_NOT_BUFFERABLE                                           \
  0x00UL /*!< Not Bufferable memory attribute */
/**
 * @}
 */
#endif /* __MPU_PRESENT */
 ...
 * @retval Value should be equal to 0xC27 for Cortex-M7 and equal to 0xC24 for
 * Cortex-M4
 */
 ...
 * @note   For cortex-M4 only 8 regions are available i.e only values from
 * LL_MPU_REGION_NUMBER0 to LL_MPU_REGION_NUMBER7 are possible.
 * @retval None
 */
