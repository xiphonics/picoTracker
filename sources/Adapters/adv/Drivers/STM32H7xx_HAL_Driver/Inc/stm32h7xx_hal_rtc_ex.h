...
typedef struct {
  ...
  uint32_t
      NoErase; /*!< Specifies the Tamper no erase mode.
                    This parameter can be a value of @ref
                  RTCEx_Tamper_EraseBackUp_Definitions This parameter is not
                  applicable to the STM32H723/33, STM32H725/35 and STM32H730
                    devices, and has been kept for backward compatibility */

  uint32_t
      MaskFlag; /*!< Specifies the Tamper Flag masking.
                     This parameter can be a value of @ref
                   RTCEx_Tamper_MaskFlag_Definitions This parameter is not
                   applicable to the STM32H723/33, STM32H725/35 and STM32H730
                     devices, and has been kept for backward compatibility */
...
typedef struct {
  uint32_t IntTamper; /*!< Specifies the Internal Tamper Pin.
                           This parameter can be a value of @ref
                         RTCEx_Internal_Tamper_Pins_Definitions */
...
/** @defgroup RTCEx_ActiveTamper_structures_definition RTC Active Tamper
...
typedef struct {
  ...
  uint32_t
      TimeStampOnTamperDetection; /*!< Specifies the timeStamp on tamper
                                     detection. This parameter can be a
                                     value of @ref
                                     RTCEx_Tamper_TimeStampOnTamperDetection_Definitions
                                   */
...
/** @defgroup RTCEx_Backup_Registers_Number_Definitions RTC Backup Registers
 * Number Definitions
 * @{
 */
#if defined(TAMP)
...
/** @defgroup RTCEx_Backup_Registers_Definitions RTC Backup Registers
 * Definitions
 * @{
 */
...
/** @defgroup RTCEx_Tamper_Interrupt_Definitions RTC Tamper Interrupts
 * Definitions
 * @{
 */
#if defined(TAMP)
...
#define RTC_IT_TAMP2                                                           \
  TAMP_IER_TAMP2IE /*!< Enable Tamper 2 Interrupt                */
#define RTC_IT_TAMP3                                                           \
  TAMP_IER_TAMP3IE /*!< Enable Tamper 3 Interrupt                */
#else
#if defined(RTC_TAMPxIE_SUPPORT)
#define RTC_IT_TAMP1                                                           \
  RTC_TAMPCR_TAMP1IE /*!< Enable Tamper 1 Interrupt                */
#define RTC_IT_TAMP2                                                           \
  RTC_TAMPCR_TAMP2IE /*!< Enable Tamper 2 Interrupt                */
#define RTC_IT_TAMP3                                                           \
  RTC_TAMPCR_TAMP3IE /*!< Enable Tamper 3 Interrupt                */
#else
#define RTC_IT_TAMP1                                                           \
  RTC_TAFCR_TAMPIE /*!< Enable Tamper Interrupt                  */
#endif             /* RTC_TAMPxIE_SUPPORT */
#endif             /* TAMP */

#if defined(TAMP)
#define RTC_IT_TAMP                                                            \
  0x00000000u /*!< No such feature in RTC3                   */
#define RTC_IT_TAMPALL (RTC_IT_TAMP1 | RTC_IT_TAMP2 | RTC_IT_TAMP3)
#else
#define RTC_IT_TAMP                                                            \
  RTC_TAMPCR_TAMPIE /*!< Enable all Tamper Interrupts              */
...
/** @defgroup RTCEx_Internal_Tamper_Pins_Definitions  RTCEx Internal Tamper Pins
 * Definition
 * @{
 */
#if defined(TAMP)
...
#define RTC_INT_TAMPER_ALL                                                     \
  (RTC_INT_TAMPER_1 | RTC_INT_TAMPER_2 | RTC_INT_TAMPER_3 | RTC_INT_TAMPER_4 | \
   RTC_INT_TAMPER_5 | RTC_INT_TAMPER_6 | RTC_INT_TAMPER_8)
#endif /* TAMP */
/**
 * @}
 */

/** @defgroup RTCEx_Internal_Tamper_Interrupt_Definitions  RTC Internal Tamper
 * Interrupt
 * @{
 */
#if defined(TAMP)
#define RTC_INTERNAL_TAMPER1_INTERRUPT                                         \
  TAMP_IER_ITAMP1IE /*!< Enable Internal Tamper 1 Interrupt   */
#define RTC_INTERNAL_TAMPER2_INTERRUPT                                         \
  TAMP_IER_ITAMP2IE /*!< Enable Internal Tamper 2 Interrupt   */
#define RTC_INTERNAL_TAMPER3_INTERRUPT                                         \
  TAMP_IER_ITAMP3IE /*!< Enable Internal Tamper 3 Interrupt   */
#define RTC_INTERNAL_TAMPER4_INTERRUPT                                         \
  TAMP_IER_ITAMP4IE /*!< Enable Internal Tamper 4 Interrupt   */
#define RTC_INTERNAL_TAMPER5_INTERRUPT                                         \
  TAMP_IER_ITAMP5IE /*!< Enable Internal Tamper 5 Interrupt   */
#define RTC_INTERNAL_TAMPER6_INTERRUPT                                         \
  TAMP_IER_ITAMP6IE /*!< Enable Internal Tamper 6 Interrupt   */
#define RTC_INTERNAL_TAMPER8_INTERRUPT                                         \
  TAMP_IER_ITAMP8IE /*!< Enable Internal Tamper 8 Interrupt   */
#endif              /* TAMP */
/**
 * @}
 */
...
#define RTC_TAMPERTRIGGER_FALLINGEDGE                                          \
  0x02u /*!< Warning : Filter must be RTC_TAMPERFILTER_DISABLE     */
#define RTC_TAMPERTRIGGER_LOWLEVEL                                             \
  0x04u /*!< Warning : Filter must not be RTC_TAMPERFILTER_DISABLE */
#define RTC_TAMPERTRIGGER_HIGHLEVEL                                            \
  0x08u /*!< Warning : Filter must not be RTC_TAMPERFILTER_DISABLE */
...
#define RTC_TAMPER_X_TRIGGER                                                   \
  (RTC_TAMPER_1_TRIGGER | RTC_TAMPER_2_TRIGGER | RTC_TAMPER_3_TRIGGER)
#else
#define RTC_TAMPER_X_TRIGGER (RTC_TAMPER_1_TRIGGER | RTC_TAMPER_3_TRIGGER)
#endif /* RTC_TAMPER2_SUPPORT */
/**
 * @}
 */

/** @defgroup RTCEx_Tamper_EraseBackUp_Definitions RTC Tamper EraseBackUp
 * Definitions
 * @{
 */
#if defined(TAMP)
...
#else
/*!< These values are not applicable to the STM32H723/33, STM32H725/35 and
   STM32H730 devices, and have been kept for backward compatibility */
#define RTC_TAMPER_ERASE_BACKUP_ENABLE 0x00u
#define RTC_TAMPER_ERASE_BACKUP_DISABLE 0x01u
...
#define RTC_TAMPER_X_MASK_FLAG                                                 \
  (RTC_TAMPER_1_MASK_FLAG | RTC_TAMPER_2_MASK_FLAG | RTC_TAMPER_3_MASK_FLAG)
#endif /* RTC_TAMPMASKFLAG_SUPPORT */
/**
 * @}
 */
...
#define RTC_TAMPERFILTER_MASK                                                  \
  TAMP_FLTCR_TAMPFLT /*!< Masking all bits except those of                     \
                           field TAMPFLT[1:0]. */
#else
#define RTC_TAMPERFILTER_DISABLE 0x00000000u /*!< Tamper filter is disabled */
...
#define RTC_TAMPERFILTER_8SAMPLE                                               \
  RTC_TAMPCR_TAMPFLT /*!< Tamper is activated after 8                          \
                           consecutive samples at the active level. */
#define RTC_TAMPERFILTER_MASK                                                  \
  RTC_TAMPCR_TAMPFLT /*!< Masking all bits except those of                     \
                           field TAMPFLT[1:0]. */
#endif               /* TAMP */
/**
 * @}
...
/** @defgroup RTCEx_Tamper_Sampling_Frequencies_Definitions RTC Tamper Sampling
...
#define RTC_TAMPERSAMPLINGFREQ_RTCCLK_DIV256                                   \
  TAMP_FLTCR_TAMPFREQ /*!< Each of the tamper inputs are sampled               \
                            with a frequency =  RTCCLK / 256   */
#define RTC_TAMPERSAMPLINGFREQ_RTCCLK_MASK                                     \
  TAMP_FLTCR_TAMPFREQ /*!< Masking all bits except those of                    \
                            field TAMPFREQ[2:0]*/
#else
#define RTC_TAMPERSAMPLINGFREQ_RTCCLK_DIV32768                                 \
  0x00000000u /*!< Each of the tamper inputs are sampled                       \
...
#define RTC_TAMPERSAMPLINGFREQ_RTCCLK_DIV512                                   \
  (RTC_TAMPCR_TAMPFREQ_1 |                                                     \
   RTC_TAMPCR_TAMPFREQ_2) /*!< Each of the tamper inputs are sampled           \
                               with a frequency =  RTCCLK / 512   */
#define RTC_TAMPERSAMPLINGFREQ_RTCCLK_DIV256                                   \
  RTC_TAMPCR_TAMPFREQ /*!< Each of the tamper inputs are sampled               \
                           with a frequency =  RTCCLK / 256   */
#define RTC_TAMPERSAMPLINGFREQ_RTCCLK_MASK                                     \
  RTC_TAMPCR_TAMPFREQ /*!< Masking all bits except those of                    \
                            field TAMPFREQ[2:0]*/
#endif                /* TAMP */
/**
 * @}
...
/** @defgroup RTCEx_Tamper_Pin_Precharge_Duration_Definitions RTC Tamper Pin
 * Precharge Duration Definitions
 * @{
 */
#if defined(TAMP)
...
#define RTC_TAMPERPRECHARGEDURATION_8RTCCLK                                    \
  TAMP_FLTCR_TAMPPRCH /*!< Tamper pins are pre-charged before                  \
                            sampling during 8 RTCCLK cycles */
#define RTC_TAMPERPRECHARGEDURATION_MASK                                       \
  TAMP_FLTCR_TAMPPRCH /*!< Masking all bits except those of                    \
                            field TAMPPRCH[1:0] */
#else
#define RTC_TAMPERPRECHARGEDURATION_1RTCCLK                                    \
  0x00000000u /*!< Tamper pins are pre-charged before                          \
...
#define RTC_TAMPERPRECHARGEDURATION_4RTCCLK                                    \
  RTC_TAMPCR_TAMPPRCH_1 /*!< Tamper pins are pre-charged before                \
                              sampling during 4 RTCCLK cycles */
#define RTC_TAMPERPRECHARGEDURATION_8RTCCLK                                    \
  RTC_TAMPCR_TAMPPRCH /*!< Tamper pins are pre-charged before                  \
                            sampling during 8 RTCCLK cycles */
#define RTC_TAMPERPRECHARGEDURATION_MASK                                       \
  RTC_TAMPCR_TAMPPRCH /*!< Masking all bits except those of                    \
                            field TAMPPRCH[1:0] */
#endif                /* TAMP */
/**
 * @}
...
/** @defgroup RTCEx_Tamper_TimeStampOnTamperDetection_Definitions RTC Tamper
 * TimeStamp On Tamper Detection Definitions
 * @{
 */
#if defined(TAMP)
...
#define RTC_TIMESTAMPONTAMPERDETECTION_MASK                                    \
  RTC_CR_TAMPTS /*!< Masking all bits except bit TAMPTS               */
#else
#define RTC_TIMESTAMPONTAMPERDETECTION_DISABLE                                 \
  0x00000000u /*!< TimeStamp on Tamper Detection event is not saved */
#define RTC_TIMESTAMPONTAMPERDETECTION_ENABLE                                  \
...
#define RTC_TIMESTAMPONTAMPERDETECTION_MASK                                    \
  RTC_TAMPCR_TAMPTS /*!< Masking all bits except bit TAMPTS               */
#endif              /* TAMP */
/**
 * @}
 */
...
#define RTC_TAMPER_PULLUP_ENABLE                                               \
  0x00000000u /*!< Tamper pins are pre-charged before sampling */
#define RTC_TAMPER_PULLUP_DISABLE                                              \
  TAMP_FLTCR_TAMPPUDIS /*!< Tamper pins pre-charge is disabled          */
#define RTC_TAMPER_PULLUP_MASK                                                 \
  TAMP_FLTCR_TAMPPUDIS /*!< Maskin all bits except bit TAMPPUDIS        */
#else
#define RTC_TAMPER_PULLUP_ENABLE                                               \
  0x00000000u /*!< TimeStamp on Tamper Detection event saved        */
#define RTC_TAMPER_PULLUP_DISABLE                                              \
  RTC_TAMPCR_TAMPPUDIS /*!< TimeStamp on Tamper Detection event is not saved   \
                        */
#define RTC_TAMPER_PULLUP_MASK                                                 \
  RTC_TAMPCR_TAMPPUDIS /*!< Maskin all bits except bit TAMPPUDIS        */
#endif                 /* TAMP */
/**
 * @}
 */

/** @defgroup RTCEx_Tamper_DetectionOutput_Definitions RTC Tamper Detection
 * Output Definitions
 * @{
 */
#if defined(TAMP)
#define RTC_TAMPERDETECTIONOUTPUT_DISABLE                                      \
  0x00000000u /*!< The tamper flag is not routed on TAMPALRM */
#define RTC_TAMPERDETECTIONOUTPUT_ENABLE                                       \
  RTC_CR_TAMPOE /*!< The tamper flag is routed on TAMPALRM combined with the   \
                   signal provided by OSEL and with the polarity provided by   \
                   POL */
#endif          /* TAMP */
/**
 * @}
...
/** @defgroup RTCEx_ActiveTamper_Async_prescaler RTC
 ...
 */
#if defined(TAMP)
/* Add this offset to RTC registers base address to reach TAMP registers base
 * address. */
...
/** @defgroup RTCEx_Smooth_calib_period_Definitions RTC Smooth Calib Period
 * Definitions
 * @{
 */
...
/** @defgroup RTCEx_Smooth_calib_Plus_pulses_Definitions RTC Smooth Calib Plus
 * pulses Definitions
 * @{
 */
...
/** @defgroup RTCEx_Calib_Output_selection_Definitions RTC Calib Output
...
/** @defgroup RTCEx_Add_1_Second_Parameter_Definitions RTC Add 1 Second
 ...
 * not.
 * @param  __HANDLE__ specifies the RTC handle.
 * @param  __INTERRUPT__ specifies the RTC WakeUpTimer interrupt sources to
...
#define __HAL_RTC_WAKEUPTIMER_GET_IT(__HANDLE__, __INTERRUPT__)                \
  (((((__HANDLE__)->Instance->SR) & (__INTERRUPT__)) != 0U) ? 1U : 0U)
#else
#define __HAL_RTC_WAKEUPTIMER_GET_IT(__HANDLE__, __INTERRUPT__)                \
...
#define __HAL_RTC_WAKEUPTIMER_GET_FLAG(__HANDLE__, __FLAG__)                   \
  (((((__HANDLE__)->Instance->SR) & (__FLAG__)) != 0U) ? 1U : 0U)
#else
/**
 * @brief  Get the selected RTC WakeUpTimer's flag status.
 * @param  __HANDLE__ specifies the RTC handle.
...
#define __HAL_RTC_WAKEUPTIMER_CLEAR_FLAG(__HANDLE__, __FLAG__)                 \
  ((__HANDLE__)->Instance->ISR) =                                              \
      (~((__FLAG__) | RTC_ISR_INIT) |                                          \
       ((__HANDLE__)->Instance->ISR & RTC_ISR_INIT))
#endif /* TAMP */
...
#define __HAL_RTC_TAMPER1_ENABLE(__HANDLE__)                                   \
  (((TAMP_TypeDef *)((uint32_t)((__HANDLE__)->Instance) + TAMP_OFFSET))        \
       ->CR1 |= (TAMP_CR1_TAMP1E))
#else
#define __HAL_RTC_TAMPER1_ENABLE(__HANDLE__)                                   \
 ...
 */
#if defined(TAMP)
#define __HAL_RTC_TAMPER_GET_SAMPLING_FREQ(__HANDLE__)                         \
  ((uint32_t)((((TAMP_TypeDef *)((uint32_t)((__HANDLE__)->Instance) +          \
                                 TAMP_OFFSET))                                 \
                   ->FLTCR) &                                                  \
              (RTC_TAMPERSAMPLINGFREQ_RTCCLK_MASK)))
#else
#define __HAL_RTC_TAMPER_GET_SAMPLING_FREQ(__HANDLE__)                         \
  ((uint32_t)(((__HANDLE__)->Instance->TAMPCR) &                               \
              (RTC_TAMPERSAMPLINGFREQ_RTCCLK_MASK)))
#endif /* TAMP */
 ...
 */
#if defined(TAMP)
#define __HAL_RTC_TAMPER_GET_SAMPLES_COUNT(__HANDLE__)                         \
  ((uint32_t)((((TAMP_TypeDef *)((uint32_t)((__HANDLE__)->Instance) +          \
                                 TAMP_OFFSET))                                 \
                   ->FLTCR) &                                                  \
...
#else
#define __HAL_RTC_TAMPER_GET_SAMPLES_COUNT(__HANDLE__)                         \
  ((uint32_t)(((__HANDLE__)->Instance->TAMPCR) & (RTC_TAMPERFILTER_MASK)))
#endif /* TAMP */
 ...
 */
#if defined(TAMP)
#define __HAL_RTC_TAMPER_GET_PRCHRG_DURATION(__HANDLE__)                       \
  ((uint32_t)((((TAMP_TypeDef *)((uint32_t)((__HANDLE__)->Instance) +          \
                                 TAMP_OFFSET))                                 \
                   ->FLTCR) &                                                  \
 ...
 */
#if defined(TAMP)
#define __HAL_RTC_TAMPER_GET_PULLUP_STATUS(__HANDLE__)                         \
  ((uint32_t)((((TAMP_TypeDef *)((uint32_t)((__HANDLE__)->Instance) +          \
                                 TAMP_OFFSET))                                 \
                   ->FLTCR) &                                                  \
...
#else
#define __HAL_RTC_TAMPER_GET_PULLUP_STATUS(__HANDLE__)                         \
  ((uint32_t)(((__HANDLE__)->Instance->TAMPCR) & (RTC_TAMPER_PULLUP_MASK)))
#endif /* TAMP */
...
#define __HAL_RTC_TIMESTAMP_GET_IT(__HANDLE__, __INTERRUPT__)                  \
  (((((__HANDLE__)->Instance->MISR) & ((__INTERRUPT__) >> 12)) != 0U) ? 1U : 0U)
#else
#define __HAL_RTC_TIMESTAMP_GET_IT(__HANDLE__, __INTERRUPT__)                  \
  (((((__HANDLE__)->Instance->ISR) & (__INTERRUPT__)) != 0U) ? 1U : 0U)
#endif /* TAMP */
...
#define __HAL_RTC_TAMPTS_ENABLE(__HANDLE__)                                    \
  ((__HANDLE__)->Instance->CR |= (RTC_TIMESTAMPONTAMPERDETECTION_MASK))
#else
#define __HAL_RTC_TAMPTS_ENABLE(__HANDLE__)                                    \
 ...
 */
#if defined(TAMP)
#define __HAL_RTC_TAMPTS_DISABLE(__HANDLE__)                                   \
  ((__HANDLE__)->Instance->CR &= ~(RTC_TIMESTAMPONTAMPERDETECTION_MASK))
#else
#define __HAL_RTC_TAMPTS_DISABLE(__HANDLE__)                                   \
  ((__HANDLE__)->Instance->TAMPCR &= ~(RTC_TIMESTAMPONTAMPERDETECTION_MASK))
 ...
 */
#if defined(TAMP)
#define __HAL_RTC_TAMPTS_GET_STATUS(__HANDLE__)                                \
  ((__HANDLE__)->Instance->CR &= RTC_TIMESTAMPONTAMPERDETECTION_MASK)
#else
#define __HAL_RTC_TAMPTS_GET_STATUS(__HANDLE__)                                \
  ((__HANDLE__)->Instance->TAMPCR &= RTC_TIMESTAMPONTAMPERDETECTION_MASK)
 ...
 * @retval None
 */
#define __HAL_RTC_TAMPOE_ENABLE(__HANDLE__)                                    \
  ((__HANDLE__)->Instance->CR |= (RTC_CR_TAMPOE))
 ...
 * @retval None
 */
#define __HAL_RTC_TAMPOE_DISABLE(__HANDLE__)                                   \
  ((__HANDLE__)->Instance->CR &= ~(RTC_CR_TAMPOE))
#endif /* TAMP */
...
#define __HAL_RTC_SHIFT_GET_FLAG(__HANDLE__, __FLAG__)                         \
  (((((__HANDLE__)->Instance->ICSR) & (__FLAG__)) != 0U) ? 1U : 0U)
#else
#define __HAL_RTC_SHIFT_GET_FLAG(__HANDLE__, __FLAG__)                         \
  (((((__HANDLE__)->Instance->ISR) & (__FLAG__)) != 0U) ? 1U : 0U)
#endif /* TAMP */
...
#define __HAL_RTC_WAKEUPTIMER_EXTI_ENABLE_IT()                                 \
  (EXTI_D1->IMR1 |= RTC_EXTI_LINE_WAKEUPTIMER_EVENT)
#else /* EXTI */
#define __HAL_RTC_WAKEUPTIMER_EXTI_ENABLE_IT()                                 \
  (EXTI->IMR1 |= RTC_EXTI_LINE_WAKEUPTIMER_EVENT)
#endif /* EXTI_D1 */
/**
...
#define __HAL_RTC_WAKEUPTIMER_EXTI_ENABLE_EVENT()                              \
  (EXTI_D1->EMR1 |= RTC_EXTI_LINE_WAKEUPTIMER_EVENT)
#else /* EXTI */
#define __HAL_RTC_WAKEUPTIMER_EXTI_ENABLE_EVENT()                              \
 ...
 * @retval None
 */
#define __HAL_RTC_WAKEUPTIMER_EXTID3_ENABLE_EVENT()                            \
 ...
 * @retval None
 */
#define __HAL_RTC_WAKEUPTIMER_EXTID3_DISABLE_EVENT()                           \
  (EXTI->D3PMR1 &= ~(RTC_EXTI_LINE_WAKEUPTIMER_EVENT))
 ...
 * @retval None
 */
#define __HAL_RTC_WAKEUPTIMER_EXTID2_ENABLE_IT()                               \
  (EXTI_D2->IMR1 |= RTC_EXTI_LINE_WAKEUPTIMER_EVENT)

/**
 * @brief  Disable interrupt on the RTC WakeUp Timer associated D2 Exti line.
 * @retval None
 */
#define __HAL_RTC_WAKEUPTIMER_EXTID2_DISABLE_IT()                              \
  (EXTI_D2->IMR1 &= ~(RTC_EXTI_LINE_WAKEUPTIMER_EVENT))
 ...
 * @retval None
 */
#define __HAL_RTC_WAKEUPTIMER_EXTID2_ENABLE_EVENT()                            \
  (EXTI_D2->EMR1 |= RTC_EXTI_LINE_WAKEUPTIMER_EVENT)

/**
 * @brief  Disable event on the RTC WakeUp Timer associated D2 Exti line.
 * @retval None
 */
#define __HAL_RTC_WAKEUPTIMER_EXTID2_DISABLE_EVENT()                           \
  (EXTI_D2->EMR1 &= ~(RTC_EXTI_LINE_WAKEUPTIMER_EVENT))

#endif /* DUAL_CORE */

/**
 * @brief  Enable falling edge trigger on the RTC WakeUp Timer associated Exti
 * line.
 * @retval None
 */
...
/**
 * @brief  Disable falling edge trigger on the RTC WakeUp Timer associated Exti
 * line.
 * @retval None
 */
...
/**
 * @brief  Enable rising edge trigger on the RTC WakeUp Timer associated Exti
 * line.
 * @retval None
 */
...
/**
 * @brief  Disable rising edge trigger on the RTC WakeUp Timer associated Exti
 * line.
 * @retval None
 */
...
/**
 * @brief  Disable rising & falling edge trigger on the RTC WakeUp Timer
 * associated Exti line. This parameter can be:
 * @retval None
 */
...
/**
 * @brief Check whether the RTC WakeUp Timer associated Exti line interrupt flag
 * is set or not.
 * @retval Line Status.
 */
#if defined(EXTI_D1)
#define __HAL_RTC_WAKEUPTIMER_EXTI_GET_FLAG()                                  \
  (EXTI_D1->PR1 & RTC_EXTI_LINE_WAKEUPTIMER_EVENT)
#else /* EXTI */
#define __HAL_RTC_WAKEUPTIMER_EXTI_GET_FLAG()                                  \
  (EXTI->PR1 & RTC_EXTI_LINE_WAKEUPTIMER_EVENT)
#endif /* EXTI_D1 */
...
/**
 * @brief Check whether the RTC WakeUp Timer associated D3 Exti line interrupt
 * flag is set or not.
 * @retval Line Status
 */
#define __HAL_RTC_WAKEUPTIMER_EXTID3_GET_FLAG()                                \
  (EXTI_D3->PR1 & RTC_EXTI_LINE_WAKEUPTIMER_EVENT)

/**
 * @brief Clear the RTC WakeUp Timer associated D3 Exti line flag.
 * @retval None.
 */
#define __HAL_RTC_WAKEUPTIMER_EXTID3_CLEAR_FLAG()                              \
  (EXTI_D3->PR1 = RTC_EXTI_LINE_WAKEUPTIMER_EVENT)

/**
 * @brief Generate a Software interrupt on the RTC WakeUp Timer associated Exti
 * line.
 * @retval None.
 */
...
/**
 * @brief Check whether the RTC WakeUp Timer associated D2 Exti line interrupt
 * flag is set or not.
 * @retval Line Status.
 */
#define __HAL_RTC_WAKEUPTIMER_EXTID2_GET_FLAG()                                \
  (EXTI_D2->PR1 & RTC_EXTI_LINE_WAKEUPTIMER_EVENT)

/**
 * @brief Clear the RTC WakeUp Timer associated D2 Exti line flag.
 * @retval None.
 */
#define __HAL_RTC_WAKEUPTIMER_EXTID2_CLEAR_FLAG()                              \
  (EXTI_D2->PR1 = RTC_EXTI_LINE_WAKEUPTIMER_EVENT)
...
/**
 * @brief  Enable interrupt on the RTC Tamper and Timestamp associated Exti
 * line.
 * @retval None
 */
#if defined(EXTI_D1)
...
/**
 * @brief  Disable interrupt on the RTC Tamper and Timestamp associated Exti
 * line.
 * @retval None
 */
#if defined(EXTI_D1)
...
#define __HAL_RTC_TAMPER_TIMESTAMP_EXTI_ENABLE_EVENT()                         \
  (EXTI_D1->EMR1 |= RTC_EXTI_LINE_TAMPER_TIMESTAMP_EVENT)
#else /* EXTI */
#define __HAL_RTC_TAMPER_TIMESTAMP_EXTI_ENABLE_EVENT()                         \
...
#if defined(DUAL_CORE)
/**
 * @brief  Enable interrupt on the RTC Tamper and Timestamp associated D2 Exti
 * line.
 * @retval None
 */
#define __HAL_RTC_TAMPER_TIMESTAMP_EXTID2_ENABLE_IT()                          \
  (EXTI_D2->IMR1 |= RTC_EXTI_LINE_TAMPER_TIMESTAMP_EVENT)

/**
 * @brief  Disable interrupt on the RTC Tamper and Timestamp associated D2 Exti
 * line.
 * @retval None
 */
#define __HAL_RTC_TAMPER_TIMESTAMP_EXTID2_DISABLE_IT()                         \
  (EXTI_D2->IMR1 &= ~(RTC_EXTI_LINE_TAMPER_TIMESTAMP_EVENT))
 ...
 * @retval None
 */
#define __HAL_RTC_TAMPER_TIMESTAMP_EXTID2_ENABLE_EVENT()                       \
  (EXTI_D2->EMR1 |= RTC_EXTI_LINE_TAMPER_TIMESTAMP_EVENT)

/**
 * @brief  Disable event on the RTC Tamper and Timestamp associated D2 Exti
 * line.
 * @retval None
 */
#define __HAL_RTC_TAMPER_TIMESTAMP_EXTID2_DISABLE_EVENT()                      \
  (EXTI_D2->EMR1 &= ~(RTC_EXTI_LINE_TAMPER_TIMESTAMP_EVENT))
...
/**
 * @brief  Enable rising edge trigger on the RTC Tamper and Timestamp associated
 * Exti line.
 * @retval None
 */
...
/**
 * @brief  Enable rising & falling edge trigger on the RTC Tamper and Timestamp
 * associated Exti line.
 * @retval None
 */
...
/**
 * @brief  Disable rising & falling edge trigger on the RTC Tamper and Timestamp
 * associated Exti line.
 * @retval None
 */
...
/**
 * @brief Check whether the RTC Tamper and Timestamp associated Exti line
 * interrupt flag is set or not.
 * @retval Line Status
 */
#if defined(EXTI_D1)
#define __HAL_RTC_TAMPER_TIMESTAMP_EXTI_GET_FLAG()                             \
  (EXTI_D1->PR1 & RTC_EXTI_LINE_TAMPER_TIMESTAMP_EVENT)
#else /* EXTI */
#define __HAL_RTC_TAMPER_TIMESTAMP_EXTI_GET_FLAG()                             \
...
#if defined(DUAL_CORE)
/**
 * @brief Check whether the RTC Tamper and Timestamp associated D2 Exti line
 * interrupt flag is set or not.
 * @retval Line Status
 */
#define __HAL_RTC_TAMPER_TIMESTAMP_EXTID2_GET_FLAG()                           \
  (EXTI_D2->PR1 & RTC_EXTI_LINE_WAKEUPTIMER_EVENT)
 ...
 * @retval None
 */
#define __HAL_RTC_TAMPER_TIMESTAMP_EXTID2_CLEAR_FLAG()                         \
  (EXTI_D2->PR1 = RTC_EXTI_LINE_TAMPER_TIMESTAMP_EVENT)
...
#define RTC_EXTI_LINE_TAMPER_TIMESTAMP_EVENT                                   \
  EXTI_IMR1_IM18 /*!< External interrupt line 18 Connected to the RTC Tamper   \
                    and Time Stamp events */
#define RTC_EXTI_LINE_WAKEUPTIMER_EVENT                                        \
  EXTI_IMR1_IM19 /*!< External interrupt line 19 Connected to the RTC Wakeup   \
                    event */
...
#if defined(RTC_TAMPxIE_SUPPORT)
#define RTC_TAMPER_X_INTERRUPT                                                 \
  ((uint32_t)(RTC_IT_TAMP1 | RTC_IT_TAMP2 | RTC_IT_TAMP3))
#else
...
#define IS_RTC_TAMPER_INTERRUPT(__INTERRUPT__)                                 \
  ((((__INTERRUPT__) & (RTC_TAMPER_X_INTERRUPT | RTC_IT_TAMPALL)) != 0x00U) && \
   (((__INTERRUPT__) & (~(RTC_TAMPER_X_INTERRUPT | RTC_IT_TAMPALL))) ==        \
    0x00U))
