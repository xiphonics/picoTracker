...
#define DMA_DOUBLE_BUFFER_M0                                                   \
  ((uint32_t)                                                                  \
       DMA_SxCR_DBM) /*!< Double buffer mode with first target memory M0 */
#define DMA_DOUBLE_BUFFER_M1                                                   \
  ((uint32_t)(DMA_SxCR_DBM | DMA_SxCR_CT)) /*!< Double buffer mode with first  \
                                              target memory M1 */
/**
 * @}
 */
...
#define __HAL_DMA_ENABLE(__HANDLE__)                                           \
  ((IS_DMA_STREAM_INSTANCE((__HANDLE__)->Instance))                            \
       ...
       : (((BDMA_Channel_TypeDef *)(__HANDLE__)->Instance)->CCR |=             \
          BDMA_CCR_EN))
...
#define __HAL_DMA_GET_TC_FLAG_INDEX(__HANDLE__)                                \
  (((uint32_t)((__HANDLE__)->Instance) == ((uint32_t)DMA1_Stream0))            \
   ...
   : ((uint32_t)((__HANDLE__)->Instance) == ((uint32_t)DMA2_Stream7))          \
       ? DMA_FLAG_TCIF3_7                                                      \
   : ((uint32_t)((__HANDLE__)->Instance) == ((uint32_t)BDMA1_Channel0))        \
       ? BDMA_FLAG_TC0                                                         \
   : ((uint32_t)((__HANDLE__)->Instance) == ((uint32_t)BDMA2_Channel0))        \
       ? BDMA_FLAG_TC0                                                         \
   : ((uint32_t)((__HANDLE__)->Instance) == ((uint32_t)BDMA1_Channel1))        \
       ? BDMA_FLAG_TC1                                                         \
   : ((uint32_t)((__HANDLE__)->Instance) == ((uint32_t)BDMA2_Channel1))        \
       ? BDMA_FLAG_TC1                                                         \
   : ((uint32_t)((__HANDLE__)->Instance) == ((uint32_t)BDMA1_Channel2))        \
       ? BDMA_FLAG_TC2                                                         \
   : ((uint32_t)((__HANDLE__)->Instance) == ((uint32_t)BDMA2_Channel2))        \
       ? BDMA_FLAG_TC2                                                         \
   : ((uint32_t)((__HANDLE__)->Instance) == ((uint32_t)BDMA1_Channel3))        \
       ? BDMA_FLAG_TC3                                                         \
   : ((uint32_t)((__HANDLE__)->Instance) == ((uint32_t)BDMA2_Channel3))        \
       ? BDMA_FLAG_TC3                                                         \
   : ((uint32_t)((__HANDLE__)->Instance) == ((uint32_t)BDMA1_Channel4))        \
       ? BDMA_FLAG_TC4                                                         \
   : ((uint32_t)((__HANDLE__)->Instance) == ((uint32_t)BDMA2_Channel4))        \
       ? BDMA_FLAG_TC4                                                         \
   : ((uint32_t)((__HANDLE__)->Instance) == ((uint32_t)BDMA1_Channel5))        \
       ? BDMA_FLAG_TC5                                                         \
   : ((uint32_t)((__HANDLE__)->Instance) == ((uint32_t)BDMA2_Channel5))        \
       ? BDMA_FLAG_TC5                                                         \
   : ((uint32_t)((__HANDLE__)->Instance) == ((uint32_t)BDMA1_Channel6))        \
       ? BDMA_FLAG_TC6                                                         \
   : ((uint32_t)((__HANDLE__)->Instance) == ((uint32_t)BDMA2_Channel6))        \
       ? BDMA_FLAG_TC6                                                         \
   : ((uint32_t)((__HANDLE__)->Instance) == ((uint32_t)BDMA1_Channel7))        \
       ? BDMA_FLAG_TC7                                                         \
   : ((uint32_t)((__HANDLE__)->Instance) == ((uint32_t)BDMA2_Channel7))        \
       ? BDMA_FLAG_TC7                                                         \
       : (uint32_t)0x00000000)
#else
#define __HAL_DMA_GET_TC_FLAG_INDEX(__HANDLE__)                                \
  (((uint32_t)((__HANDLE__)->Instance) == ((uint32_t)DMA1_Stream0))            \
   ...
   : ((uint32_t)((__HANDLE__)->Instance) == ((uint32_t)DMA2_Stream7))          \
       ? DMA_FLAG_TCIF3_7                                                      \
   : ((uint32_t)((__HANDLE__)->Instance) == ((uint32_t)BDMA_Channel0))         \
       ? BDMA_FLAG_TC0                                                         \
   : ((uint32_t)((__HANDLE__)->Instance) == ((uint32_t)BDMA_Channel1))         \
       ? BDMA_FLAG_TC1                                                         \
   : ((uint32_t)((__HANDLE__)->Instance) == ((uint32_t)BDMA_Channel2))         \
       ? BDMA_FLAG_TC2                                                         \
   : ((uint32_t)((__HANDLE__)->Instance) == ((uint32_t)BDMA_Channel3))         \
       ? BDMA_FLAG_TC3                                                         \
   : ((uint32_t)((__HANDLE__)->Instance) == ((uint32_t)BDMA_Channel4))         \
       ? BDMA_FLAG_TC4                                                         \
   : ((uint32_t)((__HANDLE__)->Instance) == ((uint32_t)BDMA_Channel5))         \
       ? BDMA_FLAG_TC5                                                         \
   : ((uint32_t)((__HANDLE__)->Instance) == ((uint32_t)BDMA_Channel6))         \
       ? BDMA_FLAG_TC6                                                         \
   : ((uint32_t)((__HANDLE__)->Instance) == ((uint32_t)BDMA_Channel7))         \
       ? BDMA_FLAG_TC7                                                         \
       : (uint32_t)0x00000000)
#endif /* BDMA1 */
...
#define DMA_TO_BDMA_IT(__DMA_IT__)                                             \
  ((((__DMA_IT__) & (DMA_IT_TC | DMA_IT_HT | DMA_IT_TE)) ==                    \
    (DMA_IT_TC | DMA_IT_HT | DMA_IT_TE))                                       \
       ? (BDMA_CCR_TCIE | BDMA_CCR_HTIE | BDMA_CCR_TEIE)                       \
   : (((__DMA_IT__) & (DMA_IT_TC | DMA_IT_HT)) == (DMA_IT_TC | DMA_IT_HT))     \
       ? (BDMA_CCR_TCIE | BDMA_CCR_HTIE)                                       \
   : (((__DMA_IT__) & (DMA_IT_HT | DMA_IT_TE)) == (DMA_IT_HT | DMA_IT_TE))     \
       ? (BDMA_CCR_HTIE | BDMA_CCR_TEIE)                                       \
   : (((__DMA_IT__) & (DMA_IT_TC | DMA_IT_TE)) == (DMA_IT_TC | DMA_IT_TE))     \
...
#define __HAL_BDMA_CHANNEL_DISABLE_IT(__HANDLE__, __INTERRUPT__)               \
  (((BDMA_Channel_TypeDef *)(__HANDLE__)->Instance)->CCR &=                    \
   ~(DMA_TO_BDMA_IT(__INTERRUPT__)))
...
#define __HAL_BDMA_CHANNEL_GET_IT_SOURCE(__HANDLE__, __INTERRUPT__)            \
  ((((BDMA_Channel_TypeDef *)(__HANDLE__)->Instance)->CCR &                    \
    (DMA_TO_BDMA_IT(__INTERRUPT__))))
...
#define IS_DMA_MODE(MODE)                                                      \
  (((MODE) == DMA_NORMAL) || ((MODE) == DMA_CIRCULAR) ||                       \
   ((MODE) == DMA_PFCTRL) || ((MODE) == DMA_DOUBLE_BUFFER_M0) ||               \
