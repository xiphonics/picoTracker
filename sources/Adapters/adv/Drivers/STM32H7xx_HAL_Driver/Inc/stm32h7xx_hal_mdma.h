...
typedef struct {
  ...
  uint32_t TransferTriggerMode; /*!< Specifies the Trigger Transfer mode : each
                                   request triggers a : a buffer transfer, a
                                   block transfer, a repeated block transfer or
                                   a linked list transfer This parameter can be
                                   a value of @ref MDMA_Transfer_TriggerMode  */

  uint32_t
      Priority; /*!< Specifies the software priority for the MDMAy channelx.
  ...
  uint32_t DataAlignment; /*!< Specifies the source to destination Memory data
                             packing/padding mode. This parameter can be a value
                             of @ref MDMA_data_Alignment */
  ...
  uint32_t
      SourceBurst; /*!< Specifies the Burst transfer configuration for the
  ...
  uint32_t DestBurst; /*!< Specifies the Burst transfer configuration for the
                         ...
                         of data to be transferred in a single non interruptible
                           transaction.
                           This parameter can be a value of @ref
  ...
  int32_t
      SourceBlockAddressOffset; /*!< this field specifies the Next block source
 ...
 *         (CTCR ,CBNDTR ,CSAR ,CDAR ,CBRUR, CLAR, CTBR, CMAR and CMDR
 * registers). When CLAR register is configured to a non NULL value , each time
 * a transfer ends, a new configuration (linked list node) is automatically
 * loaded from the address given in CLAR register.
 */
typedef struct {
...
typedef struct {
  MDMA_InitTypeDef
      Init; /*!< configuration of the specified MDMA Linked List Node    */
  uint32_t
      SrcAddress; /*!< The source memory address for the Linked list Node */
  uint32_t DstAddress; /*!< The destination memory address for the Linked list
                          Node */
  uint32_t BlockDataLength; /*!< The data length of a block in bytes */
  uint32_t BlockCount;      /*!< The number of blocks to be transferred      */

  uint32_t PostRequestMaskAddress; /*!< specifies the address to be updated
                                      (written) with PostRequestMaskData after a
                                      request is served. PostRequestMaskAddress
                                      and PostRequestMaskData could be used to
                                      automatically clear a peripheral flag when
                                      the request is served  */

  uint32_t
      PostRequestMaskData; /*!< specifies the value to be written to
                              PostRequestMaskAddress after a request is served.
                                PostRequestMaskAddress and PostRequestMaskData
                              could be used to automatically clear a peripheral
...
typedef struct __MDMA_HandleTypeDef {
  ...
  void (*XferCpltCallback)(struct __MDMA_HandleTypeDef
                               *hmdma); /*!< MDMA transfer complete callback */

  void (*XferBufferCpltCallback)(
      struct __MDMA_HandleTypeDef
          *hmdma); /*!< MDMA buffer transfer complete callback */

  void (*XferBlockCpltCallback)(
      struct __MDMA_HandleTypeDef
          *hmdma); /*!< MDMA block transfer complete callback  */

  void (*XferRepeatBlockCpltCallback)(
      struct __MDMA_HandleTypeDef
          *hmdma); /*!< MDMA block transfer repeat callback    */
  ...
  MDMA_LinkNodeTypeDef
      *FirstLinkedListNodeAddress; /*!< specifies the first node address of the
  ...
  MDMA_LinkNodeTypeDef
      *LastLinkedListNodeAddress; /*!< specifies the last node address of the
                                     transfer list this parameter is used
                                     internally by the MDMA driver to construct
                                     the linked list node
                                   */
  uint32_t
      LinkedListNodeCounter; /*!< Number of nodes in the MDMA linked list */
...
#define HAL_MDMA_ERROR_NO_XFER                                                 \
  ((uint32_t)0x00000080U) /*!< Abort or SW trigger requested with no Xfer      \
                             ongoing   */
#define HAL_MDMA_ERROR_BUSY                                                    \
  ((uint32_t)0x00000100U) /*!< DeInit or SW trigger requested with Xfer        \
                             ongoing   */
...
#define MDMA_REQUEST_DMA1_Stream0_TC                                           \
  ((uint32_t)0x00000000U) /*!< MDMA HW request is DMA1 Stream 0 Transfer       \
                             Complete Flag   */
#define MDMA_REQUEST_DMA1_Stream1_TC                                           \
  ((uint32_t)0x00000001U) /*!< MDMA HW request is DMA1 Stream 1 Transfer       \
                             Complete Flag   */
#define MDMA_REQUEST_DMA1_Stream2_TC                                           \
  ((uint32_t)0x00000002U) /*!< MDMA HW request is DMA1 Stream 2 Transfer       \
                             Complete Flag   */
#define MDMA_REQUEST_DMA1_Stream3_TC                                           \
  ((uint32_t)0x00000003U) /*!< MDMA HW request is DMA1 Stream 3 Transfer       \
                             Complete Flag   */
#define MDMA_REQUEST_DMA1_Stream4_TC                                           \
  ((uint32_t)0x00000004U) /*!< MDMA HW request is DMA1 Stream 4 Transfer       \
                             Complete Flag   */
#define MDMA_REQUEST_DMA1_Stream5_TC                                           \
  ((uint32_t)0x00000005U) /*!< MDMA HW request is DMA1 Stream 5 Transfer       \
                             Complete Flag   */
#define MDMA_REQUEST_DMA1_Stream6_TC                                           \
  ((uint32_t)0x00000006U) /*!< MDMA HW request is DMA1 Stream 6 Transfer       \
                             Complete Flag   */
#define MDMA_REQUEST_DMA1_Stream7_TC                                           \
  ((uint32_t)0x00000007U) /*!< MDMA HW request is DMA1 Stream 7 Transfer       \
                             Complete Flag   */
#define MDMA_REQUEST_DMA2_Stream0_TC                                           \
  ((uint32_t)0x00000008U) /*!< MDMA HW request is DMA2 Stream 0 Transfer       \
                             Complete Flag   */
#define MDMA_REQUEST_DMA2_Stream1_TC                                           \
  ((uint32_t)0x00000009U) /*!< MDMA HW request is DMA2 Stream 1 Transfer       \
                             Complete Flag   */
#define MDMA_REQUEST_DMA2_Stream2_TC                                           \
  ((uint32_t)0x0000000AU) /*!< MDMA HW request is DMA2 Stream 2 Transfer       \
                             Complete Flag   */
#define MDMA_REQUEST_DMA2_Stream3_TC                                           \
  ((uint32_t)0x0000000BU) /*!< MDMA HW request is DMA2 Stream 3 Transfer       \
                             Complete Flag   */
#define MDMA_REQUEST_DMA2_Stream4_TC                                           \
  ((uint32_t)0x0000000CU) /*!< MDMA HW request is DMA2 Stream 4 Transfer       \
                             Complete Flag   */
#define MDMA_REQUEST_DMA2_Stream5_TC                                           \
  ((uint32_t)0x0000000DU) /*!< MDMA HW request is DMA2 Stream 5 Transfer       \
                             Complete Flag   */
#define MDMA_REQUEST_DMA2_Stream6_TC                                           \
  ((uint32_t)0x0000000EU) /*!< MDMA HW request is DMA2 Stream 6 Transfer       \
                             Complete Flag   */
#define MDMA_REQUEST_DMA2_Stream7_TC                                           \
  ((uint32_t)0x0000000FU) /*!< MDMA HW request is DMA2 Stream 7 Transfer       \
                             Complete Flag   */
#if defined(LTDC)
#define MDMA_REQUEST_LTDC_LINE_IT                                              \
  ((uint32_t)0x00000010U) /*!< MDMA HW request is LTDC Line interrupt Flag */
#endif                    /* LTDC */
#if defined(JPEG)
#define MDMA_REQUEST_JPEG_INFIFO_TH                                            \
  ((uint32_t)0x00000011U) /*!< MDMA HW request is JPEG Input FIFO threshold    \
                             Flag         */
#define MDMA_REQUEST_JPEG_INFIFO_NF                                            \
  ((uint32_t)0x00000012U) /*!< MDMA HW request is JPEG Input FIFO not full     \
                             Flag          */
#define MDMA_REQUEST_JPEG_OUTFIFO_TH                                           \
  ((uint32_t)0x00000013U) /*!< MDMA HW request is JPEG Output FIFO threshold   \
                             Flag        */
#define MDMA_REQUEST_JPEG_OUTFIFO_NE                                           \
  ((uint32_t)0x00000014U) /*!< MDMA HW request is JPEG Output FIFO not empty   \
                             Flag        */
#define MDMA_REQUEST_JPEG_END_CONVERSION                                       \
  ((uint32_t)0x00000015U) /*!< MDMA HW request is JPEG End of conversion Flag  \
                           */
#endif                    /* JPEG */
#if defined(OCTOSPI1)
#define MDMA_REQUEST_OCTOSPI1_FIFO_TH                                          \
  ((uint32_t)0x00000016U) /*!< MDMA HW request is OCTOSPI1 FIFO threshold Flag \
                           */
#define MDMA_REQUEST_OCTOSPI1_TC                                               \
  ((uint32_t)0x00000017U) /*!< MDMA HW request is OCTOSPI1 Transfer complete   \
                             Flag        */
#endif                    /* OCTOSPI1 */
#if defined(QUADSPI)
...
#define MDMA_REQUEST_QUADSPI_TC                                                \
  ((uint32_t)0x00000017U) /*!< MDMA HW request is QSPI Transfer complete Flag  \
                           */
#endif                    /* QUADSPI */
#define MDMA_REQUEST_DMA2D_CLUT_TC                                             \
  ((uint32_t)0x00000018U) /*!< MDMA HW request is DMA2D CLUT Transfer Complete \
                             Flag      */
#define MDMA_REQUEST_DMA2D_TC                                                  \
  ((uint32_t)0x00000019U) /*!< MDMA HW request is DMA2D Transfer Complete Flag \
                           */
#define MDMA_REQUEST_DMA2D_TW                                                  \
  ((uint32_t)0x0000001AU) /*!< MDMA HW request is DMA2D Transfer Watermark     \
                             Flag          */

#if defined(DSI)
#define MDMA_REQUEST_DSI_TEARING_EFFECT                                        \
  ((uint32_t)0x0000001BU) /*!< MDMA HW request is DSI Tearing Effect Flag */
#define MDMA_REQUEST_DSI_END_REFRESH                                           \
  ((uint32_t)0x0000001CU) /*!< MDMA HW request is DSI End of refresh  Flag */
#endif                    /* DSI */

#define MDMA_REQUEST_SDMMC1_END_DATA                                           \
  ((uint32_t)0x0000001DU) /*!< MDMA HW request is SDMMC1 End of Data Flag */

#define MDMA_REQUEST_SDMMC1_DMA_ENDBUFFER                                      \
  ((uint32_t)0x0000001EU) /*!< MDMA HW request is SDMMC1 Internal DMA buffer   \
                             End Flag    */
#define MDMA_REQUEST_SDMMC1_COMMAND_END                                        \
  ((uint32_t)0x0000001FU) /*!< MDMA HW request is SDMMC1 Command End Flag */

#if defined(OCTOSPI2)
#define MDMA_REQUEST_OCTOSPI2_FIFO_TH                                          \
  ((uint32_t)0x00000020U) /*!< MDMA HW request is OCTOSPI2 FIFO threshold Flag \
                           */
#define MDMA_REQUEST_OCTOSPI2_TC                                               \
  ((uint32_t)0x00000021U) /*!< MDMA HW request is OCTOSPI2 Transfer complete   \
                             Flag        */
#endif                    /* OCTOSPI2 */
...
#define MDMA_BUFFER_TRANSFER                                                   \
  ((uint32_t)0x00000000U) /*!< Each MDMA request (SW or HW) triggers a buffer  \
                             transfer                                */
#define MDMA_BLOCK_TRANSFER                                                    \
  ((uint32_t)MDMA_CTCR_TRGM_0) /*!< Each MDMA request (SW or HW) triggers a    \
                                  block transfer */
#define MDMA_REPEAT_BLOCK_TRANSFER                                             \
  ((uint32_t)MDMA_CTCR_TRGM_1) /*!< Each MDMA request (SW or HW) triggers a    \
                                  repeated block transfer */
#define MDMA_FULL_TRANSFER                                                     \
  ((uint32_t)MDMA_CTCR_TRGM) /*!< Each MDMA request (SW or HW) triggers a Full \
                                transfer or a linked list transfer if any */
...
#define MDMA_PRIORITY_MEDIUM                                                   \
  ((uint32_t)MDMA_CCR_PL_0) /*!< Priority level: Medium    */
#define MDMA_PRIORITY_HIGH                                                     \
  ((uint32_t)MDMA_CCR_PL_1) /*!< Priority level: High      */
#define MDMA_PRIORITY_VERY_HIGH                                                \
  ((uint32_t)MDMA_CCR_PL) /*!< Priority level: Very High */
...
#define MDMA_LITTLE_BYTE_ENDIANNESS_EXCHANGE                                   \
  ((uint32_t)MDMA_CCR_BEX) /*!< BYTEs endianness exchange when destination     \
                              data size is > Byte           */
#define MDMA_LITTLE_HALFWORD_ENDIANNESS_EXCHANGE                               \
  ((uint32_t)MDMA_CCR_HEX) /*!< HALF WORDs endianness exchange when            \
                              destination data size is > HALF WORD */
#define MDMA_LITTLE_WORD_ENDIANNESS_EXCHANGE                                   \
  ((uint32_t)MDMA_CCR_WEX) /*!< WORDs endianness exchange  when destination    \
                              data size is > DOUBLE WORD   */
...
#define MDMA_SRC_INC_BYTE                                                      \
  ((uint32_t)MDMA_CTCR_SINC_1) /*!< Source address pointer is incremented by a \
                                  BYTE (8 bits)          */
#define MDMA_SRC_INC_HALFWORD                                                  \
  ((uint32_t)MDMA_CTCR_SINC_1 |                                                \
   (uint32_t)MDMA_CTCR_SINCOS_0) /*!< Source address pointer is incremented by \
                                    a half Word (16 bits)    */
#define MDMA_SRC_INC_WORD                                                      \
  ((uint32_t)MDMA_CTCR_SINC_1 |                                                \
   (uint32_t)MDMA_CTCR_SINCOS_1) /*!< Source address pointer is incremented by \
                                    a Word (32 bits)         */
#define MDMA_SRC_INC_DOUBLEWORD                                                \
  ((uint32_t)MDMA_CTCR_SINC_1 |                                                \
   (uint32_t)MDMA_CTCR_SINCOS) /*!< Source address pointer is incremented by a \
                                  double Word (64 bits)) */
#define MDMA_SRC_DEC_BYTE                                                      \
  ((uint32_t)MDMA_CTCR_SINC) /*!< Source address pointer is decremented by a   \
                                BYTE (8 bits)          */
#define MDMA_SRC_DEC_HALFWORD                                                  \
  ((uint32_t)MDMA_CTCR_SINC |                                                  \
   (uint32_t)MDMA_CTCR_SINCOS_0) /*!< Source address pointer is decremented by \
                                    a half Word (16 bits)    */
#define MDMA_SRC_DEC_WORD                                                      \
  ((uint32_t)MDMA_CTCR_SINC |                                                  \
   (uint32_t)MDMA_CTCR_SINCOS_1) /*!< Source address pointer is decremented by \
                                    a Word (32 bits)         */
#define MDMA_SRC_DEC_DOUBLEWORD                                                \
  ((uint32_t)MDMA_CTCR_SINC |                                                  \
   (uint32_t)MDMA_CTCR_SINCOS) /*!< Source address pointer is decremented by a \
                                  double Word (64 bits)) */
...
#define MDMA_DEST_INC_BYTE                                                     \
  ((uint32_t)MDMA_CTCR_DINC_1) /*!< Source address pointer is incremented by a \
                                  BYTE (8 bits)          */
#define MDMA_DEST_INC_HALFWORD                                                 \
  ((uint32_t)MDMA_CTCR_DINC_1 |                                                \
   (uint32_t)MDMA_CTCR_DINCOS_0) /*!< Source address pointer is incremented by \
                                    a half Word (16 bits)    */
#define MDMA_DEST_INC_WORD                                                     \
  ((uint32_t)MDMA_CTCR_DINC_1 |                                                \
   (uint32_t)MDMA_CTCR_DINCOS_1) /*!< Source address pointer is incremented by \
                                    a Word (32 bits)         */
#define MDMA_DEST_INC_DOUBLEWORD                                               \
  ((uint32_t)MDMA_CTCR_DINC_1 |                                                \
   (uint32_t)MDMA_CTCR_DINCOS) /*!< Source address pointer is incremented by a \
                                  double Word (64 bits)) */
#define MDMA_DEST_DEC_BYTE                                                     \
  ((uint32_t)MDMA_CTCR_DINC) /*!< Source address pointer is decremented by a   \
                                BYTE (8 bits)          */
#define MDMA_DEST_DEC_HALFWORD                                                 \
  ((uint32_t)MDMA_CTCR_DINC |                                                  \
   (uint32_t)MDMA_CTCR_DINCOS_0) /*!< Source address pointer is decremented by \
                                    a half Word (16 bits)    */
#define MDMA_DEST_DEC_WORD                                                     \
  ((uint32_t)MDMA_CTCR_DINC |                                                  \
   (uint32_t)MDMA_CTCR_DINCOS_1) /*!< Source address pointer is decremented by \
                                    a Word (32 bits)         */
#define MDMA_DEST_DEC_DOUBLEWORD                                               \
  ((uint32_t)MDMA_CTCR_DINC |                                                  \
   (uint32_t)MDMA_CTCR_DINCOS) /*!< Source address pointer is decremented by a \
                                  double Word (64 bits)) */
...
#define MDMA_DEST_DATASIZE_BYTE                                                \
  ((uint32_t)0x00000000U) /*!< Destination data size is Byte        */
...
#define MDMA_DATAALIGN_PACKENABLE                                              \
  ((uint32_t)MDMA_CTCR_PKE) /*!< The source data is packed/un-packed into the  \
                               destination data size All data are right        \
                               aligned, in Little Endien mode. */
#define MDMA_DATAALIGN_RIGHT                                                   \
  ((uint32_t)0x00000000U) /*!< Right Aligned, padded w/ 0s (default) */
#define MDMA_DATAALIGN_RIGHT_SIGNED                                            \
  ((uint32_t)                                                                  \
       MDMA_CTCR_PAM_0) /*!< Right Aligned, Sign extended ,                    \
                             Note : this mode is allowed only if the Source    \
                           data size is smaller than Destination data size  */
...
#define MDMA_SOURCE_BURST_SINGLE                                               \
  ((uint32_t)0x00000000U) /*!< single transfer                                 \
                           */
#define MDMA_SOURCE_BURST_2BEATS                                               \
  ((uint32_t)MDMA_CTCR_SBURST_0) /*!< Burst 2 beats   */
#define MDMA_SOURCE_BURST_4BEATS                                               \
  ((uint32_t)MDMA_CTCR_SBURST_1) /*!< Burst 4 beats   */
#define MDMA_SOURCE_BURST_8BEATS                                               \
  ((uint32_t)MDMA_CTCR_SBURST_0 |                                              \
   (uint32_t)MDMA_CTCR_SBURST_1) /*!< Burst 8 beats   */
#define MDMA_SOURCE_BURST_16BEATS                                              \
  ((uint32_t)MDMA_CTCR_SBURST_2) /*!< Burst 16 beats  */
#define MDMA_SOURCE_BURST_32BEATS                                              \
  ((uint32_t)MDMA_CTCR_SBURST_0 |                                              \
   (uint32_t)MDMA_CTCR_SBURST_2) /*!< Burst 32 beats  */
#define MDMA_SOURCE_BURST_64BEATS                                              \
  ((uint32_t)MDMA_CTCR_SBURST_1 |                                              \
   (uint32_t)MDMA_CTCR_SBURST_2) /*!< Burst 64 beats  */
#define MDMA_SOURCE_BURST_128BEATS                                             \
  ((uint32_t)MDMA_CTCR_SBURST) /*!< Burst 128 beats */
...
#define MDMA_DEST_BURST_2BEATS                                                 \
  ((uint32_t)MDMA_CTCR_DBURST_0) /*!< Burst 2 beats   */
#define MDMA_DEST_BURST_4BEATS                                                 \
  ((uint32_t)MDMA_CTCR_DBURST_1) /*!< Burst 4 beats   */
#define MDMA_DEST_BURST_8BEATS                                                 \
  ((uint32_t)MDMA_CTCR_DBURST_0 |                                              \
   (uint32_t)MDMA_CTCR_DBURST_1) /*!< Burst 8 beats   */
#define MDMA_DEST_BURST_16BEATS                                                \
  ((uint32_t)MDMA_CTCR_DBURST_2) /*!< Burst 16 beats  */
#define MDMA_DEST_BURST_32BEATS                                                \
  ((uint32_t)MDMA_CTCR_DBURST_0 |                                              \
   (uint32_t)MDMA_CTCR_DBURST_2) /*!< Burst 32 beats  */
#define MDMA_DEST_BURST_64BEATS                                                \
  ((uint32_t)MDMA_CTCR_DBURST_1 |                                              \
   (uint32_t)MDMA_CTCR_DBURST_2) /*!< Burst 64 beats  */
#define MDMA_DEST_BURST_128BEATS                                               \
  ((uint32_t)MDMA_CTCR_DBURST) /*!< Burst 128 beats */

/**
 * @}
 */

/** @defgroup MDMA_interrupt_enable_definitions MDMA interrupt enable
 * definitions
 * @brief    MDMA interrupt enable definitions
 * @{
 */
#define MDMA_IT_TE                                                             \
  ((uint32_t)MDMA_CCR_TEIE) /*!< Transfer Error interrupt            */
#define MDMA_IT_CTC                                                            \
  ((uint32_t)MDMA_CCR_CTCIE) /*!< Channel Transfer Complete interrupt */
#define MDMA_IT_BRT                                                            \
  ((uint32_t)MDMA_CCR_BRTIE) /*!< Block Repeat Transfer interrupt     */
#define MDMA_IT_BT                                                             \
  ((uint32_t)MDMA_CCR_BTIE) /*!< Block Transfer interrupt            */
#define MDMA_IT_BFTC                                                           \
  ((uint32_t)MDMA_CCR_TCIE) /*!< Buffer Transfer Complete interrupt  */
 ...
 */
#define MDMA_FLAG_TE                                                           \
  ((uint32_t)MDMA_CISR_TEIF) /*!< Transfer Error flag                 */
#define MDMA_FLAG_CTC                                                          \
  ((uint32_t)MDMA_CISR_CTCIF) /*!< Channel Transfer Complete flag      */
#define MDMA_FLAG_BRT                                                          \
  ((uint32_t)MDMA_CISR_BRTIF) /*!< Block Repeat Transfer complete flag */
#define MDMA_FLAG_BT                                                           \
  ((uint32_t)MDMA_CISR_BTIF) /*!< Block Transfer complete flag        */
#define MDMA_FLAG_BFTC                                                         \
  ((uint32_t)MDMA_CISR_TCIF) /*!< BuFfer Transfer complete flag       */
#define MDMA_FLAG_CRQA                                                         \
  ((uint32_t)MDMA_CISR_CRQA) /*!< Channel request Active flag          */
...
#define __HAL_MDMA_ENABLE(__HANDLE__)                                          \
  ((__HANDLE__)->Instance->CCR |= MDMA_CCR_EN)
 ...
 * @param  __HANDLE__: MDMA handle
 * @param __INTERRUPT__: specifies the MDMA interrupt sources to be enabled or
 * disabled. This parameter can be any combination of the following values:
 *            @arg MDMA_IT_TE   :  Transfer Error interrupt mask
 *            @arg MDMA_IT_CTC  :  Channel Transfer Complete interrupt mask
 *            @arg MDMA_IT_BRT  :  Block Repeat Transfer interrupt mask
...
/**
 * @brief  Checks whether the specified MDMA Channel interrupt is enabled or
 * not.
 * @param  __HANDLE__: MDMA handle
...
/**
 * @brief  Writes the number of data in bytes to be transferred on the MDMA
 * Channelx.
 * @param  __HANDLE__ : MDMA handle
...
/**
 * @brief  Returns the number of remaining data in bytes in the current MDMA
 * Channelx transfer.
 * @param  __HANDLE__ : MDMA handle
 * @retval The number of remaining data in bytes in the current MDMA Channelx
 * transfer.
 */
#define __HAL_MDMA_GET_COUNTER(__HANDLE__)                                     \
  ((__HANDLE__)->Instance->CBNDTR & MDMA_CBNDTR_BNDT)
...
/** @defgroup MDMA_Exported_Functions_Group1 Initialization and
...
HAL_StatusTypeDef
HAL_MDMA_RegisterCallback(MDMA_HandleTypeDef *hmdma,
                          HAL_MDMA_CallbackIDTypeDef CallbackID,
                          void (*pCallback)(MDMA_HandleTypeDef *_hmdma));
HAL_StatusTypeDef
HAL_MDMA_UnRegisterCallback(MDMA_HandleTypeDef *hmdma,
                            HAL_MDMA_CallbackIDTypeDef CallbackID);
...
HAL_StatusTypeDef
HAL_MDMA_LinkedList_CreateNode(MDMA_LinkNodeTypeDef *pNode,
                               MDMA_LinkNodeConfTypeDef *pNodeConfig);
HAL_StatusTypeDef
HAL_MDMA_LinkedList_AddNode(MDMA_HandleTypeDef *hmdma,
...
HAL_StatusTypeDef
HAL_MDMA_PollForTransfer(MDMA_HandleTypeDef *hmdma,
...
#define IS_MDMA_REQUEST(__REQUEST__)                                           \
  (((__REQUEST__) == MDMA_REQUEST_SW) ||                                       \
   ((__REQUEST__) <= MDMA_REQUEST_OCTOSPI2_TC))
#else
#define IS_MDMA_REQUEST(__REQUEST__)                                           \
  (((__REQUEST__) == MDMA_REQUEST_SW) ||                                       \
   ((__REQUEST__) <= MDMA_REQUEST_SDMMC1_COMMAND_END))
#endif /* OCTOSPI2 */
...
#define IS_MDMA_SOURCE_INC(__INC__)                                            \
  (((__INC__) == MDMA_SRC_INC_DISABLE) || ((__INC__) == MDMA_SRC_INC_BYTE) ||  \
   ...
   ((__INC__) == MDMA_SRC_DEC_BYTE) || ((__INC__) == MDMA_SRC_DEC_HALFWORD) || \
   ((__INC__) == MDMA_SRC_DEC_WORD) || ((__INC__) == MDMA_SRC_DEC_DOUBLEWORD))
...
/** @defgroup MDMA_Private_Functions_Prototypes MDMA Private Functions
 * Prototypes
 * @{
 */
