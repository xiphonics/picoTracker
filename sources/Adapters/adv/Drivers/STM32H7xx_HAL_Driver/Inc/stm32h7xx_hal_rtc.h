...
typedef struct {
  uint8_t Hours; /*!< Specifies the RTC Time Hour.
                    ...
                    Max_Data = 12 if the RTC_HourFormat_12 is selected. This
                    parameter must be a number between Min_Data = 0 and Max_Data
  ...
  uint32_t SubSeconds; /*!< Specifies the RTC_SSR RTC Sub Second register
                          content. This parameter corresponds to a time unit
                          range between [0-1] Second with [1 Sec /
                          SecondFraction +1] granularity */
  ...
  uint32_t DayLightSaving; /*!< Specifies RTC_DayLightSaveOperation: the value
                              of hour adjustment. This parameter can be a value
                              of @ref RTC_DayLightSaving_Definitions */

  uint32_t StoreOperation; /*!< Specifies RTC_StoreOperation value to be written
                              in the BKP bit in CR register to store the
                              operation. This parameter can be a value of @ref
...
typedef struct {
  ...
  uint8_t AlarmDateWeekDay; /*!< Specifies the RTC Alarm Date/WeekDay.
                               ...
                               must be set to a value in the 1-31 range. If the
                               Alarm WeekDay is selected, this parameter can be
...
/** @defgroup RTC_Month_Date_Definitions RTC Month Date Definitions (in BCD
 * format)
 * @{
 */
...
/** @defgroup RTC_Alarm_Sub_Seconds_Masks_Definitions RTC Alarm Sub Seconds
 * Masks Definitions
 * @{
 */
/*!< All Alarm SS fields are masked. There is no comparison on sub seconds for
 * Alarm */
...
#define RTC_ALARMSUBSECONDMASK_SS14_9                                          \
  (RTC_ALRMASSR_MASKSS_0 | RTC_ALRMASSR_MASKSS_3)
...
#define RTC_ALARMSUBSECONDMASK_SS14_11                                         \
  (RTC_ALRMASSR_MASKSS_0 | RTC_ALRMASSR_MASKSS_1 | RTC_ALRMASSR_MASKSS_3)
...
#define RTC_ALARMSUBSECONDMASK_SS14_13                                         \
  (RTC_ALRMASSR_MASKSS_0 | RTC_ALRMASSR_MASKSS_2 | RTC_ALRMASSR_MASKSS_3)
...
#define RTC_IT_ALRA                                                            \
  RTC_CR_ALRAIE /*!< Enable Alarm A Interrupt                 */
#define RTC_IT_ALRB                                                            \
  RTC_CR_ALRBIE /*!< Enable Alarm B Interrupt                 */
/**
 * @}
 */
...
#define RTC_FLAG_WUTWF                                                         \
  RTC_ICSR_WUTWF /*!< Wakeup timer write operation pending flag */
#define RTC_FLAG_ALRBWF                                                        \
  RTC_ICSR_ALRBWF /*!< Alarm B write operation pending flag */
#define RTC_FLAG_ALRAWF                                                        \
  RTC_ICSR_ALRAWF                   /*!< Alarm A write operation pending flag */
...
#define __HAL_RTC_IS_CALENDAR_INITIALIZED(__HANDLE__)                          \
  (((((__HANDLE__)->Instance->ICSR) & (RTC_FLAG_INITS)) == RTC_FLAG_INITS)     \
       ? 1U                                                                    \
       : 0U)
#else
#define __HAL_RTC_IS_CALENDAR_INITIALIZED(__HANDLE__)                          \
...
#define __HAL_RTC_ALARM_EXTI_ENABLE_EVENT()                                    \
  (EXTI_D1->EMR1 |= RTC_EXTI_LINE_ALARM_EVENT)
#else /* EXTI */
#define __HAL_RTC_ALARM_EXTI_ENABLE_EVENT()                                    \
  (EXTI->EMR1 |= RTC_EXTI_LINE_ALARM_EVENT)
#endif /* EXTI_D1 */
 ...
 * @retval None
 */
#define __HAL_RTC_ALARM_EXTID2_ENABLE_IT()                                     \
  (EXTI_D2->IMR1 |= RTC_EXTI_LINE_ALARM_EVENT)

/**
 * @brief  Disable interrupt on the RTC Alarm associated D2 Exti line.
 * @retval None
 */
#define __HAL_RTC_ALARM_EXTID2_DISABLE_IT()                                    \
  (EXTI_D2->IMR1 &= ~(RTC_EXTI_LINE_ALARM_EVENT))
 ...
 * @retval None
 */
#define __HAL_RTC_ALARM_EXTID2_ENABLE_EVENT()                                  \
  (EXTI_D2->EMR1 |= RTC_EXTI_LINE_ALARM_EVENT)

/**
 * @brief  Disable event on the RTC Alarm associated D2 Exti line.
 * @retval None
 */
#define __HAL_RTC_ALARM_EXTID2_DISABLE_EVENT()                                 \
  (EXTI_D2->EMR1 &= ~(RTC_EXTI_LINE_ALARM_EVENT))
...
#define __HAL_RTC_ALARM_EXTI_ENABLE_FALLING_EDGE()                             \
  (EXTI->FTSR1 |= RTC_EXTI_LINE_ALARM_EVENT)
...
/**
 * @brief  Enable rising & falling edge trigger on the RTC Alarm associated Exti
 * line.
 * @retval None
 */
...
/**
 * @brief  Disable rising & falling edge trigger on the RTC Alarm associated
 * Exti line.
 * @retval None
 */
...
/**
 * @brief Check whether the RTC Alarm associated Exti line interrupt flag is set
 * or not.
 * @retval Line Status.
 */
#if defined(EXTI_D1)
#define __HAL_RTC_ALARM_EXTI_GET_FLAG()                                        \
  (EXTI_D1->PR1 & RTC_EXTI_LINE_ALARM_EVENT)
#else /* EXTI */
...
#if defined(DUAL_CORE)
/**
 * @brief Check whether the RTC Alarm associated D2 Exti line interrupt flag is
 * set or not.
 * @retval Line Status
 */
#define __HAL_RTC_ALARM_EXTID2_GET_FLAG()                                      \
  (EXTI_D2->PR1 & RTC_EXTI_LINE_ALARM_EVENT)

/**
 * @brief Clear the RTC Alarm associated D2 Exti line flag.
 * @retval None
 */
#define __HAL_RTC_ALARM_EXTID2_CLEAR_FLAG()                                    \
  (EXTI_D2->PR1 = (RTC_EXTI_LINE_ALARM_EVENT))
#endif /* DUAL_CORE */
/**
...
#define RTC_EXTI_LINE_ALARM_EVENT                                              \
  EXTI_IMR1_IM17 /*!< External interrupt line 17 Connected to the RTC Alarm    \
                    event */
...
#define IS_RTC_ALARM_SUB_SECOND_MASK(MASK)                                     \
  (((MASK) == 0u) || (((MASK) >= RTC_ALARMSUBSECONDMASK_SS14_1) &&             \
