...
#define PWR_WAKEUP_FLAG_ALL                                                    \
  (PWR_WKUPFR_WKUPF1 | PWR_WKUPFR_WKUPF2 | PWR_WKUPFR_WKUPF3 |                 \
   PWR_WKUPFR_WKUPF4 | PWR_WKUPFR_WKUPF5 | PWR_WKUPFR_WKUPF6)
#else
#define PWR_WAKEUP_FLAG_ALL                                                    \
  (PWR_WKUPFR_WKUPF1 | PWR_WKUPFR_WKUPF2 | PWR_WKUPFR_WKUPF4 |                 \
   PWR_WKUPFR_WKUPF6)
#endif /* defined (PWR_WKUPFR_WKUPF3) */
/**
 * @}
...
#define PWR_AVDLEVEL_0                                                         \
  PWR_CR1_ALS_LEV0 /*!< Analog voltage detector level 0                        \
                        selection : 1V7                 */
#define PWR_AVDLEVEL_1                                                         \
  PWR_CR1_ALS_LEV1 /*!< Analog voltage detector level 1                        \
                        selection : 2V1                 */
#define PWR_AVDLEVEL_2                                                         \
  PWR_CR1_ALS_LEV2 /*!< Analog voltage detector level 2                        \
                        selection : 2V5                 */
#define PWR_AVDLEVEL_3                                                         \
  PWR_CR1_ALS_LEV3 /*!< Analog voltage detector level 3                        \
                        selection : 2V8                 */
/**
 * @}
 */
...
/** @defgroup PWREx_VBAT_Battery_Charging_Resistor PWR battery charging resistor
 * selection
 * @{
 */
...
#define PWR_BATTERY_CHARGING_RESISTOR_1_5                                      \
  PWR_CR3_VBRS /*!< VBAT charging through a 1.5 kOhms resistor */
/**
 * @}
 */
 ...
 * @{
 */
#define PWR_SRD_AHB_MEMORY_BLOCK                                               \
  PWR_CR1_SRDRAMSO /*!< SmartRun domain AHB memory shut-off in DStop/DStop2    \
                      low-power mode         */
#define PWR_USB_FDCAN_MEMORY_BLOCK                                             \
  PWR_CR1_HSITFSO /*!< High-speed interfaces USB and FDCAN memories shut-off   \
                     in DStop/DStop2 mode */
#define PWR_GFXMMU_JPEG_MEMORY_BLOCK                                           \
  PWR_CR1_GFXSO /*!< GFXMMU and JPEG memories shut-off in DStop/DStop2 mode */
#define PWR_TCM_ECM_MEMORY_BLOCK                                               \
  PWR_CR1_ITCMSO /*!< Instruction TCM and ETM memories shut-off in             \
                    DStop/DStop2 mode             */
#define PWR_RAM1_AHB_MEMORY_BLOCK                                              \
  PWR_CR1_AHBRAM1SO /*!< AHB RAM1 shut-off in DStop/DStop2 mode */
#define PWR_RAM2_AHB_MEMORY_BLOCK                                              \
  PWR_CR1_AHBRAM2SO /*!< AHB RAM2 shut-off in DStop/DStop2 mode */
#define PWR_RAM1_AXI_MEMORY_BLOCK                                              \
  PWR_CR1_AXIRAM1SO /*!< AXI RAM1 shut-off in DStop/DStop2 mode */
#define PWR_RAM2_AXI_MEMORY_BLOCK                                              \
  PWR_CR1_AXIRAM2SO /*!< AXI RAM2 shut-off in DStop/DStop2 mode */
#define PWR_RAM3_AXI_MEMORY_BLOCK                                              \
  PWR_CR1_AXIRAM3SO /*!< AXI RAM3 shut-off in DStop/DStop2 mode */
#define PWR_MEMORY_BLOCK_KEEP_ON                                               \
  0U /*!< Memory content is kept in DStop or DStop2 mode */
#define PWR_MEMORY_BLOCK_SHUT_OFF                                              \
  1U /*!< Memory content is lost in DStop or DStop2 mode */
/**
 * @}
 */
 ...
 * @retval None.
 */
#define __HAL_PWR_AVD_EXTID2_ENABLE_IT()                                       \
  SET_BIT(EXTI_D2->IMR1, PWR_EXTI_LINE_AVD)
#endif /* defined (DUAL_CORE) */
 ...
 * @retval None.
 */
#define __HAL_PWR_AVD_EXTID2_DISABLE_IT()                                      \
  CLEAR_BIT(EXTI_D2->IMR1, PWR_EXTI_LINE_AVD)
#endif /* defined (DUAL_CORE) */
 ...
 * @retval None.
 */
#define __HAL_PWR_AVD_EXTID2_ENABLE_EVENT()                                    \
  SET_BIT(EXTI_D2->EMR1, PWR_EXTI_LINE_AVD)
#endif /* defined (DUAL_CORE) */
 ...
 * @retval None.
 */
#define __HAL_PWR_AVD_EXTID2_DISABLE_EVENT()                                   \
  CLEAR_BIT(EXTI_D2->EMR1, PWR_EXTI_LINE_AVD)
#endif /* defined (DUAL_CORE) */
...
#define __HAL_PWR_AVD_EXTI_GET_FLAG()                                          \
  ((READ_BIT(EXTI->PR1, PWR_EXTI_LINE_AVD) == PWR_EXTI_LINE_AVD) ? 1UL : 0UL)
 ...
 */
#define __HAL_PWR_AVD_EXTID2_GET_FLAG()                                        \
  ((READ_BIT(EXTI_D2->PR1, PWR_EXTI_LINE_AVD) == PWR_EXTI_LINE_AVD) ? 1UL : 0UL)
#endif /* defined (DUAL_CORE) */
 ...
 * @retval None.
 */
#define __HAL_PWR_AVD_EXTID2_CLEAR_FLAG()                                      \
  SET_BIT(EXTI_D2->PR1, PWR_EXTI_LINE_AVD)
#endif /* defined (DUAL_CORE) */
...
void HAL_PWREx_EnterSTOPMode(uint32_t Regulator, uint8_t STOPEntry,
                             uint32_t Domain);
...
#define IS_PWR_DOMAIN(DOMAIN)                                                  \
  (((DOMAIN) == PWR_D1_DOMAIN) || ((DOMAIN) == PWR_D2_DOMAIN) ||               \
   ((DOMAIN) == PWR_D3_DOMAIN))
#else
#define IS_PWR_DOMAIN(DOMAIN)                                                  \
  (((DOMAIN) == PWR_D1_DOMAIN) || ((DOMAIN) == PWR_D3_DOMAIN))
#endif /* defined (PWR_CPUCR_PDDS_D2) */

/* Check D3/SRD domain state parameter */
#define IS_D3_STATE(STATE)                                                     \
  (((STATE) == PWR_D3_DOMAIN_STOP) || ((STATE) == PWR_D3_DOMAIN_RUN))
...
#define IS_PWR_WAKEUP_PIN(PIN)                                                 \
  (((PIN) == PWR_WAKEUP_PIN1) || ((PIN) == PWR_WAKEUP_PIN2) ||                 \
   ...
   ((PIN) == PWR_WAKEUP_PIN1_HIGH) || ((PIN) == PWR_WAKEUP_PIN2_HIGH) ||       \
   ((PIN) == PWR_WAKEUP_PIN4_HIGH) || ((PIN) == PWR_WAKEUP_PIN6_HIGH) ||       \
   ((PIN) == PWR_WAKEUP_PIN1_LOW) || ((PIN) == PWR_WAKEUP_PIN2_LOW) ||         \
   ((PIN) == PWR_WAKEUP_PIN4_LOW) || ((PIN) == PWR_WAKEUP_PIN6_LOW))
#endif /* defined (PWR_WKUPEPR_WKUPEN3) */
...
#define IS_PWR_WAKEUP_FLAG(FLAG)                                               \
  (((FLAG) == PWR_WAKEUP_FLAG1) || ((FLAG) == PWR_WAKEUP_FLAG2) ||             \
   ((FLAG) == PWR_WAKEUP_FLAG4) || ((FLAG) == PWR_WAKEUP_FLAG6) ||             \
   ((FLAG) == PWR_WAKEUP_FLAG_ALL))
#endif /* defined (PWR_WKUPEPR_WKUPEN3) */
...
#define IS_PWR_DOMAIN_FLAG(FLAG)                                               \
  (((FLAG) == PWR_D1_DOMAIN_FLAGS) || ((FLAG) == PWR_D2_DOMAIN_FLAGS) ||       \
