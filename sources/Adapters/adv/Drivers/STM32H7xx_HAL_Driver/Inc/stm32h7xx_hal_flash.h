...
typedef struct {
  ...
  __IO uint32_t VoltageForErase; /*!< Internal variable to provide voltage range
...
#define HAL_FLASH_ERROR_OPE                                                    \
  FLASH_FLAG_OPERR /*!< Operation Error                       */
#endif             /* FLASH_SR_OPERR */
#define HAL_FLASH_ERROR_RDP                                                    \
  FLASH_FLAG_RDPERR /*!< Read Protection Error                 */
#define HAL_FLASH_ERROR_RDS                                                    \
  FLASH_FLAG_RDSERR /*!< Read Secured Error                    */
#define HAL_FLASH_ERROR_SNECC                                                  \
  FLASH_FLAG_SNECCERR /*!< ECC Single Correction Error           */
#define HAL_FLASH_ERROR_DBECC                                                  \
  FLASH_FLAG_DBECCERR /*!< ECC Double Detection Error            */
#define HAL_FLASH_ERROR_CRCRD                                                  \
  FLASH_FLAG_CRCRDERR /*!< CRC Read Error                        */

#define HAL_FLASH_ERROR_WRP_BANK1                                              \
  FLASH_FLAG_WRPERR_BANK1 /*!< Write Protection Error on Bank 1      */
#define HAL_FLASH_ERROR_PGS_BANK1                                              \
  FLASH_FLAG_PGSERR_BANK1 /*!< Program Sequence Error on Bank 1      */
#define HAL_FLASH_ERROR_STRB_BANK1                                             \
  FLASH_FLAG_STRBERR_BANK1 /*!< Strobe Error on Bank 1                */
#define HAL_FLASH_ERROR_INC_BANK1                                              \
  FLASH_FLAG_INCERR_BANK1 /*!< Inconsistency Error on Bank 1         */
#if defined(FLASH_SR_OPERR)
#define HAL_FLASH_ERROR_OPE_BANK1                                              \
  FLASH_FLAG_OPERR_BANK1 /*!< Operation Error on Bank 1             */
#endif                   /* FLASH_SR_OPERR */
#define HAL_FLASH_ERROR_RDP_BANK1                                              \
  FLASH_FLAG_RDPERR_BANK1 /*!< Read Protection Error on Bank 1       */
#define HAL_FLASH_ERROR_RDS_BANK1                                              \
  FLASH_FLAG_RDSERR_BANK1 /*!< Read Secured Error on Bank 1          */
#define HAL_FLASH_ERROR_SNECC_BANK1                                            \
  FLASH_FLAG_SNECCERR_BANK1 /*!< ECC Single Correction Error on Bank 1 */
#define HAL_FLASH_ERROR_DBECC_BANK1                                            \
  FLASH_FLAG_DBECCERR_BANK1 /*!< ECC Double Detection Error on Bank 1  */
#define HAL_FLASH_ERROR_CRCRD_BANK1                                            \
  FLASH_FLAG_CRCRDERR_BANK1 /*!< CRC Read Error on Bank1               */

#define HAL_FLASH_ERROR_WRP_BANK2                                              \
  FLASH_FLAG_WRPERR_BANK2 /*!< Write Protection Error on Bank 2      */
#define HAL_FLASH_ERROR_PGS_BANK2                                              \
  FLASH_FLAG_PGSERR_BANK2 /*!< Program Sequence Error on Bank 2      */
#define HAL_FLASH_ERROR_STRB_BANK2                                             \
  FLASH_FLAG_STRBERR_BANK2 /*!< Strobe Error on Bank 2                */
#define HAL_FLASH_ERROR_INC_BANK2                                              \
  FLASH_FLAG_INCERR_BANK2 /*!< Inconsistency Error on Bank 2         */
#if defined(FLASH_SR_OPERR)
#define HAL_FLASH_ERROR_OPE_BANK2                                              \
  FLASH_FLAG_OPERR_BANK2 /*!< Operation Error on Bank 2             */
#endif                   /* FLASH_SR_OPERR */
#define HAL_FLASH_ERROR_RDP_BANK2                                              \
  FLASH_FLAG_RDPERR_BANK2 /*!< Read Protection Error on Bank 2       */
#define HAL_FLASH_ERROR_RDS_BANK2                                              \
  FLASH_FLAG_RDSERR_BANK2 /*!< Read Secured Error on Bank 2          */
#define HAL_FLASH_ERROR_SNECC_BANK2                                            \
  FLASH_FLAG_SNECCERR_BANK2 /*!< ECC Single Correction Error on Bank 2 */
#define HAL_FLASH_ERROR_DBECC_BANK2                                            \
  FLASH_FLAG_DBECCERR_BANK2 /*!< ECC Double Detection Error on Bank 2  */
#define HAL_FLASH_ERROR_CRCRD_BANK2                                            \
  FLASH_FLAG_CRCRDERR_BANK2 /*!< CRC Read Error on Bank2               */

#define HAL_FLASH_ERROR_OB_CHANGE                                              \
  FLASH_OPTSR_OPTCHANGEERR /*!< Option Byte Change Error              */
/**
 * @}
 */
 ...
 * @{
 */
#define FLASH_TYPEPROGRAM_FLASHWORD                                            \
  0x01U /*!< Program a flash word at a specified address */
#if defined(FLASH_OPTCR_PG_OTP)
#define FLASH_TYPEPROGRAM_OTPWORD                                              \
  0x02U /*!< Program an OTP word at a specified address  */
...
#define FLASH_FLAG_WRPERR                                                      \
  FLASH_SR_WRPERR /*!< Write Protection Error on flag                          \
                   */
#define FLASH_FLAG_PGSERR                                                      \
  FLASH_SR_PGSERR /*!< Program Sequence Error on flag                          \
                   */
...
#endif                                  /* FLASH_SR_OPERR */
#define FLASH_FLAG_RDPERR                                                      \
  FLASH_SR_RDPERR                         /*!< Read Protection Error on flag   \
                                           */
#define FLASH_FLAG_RDSERR FLASH_SR_RDSERR /*!< Read Secured Error on flag */
#define FLASH_FLAG_SNECCERR                                                    \
  FLASH_SR_SNECCERR /*!< Single ECC Error Correction on flag */
#define FLASH_FLAG_DBECCERR                                                    \
  FLASH_SR_DBECCERR /*!< Double Detection ECC Error on flag */
#define FLASH_FLAG_CRCEND FLASH_SR_CRCEND /*!< CRC End of Calculation flag */
#define FLASH_FLAG_CRCRDERR                                                    \
  FLASH_SR_CRCRDERR /*!< CRC Read Error on bank flag */

#define FLASH_FLAG_BSY_BANK1 FLASH_SR_BSY /*!< FLASH Bank 1 Busy flag */
#define FLASH_FLAG_WBNE_BANK1                                                  \
  FLASH_SR_WBNE /*!< Write Buffer Not Empty on Bank 1 flag */
#define FLASH_FLAG_QW_BANK1 FLASH_SR_QW /*!< Wait Queue on Bank 1 flag */
#define FLASH_FLAG_CRC_BUSY_BANK1                                              \
  FLASH_SR_CRC_BUSY /*!< CRC Busy on Bank 1 flag */
#define FLASH_FLAG_EOP_BANK1                                                   \
  FLASH_SR_EOP /*!< End Of Program on Bank 1 flag                              \
                */
#define FLASH_FLAG_WRPERR_BANK1                                                \
  FLASH_SR_WRPERR /*!< Write Protection Error on Bank 1 flag */
#define FLASH_FLAG_PGSERR_BANK1                                                \
  FLASH_SR_PGSERR /*!< Program Sequence Error on Bank 1 flag */
#define FLASH_FLAG_STRBERR_BANK1                                               \
  FLASH_SR_STRBERR /*!< Strobe Error on Bank 1 flag */
#define FLASH_FLAG_INCERR_BANK1                                                \
  FLASH_SR_INCERR /*!< Inconsistency Error on Bank 1 flag */
#if defined(FLASH_SR_OPERR)
#define FLASH_FLAG_OPERR_BANK1                                                 \
  FLASH_SR_OPERR /*!< Operation Error on Bank 1 flag */
#endif           /* FLASH_SR_OPERR */
#define FLASH_FLAG_RDPERR_BANK1                                                \
  FLASH_SR_RDPERR /*!< Read Protection Error on Bank 1 flag */
#define FLASH_FLAG_RDSERR_BANK1                                                \
  FLASH_SR_RDSERR /*!< Read Secured Error on Bank 1 flag */
#define FLASH_FLAG_SNECCERR_BANK1                                              \
  FLASH_SR_SNECCERR /*!< Single ECC Error Correction on Bank 1 flag */
#define FLASH_FLAG_DBECCERR_BANK1                                              \
  FLASH_SR_DBECCERR /*!< Double Detection ECC Error on Bank 1 flag */
#define FLASH_FLAG_CRCEND_BANK1                                                \
  FLASH_SR_CRCEND /*!< CRC End of Calculation on Bank 1 flag */
#define FLASH_FLAG_CRCRDERR_BANK1                                              \
  FLASH_SR_CRCRDERR /*!< CRC Read error on Bank 1 flag */
...
#define FLASH_FLAG_ALL_BANK1                                                   \
  (FLASH_FLAG_BSY_BANK1 | FLASH_FLAG_WBNE_BANK1 | FLASH_FLAG_QW_BANK1 |        \
   FLASH_FLAG_CRC_BUSY_BANK1 | FLASH_FLAG_EOP_BANK1 |                          \
   FLASH_FLAG_CRCEND_BANK1 |                                                   \
   FLASH_FLAG_ALL_ERRORS_BANK1) /*!< All Bank 1 flags */

#define FLASH_FLAG_BSY_BANK2                                                   \
  (FLASH_SR_BSY | 0x80000000U) /*!< FLASH Bank 2 Busy flag */
#define FLASH_FLAG_WBNE_BANK2                                                  \
  (FLASH_SR_WBNE | 0x80000000U) /*!< Write Buffer Not Empty on Bank 2 flag */
#define FLASH_FLAG_QW_BANK2                                                    \
  (FLASH_SR_QW | 0x80000000U) /*!< Wait Queue on Bank 2 flag */
#define FLASH_FLAG_CRC_BUSY_BANK2                                              \
  (FLASH_SR_CRC_BUSY | 0x80000000U) /*!< CRC Busy on Bank 2 flag */
#define FLASH_FLAG_EOP_BANK2                                                   \
  (FLASH_SR_EOP | 0x80000000U) /*!< End Of Program on Bank 2 flag */
#define FLASH_FLAG_WRPERR_BANK2                                                \
  (FLASH_SR_WRPERR | 0x80000000U) /*!< Write Protection Error on Bank 2 flag   \
                                   */
#define FLASH_FLAG_PGSERR_BANK2                                                \
  (FLASH_SR_PGSERR | 0x80000000U) /*!< Program Sequence Error on Bank 2 flag   \
                                   */
#define FLASH_FLAG_STRBERR_BANK2                                               \
  (FLASH_SR_STRBERR | 0x80000000U) /*!< Strobe Error on Bank 2 flag */
#define FLASH_FLAG_INCERR_BANK2                                                \
  (FLASH_SR_INCERR | 0x80000000U) /*!< Inconsistency Error on Bank 2 flag */
#if defined(FLASH_SR_OPERR)
#define FLASH_FLAG_OPERR_BANK2                                                 \
  (FLASH_SR_OPERR | 0x80000000U) /*!< Operation Error on Bank 2 flag */
#endif                           /* FLASH_SR_OPERR */
#define FLASH_FLAG_RDPERR_BANK2                                                \
  (FLASH_SR_RDPERR | 0x80000000U) /*!< Read Protection Error on Bank 2 flag */
#define FLASH_FLAG_RDSERR_BANK2                                                \
  (FLASH_SR_RDSERR | 0x80000000U) /*!< Read Secured Error on Bank 2 flag */
#define FLASH_FLAG_SNECCERR_BANK2                                              \
  (FLASH_SR_SNECCERR |                                                         \
   0x80000000U) /*!< Single ECC Error Correction on Bank 2 flag */
#define FLASH_FLAG_DBECCERR_BANK2                                              \
  (FLASH_SR_DBECCERR |                                                         \
   0x80000000U) /*!< Double Detection ECC Error on Bank 2 flag */
#define FLASH_FLAG_CRCEND_BANK2                                                \
  (FLASH_SR_CRCEND | 0x80000000U) /*!< CRC End of Calculation on Bank 2 flag   \
                                   */
#define FLASH_FLAG_CRCRDERR_BANK2                                              \
  (FLASH_SR_CRCRDERR | 0x80000000U) /*!< CRC Read error on Bank 2 flag */
...
#define FLASH_FLAG_ALL_BANK2                                                   \
  (FLASH_FLAG_BSY_BANK2 | FLASH_FLAG_WBNE_BANK2 | FLASH_FLAG_QW_BANK2 |        \
   FLASH_FLAG_CRC_BUSY_BANK2 | FLASH_FLAG_EOP_BANK2 |                          \
...
#define FLASH_IT_EOP_BANK1                                                     \
  FLASH_CR_EOPIE /*!< End of FLASH Bank 1 Operation Interrupt source */
#define FLASH_IT_WRPERR_BANK1                                                  \
  FLASH_CR_WRPERRIE /*!< Write Protection Error on Bank 1 Interrupt source */
#define FLASH_IT_PGSERR_BANK1                                                  \
  FLASH_CR_PGSERRIE /*!< Program Sequence Error on Bank 1 Interrupt source */
#define FLASH_IT_STRBERR_BANK1                                                 \
  FLASH_CR_STRBERRIE /*!< Strobe Error on Bank 1 Interrupt source */
#define FLASH_IT_INCERR_BANK1                                                  \
  FLASH_CR_INCERRIE /*!< Inconsistency Error on Bank 1 Interrupt source */
#if defined(FLASH_CR_OPERRIE)
#define FLASH_IT_OPERR_BANK1                                                   \
  FLASH_CR_OPERRIE /*!< Operation Error on Bank 1 Interrupt source */
#endif             /* FLASH_CR_OPERRIE */
#define FLASH_IT_RDPERR_BANK1                                                  \
  FLASH_CR_RDPERRIE /*!< Read protection Error on Bank 1 Interrupt source */
#define FLASH_IT_RDSERR_BANK1                                                  \
  FLASH_CR_RDSERRIE /*!< Read Secured Error on Bank 1 Interrupt source */
#define FLASH_IT_SNECCERR_BANK1                                                \
  FLASH_CR_SNECCERRIE /*!< Single ECC Error Correction on Bank 1 Interrupt     \
                         source */
#define FLASH_IT_DBECCERR_BANK1                                                \
  FLASH_CR_DBECCERRIE /*!< Double Detection ECC Error on Bank 1 Interrupt      \
                         source */
#define FLASH_IT_CRCEND_BANK1                                                  \
  FLASH_CR_CRCENDIE /*!< CRC End on Bank 1 Interrupt source */
#define FLASH_IT_CRCRDERR_BANK1                                                \
  FLASH_CR_CRCRDERRIE /*!< CRC Read error on Bank 1 Interrupt source */

#if defined(FLASH_CR_OPERRIE)
#define FLASH_IT_ALL_BANK1                                                     \
  (FLASH_IT_EOP_BANK1 | FLASH_IT_WRPERR_BANK1 | FLASH_IT_PGSERR_BANK1 |        \
   FLASH_IT_STRBERR_BANK1 | FLASH_IT_INCERR_BANK1 | FLASH_IT_OPERR_BANK1 |     \
   FLASH_IT_RDPERR_BANK1 | FLASH_IT_RDSERR_BANK1 | FLASH_IT_SNECCERR_BANK1 |   \
   FLASH_IT_DBECCERR_BANK1 | FLASH_IT_CRCEND_BANK1 |                           \
   FLASH_IT_CRCRDERR_BANK1) /*!< All Bank 1 Interrupt sources */
#else
#define FLASH_IT_ALL_BANK1                                                     \
  (FLASH_IT_EOP_BANK1 | FLASH_IT_WRPERR_BANK1 | FLASH_IT_PGSERR_BANK1 |        \
   FLASH_IT_STRBERR_BANK1 | FLASH_IT_INCERR_BANK1 | FLASH_IT_RDPERR_BANK1 |    \
   FLASH_IT_RDSERR_BANK1 | FLASH_IT_SNECCERR_BANK1 | FLASH_IT_DBECCERR_BANK1 | \
...
#define FLASH_IT_EOP_BANK2                                                     \
  (FLASH_CR_EOPIE |                                                            \
   0x80000000U) /*!< End of FLASH Bank 2 Operation Interrupt source */
#define FLASH_IT_WRPERR_BANK2                                                  \
  (FLASH_CR_WRPERRIE |                                                         \
   0x80000000U) /*!< Write Protection Error on Bank 2 Interrupt source */
#define FLASH_IT_PGSERR_BANK2                                                  \
  (FLASH_CR_PGSERRIE |                                                         \
   0x80000000U) /*!< Program Sequence Error on Bank 2 Interrupt source */
#define FLASH_IT_STRBERR_BANK2                                                 \
  (FLASH_CR_STRBERRIE |                                                        \
   0x80000000U) /*!< Strobe Error on Bank 2 Interrupt source */
#define FLASH_IT_INCERR_BANK2                                                  \
  (FLASH_CR_INCERRIE |                                                         \
   0x80000000U) /*!< Inconsistency Error on Bank 2 Interrupt source */
#if defined(FLASH_CR_OPERRIE)
#define FLASH_IT_OPERR_BANK2                                                   \
  (FLASH_CR_OPERRIE |                                                          \
   0x80000000U) /*!< Operation Error on Bank 2 Interrupt source */
#endif          /* FLASH_CR_OPERRIE */
#define FLASH_IT_RDPERR_BANK2                                                  \
  (FLASH_CR_RDPERRIE |                                                         \
   0x80000000U) /*!< Read protection Error on Bank 2 Interrupt source */
#define FLASH_IT_RDSERR_BANK2                                                  \
  (FLASH_CR_RDSERRIE |                                                         \
   0x80000000U) /*!< Read Secured Error on Bank 2 Interrupt source */
#define FLASH_IT_SNECCERR_BANK2                                                \
  (FLASH_CR_SNECCERRIE |                                                       \
   0x80000000U) /*!< Single ECC Error Correction on Bank 2 Interrupt source */
#define FLASH_IT_DBECCERR_BANK2                                                \
  (FLASH_CR_DBECCERRIE |                                                       \
   0x80000000U) /*!< Double Detection ECC Error on Bank 2 Interrupt source */
#define FLASH_IT_CRCEND_BANK2                                                  \
  (FLASH_CR_CRCENDIE | 0x80000000U) /*!< CRC End on Bank 2 Interrupt source */
#define FLASH_IT_CRCRDERR_BANK2                                                \
  (FLASH_CR_CRCRDERRIE |                                                       \
   0x80000000U) /*!< CRC Read Error on Bank 2 Interrupt source */

#if defined(FLASH_CR_OPERRIE)
#define FLASH_IT_ALL_BANK2                                                     \
  (FLASH_IT_EOP_BANK2 | FLASH_IT_WRPERR_BANK2 | FLASH_IT_PGSERR_BANK2 |        \
   FLASH_IT_STRBERR_BANK2 | FLASH_IT_INCERR_BANK2 | FLASH_IT_OPERR_BANK2 |     \
   FLASH_IT_RDPERR_BANK2 | FLASH_IT_RDSERR_BANK2 | FLASH_IT_SNECCERR_BANK2 |   \
   FLASH_IT_DBECCERR_BANK2 | FLASH_IT_CRCEND_BANK2 |                           \
   FLASH_IT_CRCRDERR_BANK2) /*!< All Bank 2 Interrupt sources */
#else
#define FLASH_IT_ALL_BANK2                                                     \
  (FLASH_IT_EOP_BANK2 | FLASH_IT_WRPERR_BANK2 | FLASH_IT_PGSERR_BANK2 |        \
   FLASH_IT_STRBERR_BANK2 | FLASH_IT_INCERR_BANK2 | FLASH_IT_RDPERR_BANK2 |    \
   FLASH_IT_RDSERR_BANK2 | FLASH_IT_SNECCERR_BANK2 | FLASH_IT_DBECCERR_BANK2 | \
 ...
 *   In case of Bank 1 This parameter can be any combination of the following
 * values:
 *     @arg FLASH_IT_EOP_BANK1       : End of FLASH Bank 1 Operation Interrupt
 * source
 *     @arg FLASH_IT_WRPERR_BANK1    : Write Protection Error on Bank 1
 * Interrupt source
 *     @arg FLASH_IT_PGSERR_BANK1    : Program Sequence Error on Bank 1
 * Interrupt source
 *     @arg FLASH_IT_STRBERR_BANK1   : Strobe Error on Bank 1 Interrupt source
 *     @arg FLASH_IT_INCERR_BANK1    : Inconsistency Error on Bank 1 Interrupt
 * source
 *     @arg FLASH_IT_OPERR_BANK1     : Operation Error on Bank 1 Interrupt
 * source
 *     @arg FLASH_IT_RDPERR_BANK1    : Read protection Error on Bank 1 Interrupt
 * source
 *     @arg FLASH_IT_RDSERR_BANK1    : Read secure Error on Bank 1 Interrupt
 * source
 *     @arg FLASH_IT_SNECCERR_BANK1  : Single ECC Error Correction on Bank 1
 * Interrupt source
 *     @arg FLASH_IT_DBECCERR_BANK1  : Double Detection ECC Error on Bank 1
 * Interrupt source
 ...
 *
 *   In case of Bank 2, this parameter can be any combination of the following
 * values:
 *     @arg FLASH_IT_EOP_BANK2       : End of FLASH Bank 2 Operation Interrupt
 * source
 *     @arg FLASH_IT_WRPERR_BANK2    : Write Protection Error on Bank 2
 * Interrupt source
 *     @arg FLASH_IT_PGSERR_BANK2    : Program Sequence Error on Bank 2
 * Interrupt source
 *     @arg FLASH_IT_STRBERR_BANK2   : Strobe Error on Bank 2 Interrupt source
 *     @arg FLASH_IT_INCERR_BANK2    : Inconsistency Error on Bank 2 Interrupt
 * source
 *     @arg FLASH_IT_OPERR_BANK2     : Operation Error on Bank 2 Interrupt
 * source
 *     @arg FLASH_IT_RDPERR_BANK2    : Read protection Error on Bank 2 Interrupt
 * source
 *     @arg FLASH_IT_RDSERR_BANK2    : Read secure Error on Bank 2 Interrupt
 * source
 *     @arg FLASH_IT_SNECCERR_BANK2  : Single ECC Error Correction on Bank 2
 * Interrupt source
 *     @arg FLASH_IT_DBECCERR_BANK2  : Double Detection ECC Error on Bank 2
 * Interrupt source
...
#define __HAL_FLASH_ENABLE_IT_BANK1(__INTERRUPT__)                             \
  (FLASH->CR1 |= (__INTERRUPT__))

#define __HAL_FLASH_ENABLE_IT_BANK2(__INTERRUPT__)                             \
  (FLASH->CR2 |= ((__INTERRUPT__) & 0x7FFFFFFFU))
...
#define __HAL_FLASH_DISABLE_IT_BANK1(__INTERRUPT__)                            \
  (FLASH->CR1 &= ~(uint32_t)(__INTERRUPT__))

#define __HAL_FLASH_DISABLE_IT_BANK2(__INTERRUPT__)                            \
  (FLASH->CR2 &= ~(uint32_t)((__INTERRUPT__) & 0x7FFFFFFFU))
 ...
 *     @arg FLASH_FLAG_SNECCE_BANK1   : Single ECC Error Correction on Bank 1
 * flag
 *     @arg FLASH_FLAG_DBECCE_BANK1   : Double Detection ECC Error on Bank 1
 * flag
 ...
 *     @arg FLASH_FLAG_SNECCE_BANK2   : Single ECC Error Correction on Bank 2
 * flag
 *     @arg FLASH_FLAG_DBECCE_BANK2   : Double Detection ECC Error on Bank 2
 * flag
...
#define __HAL_FLASH_GET_FLAG_BANK1(__FLAG__)                                   \
  (READ_BIT(FLASH->SR1, (__FLAG__)) == (__FLAG__))

#define __HAL_FLASH_GET_FLAG_BANK2(__FLAG__)                                   \
  (READ_BIT(FLASH->SR2, ((__FLAG__) & 0x7FFFFFFFU)) ==                         \
   (((__FLAG__) & 0x7FFFFFFFU)))
...
#define __HAL_FLASH_CLEAR_FLAG_BANK1(__FLAG__)                                 \
  WRITE_REG(FLASH->CCR1, (__FLAG__))

#define __HAL_FLASH_CLEAR_FLAG_BANK2(__FLAG__)                                 \
  WRITE_REG(FLASH->CCR2, ((__FLAG__) & 0x7FFFFFFFU))
...
#define IS_FLASH_PROGRAM_ADDRESS_BANK1(ADDRESS)                                \
  (((ADDRESS) >= FLASH_BANK1_BASE) && ((ADDRESS) < FLASH_BANK2_BASE))
#define IS_FLASH_PROGRAM_ADDRESS_BANK2(ADDRESS)                                \
  (((ADDRESS) >= FLASH_BANK2_BASE) && ((ADDRESS) <= FLASH_END))
#else
#define IS_FLASH_PROGRAM_ADDRESS_BANK1(ADDRESS)                                \
  (((ADDRESS) >= FLASH_BANK1_BASE) && ((ADDRESS) <= FLASH_END))
#endif /* DUAL_BANK */

#if defined(DUAL_BANK)
#if defined(FLASH_OPTCR_PG_OTP)
#define IS_FLASH_PROGRAM_ADDRESS_OTP(ADDRESS)                                  \
  (((ADDRESS) >= 0x08FFF000U) && ((ADDRESS) <= 0x08FFF3FFU))
