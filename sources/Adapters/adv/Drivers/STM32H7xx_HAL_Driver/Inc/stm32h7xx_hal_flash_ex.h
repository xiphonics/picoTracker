...
typedef struct {
  ...
  uint32_t USERType; /*!< User option byte(s) to be configured (used for
                        ...
                        @ref FLASHEx_OB_USER_Type */

  uint32_t USERConfig; /*!< Program the FLASH User Option Byte: IWDG_SW /
                          RST_STOP / RST_STDBY / IWDG_FREEZE_STOP /
                          IWDG_FREEZE_SANDBY / IO_HSLV / SWAP_BANK_OPT */
  ...
  uint32_t PCROPConfig; /*!< specifies if the PCROP area shall be erased or not
                             when RDP level decreased from Level 1 to Level 0 or
                           during a mass erase. This parameter must be a value
                           of @ref FLASHEx_OB_PCROP_RDP enumeration */

  uint32_t PCROPStartAddr; /*!< PCROP Start address (used for OPTIONBYTE_PCROP).
                                This parameter must be a value between begin and
                              end of a bank */

  uint32_t PCROPEndAddr; /*!< PCROP End address (used for OPTIONBYTE_PCROP).
                              This parameter must be a value between PCROP Start
                            address and end of a bank */

  uint32_t BootConfig; /*!< Specifies if the Boot Address to be configured
                          BOOT_ADD0, BOOT_ADD1 or both. This parameter must be a
                          value of @ref FLASHEx_OB_BOOT_OPTION enumeration */
  ...
  uint32_t
      CM4BootConfig; /*!< specifies if the CM4 boot Address to be configured
                        BOOT_ADD0, BOOT_ADD1 or both. This parameter must be a
                        value of @ref FLASHEx_OB_BOOT_OPTION enumeration */
  ...
  uint32_t
      SecureAreaConfig; /*!< specifies if the bank secured area shall be erased
                           or not when RDP level decreased from Level 1 to Level
                           0 or during a mass erase. This parameter must be a
                           value of @ref FLASHEx_OB_SECURE_RDP enumeration */

  uint32_t SecureAreaStartAddr; /*!< Bank Secure area Start address.
                                     This parameter must be a value between
                                   begin address and end address of bank1 */

  uint32_t
      SecureAreaEndAddr; /*!< Bank Secure area End address.
                              This parameter must be a value between Secure Area
                            Start address and end address of a bank1 */
  ...
  uint32_t SharedRamConfig; /*!< Specifies the configuration of TCM / AXI shared
                               RAM. This parameter must be a value of @ref
                               FLASHEx_OB_TCM_AXI_SHARED */
...
typedef struct {
  ...
  uint32_t CRCStartAddr; /*!< CRC Start address.
                              This parameter must be a value between begin
                            address and end address of a bank */

  uint32_t CRCEndAddr; /*!< CRC End address.
                            This parameter must be a value between CRC Start
                          address and end address of a bank */
...
#define FLASH_VOLTAGE_RANGE_1                                                  \
  0x00000000U /*!< Flash program/erase by 8 bits                               \
               */
#define FLASH_VOLTAGE_RANGE_2                                                  \
  FLASH_CR_PSIZE_0 /*!< Flash program/erase by 16 bits */
#define FLASH_VOLTAGE_RANGE_3                                                  \
  FLASH_CR_PSIZE_1 /*!< Flash program/erase by 32 bits */
#define FLASH_VOLTAGE_RANGE_4                                                  \
  FLASH_CR_PSIZE /*!< Flash program/erase by 64 bits */
/**
 * @}
 */
...
#define OPTIONBYTE_SECURE_AREA                                                 \
  0x20U /*!< secure area option byte configuration */
#if defined(DUAL_CORE)
#define OPTIONBYTE_CM7_BOOTADD                                                 \
  0x40U /*!< CM7 BOOT ADD option byte configuration */
#define OPTIONBYTE_CM4_BOOTADD                                                 \
  0x80U /*!< CM4 BOOT ADD option byte configuration */
#define OPTIONBYTE_BOOTADD                                                     \
  OPTIONBYTE_CM7_BOOTADD         /*!< BOOT ADD option byte configuration */
#else                            /* Single core */
...
#endif                            /* FLASH_OTPBL_LOCKBL */
#if defined(FLASH_OPTSR2_TCM_AXI_SHARED)
#define OPTIONBYTE_SHARED_RAM                                                  \
  0x100U /*!< TCM / AXI Shared RAM option byte configuration */
#endif   /* FLASH_OPTSR2_TCM_AXI_SHARED */
#if defined(FLASH_OPTSR2_CPUFREQ_BOOST)
#define OPTIONBYTE_FREQ_BOOST                                                  \
  0x200U /*!< CPU Frequency Boost option byte configuration */
#endif   /* FLASH_OPTSR2_CPUFREQ_BOOST */

#if defined(DUAL_CORE)
#define OPTIONBYTE_ALL                                                         \
  (OPTIONBYTE_WRP | OPTIONBYTE_RDP | OPTIONBYTE_USER | OPTIONBYTE_PCROP |      \
   OPTIONBYTE_BOR | OPTIONBYTE_SECURE_AREA | OPTIONBYTE_CM7_BOOTADD |          \
   OPTIONBYTE_CM4_BOOTADD) /*!< All option byte configuration */
#elif defined(FLASH_OTPBL_LOCKBL)
#define OPTIONBYTE_ALL                                                         \
  (OPTIONBYTE_WRP | OPTIONBYTE_RDP | OPTIONBYTE_USER | OPTIONBYTE_PCROP |      \
   OPTIONBYTE_BOR | OPTIONBYTE_SECURE_AREA | OPTIONBYTE_BOOTADD |              \
   OPTIONBYTE_OTP_LOCK) /*!< All option byte configuration */
#elif defined(FLASH_OPTSR2_TCM_AXI_SHARED)
#define OPTIONBYTE_ALL                                                         \
  (OPTIONBYTE_WRP | OPTIONBYTE_RDP | OPTIONBYTE_USER | OPTIONBYTE_PCROP |      \
   OPTIONBYTE_BOR | OPTIONBYTE_SECURE_AREA | OPTIONBYTE_BOOTADD |              \
   OPTIONBYTE_SHARED_RAM |                                                     \
   OPTIONBYTE_FREQ_BOOST) /*!< All option byte configuration */
#else
#define OPTIONBYTE_ALL                                                         \
  (OPTIONBYTE_WRP | OPTIONBYTE_RDP | OPTIONBYTE_USER | OPTIONBYTE_PCROP |      \
   OPTIONBYTE_BOR | OPTIONBYTE_SECURE_AREA |                                   \
...
#define OB_RDP_LEVEL_2                                                         \
  0xCC00U /*!< Warning: When enabling read protection level 2                  \
...
#define OB_STDBY_NO_RST                                                        \
  0x80U                    /*!< No reset generated when entering in STANDBY */
#define OB_STDBY_RST 0x00U /*!< Reset generated when entering in STANDBY    */
/**
 * @}
 */

/** @defgroup FLASHEx_Option_Bytes_IWDG_FREEZE_STOP FLASH IWDG Counter Freeze in
 * STOP
 * @{
 */
#define OB_IWDG_STOP_FREEZE                                                    \
  0x00000000U /*!< Freeze IWDG counter in STOP mode                            \
               */
#define OB_IWDG_STOP_ACTIVE                                                    \
  FLASH_OPTSR_FZ_IWDG_STOP /*!< IWDG counter active in STOP mode */
/**
 * @}
 */

/** @defgroup FLASHEx_Option_Bytes_IWDG_FREEZE_SANDBY FLASH IWDG Counter Freeze
 * in STANDBY
 * @{
 */
#define OB_IWDG_STDBY_FREEZE                                                   \
  0x00000000U /*!< Freeze IWDG counter in STANDBY mode */
#define OB_IWDG_STDBY_ACTIVE                                                   \
  FLASH_OPTSR_FZ_IWDG_SDBY /*!< IWDG counter active in STANDBY mode */
/**
 * @}
 */
...
#define OB_BOR_LEVEL1                                                          \
  FLASH_OPTSR_BOR_LEV_0 /*!< Reset level threshold is set to 2.1V */
#define OB_BOR_LEVEL2                                                          \
  FLASH_OPTSR_BOR_LEV_1 /*!< Reset level threshold is set to 2.4V */
#define OB_BOR_LEVEL3                                                          \
  (FLASH_OPTSR_BOR_LEV_1 |                                                     \
   FLASH_OPTSR_BOR_LEV_0) /*!< Reset level threshold is set to 2.7V  */
/**
 * @}
 */
...
#define OB_BOOTADDR_ITCM_RAM                                                   \
  0x0000U /*!< Boot from ITCM RAM (0x00000000)                 */
#define OB_BOOTADDR_SYSTEM                                                     \
  0x0040U /*!< Boot from System memory bootloader (0x00100000) */
#define OB_BOOTADDR_ITCM_FLASH                                                 \
  0x0080U /*!< Boot from Flash on ITCM interface (0x00200000)  */
#define OB_BOOTADDR_AXIM_FLASH                                                 \
  0x2000U /*!< Boot from Flash on AXIM interface (0x08000000)  */
#define OB_BOOTADDR_DTCM_RAM                                                   \
  0x8000U /*!< Boot from DTCM RAM (0x20000000)                 */
#define OB_BOOTADDR_SRAM1                                                      \
  0x8004U /*!< Boot from SRAM1 (0x20010000)                    */
#define OB_BOOTADDR_SRAM2                                                      \
  0x8013U /*!< Boot from SRAM2 (0x2004C000)                    */
/**
 * @}
 */
...
#define FLASH_LATENCY_8                                                        \
  FLASH_ACR_LATENCY_8WS /*!< FLASH Eight Latency cycle     */
#define FLASH_LATENCY_9                                                        \
  FLASH_ACR_LATENCY_9WS /*!< FLASH Nine Latency cycle      */
...
#define OB_PCROP_RDP_ERASE                                                     \
  FLASH_PRAR_DMEP /*!< PCROP area is erased when the RDP level is              \
...
#define OB_WRP_SECTOR_0TO3                                                     \
  0x00000001U /*!< Write protection of Sector0  to Sector3    */
#define OB_WRP_SECTOR_4TO7                                                     \
  0x00000002U /*!< Write protection of Sector4  to Sector7    */
#define OB_WRP_SECTOR_8TO11                                                    \
  0x00000004U /*!< Write protection of Sector8  to Sector11   */
#define OB_WRP_SECTOR_12TO15                                                   \
  0x00000008U /*!< Write protection of Sector12 to Sector15   */
#define OB_WRP_SECTOR_16TO19                                                   \
  0x00000010U /*!< Write protection of Sector16 to Sector19   */
#define OB_WRP_SECTOR_20TO23                                                   \
  0x00000020U /*!< Write protection of Sector20 to Sector23   */
#define OB_WRP_SECTOR_24TO27                                                   \
  0x00000040U /*!< Write protection of Sector24 to Sector27   */
#define OB_WRP_SECTOR_28TO31                                                   \
  0x00000080U /*!< Write protection of Sector28 to Sector31   */
#define OB_WRP_SECTOR_32TO35                                                   \
  0x00000100U /*!< Write protection of Sector32 to Sector35   */
#define OB_WRP_SECTOR_36TO39                                                   \
  0x00000200U /*!< Write protection of Sector36 to Sector39   */
#define OB_WRP_SECTOR_40TO43                                                   \
  0x00000400U /*!< Write protection of Sector40 to Sector43   */
#define OB_WRP_SECTOR_44TO47                                                   \
  0x00000800U /*!< Write protection of Sector44 to Sector47   */
#define OB_WRP_SECTOR_48TO51                                                   \
  0x00001000U /*!< Write protection of Sector48 to Sector51   */
#define OB_WRP_SECTOR_52TO55                                                   \
  0x00002000U /*!< Write protection of Sector52 to Sector55   */
#define OB_WRP_SECTOR_56TO59                                                   \
  0x00004000U /*!< Write protection of Sector56 to Sector59   */
#define OB_WRP_SECTOR_60TO63                                                   \
  0x00008000U /*!< Write protection of Sector60 to Sector63   */
#define OB_WRP_SECTOR_64TO67                                                   \
  0x00010000U /*!< Write protection of Sector64 to Sector67   */
#define OB_WRP_SECTOR_68TO71                                                   \
  0x00020000U /*!< Write protection of Sector68 to Sector71   */
#define OB_WRP_SECTOR_72TO75                                                   \
  0x00040000U /*!< Write protection of Sector72 to Sector75   */
#define OB_WRP_SECTOR_76TO79                                                   \
  0x00080000U /*!< Write protection of Sector76 to Sector79   */
#define OB_WRP_SECTOR_80TO83                                                   \
  0x00100000U /*!< Write protection of Sector80 to Sector83   */
#define OB_WRP_SECTOR_84TO87                                                   \
  0x00200000U /*!< Write protection of Sector84 to Sector87   */
#define OB_WRP_SECTOR_88TO91                                                   \
  0x00400000U /*!< Write protection of Sector88 to Sector91   */
#define OB_WRP_SECTOR_92TO95                                                   \
  0x00800000U /*!< Write protection of Sector92 to Sector95   */
#define OB_WRP_SECTOR_96TO99                                                   \
  0x01000000U /*!< Write protection of Sector96  to Sector99  */
#define OB_WRP_SECTOR_100TO103                                                 \
  0x02000000U /*!< Write protection of Sector100 to Sector103 */
#define OB_WRP_SECTOR_104TO107                                                 \
  0x04000000U /*!< Write protection of Sector104 to Sector107 */
#define OB_WRP_SECTOR_108TO111                                                 \
  0x08000000U /*!< Write protection of Sector108 to Sector111 */
#define OB_WRP_SECTOR_112TO115                                                 \
  0x10000000U /*!< Write protection of Sector112 to Sector115 */
#define OB_WRP_SECTOR_116TO119                                                 \
  0x20000000U /*!< Write protection of Sector116 to Sector119 */
#define OB_WRP_SECTOR_120TO123                                                 \
  0x40000000U /*!< Write protection of Sector120 to Sector123 */
#define OB_WRP_SECTOR_124TO127                                                 \
  0x80000000U /*!< Write protection of Sector124 to Sector127 */
#define OB_WRP_SECTOR_ALL                                                      \
  0xFFFFFFFFU /*!< Write protection of all Sectors            */
#else
#define OB_WRP_SECTOR_0                                                        \
  0x00000001U /*!< Write protection of Sector0                */
#define OB_WRP_SECTOR_1                                                        \
  0x00000002U /*!< Write protection of Sector1                */
#define OB_WRP_SECTOR_2                                                        \
  0x00000004U /*!< Write protection of Sector2                */
#define OB_WRP_SECTOR_3                                                        \
  0x00000008U /*!< Write protection of Sector3                */
#define OB_WRP_SECTOR_4                                                        \
  0x00000010U /*!< Write protection of Sector4                */
#define OB_WRP_SECTOR_5                                                        \
  0x00000020U /*!< Write protection of Sector5                */
#define OB_WRP_SECTOR_6                                                        \
  0x00000040U /*!< Write protection of Sector6                */
#define OB_WRP_SECTOR_7                                                        \
  0x00000080U /*!< Write protection of Sector7                */
#define OB_WRP_SECTOR_ALL                                                      \
  0x000000FFU /*!< Write protection of all Sectors            */
...
#define OB_ST_RAM_SIZE_4KB                                                     \
  FLASH_OPTSR_ST_RAM_SIZE_0 /*!< 4 Kbytes reserved to ST code */
#define OB_ST_RAM_SIZE_8KB                                                     \
  FLASH_OPTSR_ST_RAM_SIZE_1 /*!< 8 Kbytes reserved to ST code */
#define OB_ST_RAM_SIZE_16KB                                                    \
  FLASH_OPTSR_ST_RAM_SIZE /*!< 16 Kbytes reserved to ST code */
/**
 * @}
 */
 ...
 */
#define OB_IWDG1_SW                                                            \
  FLASH_OPTSR_IWDG1_SW          /*!< Hardware independent watchdog 1           \
                                 */
 ...
 */
#define OB_IWDG2_SW                                                            \
  FLASH_OPTSR_IWDG2_SW          /*!< Hardware independent watchdog             \
                                   2*/
 ...
 * @{
 */
#define OB_STOP_RST_D1                                                         \
  0x00000000U /*!< Reset generated when entering the D1 to stop mode */
#define OB_STOP_NO_RST_D1                                                      \
  FLASH_OPTSR_NRST_STOP_D1 /*!< No reset generated when entering the D1 to     \
                              stop mode */
/**
 * @}
 */
 ...
 * @{
 */
#define OB_STDBY_RST_D1                                                        \
  0x00000000U /*!< Reset generated when entering the D1 to standby mode */
#define OB_STDBY_NO_RST_D1                                                     \
  FLASH_OPTSR_NRST_STBY_D1 /*!< No reset generated when entering the D1 to     \
                              standby mode */
/**
 * @}
 */
 ...
 * @{
 */
#define OB_STOP_RST_D2                                                         \
  0x00000000U /*!< Reset generated when entering the D2 to stop mode */
#define OB_STOP_NO_RST_D2                                                      \
  FLASH_OPTSR_NRST_STOP_D2 /*!< No reset generated when entering the D2 to     \
                              stop mode */
/**
 * @}
 */
 ...
 * @{
 */
#define OB_STDBY_RST_D2                                                        \
  0x00000000U /*!< Reset generated when entering the D2 to standby mode */
#define OB_STDBY_NO_RST_D2                                                     \
  FLASH_OPTSR_NRST_STBY_D2 /*!< No reset generated when entering the D2 to     \
                              standby mode */
/**
 * @}
 */
...
#define OB_SWAP_BANK_ENABLE                                                    \
  FLASH_OPTSR_SWAP_BANK_OPT /*!< Bank swap enabled                             \
                             */
/**
 * @}
 */
...
#define OB_VDDMMC_HSLV_ENABLE                                                  \
  FLASH_OPTSR_VDDMMC_HSLV /*!< VDDMMC HSLV enabled */
/**
 * @}
 */
...
#define OB_CPUFREQ_BOOST_ENABLE                                                \
  FLASH_OPTSR2_CPUFREQ_BOOST /*!< CPUFREQ BOOST enabled */
/**
 * @}
 */
#endif /* FLASH_OPTSR2_CPUFREQ_BOOST */
 ...
 * @{
 */
#define OB_TCM_AXI_SHARED_ITCM64KB                                             \
  0x00000000U /*!< 64KB ITCM / 320KB system AXI  */
#define OB_TCM_AXI_SHARED_ITCM128KB                                            \
  FLASH_OPTSR2_TCM_AXI_SHARED_0 /*!< 128KB ITCM / 256KB system AXI */
#define OB_TCM_AXI_SHARED_ITCM192KB                                            \
  FLASH_OPTSR2_TCM_AXI_SHARED_1 /*!< 192KB ITCM / 192KB system AXI */
#define OB_TCM_AXI_SHARED_ITCM256KB                                            \
  FLASH_OPTSR2_TCM_AXI_SHARED /*!< 256KB ITCM / 128KB system AXI */
/**
 * @}
 */
#endif /* FLASH_OPTSR2_TCM_AXI_SHARED */
...
#define OB_USER_NRST_STOP_D1                                                   \
  0x0002U /*!< Reset when entering Stop mode selection*/
#define OB_USER_NRST_STDBY_D1                                                  \
  0x0004U /*!< Reset when entering standby mode selection*/
#define OB_USER_IWDG_STOP                                                      \
  0x0008U /*!< Independent watchdog counter freeze in stop mode */
#define OB_USER_IWDG_STDBY                                                     \
  0x0010U /*!< Independent watchdog counter freeze in standby mode */
...
#endif                           /*DUAL_CORE*/
#if defined(FLASH_OPTSR_NRST_STOP_D2)
#define OB_USER_NRST_STOP_D2                                                   \
  0x1000U /*!< Reset when entering Stop mode selection */
#define OB_USER_NRST_STDBY_D2                                                  \
  0x2000U /*!< Reset when entering standby mode selection */
#endif    /* FLASH_OPTSR_NRST_STOP_D2 */

#if defined(DUAL_CORE)
#define OB_USER_ALL                                                            \
  (OB_USER_IWDG1_SW | OB_USER_NRST_STOP_D1 | OB_USER_NRST_STDBY_D1 |           \
   OB_USER_IWDG_STOP | OB_USER_IWDG_STDBY | OB_USER_ST_RAM_SIZE |              \
   OB_USER_SECURITY | OB_USER_IOHSLV | OB_USER_SWAP_BANK | OB_USER_IWDG2_SW |  \
   OB_USER_BCM4 | OB_USER_BCM7 | OB_USER_NRST_STOP_D2 | OB_USER_NRST_STDBY_D2)
...
#define OB_USER_ALL                                                            \
  (OB_USER_IWDG1_SW | OB_USER_NRST_STOP_D1 | OB_USER_NRST_STDBY_D1 |           \
   OB_USER_IWDG_STOP | OB_USER_IWDG_STDBY | OB_USER_ST_RAM_SIZE |              \
   OB_USER_SECURITY | OB_USER_IOHSLV | OB_USER_VDDMMC_HSLV)
#endif /* DUAL_BANK */
#elif defined(FLASH_OPTSR2_TCM_AXI_SHARED)
#define OB_USER_ALL                                                            \
  (OB_USER_IWDG1_SW | OB_USER_NRST_STOP_D1 | OB_USER_NRST_STDBY_D1 |           \
   OB_USER_IWDG_STOP | OB_USER_IWDG_STDBY | OB_USER_ST_RAM_SIZE |              \
   OB_USER_SECURITY | OB_USER_IOHSLV | OB_USER_NRST_STOP_D2 |                  \
...
#define OB_SECURE_RDP_NOT_ERASE                                                \
  0x00000000U /*!< Secure area is not erased when the RDP level                \
                   is decreased from Level 1 to Level 0 or during a mass erase \
               */
#define OB_SECURE_RDP_ERASE                                                    \
  FLASH_SCAR_DMES /*!< Secure area is erased when the RDP level is             \
                       decreased from Level 1 to Level 0 (full mass erase) */
/**
 * @}
 */
...
#define FLASH_CRC_SECTORS                                                      \
  FLASH_CRCCR_CRC_BY_SECT /*!< CRC selection type by sectors  */
#define FLASH_CRC_BANK                                                         \
  (FLASH_CRCCR_ALL_BANK |                                                      \
   FLASH_CRCCR_CRC_BY_SECT) /*!< CRC selection type by bank */
/**
 * @}
 */
 ...
 * @{
 */
#define FLASH_CRC_BURST_SIZE_4                                                 \
  0x00000000U /*!< Every burst has a size of 4 Flash words (256-bit)  */
#define FLASH_CRC_BURST_SIZE_16                                                \
  FLASH_CRCCR_CRC_BURST_0 /*!< Every burst has a size of 16 Flash words        \
                             (256-bit)   */
#define FLASH_CRC_BURST_SIZE_64                                                \
  FLASH_CRCCR_CRC_BURST_1 /*!< Every burst has a size of 64 Flash words        \
                             (256-bit)   */
#define FLASH_CRC_BURST_SIZE_256                                               \
  FLASH_CRCCR_CRC_BURST /*!< Every burst has a size of 256 Flash words         \
                           (256-bit) */
/**
 * @}
 */
...
#define FLASH_PROGRAMMING_DELAY_0                                              \
  0x00000000U /*!< programming delay set for Flash running at 70 MHz or below  \
               */
...
#define FLASH_PROGRAMMING_DELAY_2                                              \
  FLASH_ACR_WRHIGHFREQ_1 /*!< programming delay set for Flash running between  \
                            185 MHz and 225 MHz */
#define FLASH_PROGRAMMING_DELAY_3                                              \
  FLASH_ACR_WRHIGHFREQ /*!< programming delay set for Flash at startup */
/**
 * @}
 */
 ...
 * @param  __ADDRESS__: FLASH Boot Address (in the range 0x0000 0000 to 0x2004
 * FFFF with a granularity of 16KB)
...
#define __HAL_FLASH_GET_PSIZE(__BANK__)                                        \
  (((__BANK__) == FLASH_BANK_1) ? READ_BIT((FLASH->CR1), FLASH_CR_PSIZE)       \
...
#define IS_OB_WRP_SECTOR(SECTOR)                                               \
  ((((SECTOR) & 0xFFFFFF00U) == 0x00000000U) && ((SECTOR) != 0x00000000U))
#else
...
#define IS_OB_USER_IOHSLV(VALUE)                                               \
  (((VALUE) == OB_IOHSLV_DISABLE) || ((VALUE) == OB_IOHSLV_ENABLE))

#if defined(FLASH_OPTSR_VDDMMC_HSLV)
#define IS_OB_USER_VDDMMC_HSLV(VALUE)                                          \
  (((VALUE) == OB_VDDMMC_HSLV_DISABLE) || ((VALUE) == OB_VDDMMC_HSLV_ENABLE))
#endif /* FLASH_OPTSR_VDDMMC_HSLV */

#define IS_OB_IWDG1_SOURCE(SOURCE)                                             \
  (((SOURCE) == OB_IWDG1_SW) || ((SOURCE) == OB_IWDG1_HW))
#if defined(DUAL_CORE)
#define IS_OB_IWDG2_SOURCE(SOURCE)                                             \
  (((SOURCE) == OB_IWDG2_SW) || ((SOURCE) == OB_IWDG2_HW))
#endif /* DUAL_CORE */
#define IS_OB_STOP_D1_RESET(VALUE)                                             \
  (((VALUE) == OB_STOP_NO_RST_D1) || ((VALUE) == OB_STOP_RST_D1))

#define IS_OB_STDBY_D1_RESET(VALUE)                                            \
  (((VALUE) == OB_STDBY_NO_RST_D1) || ((VALUE) == OB_STDBY_RST_D1))
...
#define IS_OB_USER_SECURITY(VALUE)                                             \
  (((VALUE) == OB_SECURITY_ENABLE) || ((VALUE) == OB_SECURITY_DISABLE))

#if defined(DUAL_CORE)
#define IS_OB_USER_BCM4(VALUE)                                                 \
  (((VALUE) == OB_BCM4_DISABLE) || ((VALUE) == OB_BCM4_ENABLE))

#define IS_OB_USER_BCM7(VALUE)                                                 \
  (((VALUE) == OB_BCM7_DISABLE) || ((VALUE) == OB_BCM7_ENABLE))
#endif /* DUAL_CORE */

#if defined(FLASH_OPTSR_NRST_STOP_D2)
#define IS_OB_STOP_D2_RESET(VALUE)                                             \
  (((VALUE) == OB_STOP_NO_RST_D2) || ((VALUE) == OB_STOP_RST_D2))

#define IS_OB_STDBY_D2_RESET(VALUE)                                            \
  (((VALUE) == OB_STDBY_NO_RST_D2) || ((VALUE) == OB_STDBY_RST_D2))
#endif /* FLASH_OPTSR_NRST_STOP_D2 */

#if defined(FLASH_OPTSR2_TCM_AXI_SHARED)
#define IS_OB_USER_TCM_AXI_SHARED(VALUE)                                       \
  (((VALUE) == OB_TCM_AXI_SHARED_ITCM64KB) ||                                  \
   ((VALUE) == OB_TCM_AXI_SHARED_ITCM128KB) ||                                 \
   ((VALUE) == OB_TCM_AXI_SHARED_ITCM192KB) ||                                 \
   ((VALUE) == OB_TCM_AXI_SHARED_ITCM256KB))
#endif /* FLASH_OPTSR2_TCM_AXI_SHARED */

#if defined(FLASH_OPTSR2_CPUFREQ_BOOST)
#define IS_OB_USER_CPUFREQ_BOOST(VALUE)                                        \
  (((VALUE) == OB_CPUFREQ_BOOST_DISABLE) ||                                    \
   ((VALUE) == OB_CPUFREQ_BOOST_ENABLE))
#endif /* FLASH_OPTSR2_CPUFREQ_BOOST */
...
#define IS_OB_BOOT_ADD_OPTION(VALUE)                                           \
  (((VALUE) == OB_BOOT_ADD0) || ((VALUE) == OB_BOOT_ADD1) ||                   \
   ((VALUE) == OB_BOOT_ADD_BOTH))

#define IS_FLASH_TYPECRC(VALUE)                                                \
  (((VALUE) == FLASH_CRC_ADDR) || ((VALUE) == FLASH_CRC_SECTORS) ||            \
   ((VALUE) == FLASH_CRC_BANK))

#if defined(FLASH_OTPBL_LOCKBL)
#define IS_OTP_BLOCK(VALUE)                                                    \
  ((((VALUE) & 0xFFFF0000U) == 0x00000000U) && ((VALUE) != 0x00000000U))
#endif /* FLASH_OTPBL_LOCKBL */
/**
 * @}
 */
