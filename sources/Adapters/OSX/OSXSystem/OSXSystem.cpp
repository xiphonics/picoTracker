...
void *OSXSystem::Malloc(unsigned size) { return malloc(size); }

//------------------------------------------------------------------------------

void OSXSystem::Free(void *ptr) { free(ptr); }
...
void OSXSystem::PostQuitMessage() { eventManager_->PostQuitMessage(); }

//------------------------------------------------------------------------------

int unsigned OSXSystem::GetMemoryUsage() { return 0; }
