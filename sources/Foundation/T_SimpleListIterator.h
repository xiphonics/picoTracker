...
//
// T_SimpleListIterator: An iterator that traverses the content of a
// T_SimpleList and complies with the generic I_Iterator interface
//

template <class Item> class T_SimpleListIterator : public I_Iterator<Item> {
public:
