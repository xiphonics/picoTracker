...
*the *	internal state of the converter. Choose a converter from the enums
*below. *	The cb_data pointer can point to any data or be set to NULL.
*Whatever the *	value, when processing, user supplied function "func" gets
*called with *	cb_data as first parameter.
*/
