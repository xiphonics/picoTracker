...
When in the wave sample File Browser, use the arrow keys <span class="minikeys">UP/DOWN ![up/down](image/pt-buttons-small-arrows-updown.jpg)</span> to navigate through the list of available sample files and subdirectories, subdirectories are indicated with a `/` prefix. Press <span class="minikeys">ENTER ![Enter](image/pt-buttons-small-enter.jpg)</span> to enter a subdirectory, you can go back to the parent directory by navigating to the `/..` entry and pressing <span class="minikeys">ENTER ![enter](image/pt-buttons-small-enter.jpg)</span> or by pressing <span class="minikeys">EDIT+LEFT</span>. Press <span class="minikeys">PLAY ![play](image/pt-buttons-small-play.jpg)</span> to audition the currently selected sample wave file. To import the currently selected wave file press <span class="minikeys">ALT+PLAY ![alt+play](image/pt-buttons-small-alt_play.jpg)</span>. At any time, you can return to the instrument screen from the sample file browser by pressing <span class="minikeys">NAV+LEFT ![nav+left](image/pt-buttons-small-nav_left.jpg)</span>.
